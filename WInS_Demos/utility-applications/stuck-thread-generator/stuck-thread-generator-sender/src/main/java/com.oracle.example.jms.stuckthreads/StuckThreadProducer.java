package com.oracle.example.jms.stuckthreads;
 ...
 * ****************************************************************************
 */
public class StuckThreadProducer
    extends WLJMSProducer
{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      sender = new WLJMSProducer(Constants.WL_INITIAL_CONTEXT,
                                 Constants.JMS_ENDPOINT_ADDRESS, Constants.USERNAME,
                                 Constants.PASSWORD, JMS_CF_JNDI, JMS_QUEUE_JNDI);
