...
/**
 * <p>Java class for GetParcelEventLogRequestType complex type.
 * <p/>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p/>
 * <pre>
 * &lt;complexType name="GetParcelEventLogRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "GetParcelEventLogRequestType", namespace = "http://demo.oracle.com/ops/domain/services/parcel", propOrder = {
    "requestHeader",
    "parcelId"
})
@XmlRootElement(name = "GetParcelEventLogRequest", namespace = "http://demo.oracle.com/ops/domain/services/parcel")
public class GetParcelEventLogRequest
