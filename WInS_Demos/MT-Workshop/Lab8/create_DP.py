...
cmo.setRoot('/u01/wins/wls1221/user_projects/domains/base_domain/partitions/dp6/system')
...
startEdit()
deploy(appName='conference', partition='dp6', resourceGroup='app6RG', path='/u01/content/weblogic-innovation-seminars/WInS_Demos/MT-Workshop/Lab8/ConferencePlanner.war')
activate()
