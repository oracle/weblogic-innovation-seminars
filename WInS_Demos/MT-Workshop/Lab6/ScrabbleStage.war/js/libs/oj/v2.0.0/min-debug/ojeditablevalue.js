...
define(["ojs/ojcore", "jquery", "hammerjs", "ojs/ojjquery-hammer", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/ojpopup"], function($oj$$4$$, $$$$4$$, $Hammer$$1$$) {
  ...
  $oj$$4$$.$__registerWidget$("oj.editableValue", $$$$4$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{disabled:!1, displayOptions:void 0, help:{definition:null, source:null}, messagesCustom:void 0, messagesHidden:void 0, messagesShown:void 0, required:!1, title:"", validators:void 0, value:void 0}, getNodeBySubId:function($locator$$4$$) {
  ...
  }, $_SaveAttributes$:function($element$$34$$) {
    this.$_SaveAllAttributes$($element$$34$$);
  }, $_RestoreAttributes$:function($element$$35$$) {
    this.$_RestoreAllAttributes$($element$$35$$);
  ...
  }, $_HandleChangeEvent$:function($event$$39$$) {
    var $submittedValue$$ = this.$_GetDisplayValue$();
    this.$_SetValue$($submittedValue$$, $event$$39$$);
  }, $_SetRawValue$:function($val$$20$$, $event$$40$$) {
    var $flags$$11$$ = {};
    $flags$$11$$._context = {originalEvent:$event$$40$$, $writeback$:!0, $internalSet$:!0};
  ...
  }, $_SetValue$:function($newValue_parsed$$, $event$$41$$, $options$$124$$) {
    ...
    if ($doValueChangeCheck$$ && $newValue_parsed$$ === this.$_getLastDisplayValue$()) {
      ...
      if ($newValue_parsed$$ = this.$_Validate$($newValue_parsed$$, $event$$41$$, $options$$124$$), void 0 !== $newValue_parsed$$ && this.isValid()) {
        var $updateContext$$;
        $options$$124$$ && $options$$124$$._context && ($updateContext$$ = $options$$124$$._context);
        this.$_updateValueOption$($newValue_parsed$$, $event$$41$$, $options$$124$$ && $options$$124$$.$validationContext$, $updateContext$$);
        return!0;
      }
    }
    return!1;
  }, $_Validate$:function($newValue$$1$$, $event$$42$$, $doNotClearMessages$$1_options$$125$$) {
    ...
    if (void 0 === $newValue$$1$$) {
      ...
      if (this.$_CanSetValue$()) {
        $doNotClearMessages$$1_options$$125$$ || this.$_clearAllMessages$($event$$42$$);
        this.$_setLastSubmittedValue$($newValue$$1$$);
        try {
          return this.$_runNormalValidation$($newValue$$1$$, $mode$$11$$, $context$$36$$, $event$$42$$);
        } catch ($e$$31$$) {
        }
      } else {
    ...
    return "";
  }, $_MESSAGING_CONTENT_UPDATE_TYPE$:{$ALL$:1, $VALIDITY_STATE$:2, $CONVERTER_HINT$:3, $VALIDATOR_HINTS$:4, $TITLE$:5}, $_OPTION_TO_CSS_MAPPING$:{disabled:"oj-disabled", required:"oj-required"}, $_clearAllMessages$:function($event$$43$$, $doNotSetOption$$) {
    $doNotSetOption$$ ? (this.options.messagesHidden = [], this.options.messagesShown = [], this.options.messagesCustom = []) : (this.$_clearMessages$("messagesHidden", $event$$43$$), this.$_clearMessages$("messagesShown", $event$$43$$), this.$_clearMessages$("messagesCustom", $event$$43$$));
  ...
  }, $_setMessagesOption$:function($key$$35$$, $value$$83$$, $event$$44$$, $changed$$1$$) {
    var $flags$$12$$ = {}, $bothEmpty$$ = 0 === $value$$83$$.length && 0 === this.options[$key$$35$$].length;
    if ($changed$$1$$ || !$bothEmpty$$) {
      $flags$$12$$._context = {originalEvent:$event$$44$$, $writeback$:!0, $internalSet$:!0}, $flags$$12$$.changed = $changed$$1$$ || !$bothEmpty$$, this.$_resetValid$(), this.option($key$$35$$, $value$$83$$, $flags$$12$$), this.$_updateMessagingContent$();
    }
  }, $_clearMessages$:function($option$$7$$, $event$$45$$) {
    this.$_setMessagesOption$($option$$7$$, [], $event$$45$$);
  ...
  }, $_updateMessagesOption$:function($option$$8$$, $newMsgs$$, $event$$46$$) {
    ...
    this.$_setMessagesOption$($option$$8$$, $msgs$$1$$, $event$$46$$, !0);
  }, $_updateMessagingContent$:function() {
    this.$_getComponentMessaging$().update(this.$_getMessagingContent$());
  }, $_updateValueOption$:function($newValue$$2$$, $event$$47$$, $validationContext$$, $context$$39_updateContext$$1$$) {
    $context$$39_updateContext$$1$$ = $context$$39_updateContext$$1$$ || {};
    $event$$47$$ && ($context$$39_updateContext$$1$$.originalEvent = $event$$47$$);
  ...
  }, $_runNormalValidation$:function($newMsgs$$2_value$$91$$, $mode$$12$$, $context$$42$$, $event$$48$$) {
    ...
    try {
      ...
      throw $newMsgs$$2_value$$91$$ = this.$_processValidationErrors$($ve$$1$$, $context$$42$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$2_value$$91$$, $event$$48$$), $ve$$1$$;
    }
    return $newValue$$4$$;
  ...
  }, $_updateElementDisplayValue$:function($modelValue$$1$$, $event$$49$$) {
    ...
    try {
      ...
      $newMsgs$$3$$ = this.$_processValidationErrors$($e$$34$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$3$$, $event$$49$$);
    }
  ...
  $oj$$4$$.$EditableValueUtils$.$getAttributeValue$ = function $$oj$$4$$$$EditableValueUtils$$$getAttributeValue$$($element$$36$$, $attribute$$2$$) {
    var $attrVal_result$$5$$, $propVal$$, $returnVal$$ = {};
    if ($element$$36$$ && $attribute$$2$$) {
      switch($attribute$$2$$) {
        case "disabled":
          $attrVal_result$$5$$ = void 0 !== $element$$36$$.attr("disabled") ? !!$element$$36$$.prop("disabled") : void 0;
          break;
        case "pattern":
          $attrVal_result$$5$$ = $element$$36$$.prop("pattern") || void 0;
          break;
        case "placeholder":
          $attrVal_result$$5$$ = $element$$36$$.prop("placeholder") || void 0;
          break;
        case "readonly":
          $attrVal_result$$5$$ = void 0 !== $element$$36$$.attr("readonly") ? !!$element$$36$$.prop("readonly") : void 0;
          break;
        case "required":
          $attrVal_result$$5$$ = $element$$36$$.attr("required");
          $propVal$$ = $element$$36$$.prop("required");
          $attrVal_result$$5$$ = void 0 !== $attrVal_result$$5$$ ? void 0 !== $propVal$$ ? !!$propVal$$ : !!$attrVal_result$$5$$ : void 0;
          break;
        case "title":
          $attrVal_result$$5$$ = void 0 !== $element$$36$$.attr("title") ? $element$$36$$.prop("title") : void 0;
          break;
        case "value":
          $attrVal_result$$5$$ = $element$$36$$.val() || void 0;
          break;
        default:
          $attrVal_result$$5$$ = $element$$36$$.attr($attribute$$2$$) || void 0;
      }
    }
  ...
  $oj$$4$$.$EditableValueUtils$.$initializeOptionsFromDom$ = function $$oj$$4$$$$EditableValueUtils$$$initializeOptionsFromDom$$($props$$5$$, $constructorOptions$$5$$, $comp$$1$$, $postprocessCallback$$) {
    for (var $initializedOptions$$ = {}, $i$$103$$ = 0;$i$$103$$ < $props$$5$$.length;$i$$103$$++) {
      ...
      var $option$$10$$ = $finalValue_prop$$53$$.option || $attribute$$3_result$$6$$, $coerceDomValue_valueToValidate$$ = $finalValue_prop$$53$$.$coerceDomValue$, $validateOption$$ = $finalValue_prop$$53$$.$validateOption$, $element$$37$$ = $comp$$1$$.element, $previousValue$$ = $comp$$1$$.options[$option$$10$$];
      void 0 === $constructorOptions$$5$$[$option$$10$$] && ($previousValue$$ = $comp$$1$$.options[$option$$10$$], $attribute$$3_result$$6$$ = $oj$$4$$.$EditableValueUtils$.$getAttributeValue$($element$$37$$, $attribute$$3_result$$6$$), $attribute$$3_result$$6$$.$fromDom$ ? ($finalValue_prop$$53$$ = $attribute$$3_result$$6$$.value, $coerceDomValue_valueToValidate$$ && ("boolean" === typeof $coerceDomValue_valueToValidate$$ ? $finalValue_prop$$53$$ = $oj$$4$$.$EditableValueUtils$.$coerceDomValueForOption$($option$$10$$, 
  ...
  $oj$$4$$.$InlineMessagingStrategy$.prototype.$_refreshInlineMessage$ = function $$oj$$4$$$$InlineMessagingStrategy$$$$_refreshInlineMessage$$() {
    ...
    this.$_doesMessageContentRootDomExist$() || (this.$$messagingContentRoot$ = $$$$4$$("\x3cdiv class\x3d'oj-messaging-inline-container'\x3e\x3c/div\x3e"), this.$_addAriaDescribedBy$(this.$$messagingContentRoot$), $domNode_widget$$2$$.append(this.$$messagingContentRoot$));
  ...
  (function() {
    $oj$$4$$.$__registerWidget$("oj._ojLabel", $$$$4$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3clabel\x3e", widgetEventPrefix:"oj", options:{ariaRequiredUnsupported:!1, describedById:null, help:{definition:null, source:null}, required:!1, rootAttributes:null}, $_BUNDLE_KEY$:{$_TOOLTIP_HELP$:"tooltipHelp", $_TOOLTIP_REQUIRED$:"tooltipRequired"}, widget:function() {
      ...
      this.$_drawOnCreate$();
    }, $_SaveAttributes$:function($element$$38$$) {
      this.$_savedClasses$ = $element$$38$$.attr("class");
      ...
      if (0 != $helpIcon$$.length) {
        ...
        var $self$$46$$ = this;
        this.$_openPopupForHelpDefCallbackListener$ || (this.$_openPopupForHelpDefCallbackListener$ = function $this$$_openPopupForHelpDefCallbackListener$$($event$$51$$) {
          $self$$46$$.$_handleOpenPopupForHelpDef$($event$$51$$, $$helpDefPopupDiv$$, $helpIcon$$, !1);
        });
    ...
    }, $_handleOpenPopupForHelpDef$:function($event$$52$$, $helpDefPopupDiv$$1$$, $helpIcon$$1$$, $inMouseDown$$1$$) {
      if ("mousedown" === $event$$52$$.type) {
        $inMouseDown$$1$$ = !0;
      } else {
        if ("focusin" === $event$$52$$.type && $inMouseDown$$1$$) {
          $inMouseDown$$1$$ = !1;
        } else {
          if (this.$_bTouchSupported$) {
            if ("press" === $event$$52$$.type) {
      ...
      var $element$$40$$ = this.element, $helpDef$$6$$ = this.options.help.definition, $title$$7$$;
      $helpDef$$6$$ && ($element$$40$$.addClass("oj-label-help-def"), ($title$$7$$ = $element$$40$$.attr("title")) ? $element$$40$$.attr("title", $title$$7$$ + " " + $helpDef$$6$$) : $element$$40$$.attr("title", $helpDef$$6$$));
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupOpenCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupOpenCallback$$($event$$54$$) {
    var $target$$74$$ = $$$$4$$($event$$54$$.target), $self$$48$$ = this;
  ...
  $oj$$4$$.$PopupMessagingStrategy$.prototype.$_popupCloseCallback$ = function $$oj$$4$$$$PopupMessagingStrategy$$$$_popupCloseCallback$$($event$$55_target$$75$$) {
    $event$$55_target$$75$$ = $$$$4$$($event$$55_target$$75$$.target);
    $oj$$4$$.Components.$isComponentInitialized$($event$$55_target$$75$$) && ($event$$55_target$$75$$.ojPopup("option", "autoDismiss", "none"), $event$$55_target$$75$$.ojPopup("option", "open", null), $event$$55_target$$75$$.ojPopup("option", "close", null));
    delete this.$$messagingContentRoot$;
    $event$$55_target$$75$$.children().remove();
  };
