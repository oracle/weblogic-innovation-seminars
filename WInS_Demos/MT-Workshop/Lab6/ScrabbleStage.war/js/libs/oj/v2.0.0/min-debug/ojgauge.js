...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtGauge"], function($oj$$16$$, $$$$16$$, $comp$$6$$, $base$$4$$, $dvt$$2$$) {
  $oj$$16$$.$__registerWidget$("oj.dvtBaseGauge", $$$$16$$.oj.dvtBaseComponent, {$_ProcessStyles$:function() {
    ...
    return $ret$$32$$;
  }, $_HandleEvent$:function($event$$248$$) {
    var $newValue$$11_type$$82$$ = $event$$248$$ && $event$$248$$.getType ? $event$$248$$.getType() : null;
    $newValue$$11_type$$82$$ === $dvt$$2$$.DvtValueChangeEvent.TYPE ? this.$_UserOptionChange$("value", $event$$248$$.getNewValue()) : $newValue$$11_type$$82$$ === $dvt$$2$$.DvtValueChangeEvent.TYPE_INPUT ? ($newValue$$11_type$$82$$ = $event$$248$$.getNewValue(), this._trigger("input", null, {value:$newValue$$11_type$$82$$}), this.$_UserOptionChange$("rawValue", $event$$248$$.getNewValue())) : this._super($event$$248$$);
  ...
  $oj$$16$$.$__registerWidget$("oj.ojDialGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$72$$, $callback$$93$$, $callbackObj$$1$$) {
    return $dvt$$2$$.DvtDialGauge.newInstance($context$$72$$, $callback$$93$$, $callbackObj$$1$$);
  }, $_ConvertSubIdToLocator$:function($subId$$27$$) {
    var $locator$$22$$ = {};
    "tooltip" == $subId$$27$$ && ($locator$$22$$.subId = "oj-dialgauge-tooltip");
    return $locator$$22$$;
  }, $_GetComponentStyleClasses$:function() {
    var $styleClasses$$3$$ = this._super();
    $styleClasses$$3$$.push("oj-dialgauge");
  ...
  $oj$$16$$.$__registerWidget$("oj.ojLedGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{}, $_CreateDvtComponent$:function($context$$73$$, $callback$$94$$, $callbackObj$$2$$) {
    return $dvt$$2$$.DvtLedGauge.newInstance($context$$73$$, $callback$$94$$, $callbackObj$$2$$);
  }, $_ConvertSubIdToLocator$:function($subId$$28$$) {
    var $locator$$23$$ = {};
    "tooltip" == $subId$$28$$ && ($locator$$23$$.subId = "oj-ledgauge-tooltip");
    return $locator$$23$$;
  }, $_GetComponentStyleClasses$:function() {
    var $styleClasses$$4$$ = this._super();
    $styleClasses$$4$$.push("oj-ledgauge");
  ...
  $oj$$16$$.$__registerWidget$("oj.ojRatingGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$74$$, $callback$$95$$, $callbackObj$$3$$) {
    return $dvt$$2$$.DvtRatingGauge.newInstance($context$$74$$, $callback$$95$$, $callbackObj$$3$$);
  }, $_ConvertSubIdToLocator$:function($subId$$29$$) {
    var $locator$$24$$ = {};
    "tooltip" == $subId$$29$$ ? $locator$$24$$.subId = "oj-ratinggauge-tooltip" : 0 == $subId$$29$$.indexOf("item") && ($locator$$24$$.subId = "oj-ratinggauge-item", $locator$$24$$.index = this.$_GetFirstIndex$($subId$$29$$));
    return $locator$$24$$;
  }, $_GetComponentStyleClasses$:function() {
    var $styleClasses$$5$$ = this._super();
    $styleClasses$$5$$.push("oj-ratinggauge");
  ...
  $oj$$16$$.$__registerWidget$("oj.ojStatusMeterGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$75$$, $callback$$96$$, $callbackObj$$4$$) {
    return $dvt$$2$$.DvtStatusMeterGauge.newInstance($context$$75$$, $callback$$96$$, $callbackObj$$4$$);
