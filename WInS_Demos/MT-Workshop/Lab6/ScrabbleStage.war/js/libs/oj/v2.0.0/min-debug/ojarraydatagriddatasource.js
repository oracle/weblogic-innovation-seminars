...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$23$$) {
  $oj$$23$$.$ArrayCellSet$ = function $$oj$$23$$$$ArrayCellSet$$($startRow$$1$$, $endRow$$, $startColumn$$1$$, $endColumn$$, $callback$$101$$) {
    this.$m_startRow$ = $startRow$$1$$;
    this.$m_endRow$ = $endRow$$;
    this.$m_startColumn$ = $startColumn$$1$$;
    this.$m_endColumn$ = $endColumn$$;
    this.$m_callback$ = $callback$$101$$;
  };
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_getCellData$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_getCellData$$($row$$30$$, $column$$21$$) {
    var $col$$2$$ = this.columns[$column$$21$$];
    return this.$getDataArray$()[$row$$30$$][$col$$2$$];
  };
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_getCellMetadata$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_getCellMetadata$$($row$$31$$, $column$$22$$) {
    return{keys:{row:this.$_getRowKeyByIndex$($row$$31$$), column:this.columns[$column$$22$$]}};
  };
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$fetchCells$$($cellRanges$$, $callbacks$$19$$, $callbackObjects$$5$$) {
    var $cellSet_i$$304$$, $cellRange$$2$$, $rowStart$$1$$, $rowEnd$$, $colStart$$, $colEnd$$;
    for ($cellSet_i$$304$$ = 0;$cellSet_i$$304$$ < $cellRanges$$.length;$cellSet_i$$304$$ += 1) {
      $cellRange$$2$$ = $cellRanges$$[$cellSet_i$$304$$], "row" === $cellRange$$2$$.axis ? ($rowStart$$1$$ = $cellRange$$2$$.start, $rowEnd$$ = Math.min(this.$_size$(), $rowStart$$1$$ + $cellRange$$2$$.count)) : "column" === $cellRange$$2$$.axis && ($colStart$$ = $cellRange$$2$$.start, $colEnd$$ = Math.min(this.columns.length, $colStart$$ + $cellRange$$2$$.count));
    }
    void 0 === $rowEnd$$ || void 0 === $colEnd$$ ? null != $callbacks$$19$$ && null != $callbacks$$19$$.error && (null == $callbackObjects$$5$$ && ($callbackObjects$$5$$ = {}), $callbacks$$19$$.error.call($callbackObjects$$5$$.error)) : ($cellSet_i$$304$$ = new $oj$$23$$.$ArrayCellSet$($rowStart$$1$$, $rowEnd$$, $colStart$$, $colEnd$$, this), null != $callbacks$$19$$ && null != $callbacks$$19$$.success && (null == $callbackObjects$$5$$ && ($callbackObjects$$5$$ = {}), $callbacks$$19$$.success.call($callbackObjects$$5$$.success, 
    $cellSet_i$$304$$, $cellRanges$$)));
  };
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.keys = function $$oj$$23$$$$ArrayDataGridDataSource$$$keys$($indexes$$10$$) {
    ...
    return new Promise(function($resolve$$33$$) {
      $resolve$$33$$({row:this.$_getRowKeyByIndex$($rowIndex$$6$$), column:this.columns[$columnIndex$$2$$]});
    }.bind(this));
  };
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$indexes$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$indexes$$($keys$$35$$) {
    var $rowKey$$30$$ = $keys$$35$$.row, $columnKey$$1$$ = $keys$$35$$.column;
    return new Promise(function($resolve$$34$$) {
      $resolve$$34$$({row:this.$_getRowIndexByKey$($rowKey$$30$$), column:this.columns.indexOf($columnKey$$1$$)});
    }.bind(this));
  };
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.sort = function $$oj$$23$$$$ArrayDataGridDataSource$$$sort$($criteria$$1_direction$$5$$, $callbacks$$20$$, $callbackObjects$$6$$) {
    var $sortArray$$ = [], $newColumns$$ = [], $axis$$34_i$$305$$, $headerIndex$$1_headerKey$$;
    ...
    if (null == $criteria$$1_direction$$5$$) {
      ...
      if ($axis$$34_i$$305$$ = $criteria$$1_direction$$5$$.axis, $headerIndex$$1_headerKey$$ = $criteria$$1_direction$$5$$.key, $criteria$$1_direction$$5$$ = $criteria$$1_direction$$5$$.direction, "column" === $axis$$34_i$$305$$) {
        ...
        if ("row" === $axis$$34_i$$305$$) {
          $headerIndex$$1_headerKey$$ = this.$_getRowIndexByKey$($headerIndex$$1_headerKey$$);
          for ($axis$$34_i$$305$$ = 0;$axis$$34_i$$305$$ < this.columns.length;$axis$$34_i$$305$$ += 1) {
            $sortArray$$[$axis$$34_i$$305$$] = this.$getDataArray$()[$headerIndex$$1_headerKey$$][this.columns[$axis$$34_i$$305$$]];
          }
          $sortArray$$.sort(this.$_naturalSort$($criteria$$1_direction$$5$$));
          for ($axis$$34_i$$305$$ = 0;$axis$$34_i$$305$$ < this.columns.length;$axis$$34_i$$305$$ += 1) {
            $newColumns$$[$axis$$34_i$$305$$] = this.columns[$sortArray$$.indexOf(this.$getDataArray$()[$headerIndex$$1_headerKey$$][this.columns[$axis$$34_i$$305$$]])];
          }
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.move = function $$oj$$23$$$$ArrayDataGridDataSource$$$move$($moveKey$$, $atKey$$) {
    var $event$$354_moveKeyIndex$$, $moveData$$, $atKeyIndex$$;
    $event$$354_moveKeyIndex$$ = this.$_getRowIndexByKey$($moveKey$$);
    $moveData$$ = this.data.splice($event$$354_moveKeyIndex$$, 1)[0];
    this.data instanceof Array && ($event$$354_moveKeyIndex$$ = this.$_getModelEvent$("delete", $moveKey$$, null, $event$$354_moveKeyIndex$$, -1, !0), this.handleEvent("change", $event$$354_moveKeyIndex$$));
    null === $atKey$$ ? this.data.push($moveData$$) : ($atKeyIndex$$ = this.$_getRowIndexByKey$($atKey$$), this.data.splice($atKeyIndex$$, 0, $moveData$$));
    this.data instanceof Array && ($event$$354_moveKeyIndex$$ = this.$_getModelEvent$("insert", $moveKey$$, null, $atKeyIndex$$, -1), this.handleEvent("change", $event$$354_moveKeyIndex$$));
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_getRowIndexByKey$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_getRowIndexByKey$$($key$$132$$) {
    var $i$$306$$, $data$$144$$ = this.$getDataArray$();
    for ($i$$306$$ = 0;$i$$306$$ < $data$$144$$.length;$i$$306$$++) {
      if ($data$$144$$[$i$$306$$].ojKey === $key$$132$$) {
        return $i$$306$$;
      }
    }
    return-1;
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_getModelEvent$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_getModelEvent$$($operation$$4$$, $rowKey$$31$$, $columnKey$$2$$, $rowIndex$$7$$, $columnIndex$$3$$, $silent$$22$$) {
    ...
    $event$$355$$.operation = $operation$$4$$;
    $event$$355$$.keys = {row:$rowKey$$31$$, column:$columnKey$$2$$};
    $event$$355$$.indexes = {row:$rowIndex$$7$$, column:$columnIndex$$3$$};
    $event$$355$$.silent = $silent$$22$$;
    return $event$$355$$;
  };
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_subscribe$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_subscribe$$($changes$$5$$) {
    var $i$$307$$, $move_rowData$$4_rowKey$$32$$, $change$$5_event$$356_rowIndex$$8$$, $added$$1$$ = !1;
    $move_rowData$$4_rowKey$$32$$ = !1;
    var $keys$$36$$ = [], $indexes$$11$$ = [];
    for ($i$$307$$ = 0;$i$$307$$ < $changes$$5$$.length;$i$$307$$++) {
      $change$$5_event$$356_rowIndex$$8$$ = $changes$$5$$[$i$$307$$];
      if (void 0 !== $change$$5_event$$356_rowIndex$$8$$.moved) {
        $move_rowData$$4_rowKey$$32$$ = !0;
        $change$$5_event$$356_rowIndex$$8$$ = this.$_getModelEvent$("refresh", null, null);
        this.handleEvent("change", $change$$5_event$$356_rowIndex$$8$$);
        break;
      }
      "added" === $change$$5_event$$356_rowIndex$$8$$.status && ($added$$1$$ = !0);
    }
    if (!$move_rowData$$4_rowKey$$32$$) {
      for ($i$$307$$ = 0;$i$$307$$ < $changes$$5$$.length;$i$$307$$++) {
        $change$$5_event$$356_rowIndex$$8$$ = $changes$$5$$[$i$$307$$], "deleted" === $change$$5_event$$356_rowIndex$$8$$.status && ($move_rowData$$4_rowKey$$32$$ = $change$$5_event$$356_rowIndex$$8$$.value, $change$$5_event$$356_rowIndex$$8$$ = $change$$5_event$$356_rowIndex$$8$$.index, $move_rowData$$4_rowKey$$32$$ = $move_rowData$$4_rowKey$$32$$.ojKey, $keys$$36$$.push({row:$move_rowData$$4_rowKey$$32$$, column:-1}), $indexes$$11$$.push({row:$change$$5_event$$356_rowIndex$$8$$, column:-1}));
      }
      0 < $keys$$36$$.length && ($change$$5_event$$356_rowIndex$$8$$ = {source:this, operation:"delete", keys:$keys$$36$$, indexes:$indexes$$11$$, silent:$added$$1$$}, this.handleEvent("change", $change$$5_event$$356_rowIndex$$8$$));
      for ($i$$307$$ = 0;$i$$307$$ < $changes$$5$$.length;$i$$307$$++) {
        $change$$5_event$$356_rowIndex$$8$$ = $changes$$5$$[$i$$307$$], "added" === $change$$5_event$$356_rowIndex$$8$$.status && ($move_rowData$$4_rowKey$$32$$ = $change$$5_event$$356_rowIndex$$8$$.value, $change$$5_event$$356_rowIndex$$8$$ = $change$$5_event$$356_rowIndex$$8$$.index, null == $move_rowData$$4_rowKey$$32$$.ojKey && ($move_rowData$$4_rowKey$$32$$.ojKey = this.$lastKey$.toString(), this.$lastKey$++), $move_rowData$$4_rowKey$$32$$ = $move_rowData$$4_rowKey$$32$$.ojKey, $change$$5_event$$356_rowIndex$$8$$ = 
        this.$_getModelEvent$("insert", $move_rowData$$4_rowKey$$32$$, null, $change$$5_event$$356_rowIndex$$8$$, -1), this.handleEvent("change", $change$$5_event$$356_rowIndex$$8$$));
      }
    }
    null != this.$origData$ && (this.$origData$ = this.data.slice());
  };
  ...
  $oj$$23$$.$ArrayHeaderSet$ = function $$oj$$23$$$$ArrayHeaderSet$$($start$$46$$, $end$$16$$, $axis$$35$$, $callback$$102$$) {
    this.$m_start$ = $start$$46$$;
    this.$m_end$ = $end$$16$$;
    this.$m_axis$ = $axis$$35$$;
    this.$m_callback$ = $callback$$102$$;
  };
