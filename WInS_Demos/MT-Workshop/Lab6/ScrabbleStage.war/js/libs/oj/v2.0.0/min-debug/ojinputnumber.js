...
*/
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojbutton"], function($oj$$45$$, $$$$43$$) {
  $oj$$45$$.$__registerWidget$("oj.ojInputNumber", $$$$43$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:$oj$$45$$.$Validation$.$converterFactory$($oj$$45$$.$ConverterFactory$.CONVERTER_TYPE_NUMBER).createConverter(), max:null, min:null, placeholder:void 0, rawValue:void 0, readOnly:!1, step:1, value:null}, getNodeBySubId:function($locator$$42$$) {
    var $node$$92$$ = this._superApply(arguments), $subId$$47$$;
    $node$$92$$ || ($subId$$47$$ = $locator$$42$$.subId, "oj-inputnumber-up" === $subId$$47$$ && ($node$$92$$ = this.widget().find(".oj-inputnumber-up")[0]), "oj-inputnumber-down" === $subId$$47$$ && ($node$$92$$ = this.widget().find(".oj-inputnumber-down")[0]), "oj-inputnumber-input" === $subId$$47$$ && ($node$$92$$ = this.widget().find(".oj-inputnumber-input")[0]));
    return $node$$92$$ || null;
  }, getSubIdByNode:function($node$$93$$) {
    var $subId$$48$$ = null;
    null != $node$$93$$ && ($node$$93$$ === this.widget().find(".oj-inputnumber-up")[0] ? $subId$$48$$ = {subId:"oj-inputnumber-up"} : $node$$93$$ === this.widget().find(".oj-inputnumber-down")[0] ? $subId$$48$$ = {subId:"oj-inputnumber-down"} : $node$$93$$ === this.widget().find(".oj-inputnumber-input")[0] && ($subId$$48$$ = {subId:"oj-inputnumber-input"}));
    ...
    $oj$$45$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"placeholder"}, {$attribute$:"value"}, {$attribute$:"readonly", option:"readOnly", $validateOption$:!0}, {$attribute$:"required", $coerceDomValue$:!0, $validateOption$:!0}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$15$$, this, function($initializedOptions$$1$$) {
      for (var $toParse$$ = ["value", "step", "min", "max"], $i$$374$$ = 0;$i$$374$$ < $toParse$$.length;$i$$374$$++) {
        var $opt$$20$$ = $toParse$$[$i$$374$$], $value$$269$$ = $opt$$20$$ in $initializedOptions$$1$$ ? $initializedOptions$$1$$[$opt$$20$$] : $opts$$35$$[$opt$$20$$];
        null != $value$$269$$ && ($initializedOptions$$1$$[$opt$$20$$] = "step" === $opt$$20$$ ? $self$$196$$.$_parseStep$($value$$269$$) : $self$$196$$.$_parse$($opt$$20$$, $value$$269$$));
      }
    });
    ...
    var $node$$94$$ = this.element;
    this._super();
    this.$_draw$();
    $node$$94$$.removeAttr("pattern");
  ...
  }, _setOption:function($key$$161$$, $value$$270$$, $flags$$42$$) {
    var $coercedValue$$;
    $coercedValue$$ = "value" === $key$$161$$ || "max" === $key$$161$$ || "min" === $key$$161$$ ? this.$_parse$($key$$161$$, $value$$270$$) : "step" === $key$$161$$ ? this.$_parseStep$($value$$270$$) : $value$$270$$;
    this._super($key$$161$$, $coercedValue$$, $flags$$42$$);
    if ("max" === $key$$161$$ || "min" === $key$$161$$) {
      this.$_createRangeValidator$(), this.$_AfterSetOptionValidators$();
    }
    "disabled" === $key$$161$$ && this.element.prop("disabled", !!$value$$270$$);
    "readOnly" === $key$$161$$ && (this.element.prop("readonly", !!$value$$270$$), this.$_refreshStateTheming$("readOnly", this.options.readOnly), this.$_refreshRoleSpinbutton$("readOnly", this.options.readOnly));
  }, _destroy:function() {
    ...
    $oj$$45$$.$DomUtils$.unwrap(this.element, this.$uiInputNumber$);
    clearTimeout(this.$timer$);
    return $ret$$43$$;
  }, $_Refresh$:function($name$$115$$, $value$$271$$, $forceDisplayValueRefresh$$1$$) {
    this._superApply(arguments);
    var $valueMinMax$$ = "value" === $name$$115$$ || "max" === $name$$115$$ || "min" === $name$$115$$, $valueMinMaxDisabled$$ = $valueMinMax$$ || "disabled" === $name$$115$$, $valuenow$$;
    $valueMinMaxDisabled$$ && ($valuenow$$ = this.$_getConvertedDisplayValue$());
    $valueMinMax$$ && this.$_refreshAriaMinMaxValue$($valuenow$$);
    "converter" === $name$$115$$ && this.$_refreshAriaText$($valuenow$$);
    ...
    return $$$$43$$.extend(this.$_inputNumberDefaultValidators$, $ret$$44$$);
    ...
    var $element$$127$$ = this.element, $uiInputNumber$$ = this.$uiInputNumber$ = $element$$127$$.addClass("oj-inputnumber-input").wrap("\x3cspan class\x3d'oj-inputnumber-wrapper'\x3e\x3c/span\x3e").parent().append("\x3cbutton type\x3d'button' class\x3d'oj-inputnumber-button oj-inputnumber-down'\x3e\x3c/button\x3e\x3cbutton type\x3d'button' class\x3d'oj-inputnumber-button oj-inputnumber-up'\x3e\x3c/button\x3e").wrap("\x3cdiv class\x3d'oj-inputnumber oj-component'\x3e\x3c/div\x3e").parent();
    this.saveType = $element$$127$$.prop("type");
    $element$$127$$.attr("type", "text");
  ...
  }, $_repeat$:function($i$$375$$, $steps$$2$$, $event$$511$$) {
    $i$$375$$ = $i$$375$$ || 500;
    clearTimeout(this.$timer$);
    ...
    var $value$$272$$ = this.$_getConvertedDisplayValue$(), $value$$272$$ = this.$_adjustValue$($value$$272$$, $step$$);
    this.$_SetValue$($value$$272$$, $event$$512$$, this.$_VALIDATION_MODE$.$VALIDATORS_ONLY$);
  }, $_precision$:function() {
  ...
  }, $_adjustValue$:function($value$$273$$, $step$$1$$) {
    var $aboveMin_newValue$$20$$, $stepBase$$, $options$$348_precision$$2$$ = this.options, $minOpt$$1_validMax$$ = $options$$348_precision$$2$$.min, $stepOpt$$ = $options$$348_precision$$2$$.step, $maxOpt$$ = $options$$348_precision$$2$$.max, $options$$348_precision$$2$$ = this.$_precision$();
    $stepBase$$ = null != $minOpt$$1_validMax$$ ? $minOpt$$1_validMax$$ : 0;
    $aboveMin_newValue$$20$$ = $value$$273$$ - $stepBase$$;
    var $rounded$$1$$ = Math.round($aboveMin_newValue$$20$$ / $stepOpt$$) * $stepOpt$$, $rounded$$1$$ = parseFloat($rounded$$1$$.toFixed($options$$348_precision$$2$$));
    $rounded$$1$$ !== $aboveMin_newValue$$20$$ ? ($aboveMin_newValue$$20$$ = 0 > $step$$1$$ ? Math.ceil($aboveMin_newValue$$20$$ / $stepOpt$$) * $stepOpt$$ : Math.floor($aboveMin_newValue$$20$$ / $stepOpt$$) * $stepOpt$$, $aboveMin_newValue$$20$$ = $stepBase$$ + $aboveMin_newValue$$20$$ + $step$$1$$) : $aboveMin_newValue$$20$$ = $value$$273$$ + $step$$1$$;
    $aboveMin_newValue$$20$$ = parseFloat($aboveMin_newValue$$20$$.toFixed($options$$348_precision$$2$$));
    return null != $minOpt$$1_validMax$$ && $aboveMin_newValue$$20$$ < $minOpt$$1_validMax$$ ? $minOpt$$1_validMax$$ : null != $maxOpt$$ && $aboveMin_newValue$$20$$ > $maxOpt$$ ? ($minOpt$$1_validMax$$ = Math.floor(($maxOpt$$ - $stepBase$$) / $stepOpt$$) * $stepOpt$$ + $stepBase$$, $minOpt$$1_validMax$$ = parseFloat($minOpt$$1_validMax$$.toFixed($options$$348_precision$$2$$))) : $aboveMin_newValue$$20$$;
  }, $_stop$:function() {
    ...
    var $value$$274$$, $displayValue$$11$$;
    try {
      $displayValue$$11$$ = this.$_GetDisplayValue$() || 0, $value$$274$$ = this.$_parseValue$($displayValue$$11$$);
    } catch ($e$$100$$) {
      $value$$274$$ = void 0;
    }
    return $value$$274$$;
  }, $_blurEnterSetValue$:function($event$$514$$) {
    var $val$$52$$ = this.element.val();
    this.$_stop$();
    var $valuenow$$3$$ = this.$_getConvertedDisplayValue$();
    this.$_refreshAriaMinMaxValue$($valuenow$$3$$);
    this.$_updateButtons$($valuenow$$3$$);
    this.$_SetValue$($val$$52$$, $event$$514$$);
    ...
    this.$_inputNumberDefaultValidators$[$oj$$45$$.$ValidatorFactory$.VALIDATOR_TYPE_NUMBERRANGE] = $oj$$45$$.$Validation$.$validatorFactory$($oj$$45$$.$ValidatorFactory$.VALIDATOR_TYPE_NUMBERRANGE).createValidator($minOpt$$3_numberRangeOptions$$);
  }, $_parse$:function($option$$35$$, $val$$53$$) {
    var $returnValue$$7$$;
    $returnValue$$7$$ = null !== $val$$53$$ ? +$val$$53$$ : $val$$53$$;
    if (isNaN($returnValue$$7$$)) {
      throw Error("ojInputNumber's " + $option$$35$$ + " option is not a number");
    }
    return $returnValue$$7$$;
  }, $_parseStep$:function($parsedStep_val$$54$$) {
    if (null === $parsedStep_val$$54$$) {
      return 1;
    }
    $parsedStep_val$$54$$ = this.$_parse$("step", $parsedStep_val$$54$$);
    if (0 >= $parsedStep_val$$54$$) {
      throw Error("Invalid step for ojInputNumber; step must be \x3e 0");
    }
    if (null === $parsedStep_val$$54$$ || 0 >= $parsedStep_val$$54$$) {
      $parsedStep_val$$54$$ = 1;
    }
    return $parsedStep_val$$54$$;
  }, $_refreshStateTheming$:function($option$$36$$, $value$$275$$) {
    -1 != Object.keys(this.$_OPTION_TO_CSS_MAPPING$).indexOf($option$$36$$) && this.widget().toggleClass(this.$_OPTION_TO_CSS_MAPPING$[$option$$36$$], !!$value$$275$$);
    ...
    var $element$$129$$ = this.element, $valuetext$$ = $element$$129$$.val();
    this.$_CompareOptionValues$("value", "" + $valuenow$$5$$, $valuetext$$) || $element$$129$$.attr({"aria-valuetext":$valuetext$$});
