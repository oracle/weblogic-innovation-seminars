...
define(["ojs/ojcore", "jquery", "ojL10n!ojtranslations/nls/localeElements", "ojs/ojmessaging"], function($oj$$6$$, $$$$6$$, $ojld$$1$$) {
  ...
  $oj$$6$$.$DateTimeRangeValidator$.prototype.validate = function $$oj$$6$$$$DateTimeRangeValidator$$$validate$($value$$107$$) {
    ...
    $customMessageSummary_messageSummaryRangeUnderflow$$.rangeUnderflow, $converterUtils$$ = $oj$$6$$.$IntlConverterUtils$, $min$$1$$ = this.$_min$, $max$$1$$ = this.$_max$, $summary$$13$$ = "", $detail$$16$$ = "", $translations$$3$$ = $oj$$6$$.$Translations$, $params$$5_valStr$$ = null, $valDate$$, $minStr$$, $maxStr$$;
    if (null === $value$$107$$) {
      return $value$$107$$;
    }
    $params$$5_valStr$$ = this.$_converter$.format($value$$107$$);
    ...
    null !== $max$$1$$ && $valDate$$ > $max$$1$$ ? ($params$$5_valStr$$ = {value:$params$$5_valStr$$, max:$maxStr$$}, $summary$$13$$ = $messageSummaryRangeOverflow$$ ? $messageSummaryRangeOverflow$$ : $translations$$3$$.$getTranslatedString$("oj-validator.range.datetime.messageSummary.rangeOverflow"), $detail$$16$$ = $messageDetailRangeOverflow$$ ? $translations$$3$$.$applyParameters$($messageDetailRangeOverflow$$, $params$$5_valStr$$) : $translations$$3$$.$getTranslatedString$("oj-validator.range.datetime.messageDetail.rangeOverflow", 
    $params$$5_valStr$$)) : null !== $min$$1$$ && $valDate$$ < $min$$1$$ && ($params$$5_valStr$$ = {value:$params$$5_valStr$$, min:$minStr$$}, $summary$$13$$ = $customMessageSummary_messageSummaryRangeUnderflow$$ ? $customMessageSummary_messageSummaryRangeUnderflow$$ : $translations$$3$$.$getTranslatedString$("oj-validator.range.datetime.messageSummary.rangeUnderflow"), $detail$$16$$ = $customMessageDetail_messageDetailRangeUnderflow$$ ? $translations$$3$$.$applyParameters$($customMessageDetail_messageDetailRangeUnderflow$$, 
    $params$$5_valStr$$) : $translations$$3$$.$getTranslatedString$("oj-validator.range.datetime.messageDetail.rangeUnderflow", $params$$5_valStr$$));
  ...
  $oj$$6$$.$DateTimeRangeValidator$.prototype.$getHint$ = function $$oj$$6$$$$DateTimeRangeValidator$$$$getHint$$() {
    var $hint$$3$$ = null, $hintMaximum_hints$$4$$ = this.$_hint$, $hintInRange$$ = $hintMaximum_hints$$4$$.inRange, $hintMinimum$$ = $hintMaximum_hints$$4$$.min, $hintMaximum_hints$$4$$ = $hintMaximum_hints$$4$$.max, $min$$2$$ = this.$_min$, $max$$2$$ = this.$_max$, $minStr$$1$$ = $min$$2$$ && this.$_converter$ ? this.$_converter$.format($min$$2$$) : $min$$2$$, $maxStr$$1$$ = $max$$2$$ && this.$_converter$ ? this.$_converter$.format($max$$2$$) : $max$$2$$, $params$$6$$ = null, $translations$$4$$ = 
    $oj$$6$$.$Translations$;
    null !== $min$$2$$ && null !== $max$$2$$ ? ($params$$6$$ = {min:$minStr$$1$$, max:$maxStr$$1$$}, $hint$$3$$ = $hintInRange$$ ? $translations$$4$$.$applyParameters$($hintInRange$$, $params$$6$$) : $translations$$4$$.$getTranslatedString$("oj-validator.range.datetime.hint.inRange", $params$$6$$)) : null !== $min$$2$$ ? ($params$$6$$ = {min:$minStr$$1$$}, $hint$$3$$ = $hintMinimum$$ ? $translations$$4$$.$applyParameters$($hintMinimum$$, $params$$6$$) : $translations$$4$$.$getTranslatedString$("oj-validator.range.datetime.hint.min", 
    $params$$6$$)) : null !== $max$$2$$ && ($params$$6$$ = {max:$maxStr$$1$$}, $hint$$3$$ = $hintMaximum_hints$$4$$ ? $translations$$4$$.$applyParameters$($hintMaximum_hints$$4$$, $params$$6$$) : $translations$$4$$.$getTranslatedString$("oj-validator.range.datetime.hint.max", $params$$6$$));
    return $hint$$3$$;
  };
  ...
  $oj$$6$$.$LengthValidator$.prototype.$getHint$ = function $$oj$$6$$$$LengthValidator$$$$getHint$$() {
    var $hint$$4_params$$7$$ = null, $hintExact_hints$$5$$ = this.$_hint$, $hintInRange$$1$$ = $hintExact_hints$$5$$.inRange, $hintMinimum$$1$$ = $hintExact_hints$$5$$.min, $hintMaximum$$1$$ = $hintExact_hints$$5$$.max, $hintExact_hints$$5$$ = $hintExact_hints$$5$$.exact, $translations$$5$$ = $oj$$6$$.$Translations$, $min$$3$$ = void 0 !== this.$_min$ ? parseInt(this.$_min$, 10) : null, $max$$3$$ = void 0 !== this.$_max$ ? parseInt(this.$_max$, 10) : null;
    null !== $min$$3$$ && null !== $max$$3$$ ? $min$$3$$ !== $max$$3$$ ? ($hint$$4_params$$7$$ = {min:$min$$3$$, max:$max$$3$$}, $hint$$4_params$$7$$ = $hintInRange$$1$$ ? $translations$$5$$.$applyParameters$($hintInRange$$1$$, $hint$$4_params$$7$$) : $translations$$5$$.$getTranslatedString$("oj-validator.length.hint.inRange", $hint$$4_params$$7$$)) : ($hint$$4_params$$7$$ = {length:$min$$3$$}, $hint$$4_params$$7$$ = $hintExact_hints$$5$$ ? $translations$$5$$.$applyParameters$($hintExact_hints$$5$$, 
    $hint$$4_params$$7$$) : $translations$$5$$.$getTranslatedString$("oj-validator.length.hint.exact", $hint$$4_params$$7$$)) : null !== $min$$3$$ ? ($hint$$4_params$$7$$ = {min:$min$$3$$}, $hint$$4_params$$7$$ = $hintMinimum$$1$$ ? $translations$$5$$.$applyParameters$($hintMinimum$$1$$, $hint$$4_params$$7$$) : $translations$$5$$.$getTranslatedString$("oj-validator.length.hint.min", $hint$$4_params$$7$$)) : null !== $max$$3$$ && ($hint$$4_params$$7$$ = {max:$max$$3$$}, $hint$$4_params$$7$$ = $hintMaximum$$1$$ ? 
    $translations$$5$$.$applyParameters$($hintMaximum$$1$$, $hint$$4_params$$7$$) : $translations$$5$$.$getTranslatedString$("oj-validator.length.hint.max", $hint$$4_params$$7$$));
    return $hint$$4_params$$7$$;
  };
  $oj$$6$$.$LengthValidator$.prototype.validate = function $$oj$$6$$$$LengthValidator$$$validate$($params$$8_value$$119$$) {
    var $string$$1_summary$$17$$ = "", $detail$$20_messageTooShort$$ = "", $string$$1_summary$$17$$ = "" + $params$$8_value$$119$$, $length$$12$$ = $string$$1_summary$$17$$.length, $customMessageDetail$$1_messageTooLong$$ = this.$_customMessageDetail$, $customMessageSummary$$1_translations$$6$$ = this.$_customMessageSummary$, $detail$$20_messageTooShort$$ = $customMessageDetail$$1_messageTooLong$$.tooShort, $customMessageDetail$$1_messageTooLong$$ = $customMessageDetail$$1_messageTooLong$$.tooLong, 
    ...
    $length$$12$$ < this.$_min$ ? ($params$$8_value$$119$$ = {value:$params$$8_value$$119$$, min:$min$$4$$}, $string$$1_summary$$17$$ = $messageSummaryTooShort$$ ? $customMessageSummary$$1_translations$$6$$.$applyParameters$($messageSummaryTooShort$$, $params$$8_value$$119$$) : $customMessageSummary$$1_translations$$6$$.$getTranslatedString$("oj-validator.length.messageSummary.tooShort"), $detail$$20_messageTooShort$$ = $detail$$20_messageTooShort$$ ? $customMessageSummary$$1_translations$$6$$.$applyParameters$($detail$$20_messageTooShort$$, 
    $params$$8_value$$119$$) : $customMessageSummary$$1_translations$$6$$.$getTranslatedString$("oj-validator.length.messageDetail.tooShort", $params$$8_value$$119$$)) : ($params$$8_value$$119$$ = {value:$params$$8_value$$119$$, max:$max$$4$$}, $string$$1_summary$$17$$ = $messageSummaryTooLong$$ ? $customMessageSummary$$1_translations$$6$$.$applyParameters$($messageSummaryTooLong$$, $params$$8_value$$119$$) : $customMessageSummary$$1_translations$$6$$.$getTranslatedString$("oj-validator.length.messageSummary.tooLong"), 
    $detail$$20_messageTooShort$$ = $customMessageDetail$$1_messageTooLong$$ ? $customMessageSummary$$1_translations$$6$$.$applyParameters$($customMessageDetail$$1_messageTooLong$$, $params$$8_value$$119$$) : $customMessageSummary$$1_translations$$6$$.$getTranslatedString$("oj-validator.length.messageDetail.tooLong", $params$$8_value$$119$$));
  ...
  $oj$$6$$.$NumberRangeValidator$.prototype.validate = function $$oj$$6$$$$NumberRangeValidator$$$validate$($value$$120$$) {
    ...
    this.$_converter$ ? this.$_converter$.format($max$$5$$) : $max$$5$$, $summary$$18$$ = "", $detail$$21$$ = "", $params$$9$$ = null, $translations$$7$$ = $oj$$6$$.$Translations$;
    if (null === $value$$120$$) {
      return $value$$120$$;
    }
    ...
    null !== $max$$5$$ && $numberValue$$ > $max$$5$$ ? ($params$$9$$ = {value:$value$$120$$, max:$maxStr$$2$$}, $summary$$18$$ = $messageSummaryRangeOverflow$$1$$ ? $messageSummaryRangeOverflow$$1$$ : $translations$$7$$.$getTranslatedString$("oj-validator.range.number.messageSummary.rangeOverflow"), $detail$$21$$ = $messageDetailRangeOverflow$$1$$ ? $translations$$7$$.$applyParameters$($messageDetailRangeOverflow$$1$$, $params$$9$$) : $translations$$7$$.$getTranslatedString$("oj-validator.range.number.messageDetail.rangeOverflow", 
    $params$$9$$)) : null !== $min$$5$$ && $numberValue$$ < $min$$5$$ && ($params$$9$$ = {value:$value$$120$$, min:$minStr$$2$$}, $summary$$18$$ = $customMessageSummary$$2_messageSummaryRangeUnderflow$$1$$ ? $customMessageSummary$$2_messageSummaryRangeUnderflow$$1$$ : $translations$$7$$.$getTranslatedString$("oj-validator.range.number.messageSummary.rangeUnderflow"), $detail$$21$$ = $customMessageDetail$$2_messageDetailRangeUnderflow$$1$$ ? $translations$$7$$.$applyParameters$($customMessageDetail$$2_messageDetailRangeUnderflow$$1$$, 
    $params$$9$$) : $translations$$7$$.$getTranslatedString$("oj-validator.range.number.messageDetail.rangeUnderflow", $params$$9$$));
  ...
  $OraDateTimeConverter$$ = function() {
    ...
    $_parseLenientyMEd$$ = function $$_parseLenientyMEd$$$($timepart$$1_value$$132$$, $format$$15$$, $options$$170_parsedDate_result$$10$$, $localeElements$$27$$, $isDateTime$$) {
      ...
      var $dName$$1_year$$2$$, $month$$2_weekDay$$, $day$$1$$, $yearIndex$$1$$, $dayIndex$$, $i$$114$$, $foundYear$$ = !1, $foundDay$$ = !1;
      for ($i$$114$$ = 1;3 >= $i$$114$$;$i$$114$$++) {
        var $tokenMatch$$ = $daysInMonth_match$$6$$[$i$$114$$];
        if (2 < $tokenMatch$$.length || 31 < $tokenMatch$$) {
          $dName$$1_year$$2$$ = $tokenMatch$$, $foundYear$$ = !0, $yearIndex$$1$$ = $i$$114$$ - 1;
        }
      }
      ...
      if ($foundDay$$) {
        for ($i$$114$$ = 0;3 > $i$$114$$;$i$$114$$++) {
          if ($i$$114$$ !== $dayIndex$$ && $i$$114$$ !== $yearIndex$$1$$) {
    ...
    $_parseLenientyMMMEd$$ = function $$_parseLenientyMMMEd$$$($timepart$$2_value$$133$$, $format$$16$$, $options$$171_parsedDate$$1$$, $localeElements$$28$$, $isDateTime$$1$$) {
      ...
      for ($dRegExp$$1_i$$115_weekDay$$1$$ = 1;2 >= $dRegExp$$1_i$$115_weekDay$$1$$;$dRegExp$$1_i$$115_weekDay$$1$$++) {
        if ($reverseMonth_tokenMatch$$1$$ = $calMonthsFmt$$1_match$$7_months$$2$$[$dRegExp$$1_i$$115_weekDay$$1$$], 2 < $reverseMonth_tokenMatch$$1$$.length || 31 < $reverseMonth_tokenMatch$$1$$) {
          $daysInMonth$$1_result$$11_year$$3$$ = $reverseMonth_tokenMatch$$1$$, $calMonthsStandAlone_foundMatch$$1_foundYear$$1_mainNode$$11$$ = !0, $day$$2_yearIndex$$2$$ = $dRegExp$$1_i$$115_weekDay$$1$$ - 1;
        }
      }
  ...
  $OraNumberConverter$$ = function() {
    ...
    $_toRawFixed$$ = function $$_toRawFixed$$$($number$$2_sep$$, $options$$184_stringIndex$$, $numberSettings$$6$$) {
      ...
      for ($right$$4$$ = 1 < $right$$4$$.length ? $right$$4$$ : "";0 <= $options$$184_stringIndex$$;) {
        if (0 === $curSize_rets$$ || $curSize_rets$$ > $options$$184_stringIndex$$) {
          return $curSize_rets$$ = $factor$$2_numberString_rounded$$.slice(0, $options$$184_stringIndex$$ + 1) + ($precision_ret$$16$$.length ? $number$$2_sep$$ + $precision_ret$$16$$ + $right$$4$$ : $right$$4$$);
        }
        $precision_ret$$16$$ = $factor$$2_numberString_rounded$$.slice($options$$184_stringIndex$$ - $curSize_rets$$ + 1, $options$$184_stringIndex$$ + 1) + ($precision_ret$$16$$.length ? $number$$2_sep$$ + $precision_ret$$16$$ : "");
        $options$$184_stringIndex$$ -= $curSize_rets$$;
      }
      return $curSize_rets$$ = $factor$$2_numberString_rounded$$.slice(0, $options$$184_stringIndex$$ + 1) + $number$$2_sep$$ + $precision_ret$$16$$ + $right$$4$$;
    };
    ...
    $_applyPatternImpl$$ = function $$_applyPatternImpl$$$($options$$187$$, $pattern$$10$$, $localeElements$$44$$, $numberSettings$$13$$) {
      for (var $gotNegative$$ = !1, $useExponentialNotation$$ = !1, $phaseOneLength$$ = 0, $start$$26$$ = 0, $isPrefix$$ = !0, $j$$18$$ = 1;0 <= $j$$18$$ && $start$$26$$ < $pattern$$10$$.length;--$j$$18$$) {
        for (var $digitTotalCount_inQuote$$ = !1, $prefix$$16$$ = "", $suffix$$ = "", $decimalPos$$1$$ = -1, $multiplier$$ = 1, $digitLeftCount$$ = 0, $n$$19_zeroDigitCount$$ = 0, $digitRightCount$$ = 0, $groupingCount$$ = -1, $minExponentDigits$$, $phase$$ = 0, $isPrefix$$ = !0, $pos$$4$$ = $start$$26$$;$pos$$4$$ < $pattern$$10$$.length;++$pos$$4$$) {
  ...
  $oj$$6$$.$RegExpValidator$.prototype.validate = function $$oj$$6$$$$RegExpValidator$$$validate$($params$$10_value$$147$$) {
    var $pattern$$11$$ = this.$_options$ && this.$_options$.pattern || "", $label$$2$$, $localizedSummary_summary$$19$$, $detail$$22_localizedDetail$$;
    if (null === $params$$10_value$$147$$ || void 0 === $params$$10_value$$147$$ || "" === $params$$10_value$$147$$) {
      return!0;
    }
    $params$$10_value$$147$$ = $params$$10_value$$147$$ ? $params$$10_value$$147$$.toString() : $params$$10_value$$147$$;
    var $matchArr$$;
    $matchArr$$ = $params$$10_value$$147$$.match("^(" + $pattern$$11$$ + ")$");
    if (null === $matchArr$$ || $matchArr$$[0] !== $params$$10_value$$147$$) {
      throw this.$_options$ && ($localizedSummary_summary$$19$$ = this.$_options$.messageSummary || null, $detail$$22_localizedDetail$$ = this.$_options$.messageDetail || null, $label$$2$$ = this.$_options$ && this.$_options$.label || ""), $params$$10_value$$147$$ = {label:$label$$2$$, pattern:$pattern$$11$$, value:$params$$10_value$$147$$}, $localizedSummary_summary$$19$$ = $localizedSummary_summary$$19$$ ? $oj$$6$$.$Translations$.$applyParameters$($localizedSummary_summary$$19$$, $params$$10_value$$147$$) : 
      $oj$$6$$.$Translations$.$getTranslatedString$(this.$_getSummaryKey$(), $params$$10_value$$147$$), $detail$$22_localizedDetail$$ = $detail$$22_localizedDetail$$ ? $oj$$6$$.$Translations$.$applyParameters$($detail$$22_localizedDetail$$, $params$$10_value$$147$$) : $oj$$6$$.$Translations$.$getTranslatedString$(this.$_getDetailKey$(), $params$$10_value$$147$$), new $oj$$6$$.$ValidatorError$($localizedSummary_summary$$19$$, $detail$$22_localizedDetail$$);
    }
    return!0;
  };
  ...
  $oj$$6$$.$RequiredValidator$.prototype.validate = function $$oj$$6$$$$RequiredValidator$$$validate$($localizedSummary$$1_value$$148$$) {
    var $detail$$23_localizedDetail$$1$$, $summary$$20$$, $label$$3_params$$12$$ = {}, $label$$3_params$$12$$ = "";
    ...
    this.$_options$ && ($detail$$23_localizedDetail$$1$$ = this.$_options$.messageDetail || this.$_options$.message || null, $summary$$20$$ = this.$_options$.messageSummary || null, $label$$3_params$$12$$ = this.$_options$.label || "");
    $label$$3_params$$12$$ = {label:$label$$3_params$$12$$};
    $localizedSummary$$1_value$$148$$ = $summary$$20$$ ? $oj$$6$$.$Translations$.$applyParameters$($summary$$20$$, $label$$3_params$$12$$) : $oj$$6$$.$Translations$.$getTranslatedString$(this.$_getSummaryKey$(), $label$$3_params$$12$$);
    $detail$$23_localizedDetail$$1$$ = $detail$$23_localizedDetail$$1$$ ? $oj$$6$$.$Translations$.$applyParameters$($detail$$23_localizedDetail$$1$$, $label$$3_params$$12$$) : $oj$$6$$.$Translations$.$getTranslatedString$(this.$_getDetailKey$(), $label$$3_params$$12$$);
