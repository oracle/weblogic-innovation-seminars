 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise"], function($oj$$41$$, $$$$39$$) {
  $oj$$41$$.$FilmStripPagingModel$ = function $$oj$$41$$$$FilmStripPagingModel$$() {
    this.Init();
  };
  $oj$$41$$.$Object$.$createSubclass$($oj$$41$$.$FilmStripPagingModel$, $oj$$41$$.$EventSource$, "oj.FilmStripPagingModel");
  $oj$$41$$.$FilmStripPagingModel$.prototype.Init = function $$oj$$41$$$$FilmStripPagingModel$$$Init$() {
    $oj$$41$$.$FilmStripPagingModel$.$superclass$.Init.call(this);
    this.$_page$ = -1;
    this.$_totalSize$ = 0;
    this.$_pageSize$ = -1;
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.Init", {Init:$oj$$41$$.$FilmStripPagingModel$.prototype.Init});
  $oj$$41$$.$FilmStripPagingModel$.prototype.$setTotalSize$ = function $$oj$$41$$$$FilmStripPagingModel$$$$setTotalSize$$($totalSize$$7$$) {
    this.$_totalSize$ = $totalSize$$7$$;
  };
  $oj$$41$$.$FilmStripPagingModel$.prototype.getPage = function $$oj$$41$$$$FilmStripPagingModel$$$getPage$() {
    return this.$_page$;
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getPage", {getPage:$oj$$41$$.$FilmStripPagingModel$.prototype.getPage});
  $oj$$41$$.$FilmStripPagingModel$.prototype.setPage = function $$oj$$41$$$$FilmStripPagingModel$$$setPage$($page$$8$$, $options$$325$$) {
    ...
    try {
      ...
      $options$$325$$ && $options$$325$$.pageSize && ($pageSize$$8$$ = $options$$325$$.pageSize);
      ...
      return Promise.reject($e$$98$$);
    }
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.setPage", {setPage:$oj$$41$$.$FilmStripPagingModel$.prototype.setPage});
  $oj$$41$$.$FilmStripPagingModel$.prototype.getStartItemIndex = function $$oj$$41$$$$FilmStripPagingModel$$$getStartItemIndex$() {
    return this.$_page$ * this.$_pageSize$;
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getStartItemIndex", {getStartItemIndex:$oj$$41$$.$FilmStripPagingModel$.prototype.getStartItemIndex});
  $oj$$41$$.$FilmStripPagingModel$.prototype.getEndItemIndex = function $$oj$$41$$$$FilmStripPagingModel$$$getEndItemIndex$() {
    return Math.min(this.getStartItemIndex() + this.$_pageSize$, this.$_totalSize$) - 1;
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getEndItemIndex", {getEndItemIndex:$oj$$41$$.$FilmStripPagingModel$.prototype.getEndItemIndex});
  $oj$$41$$.$FilmStripPagingModel$.prototype.getPageCount = function $$oj$$41$$$$FilmStripPagingModel$$$getPageCount$() {
    return Math.ceil(this.$_totalSize$ / this.$_pageSize$);
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.getPageCount", {getPageCount:$oj$$41$$.$FilmStripPagingModel$.prototype.getPageCount});
  $oj$$41$$.$FilmStripPagingModel$.prototype.totalSize = function $$oj$$41$$$$FilmStripPagingModel$$$totalSize$() {
    return this.$_totalSize$;
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.totalSize", {totalSize:$oj$$41$$.$FilmStripPagingModel$.prototype.totalSize});
  $oj$$41$$.$FilmStripPagingModel$.prototype.totalSizeConfidence = function $$oj$$41$$$$FilmStripPagingModel$$$totalSizeConfidence$() {
    return "actual";
  };
  $oj$$41$$.$Object$.$exportPrototypeSymbol$("FilmStripPagingModel.prototype.totalSizeConfidence", {totalSizeConfidence:$oj$$41$$.$FilmStripPagingModel$.prototype.totalSizeConfidence});
  (function() {
    ...
    $oj$$41$$.$__registerWidget$("oj.ojFilmStrip", $$$$39$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{maxItemsPerPage:0, orientation:"horizontal", currentItem:0, arrowPlacement:"adjacent", arrowVisibility:"auto"}, _ComponentCreate:function() {
      this._super();
      var $elem$$91_options$$326$$ = this.element;
      $elem$$91_options$$326$$.addClass("oj-filmstrip oj-component").attr("tabindex", 0).attr("role", "region");
      $elem$$91_options$$326$$.uniqueId();
      $elem$$91_options$$326$$ = this.options;
      $elem$$91_options$$326$$.disabled && $oj$$41$$.$Logger$.warn($_WARNING_DISABLED_OPTION$$1$$);
      if ($elem$$91_options$$326$$.orientation !== $_HORIZONTAL$$ && $elem$$91_options$$326$$.orientation !== $_VERTICAL$$) {
        throw Error($_ERROR_INVALID_ORIENTATION$$ + $elem$$91_options$$326$$.orientation);
      }
      if ($elem$$91_options$$326$$.arrowPlacement !== $_ADJACENT$$ && $elem$$91_options$$326$$.arrowPlacement !== $_OVERLAY$$) {
        throw Error($_ERROR_INVALID_NAV_ARROW_PLACEMENT$$ + $elem$$91_options$$326$$.arrowPlacement);
      }
      if ($elem$$91_options$$326$$.arrowVisibility !== $_VISIBLE$$ && $elem$$91_options$$326$$.arrowVisibility !== $_HIDDEN$$ && $elem$$91_options$$326$$.arrowVisibility !== $_HOVER$$ && $elem$$91_options$$326$$.arrowVisibility !== $_AUTO$$) {
        throw Error($_ERROR_INVALID_NAV_ARROW_VISIBILITY$$ + $elem$$91_options$$326$$.arrowVisibility);
      }
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        this.$_bTouchSupported$ = $oj$$41$$.$DomUtils$.$isTouchSupported$();
        var $elem$$92_oldIsInit$$1$$ = this.element, $self$$182$$ = this;
        $isInit$$1_pagingModel$$ ? (this.$_itemsPerPage$ = 0, this.$_handlePageFunc$ = function $this$$_handlePageFunc$$($event$$469$$) {
          $self$$182$$.$_handlePage$($event$$469$$);
        }, this.$_pagingModel$ = new $oj$$41$$.$FilmStripPagingModel$, this.$_componentSize$ = 0, this.$_itemSize$ = -1, this.$_handleTransitionEndFunc$ = function $this$$_handleTransitionEndFunc$$() {
        ...
        for (var $originalItems$$ = $elem$$92_oldIsInit$$1$$.children(), $i$$351$$ = 0;$i$$351$$ < $originalItems$$.length;$i$$351$$++) {
          $oj$$41$$.Components.$subtreeDetached$($originalItems$$[$i$$351$$]);
        }
        ...
        this.$_wrapChildren$();
        this.$_adjustSizes$();
        for ($i$$351$$ = 0;$i$$351$$ < $originalItems$$.length;$i$$351$$++) {
          $oj$$41$$.Components.$subtreeAttached$($originalItems$$[$i$$351$$]);
        }
        $oj$$41$$.$DomUtils$.$addResizeListener$($elem$$92_oldIsInit$$1$$[0], this.$_handleResizeFunc$);
      } else {
        $elem$$92_oldIsInit$$1$$ = !1, this.$_needsSetup$ && ($elem$$92_oldIsInit$$1$$ = this.$_needsSetup$[0]), this.$_needsSetup$ = [$isInit$$1_pagingModel$$ || $elem$$92_oldIsInit$$1$$];
      }
    }, _destroy:function() {
      ...
      var $elem$$93$$ = this.element;
      $elem$$93$$.removeClass("oj-filmstrip oj-component " + $_OJ_FILMSTRIP_HOVER$$).removeAttr("tabindex role");
      $elem$$93$$.removeUniqueId();
      this._super();
    }, $_destroyInternal$:function() {
      $oj$$41$$.$DomUtils$.$removeResizeListener$(this.element[0], this.$_handleResizeFunc$);
      this.$_itemSize$ = -1;
      this.$_queuedHandleResize$ && (clearTimeout(this.$_queuedHandleResize$), this.$_queuedHandleResize$ = null);
      for (var $originalItems$$1$$ = this.$_getItems$(), $i$$352$$ = 0;$i$$352$$ < $originalItems$$1$$.length;$i$$352$$++) {
        $oj$$41$$.Components.$subtreeDetached$($originalItems$$1$$[$i$$352$$]);
      }
      this.$_clearCalculatedSizes$();
      this.$_getItemContainers$().unwrap();
      this.$_unwrapChildren$();
      for ($i$$352$$ = 0;$i$$352$$ < $originalItems$$1$$.length;$i$$352$$++) {
        $oj$$41$$.Components.$subtreeAttached$($originalItems$$1$$[$i$$352$$]);
      }
    }, _setOption:function($key$$157$$, $value$$266$$, $flags$$40$$) {
      ...
      switch($key$$157$$) {
        case "disabled":
          $oj$$41$$.$Logger$.warn($_WARNING_DISABLED_OPTION$$1$$);
          break;
        case "orientation":
          if ($value$$266$$ !== $_HORIZONTAL$$ && $value$$266$$ !== $_VERTICAL$$) {
            throw Error($_ERROR_INVALID_ORIENTATION$$ + $value$$266$$);
          }
          $bRefresh$$ = $options$$327$$.orientation != $value$$266$$;
          break;
        case "maxItemsPerPage":
          $bRefresh$$ = $options$$327$$.maxItemsPerPage != $value$$266$$;
          break;
        case "arrowPlacement":
          if ($value$$266$$ !== $_ADJACENT$$ && $value$$266$$ !== $_OVERLAY$$) {
            throw Error($_ERROR_INVALID_NAV_ARROW_PLACEMENT$$ + $value$$266$$);
          }
          $bRefresh$$ = $options$$327$$.arrowPlacement != $value$$266$$;
          break;
        case "arrowVisibility":
          if ($value$$266$$ !== $_VISIBLE$$ && $value$$266$$ !== $_HIDDEN$$ && $value$$266$$ !== $_HOVER$$ && $value$$266$$ !== $_AUTO$$) {
            throw Error($_ERROR_INVALID_NAV_ARROW_VISIBILITY$$ + $value$$266$$);
          }
          $bRefresh$$ = $options$$327$$.arrowVisibility != $value$$266$$;
          break;
        case $_CURRENT_ITEM$$:
          if ($options$$327$$.currentItem != $value$$266$$ && ($newPageIndex$$ = this.$_findPage$($value$$266$$), 0 > $newPageIndex$$ || $newPageIndex$$ >= $pagingModel$$1$$.getPageCount())) {
            throw Error($_ERROR_CURRENT_ITEM_NOT_FOUND$$ + $value$$266$$);
          }
        ;
      }
      this._super($key$$157$$, $value$$266$$, $flags$$40$$);
      switch($key$$157$$) {
        case $_CURRENT_ITEM$$:
      ...
      var $div$$4$$ = document.createElement("div"), $elem$$95_style$$19$$ = $div$$4$$.style;
      $elem$$95_style$$19$$.position = "absolute";
      $elem$$95_style$$19$$.width = "10px";
      $elem$$95_style$$19$$.height = "10px";
      $elem$$95_style$$19$$ = this.element[0];
      $elem$$95_style$$19$$.appendChild($div$$4$$);
      var $bCanCalcSizes$$1$$ = !1;
      try {
        $bCanCalcSizes$$1$$ = 0 < $div$$4$$.offsetWidth && 0 < $div$$4$$.offsetHeight;
      } catch ($e$$99$$) {
      }
      $elem$$95_style$$19$$.removeChild($div$$4$$);
      return $bCanCalcSizes$$1$$;
    }, $_wrapChildren$:function() {
      var $elem$$96$$ = this.element, $bHorizontal$$2$$ = this.$_isHorizontal$();
      $elem$$96$$.children().addClass($_OJ_FILMSTRIP_ITEM$$).wrap("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_ITEM_CONTAINER$$ + "'\x3e\x3c/div\x3e");
      var $cssAttr_pagesWrapper$$ = this.$_getCssPositionAttr$();
      this.$_pagesWrapper$ = $cssAttr_pagesWrapper$$ = $elem$$96$$.children().wrapAll("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_PAGES_CONTAINER$$ + "' style\x3d'" + $cssAttr_pagesWrapper$$ + ": 0px;'\x3e\x3c/div\x3e").parent();
      ...
      $elem$$96$$.addClass($_OJ_FILMSTRIP_CONTAINER$$);
      $bHorizontal$$2$$ || $elem$$96$$.addClass($_OJ_FILMSTRIP_VERTICAL$$);
      $options$$329$$.arrowVisibility !== $_HIDDEN$$ && (this.$_prevButton$ = this.$_createPrevNavArrow$(), this.$_nextButton$ = this.$_createNextNavArrow$(), this.$_navArrowsShownOnHover$() && this.$_setupNavArrowsHoverable$());
    }, $_unwrapChildren$:function() {
      var $elem$$97$$ = this.element, $originalItems$$3$$ = this.$_getItems$();
      ...
      var $navArrowContainers$$ = $elem$$97$$.children($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW_CONTAINER$$);
      ...
      $elem$$97$$.removeClass($_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_VERTICAL$$);
      ...
      var $elem$$100_label$$13$$ = this.element, $locationMarker_navArrow$$ = this.$_isHorizontal$() ? $_OJ_START$$ : $_OJ_TOP$$, $container$$25$$ = this.$_createNavigationArrowContainer$($locationMarker_navArrow$$);
      this.options.arrowPlacement === $_OVERLAY$$ ? $elem$$100_label$$13$$.append($container$$25$$) : $elem$$100_label$$13$$.prepend($container$$25$$);
      var $elem$$100_label$$13$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowPreviousPage")), $tooltip$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowPreviousPage")), $locationMarker_navArrow$$ = this.$_createNavigationArrow$($container$$25$$, $locationMarker_navArrow$$, $elem$$100_label$$13$$, $tooltip$$), $self$$184$$ = this;
      $locationMarker_navArrow$$.on("click", function() {
        $self$$184$$.$_prevPage$();
      });
      return $locationMarker_navArrow$$;
    }, $_createNextNavArrow$:function() {
      var $elem$$101_label$$14$$ = this.element, $locationMarker$$1_navArrow$$1$$ = this.$_isHorizontal$() ? $_OJ_END$$ : $_OJ_BOTTOM$$, $container$$26$$ = this.$_createNavigationArrowContainer$($locationMarker$$1_navArrow$$1$$);
      $elem$$101_label$$14$$.append($container$$26$$);
      var $elem$$101_label$$14$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowNextPage")), $tooltip$$1$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowNextPage")), $locationMarker$$1_navArrow$$1$$ = this.$_createNavigationArrow$($container$$26$$, $locationMarker$$1_navArrow$$1$$, $elem$$101_label$$14$$, $tooltip$$1$$), $self$$185$$ = this;
      ...
      return $container$$27$$;
    }, $_createNavigationArrow$:function($arrowElem_parentElem$$4$$, $elemId_locationMarker$$3$$, $label$$15$$, $tooltip$$2$$) {
      ...
      this.$_clearCalculatedSizes$();
      var $currPage_options$$336$$ = this.options, $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = this.$_isHorizontal$(), $fitCount_itemsPerPage$$ = $currPage_options$$336$$.maxItemsPerPage, $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ = 1 > $fitCount_itemsPerPage$$, $elem$$103_firstArrowContainer_pagingModel$$7$$ = this.element, $items$$11$$ = this.$_getItemContainers$();
      if (0 > this.$_itemSize$) {
        ...
        $oj$$41$$.Components.$subtreeShown$($optionItem_pages$$2$$[0]);
      ...
      $componentSize_optionItemContainer_optionItemIndex$$ = $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ ? $elem$$103_firstArrowContainer_pagingModel$$7$$.width() : $elem$$103_firstArrowContainer_pagingModel$$7$$.height();
      $currPage_options$$336$$.arrowVisibility !== $_HIDDEN$$ && $currPage_options$$336$$.arrowPlacement === $_ADJACENT$$ && ($elem$$103_firstArrowContainer_pagingModel$$7$$ = $elem$$103_firstArrowContainer_pagingModel$$7$$.children($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW_CONTAINER$$).eq(0), $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ ? $elem$$103_firstArrowContainer_pagingModel$$7$$.width() : $elem$$103_firstArrowContainer_pagingModel$$7$$.height(), 
      ...
      $elem$$103_firstArrowContainer_pagingModel$$7$$ = this.$_pagingModel$;
      if ($elem$$103_firstArrowContainer_pagingModel$$7$$.getPageCount() != $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ || this.$_itemsPerPage$ != $fitCount_itemsPerPage$$ || !$optionItem_pages$$2$$ || 1 > $optionItem_pages$$2$$.length) {
        $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = !0;
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for (var $i$$353$$ = 0;$i$$353$$ < $items$$11$$.length;$i$$353$$++) {
            $oj$$41$$.Components.$subtreeDetached$($items$$11$$[$i$$353$$]);
          }
        }
        $optionItem_pages$$2$$ && 0 < $optionItem_pages$$2$$.length && $items$$11$$.unwrap();
        for ($i$$353$$ = 0;$i$$353$$ < $items$$11$$.length;$i$$353$$ += $fitCount_itemsPerPage$$) {
          $items$$11$$.slice($i$$353$$, $i$$353$$ + $fitCount_itemsPerPage$$).wrapAll("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_PAGE$$ + "' style\x3d'" + $_DISPLAY$$ + ": " + $_NONE$$ + ";' " + $_ARIA_HIDDEN$$ + "\x3d'true'\x3e\x3c/div\x3e");
        }
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for ($i$$353$$ = 0;$i$$353$$ < $items$$11$$.length;$i$$353$$++) {
            $oj$$41$$.Components.$subtreeAttached$($items$$11$$[$i$$353$$]);
          }
        }
      }
      $optionItem_pages$$2$$ = this.$_getPages$();
      ...
      $elem$$103_firstArrowContainer_pagingModel$$7$$.getPageCount() != $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ || this.$_itemsPerPage$ != $fitCount_itemsPerPage$$ || $elem$$103_firstArrowContainer_pagingModel$$7$$.getPage() != $bNotifyAttach_contentWrapper_newPageIndex$$1$$ ? $elem$$103_firstArrowContainer_pagingModel$$7$$.setPage($bNotifyAttach_contentWrapper_newPageIndex$$1$$, {pageSize:$fitCount_itemsPerPage$$}) : $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ && ($currPage_options$$336$$ = 
      $elem$$103_firstArrowContainer_pagingModel$$7$$.getPage(), this.$_handlePage$({previousPage:$currPage_options$$336$$, page:$currPage_options$$336$$}));
      ...
      var $pages$$3$$ = this.$_getPages$(), $oldPage_pageSize$$9$$ = this.$_pagingModel$.$_pageSize$, $bImmediate$$2$$ = 0 > $prevPageIndex$$ || $prevPageIndex$$ == $pageIndex$$1$$ || this.$_itemsPerPage$ != $oldPage_pageSize$$9$$;
      this.$_itemsPerPage$ = $oldPage_pageSize$$9$$;
      $oldPage_pageSize$$9$$ = null;
      $bImmediate$$2$$ || ($oldPage_pageSize$$9$$ = $$$$39$$($pages$$3$$[$prevPageIndex$$]));
      ...
      -1 < $prevPageIndex$$ && !$bImmediate$$2$$ && ($bDeferScroll$$ = !0, $event$$480_pagesWrapper$$6$$.css(this.$_getCssSizeAttr$(), 2 * this.$_componentSize$), $pageIndex$$1$$ < $prevPageIndex$$ && $bPageHidden$$ && $event$$480_pagesWrapper$$6$$.css($cssAttr$$1$$, -this.$_componentSize$ + $_PX$$), $pageIndex$$1$$ > $prevPageIndex$$ ? ($oldPage_pageSize$$9$$.addClass($_OJ_FILMSTRIP_TRANSITION_NEXT_OLDPAGE_FROM$$), $newPage$$.addClass($_OJ_FILMSTRIP_TRANSITION_NEXT_NEWPAGE_FROM$$)) : ($oldPage_pageSize$$9$$.addClass($_OJ_FILMSTRIP_TRANSITION_PREV_OLDPAGE_FROM$$), 
      ...
      var $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ = this.$_pagesWrapper$, $cssAttr$$2_elem$$104_focusElem$$ = this.$_getCssPositionAttr$();
      $newFirstItem_pageIndex$$3_pagesWrapper$$8$$.off(this.eventNamespace).css(this.$_getCssSizeAttr$(), this.$_componentSize$).css($cssAttr$$2_elem$$104_focusElem$$, "0px");
      $cssAttr$$2_elem$$104_focusElem$$ = null;
      if ($oj$$41$$.$FocusUtils$.$containsFocus$($newFirstItem_pageIndex$$3_pagesWrapper$$8$$[0]) || this.$_nextButton$ && $oj$$41$$.$FocusUtils$.$containsFocus$(this.$_nextButton$[0]) || this.$_prevButton$ && $oj$$41$$.$FocusUtils$.$containsFocus$(this.$_prevButton$[0])) {
        $cssAttr$$2_elem$$104_focusElem$$ = document.activeElement;
      }
      for (var $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ = this.$_pagingModel$.getPage(), $firstTabStop_pages$$5$$ = this.$_getPages$(), $i$$354$$ = 0;$i$$354$$ < $firstTabStop_pages$$5$$.length;$i$$354$$++) {
        $i$$354$$ != $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ && this.$_hidePage$($$$$39$$($firstTabStop_pages$$5$$[$i$$354$$]));
      }
      ...
      $cssAttr$$2_elem$$104_focusElem$$ && $$$$39$$($cssAttr$$2_elem$$104_focusElem$$).is($_HIDDEN_SELECTOR$$) && ($cssAttr$$2_elem$$104_focusElem$$ = this.element, ($firstTabStop_pages$$5$$ = $oj$$41$$.$FocusUtils$.$getFirstTabStop$($firstTabStop_pages$$5$$[$newFirstItem_pageIndex$$3_pagesWrapper$$8$$])) ? $oj$$41$$.$FocusUtils$.$focusElement$($firstTabStop_pages$$5$$) : $oj$$41$$.$FocusUtils$.$focusElement$($cssAttr$$2_elem$$104_focusElem$$[0]));
      ...
      if ("number" === typeof $item$$113$$) {
        ...
        if ("string" === typeof $item$$113$$ && $oj$$41$$.$DomUtils$.$isValidIdentifier$($item$$113$$)) {
          for (var $i$$355$$ = 0;$i$$355$$ < $items$$12$$.length;$i$$355$$++) {
            var $itemId$$ = $items$$12$$[$i$$355$$].id;
      ...
      $oj$$41$$.Components.$subtreeHidden$($page$$9$$[0]);
      ...
      $oj$$41$$.Components.$subtreeShown$($page$$10$$[0]);
      ...
      if (this.$_bTouch$) {
        ...
        if (this.$_bDragInit$) {
          ...
          if ($bNext$$2$$ && $pageIndex$$7_pageToHide$$ < $pagingModel$$14_scrollVal_transform$$.getPageCount() - 1 || !$bNext$$2$$ && 0 < $pageIndex$$7_pageToHide$$) {
            var $currScroll$$4_elem$$111_pages$$7$$ = this.element[0], $threshold$$2$$ = Math.min($_DRAG_SCROLL_THRESHOLD$$ * ($bHorizontal$$8_newPageIndex$$3$$ ? $currScroll$$4_elem$$111_pages$$7$$.offsetWidth : $currScroll$$4_elem$$111_pages$$7$$.offsetHeight), $_DRAG_SCROLL_MAX_THRESHOLD$$), $cssAttr$$4$$ = this.$_getCssPositionAttr$(), $pagesWrapper$$10$$ = this.$_pagesWrapper$, $currScroll$$4_elem$$111_pages$$7$$ = this.$_getPages$();
            Math.abs($diff$$1$$) >= $threshold$$2$$ ? ($bHorizontal$$8_newPageIndex$$3$$ = $bNext$$2$$ ? $pageIndex$$7_pageToHide$$ + 1 : $pageIndex$$7_pageToHide$$ - 1, this.$_getFirstItemOnPage$($bHorizontal$$8_newPageIndex$$3$$), $pageIndex$$7_pageToHide$$ = $bNext$$2$$ ? $pageIndex$$7_pageToHide$$ - 1 : $pageIndex$$7_pageToHide$$ + 1, -1 < $pageIndex$$7_pageToHide$$ && $pageIndex$$7_pageToHide$$ < $pagingModel$$14_scrollVal_transform$$.getPageCount() && this.$_hidePage$($$$$39$$($currScroll$$4_elem$$111_pages$$7$$[$pageIndex$$7_pageToHide$$])), 
            $bNext$$2$$ && -1 < $pageIndex$$7_pageToHide$$ && ($currScroll$$4_elem$$111_pages$$7$$ = parseInt($pagesWrapper$$10$$.css($cssAttr$$4$$), 10), $pagesWrapper$$10$$.css($cssAttr$$4$$, $currScroll$$4_elem$$111_pages$$7$$ + this.$_componentSize$ + $_PX$$)), $pagesWrapper$$10$$.css(this.$_getCssSizeAttr$(), 2 * this.$_componentSize$), this.$_bTouch$ = !1, $pagingModel$$14_scrollVal_transform$$.setPage($bHorizontal$$8_newPageIndex$$3$$)) : ($pagingModel$$14_scrollVal_transform$$ = $bHorizontal$$8_newPageIndex$$3$$ && 
            this.$_bRTL$ ? -$diff$$1$$ : $diff$$1$$, $pagingModel$$14_scrollVal_transform$$ = $bHorizontal$$8_newPageIndex$$3$$ ? "translate3d(" + $pagingModel$$14_scrollVal_transform$$ + "px, 0, 0)" : "translate3d(0, " + $pagingModel$$14_scrollVal_transform$$ + "px, 0)", $_applyTransform$$($currScroll$$4_elem$$111_pages$$7$$.filter($_VISIBLE_SELECTOR$$), $pagingModel$$14_scrollVal_transform$$));
    ...
    }, getSubIdByNode:function($currentNode$$3_node$$89$$) {
      for (var $startArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-start-arrow"}), $endArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-end-arrow"}), $topArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-top-arrow"}), $bottomArrow$$ = this.getNodeBySubId({subId:"oj-filmstrip-bottom-arrow"}), $elem$$112$$ = this.element[0];$currentNode$$3_node$$89$$ && $currentNode$$3_node$$89$$ != $elem$$112$$;) {
        if ($currentNode$$3_node$$89$$ === $startArrow$$) {
          return{subId:"oj-filmstrip-start-arrow"};
        }
        if ($currentNode$$3_node$$89$$ === $endArrow$$) {
          return{subId:"oj-filmstrip-end-arrow"};
        }
        if ($currentNode$$3_node$$89$$ === $topArrow$$) {
          return{subId:"oj-filmstrip-top-arrow"};
        }
        if ($currentNode$$3_node$$89$$ === $bottomArrow$$) {
          return{subId:"oj-filmstrip-bottom-arrow"};
        }
        $currentNode$$3_node$$89$$ = $currentNode$$3_node$$89$$.parentElement;
      }
      return null;
    }});
