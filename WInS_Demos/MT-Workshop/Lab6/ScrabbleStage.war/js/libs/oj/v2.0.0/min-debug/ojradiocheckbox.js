 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$64$$, $$$$59$$) {
  $oj$$64$$.$__registerWidget$("oj._ojRadioCheckbox", $$$$59$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:null, checked:null, type:null}, label:function() {
    ...
    this._super();
    var $type$$100$$ = this.options.type;
    "checkbox" == $type$$100$$ ? (this.$uiRadioCheckbox$ = this.element.addClass("oj-checkbox oj-component"), this.$$label$ = this.$_getLabelsForElement$(), this.$$label$.addClass("oj-checkbox-label")) : "radio" == $type$$100$$ && (this.$uiRadioCheckbox$ = this.element.addClass("oj-radio oj-component"), this.$$label$ = this.$_getLabelsForElement$(), this.$$label$.addClass("oj-radio-label"));
    ...
    this.$_setup$();
  }, $_SaveAttributes$:function($element$$143$$) {
    this.$_savedClasses$ = $element$$143$$.attr("class");
  ...
  }, _setOption:function($key$$176$$, $value$$290$$) {
    this._superApply(arguments);
    "disabled" === $key$$176$$ && ($value$$290$$ = !!$value$$290$$, this.$_renderDisabled$($value$$290$$));
    "checked" === $key$$176$$ && (this.$_setCheckedOnDom$($value$$290$$), this.element.toggleClass("oj-selected", $value$$290$$), this.$$label$.toggleClass("oj-selected", $value$$290$$), this.$$choiceRow$ && this.$$choiceRow$.toggleClass("oj-selected", $value$$290$$));
    ...
    $oj$$64$$.$Logger$.warn("The radioset/checkboxset's input and label dom should be wrapped in a dom node with class 'oj-choice-row' or 'oj-choice-row-inline'");
    return null;
  }, getNodeBySubId:function($locator$$51_subId$$55$$) {
    var $node$$110$$ = this._super($locator$$51_subId$$55$$);
    $node$$110$$ || ($locator$$51_subId$$55$$ = $locator$$51_subId$$55$$.subId, "oj-radiocheckbox-input" === $locator$$51_subId$$55$$ && ($node$$110$$ = this.element[0]), "oj-radiocheckbox-label" === $locator$$51_subId$$55$$ && ($node$$110$$ = this.label()[0]));
    return $node$$110$$ || null;
  }, _destroy:function() {
    var $ret$$55$$ = this._super(), $type$$101$$ = this.options.type;
    "checkbox" == $type$$101$$ ? this.$$label$.removeClass("oj-enabled oj-disabled oj-selected oj-checkbox-label") : "radio" == $type$$101$$ && this.$$label$.removeClass("oj-enabled oj-disabled oj-selected oj-radio-label");
