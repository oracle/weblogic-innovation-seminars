...
*/
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "jqueryui-amd/draggable", "ojs/ojtouchproxy"], function($oj$$66$$, $$$$61$$) {
  (function() {
    $oj$$66$$.$__registerWidget$("oj.ojSlider", $$$$61$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", version:"1.0.1", widgetEventPrefix:"oj", options:{distance:0, max:100, min:0, orientation:"horizontal", readOnly:!1, disabled:!1, step:1, type:"fromMin", value:0, rawValue:void 0}, $_numPages$:5, $_sliderDisplayValue$:null, $_isRTL$:function() {
      return "rtl" === $oj$$66$$.$DomUtils$.$getReadingDirection$();
      ...
      var $id$$51_spanQuery$$ = this.element.prop("id");
      if (void 0 !== $id$$51_spanQuery$$) {
        var $jqLabelQuery$$ = $$$$61$$("label[for\x3d'" + $id$$51_spanQuery$$ + "']");
        if (0 < $jqLabelQuery$$.length) {
          return $jqLabelQuery$$;
        }
        $id$$51_spanQuery$$ = "span[for\x3d'" + $id$$51_spanQuery$$ + "']";
        if (0 !== $$$$61$$($id$$51_spanQuery$$).length) {
          return $$$$61$$($id$$51_spanQuery$$);
        }
      }
      return null;
    ...
    }, $_getThumbId$:function($index$$256$$) {
      return this.$_getElementId$() + "-thumb" + $index$$256$$;
      ...
      var $i$$431$$, $thumbCount$$, $thumb$$1$$ = "", $thumbClasses$$ = "class\x3d'oj-slider-thumb ui-state-default' tabindex\x3d'0' role\x3d'slider'" + ("aria-valuemin \x3d '" + this.$_valueMin$() + "' ") + ("aria-valuemax \x3d '" + this.$_valueMax$() + "' ") + "\x3e\x3c/span\x3e", $thumbs$$ = [];
      $thumbCount$$ = this.$_multipleThumbs$ ? this.options.value.length : 1;
      for ($i$$431$$ = 0;$i$$431$$ < $thumbCount$$;$i$$431$$++) {
        $thumb$$1$$ = "\x3cspan " + ("id\x3d'" + this.$_getThumbId$($i$$431$$) + "' ") + $thumbClasses$$, $thumbs$$.push($thumb$$1$$);
      }
      this.$_thumbs$ = $$$$61$$($thumbs$$.join("")).appendTo(this.$_sliderContainer$);
      this.$_thumb$ = this.$_thumbs$.eq(0);
      var $that$$11$$ = this;
      this.$_thumbs$.each(function($i$$432$$) {
        $$$$61$$(this).data("oj-slider-thumb-index", $i$$432$$);
    ...
    }, $_setupTouch$:function($e$$112$$) {
      this.$_touchProxy$ = $oj$$66$$.$_TouchProxy$.$addTouchListeners$($e$$112$$);
    }, $_tearDownTouch$:function($e$$113$$) {
      $oj$$66$$.$_TouchProxy$.$removeTouchListeners$($e$$113$$);
      ...
      $oj$$66$$.$DomUtils$.unwrap(this.element, this.$_elementWrapped$);
      ...
      var $normValue$$, $distance$$1$$, $index$$260$$, $that$$14$$ = this, $o$$11$$ = this.options;
      $index$$260$$ = 0;
      ...
      this.$_multipleThumbs$ && this.$_thumbs$.each(function($i$$435$$) {
        var $thisDistance$$ = Math.abs($normValue$$ - $that$$14$$.$_getMultiValues$($i$$435$$));
        if ($distance$$1$$ > $thisDistance$$ || $distance$$1$$ === $thisDistance$$ && ($i$$435$$ === $that$$14$$.$_lastChangedValueIndex$ || $that$$14$$.$_getMultiValues$($i$$435$$) === $o$$11$$.min)) {
          $distance$$1$$ = $thisDistance$$, this.$_closestThumb$ = $$$$61$$(this), $index$$260$$ = $i$$435$$;
        }
      });
      this.$_thumbIndex$ = $index$$260$$;
      if (this.$_closestThumb$) {
        return this.$_thumbs$.hasClass("ui-state-hover") || this.$_slide$($event$$609$$, $index$$260$$, $normValue$$), this.$_getActiveThumb$().addClass("oj-active").focus(), this.$_range$.addClass("oj-active"), !0;
      }
    ...
    }, $_getOtherThumbValue$:function($index$$261$$) {
      return this.$_getMultiValues$($index$$261$$ ? 0 : 1);
    }, $_getNewThumbValueLimited$:function($index$$262$$, $newVal$$1$$, $otherVal$$) {
      return 2 === this.options.value.length && (0 === $index$$262$$ && $newVal$$1$$ > $otherVal$$ || 1 === $index$$262$$ && $newVal$$1$$ < $otherVal$$) ? $otherVal$$ : $newVal$$1$$;
    }, $_slide$:function($event$$613$$, $index$$263$$, $newVal$$2$$, $rawOnly$$) {
      var $otherVal$$1$$;
      this.$_multipleThumbs$ ? ($otherVal$$1$$ = this.$_getOtherThumbValue$($index$$263$$), $newVal$$2$$ = this.$_getNewThumbValueLimited$($index$$263$$, $newVal$$2$$, $otherVal$$1$$), $newVal$$2$$ !== this.$_getMultiValues$($index$$263$$) && this.$_setMultiValue$($event$$613$$, $index$$263$$, $newVal$$2$$, $rawOnly$$)) : $newVal$$2$$ !== this.$_getSingleValue$() && (this.$_setSingleValue$($event$$613$$, $newVal$$2$$, $rawOnly$$), $rawOnly$$ || this.$_inputtag$ && this.element.val($newVal$$2$$));
    }, $_setSingleValue$:function($event$$614$$, $newValue$$22$$, $rawOnly$$1$$) {
      this.$_newValue$ = this.$_trimAlignValue$($newValue$$22$$);
      $rawOnly$$1$$ || (this.$_SetValue$(this.$_newValue$, $event$$614$$), this.$_updateUI$());
      this.$_SetRawValue$(this.$_newValue$, $event$$614$$);
    }, $_change$:function($event$$615$$, $index$$264$$, $rawOnly$$2$$) {
      this.$_multipleThumbs$ ? (this.$_lastChangedValues$ = this.$_getNewValues$($index$$264$$, this.$_newMultiValue$[$index$$264$$]), this.$_SetRawValue$(this.$_lastChangedValues$, $event$$615$$), $rawOnly$$2$$ || this.$_SetValue$(this.$_lastChangedValues$, $event$$615$$)) : (this.$_SetRawValue$(this.$_newValue$, $event$$615$$), $rawOnly$$2$$ || this.$_SetValue$(this.$_newValue$, $event$$615$$));
      this.$_lastChangedValueIndex$ = $index$$264$$;
    }, $_getNewValues$:function($index$$265$$, $newValue$$23$$) {
      var $vals$$, $i$$436$$;
      $vals$$ = this.options.value.slice();
      for ($i$$436$$ = 0;$i$$436$$ < $vals$$.length;$i$$436$$ += 1) {
        $vals$$[$i$$436$$] = this.$_trimAlignValue$($vals$$[$i$$436$$]);
      }
      $index$$265$$ === this.$_thumbIndex$ && ($vals$$[$index$$265$$] = $newValue$$23$$);
      return $vals$$;
    }, $_getSingleValue$:function() {
      return this.$_getValueAligned$();
    }, $_getMultiValues$:function($index$$266$$) {
      return this.$_getValuesAligned$($index$$266$$);
    }, $_setMultiValue$:function($event$$616$$, $index$$267$$, $newValue$$24$$, $rawOnly$$3$$) {
      this.$_newMultiValue$[$index$$267$$] = this.$_trimAlignValue$($newValue$$24$$);
      this.$_change$($event$$616$$, $index$$267$$, $rawOnly$$3$$);
      $rawOnly$$3$$ || this.$_updateUI$();
    }, _setOption:function($key$$178$$, $coercedValue$$1_value$$294$$, $flags$$46$$) {
      "value" === $key$$178$$ && (Array.isArray($coercedValue$$1_value$$294$$) ? isNaN($coercedValue$$1_value$$294$$[0]) ? (this.$_multipleThumbs$ = !1, this.$_parse$($key$$178$$, $coercedValue$$1_value$$294$$[0])) : this.$_multipleThumbs$ = !0 : (this.$_multipleThumbs$ = !1, this.$_parse$($key$$178$$, $coercedValue$$1_value$$294$$)));
      $coercedValue$$1_value$$294$$ = "max" === $key$$178$$ || "min" === $key$$178$$ ? this.$_parse$($key$$178$$, $coercedValue$$1_value$$294$$) : "step" === $key$$178$$ ? this.$_parseStep$($coercedValue$$1_value$$294$$) : $coercedValue$$1_value$$294$$;
      "disabled" != $key$$178$$ && this._super($key$$178$$, $coercedValue$$1_value$$294$$, $flags$$46$$);
      "readOnly" === $key$$178$$ && (this.options.$readonly$ = $coercedValue$$1_value$$294$$);
      "disabled" === $key$$178$$ && (this.options.disabled = $coercedValue$$1_value$$294$$);
      switch($key$$178$$) {
        case "value":
          this.$_updateUI$();
          this.$_makeDraggable$();
      ...
      var $val$$58$$ = this.options.value;
      return $val$$58$$ = this.$_trimAlignValue$($val$$58$$);
    }, $_getValuesAligned$:function($index$$268$$) {
      return this.$_trimAlignValue$(this.options.value[$index$$268$$]);
    }, $_trimAlignValue$:function($alignValue_val$$60$$) {
      if ($alignValue_val$$60$$ <= this.$_valueMin$()) {
        return this.$_valueMin$();
      }
      if ($alignValue_val$$60$$ >= this.$_valueMax$()) {
        return this.$_valueMax$();
      }
      var $step$$2$$ = 0 < this.options.step ? this.options.step : 1, $valModStep$$ = ($alignValue_val$$60$$ - this.$_valueMin$()) % $step$$2$$;
      $alignValue_val$$60$$ -= $valModStep$$;
      2 * Math.abs($valModStep$$) >= $step$$2$$ && ($alignValue_val$$60$$ += 0 < $valModStep$$ ? $step$$2$$ : -$step$$2$$);
      return parseFloat($alignValue_val$$60$$.toFixed(5));
    ...
    }, $_getThumbsValueFrac$:function($index$$269$$) {
      return(this.$_getMultiValues$($index$$269$$) - this.$_valueMin$()) / (this.$_valueMax$() - this.$_valueMin$());
    }, $_updateUI$:function() {
      var $valPercent$$, $value$$295$$, $valueMin$$, $valueMax$$;
      this.$_multipleThumbs$ ? this.$_thumbs$.toArray().forEach(function($current$$22$$, $i$$438$$) {
        var $thumb$$12$$ = $$$$61$$($current$$22$$);
        $valPercent$$ = 100 * this.$_getThumbsValueFrac$($i$$438$$);
        ...
        $$$$61$$($thumb$$12$$).attr("aria-valuenow", this.$_getMultiValues$($i$$438$$));
        this.$_setRangeMultiThumb$($valPercent$$, $i$$438$$);
      }, this) : ($value$$295$$ = this.$_getValueAligned$(), $valueMin$$ = this.$_valueMin$(), $valueMax$$ = this.$_valueMax$(), $valPercent$$ = $valueMax$$ !== $valueMin$$ ? ($value$$295$$ - $valueMin$$) / ($valueMax$$ - $valueMin$$) * 100 : 0, this.$_isRTL$() && !this.$_isVertical$() && ($valPercent$$ = 100 - $valPercent$$), this.$_isVertical$() ? this.$_thumb$.css({top:100 - $valPercent$$ + "%"}) : this.$_thumb$.css({left:$valPercent$$ + "%"}), $$$$61$$(this.$_thumb$).attr("aria-valuenow", $value$$295$$), 
      this.$_setRange$($valPercent$$));
    }, $_setRange$:function($val$$61$$) {
      var $oRange$$ = this.options.type;
      this.$_isVertical$() ? ("fromMin" === $oRange$$ && this.$_range$.css({height:$val$$61$$ + "%"}), "fromMax" === $oRange$$ && this.$_range$.css({height:100 - $val$$61$$ + "%"})) : this.$_isRTL$() ? ("fromMin" === $oRange$$ && this.$_range$.css({width:100 - $val$$61$$ + "%"}), "fromMax" === $oRange$$ && this.$_range$.css({width:$val$$61$$ + "%"})) : ("fromMin" === $oRange$$ && this.$_range$.css({width:$val$$61$$ + "%"}), "fromMax" === $oRange$$ && this.$_range$.css({width:100 - $val$$61$$ + "%"}));
    }, $_setRangeMultiThumb$:function($val$$62$$, $index$$270$$) {
      var $id$$52_thumb1Pct$$ = this.$_range$.attr("id");
      if (0 == $index$$270$$) {
        switch($id$$52_thumb1Pct$$ = 100 * this.$_getThumbsValueFrac$(1), this.options.type) {
          case "fromMin":
            this.$_isVertical$() ? this.$_range$.css({height:$val$$62$$ + "%"}) : this.$_range$.css({width:$val$$62$$ + "%"});
            break;
          case "range":
            this.$_isVertical$() ? (this.$_range$.css({top:100 - $id$$52_thumb1Pct$$ + "%"}), this.$_range$.css({height:$id$$52_thumb1Pct$$ - $val$$62$$ + "%"})) : this.$_isRTL$() ? (this.$_range$.css({left:100 - $id$$52_thumb1Pct$$ + "%"}), this.$_range$.css({width:$id$$52_thumb1Pct$$ - (100 - $val$$62$$) + "%"})) : (this.$_range$.css({left:$val$$62$$ + "%"}), this.$_range$.css({width:$id$$52_thumb1Pct$$ - $val$$62$$ + "%"}));
        }
      } else {
        var $thumb0Pct$$ = 100 * this.$_getThumbsValueFrac$(0);
        switch(this.options.type) {
          case "fromMax":
            this.$_isVertical$() ? this.$_range$.css({height:100 - $val$$62$$ + "%"}) : this.$_range$.css({width:100 - $val$$62$$ + "%"});
            break;
          case "range":
            this.$_isVertical$() ? document.getElementById($id$$52_thumb1Pct$$) && (this.$_range$.css({top:100 - $val$$62$$ + "%"}), this.$_range$.css({height:$val$$62$$ - $thumb0Pct$$ + "%"})) : this.$_isRTL$() ? document.getElementById($id$$52_thumb1Pct$$) && (this.$_range$.css({left:$val$$62$$ + "%"}), this.$_range$.css({width:-$val$$62$$ + 100 - $thumb0Pct$$ + "%"})) : document.getElementById($id$$52_thumb1Pct$$) && this.$_range$.css({width:$val$$62$$ - parseInt(document.getElementById($id$$52_thumb1Pct$$).style.left, 
            10) + "%"});
        }
      }
    }, $_thumbEvents$:{keydown:function($event$$617$$) {
      var $curVal_tempVal$$, $newVal$$3$$, $step$$3$$, $index$$271$$ = $$$$61$$($event$$617$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$271$$;
      ...
      $curVal_tempVal$$ = this.$_multipleThumbs$ ? $newVal$$3$$ = this.$_getMultiValues$($index$$271$$) : $newVal$$3$$ = this.$_getSingleValue$();
      switch($event$$617$$.keyCode) {
        case $$$$61$$.ui.keyCode.HOME:
        ...
        case $$$$61$$.ui.keyCode.UP:
          ...
          $newVal$$3$$ = this.$_trimAlignValue$($curVal_tempVal$$ + $step$$3$$);
          break;
        case $$$$61$$.ui.keyCode.RIGHT:
      ...
      this.$_slide$($event$$617$$, $index$$271$$, $newVal$$3$$);
    }, keyup:function($event$$618$$) {
      var $index$$272$$ = $$$$61$$($event$$618$$.target).data("oj-slider-thumb-index");
      this.$_thumbIndex$ = $index$$272$$;
      this.$_change$($event$$618$$, $index$$272$$, !1);
      ...
      $oj$$66$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"value"}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$19$$, this, function($initializedOptions$$2$$) {
        for (var $toParse$$1$$ = ["value", "step", "min", "max"], $i$$439$$ = 0;$i$$439$$ < $toParse$$1$$.length;$i$$439$$++) {
          var $opt$$21$$ = $toParse$$1$$[$i$$439$$], $value$$296$$ = $opt$$21$$ in $initializedOptions$$2$$ ? $initializedOptions$$2$$[$opt$$21$$] : $opts$$37$$[$opt$$21$$];
          null != $value$$296$$ && ("step" === $opt$$21$$ ? $initializedOptions$$2$$[$opt$$21$$] = $self$$213$$.$_parseStep$($value$$296$$) : "min" === $opt$$21$$ || "max" === $opt$$21$$ ? $initializedOptions$$2$$[$opt$$21$$] = $self$$213$$.$_parse$($opt$$21$$, $value$$296$$) : "value" === $opt$$21$$ && (Array.isArray($value$$296$$) ? $initializedOptions$$2$$[$opt$$21$$] = $value$$296$$ : $initializedOptions$$2$$[$opt$$21$$] = $self$$213$$.$_parse$($opt$$21$$, $value$$296$$)));
        }
      });
    ...
    }, getSubIdByNode:function($node$$114$$) {
      if (null != $node$$114$$) {
        if ($node$$114$$.id === this.$_getThumbId$(0) && $$$$61$$($node$$114$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-0"};
        }
        if ($node$$114$$.id === this.$_getThumbId$(1) && $$$$61$$($node$$114$$).hasClass("oj-slider-thumb")) {
          return{subId:"oj-slider-thumb-1"};
        }
        if ($$$$61$$($node$$114$$).hasClass("oj-slider-bar")) {
          return{subId:"oj-slider-bar"};
        }
        if ($$$$61$$($node$$114$$).hasClass("oj-slider-bar-value")) {
      ...
      return "oj-slider";
    }, $_parse$:function($option$$38$$, $val$$63$$) {
      var $returnValue$$8$$;
      $returnValue$$8$$ = null !== $val$$63$$ ? +$val$$63$$ : $val$$63$$;
      if (isNaN($returnValue$$8$$)) {
        throw Error(this.$getTranslatedString$("optionNum", {option:$option$$38$$}));
      }
      return $returnValue$$8$$;
    }, $_parseStep$:function($parsedStep$$1_val$$64$$) {
      if (null === $parsedStep$$1_val$$64$$) {
        return 1;
      }
      $parsedStep$$1_val$$64$$ = this.$_parse$("step", $parsedStep$$1_val$$64$$);
      if (0 >= $parsedStep$$1_val$$64$$) {
        throw Error(this.$getTranslatedString$("invalidStep"));
      }
      if (null === $parsedStep$$1_val$$64$$ || 0 >= $parsedStep$$1_val$$64$$) {
        $parsedStep$$1_val$$64$$ = 1;
      }
      return $parsedStep$$1_val$$64$$;
