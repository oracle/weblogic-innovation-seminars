...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$26$$, $$$$25$$) {
  (function() {
    function $_getChromingDefault$$($componentName$$8$$, $element$$115_element$$inline_830$$, $actualContainers$$1_containerConstructor$$) {
      a: {
        for (var $interestingContainers$$inline_832$$ = $_interestingContainers$$[$componentName$$8$$], $i$$inline_833$$ = 0;$i$$inline_833$$ < $interestingContainers$$inline_832$$.length;++$i$$inline_833$$) {
          var $containerName$$inline_834$$ = $interestingContainers$$inline_832$$[$i$$inline_833$$];
          if (0 <= $actualContainers$$1_containerConstructor$$.indexOf($containerName$$inline_834$$)) {
            for (;;$element$$115_element$$inline_830$$ = $element$$115_element$$inline_830$$.parentNode) {
              var $func$$inline_835$$ = $oj$$26$$.Components.$getWidgetConstructor$($element$$115_element$$inline_830$$, $containerName$$inline_834$$);
              if ($func$$inline_835$$) {
                $actualContainers$$1_containerConstructor$$ = $func$$inline_835$$;
                break a;
              }
            }
          }
    ...
    function $_radioGroup$$($radio$$, $$elems$$) {
      var $name$$112_selector$$30$$ = $radio$$.name, $$radios_form$$1$$ = $radio$$.form;
      $name$$112_selector$$30$$ ? ($name$$112_selector$$30$$ = $name$$112_selector$$30$$.replace(/'/g, "\\'"), $name$$112_selector$$30$$ = ":radio[name\x3d'" + $name$$112_selector$$30$$ + "']:oj-button", $$radios_form$$1$$ = $$elems$$ ? $$elems$$.filter($name$$112_selector$$30$$) : $$radios_form$$1$$ ? $$$$25$$($$radios_form$$1$$).find($name$$112_selector$$30$$) : $$$$25$$($name$$112_selector$$30$$, $radio$$.ownerDocument).filter(function() {
        return!this.form;
    ...
    $oj$$26$$.$__registerWidget$("oj.ojButton", $$$$25$$.oj.baseComponent, {defaultElement:"\x3cbutton\x3e", widgetEventPrefix:"oj", options:{chroming:"full", disabled:!1, display:"all", label:null, icons:{start:null, end:null}, menu:null}, $_InitOptions$:function($originalDefaults$$10$$, $constructorOptions$$12$$) {
      ...
      }).bind("click" + this.eventNamespace, function($event$$359$$) {
        $self$$149$$.$_IsEffectivelyDisabled$() && ($event$$359$$.preventDefault(), $event$$359$$.stopImmediatePropagation());
      });
      ...
      $tabIndex$$4_toggleButton$$ && (this.element.bind("change" + this.eventNamespace, function($event$$360$$) {
        ...
        $buttonset$$ && void 0 !== $checkedState$$ && $buttonset$$.option("checked", $checkedState$$, {_context:{$writeback$:!0, originalEvent:$event$$360$$, $internalSet$:!0}});
      ...
      "checkbox" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
      ...
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$364$$) {
        $event$$364$$.keyCode === $$$$25$$.ui.keyCode.ENTER && ($self$$149$$.$_IsEffectivelyDisabled$() || $self$$149$$.element.click());
      })) : "radio" === this.type ? (this.$buttonElement$.bind("click" + this.eventNamespace, function() {
        if ($self$$149$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
      }), this.element.bind("keyup" + this.eventNamespace, function($event$$365$$) {
        $event$$365$$.keyCode !== $$$$25$$.ui.keyCode.ENTER || $self$$149$$.element[0].checked || $self$$149$$.$_IsEffectivelyDisabled$() || ($self$$149$$.element[0].checked = !0, $self$$149$$.element.change(), $self$$149$$.element.click());
      })) : (this.$buttonElement$.bind("mousedown" + this.eventNamespace, function($event$$366$$) {
        if ($self$$149$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        1 !== $event$$366$$.which || $self$$149$$.$_recentTouch$() || ($$$$25$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only"), $_lastActive$$ = this, $self$$149$$.document.one("mouseup", function() {
          $_lastActive$$ = null;
        }));
      }).bind("mouseup" + this.eventNamespace, function() {
        if ($self$$149$$.$_IsEffectivelyDisabled$()) {
        ...
        $self$$149$$.$_toggleDefaultClasses$();
      }).bind("keydown" + this.eventNamespace, function($event$$367$$) {
        if ($self$$149$$.$_IsEffectivelyDisabled$()) {
          return!1;
        }
        var $isSpace$$ = $event$$367$$.keyCode === $$$$25$$.ui.keyCode.SPACE, $isAnchor$$ = "anchor" === $self$$149$$.type;
        $isAnchor$$ && $isSpace$$ && $event$$367$$.preventDefault();
        ($isSpace$$ && !$isAnchor$$ || $event$$367$$.keyCode === $$$$25$$.ui.keyCode.ENTER) && $$$$25$$(this).addClass("oj-active").removeClass("oj-default oj-focus-only");
    ...
    }, $_NotifyContextMenuGesture$:function($menu$$10$$, $event$$368$$, $eventType$$41$$) {
      this.$_OpenContextMenu$($event$$368$$, $eventType$$41$$, {position:{of:"keyboard" === $eventType$$41$$ ? this.$rootElement$ : $event$$368$$}});
    ...
    }, _setOption:function($key$$138$$, $value$$251$$, $flags$$34$$) {
      this._super($key$$138$$, $value$$251$$, $flags$$34$$);
      switch($key$$138$$) {
        case "chroming":
          $_setChromingClass$$(this.$rootElement$, $value$$251$$);
          break;
        case "disabled":
          this.$_updateEffectivelyDisabled$();
          break;
      ...
      if (this.options.menu) {
        var $self$$150$$ = this;
        this.element.attr("aria-haspopup", !0).on("keydown" + this.$menuEventNamespace$, function($event$$369$$) {
          if ($event$$369$$.which === $$$$25$$.ui.keyCode.DOWN) {
            $self$$150$$.$_showMenu$($event$$369$$, "firstItem"), $event$$369$$.preventDefault();
          } else {
            if ($event$$369$$.which === $$$$25$$.ui.keyCode.ESCAPE) {
              var $bubbleEscUp$$ = $self$$150$$.$_checkMenuParent$($self$$150$$.$rootElement$);
              $self$$150$$.$_dismissMenu$($event$$369$$);
              return $bubbleEscUp$$;
            }
          }
          return!0;
        }).on("click" + this.$menuEventNamespace$, function($event$$370$$) {
          var $menu$$11$$ = $self$$150$$.$_getMenu$();
          $menu$$11$$.$__spaceEnterDownInMenu$ || $self$$150$$.$_showMenu$($event$$370$$, "firstItem");
          $menu$$11$$.$__spaceEnterDownInMenu$ = !1;
          $event$$370$$.preventDefault();
          return!0;
        });
      }
    }, $_checkMenuParent$:function($element$$113$$) {
      return!$element$$113$$.hasClass("oj-selected");
      ...
      if (!this.$_menu$) {
        ...
        var $self$$151$$ = this;
        this.$_menu$.widget().on("ojclose" + this.$menuEventNamespace$, function($event$$371$$) {
          $self$$151$$.$_menuDismissHandler$($event$$371$$);
        });
      }
      return this.$_menu$;
    }, $_showMenu$:function($event$$372$$, $focus$$) {
      if (!this.$_IsEffectivelyDisabled$()) {
        var $menu$$12$$ = this.$_getMenu$(), $menuElem$$ = $menu$$12$$.widget();
        $menu$$12$$.open($event$$372$$, {launcher:this.element, initialFocus:$focus$$});
        this.$_menuVisible$ = !0;
    ...
    }, $_dismissMenu$:function($event$$373$$) {
      this.$_menuVisible$ && (this.$_menu$.$__collapseAll$($event$$373$$, !0), this.$_menu$.$__dismiss$($event$$373$$));
    ...
    $oj$$26$$.$__registerWidget$("oj.ojButtonset", $$$$25$$.oj.baseComponent, {$_items$:"button, input[type\x3dbutton], input[type\x3dsubmit], input[type\x3dreset], input[type\x3dcheckbox], input[type\x3dradio], a", widgetEventPrefix:"oj", options:{checked:null, chroming:"full", focusManagement:"oneTabstop"}, $_setCheckedOnDom$:function($checked$$1$$, $$buttons$$1$$) {
      var $name$$110_type$$86_valid$$10_validRadios$$ = $$$$25$$.type($checked$$1$$), $allCheckboxes$$;
      if ("null" === $name$$110_type$$86_valid$$10_validRadios$$ || "array" === $name$$110_type$$86_valid$$10_validRadios$$) {
        $allCheckboxes$$ = $$buttons$$1$$.filter("input[type\x3dcheckbox]").length === $$buttons$$1$$.length;
      }
      if ($allCheckboxes$$ && "null" === $name$$110_type$$86_valid$$10_validRadios$$) {
        throw Error("Invalid 'checked' value set on JET Buttonset: " + $checked$$1$$);
      }
      if ("string" === $name$$110_type$$86_valid$$10_validRadios$$ || "null" === $name$$110_type$$86_valid$$10_validRadios$$) {
        ($name$$110_type$$86_valid$$10_validRadios$$ = (($name$$110_type$$86_valid$$10_validRadios$$ = $$buttons$$1$$[0].name) || 1 >= $$buttons$$1$$.length) && $$buttons$$1$$.filter("input[type\x3dradio][name\x3d" + $name$$110_type$$86_valid$$10_validRadios$$ + "]").length === $$buttons$$1$$.length && (null === $checked$$1$$ || $$buttons$$1$$.filter("[value\x3d" + $checked$$1$$ + "]").length)) && $$buttons$$1$$.each(function() {
          this.checked = this.value === $checked$$1$$;
        }), $name$$110_type$$86_valid$$10_validRadios$$ = $name$$110_type$$86_valid$$10_validRadios$$ || null === $checked$$1$$;
      } else {
        if ("array" === $name$$110_type$$86_valid$$10_validRadios$$) {
          var $last$$2$$;
          ($name$$110_type$$86_valid$$10_validRadios$$ = $allCheckboxes$$ && $checked$$1$$.concat().sort().every(function($elem$$64$$) {
            var $retVal$$16$$ = $elem$$64$$ !== $last$$2$$ && $$buttons$$1$$.filter("[value\x3d" + $elem$$64$$ + "]").length;
            $last$$2$$ = $elem$$64$$;
            return $retVal$$16$$;
          ...
          $name$$110_type$$86_valid$$10_validRadios$$ = !1;
        }
      }
      if (!$name$$110_type$$86_valid$$10_validRadios$$) {
        throw Error("Invalid 'checked' value set on JET Buttonset: " + $checked$$1$$);
      }
    }, $_getCheckedFromDom$:function($$buttons$$2$$) {
      var $checked$$2$$ = void 0, $isRadio$$ = null, $name$$111$$ = null;
      $$buttons$$2$$.each(function() {
        ...
        if (void 0 !== $checked$$2$$ && ($currentIsRadio_currentType$$ !== $isRadio$$ || $currentName$$ !== $name$$111$$ || $isRadio$$ && !$name$$111$$)) {
          return $checked$$2$$ = void 0, !1;
        }
        void 0 === $checked$$2$$ ? ($checked$$2$$ = $currentIsRadio_currentType$$ ? this.checked ? this.value : null : this.checked ? [this.value] : [], $isRadio$$ = $currentIsRadio_currentType$$, $name$$111$$ = $currentName$$) : this.checked && ($isRadio$$ ? $checked$$2$$ = this.value : $checked$$2$$.push(this.value));
      });
      return $checked$$2$$;
      ...
      this.$_setup$(!0);
    }, $_NotifyContextMenuGesture$:function($currentButton_menu$$13$$, $event$$375$$, $eventType$$42$$) {
      $currentButton_menu$$13$$ = this.element.find(":oj-button[tabindex\x3d0]");
      this.$_OpenContextMenu$($event$$375$$, $eventType$$42$$, {launcher:$currentButton_menu$$13$$, position:{of:"keyboard" === $eventType$$42$$ ? $currentButton_menu$$13$$.ojButton("widget") : $event$$375$$}});
    ...
    }, _setOption:function($key$$139$$, $value$$252$$, $flags$$35$$) {
      this._superApply(arguments);
      "disabled" === $key$$139$$ ? this.$_propagateDisabled$($value$$252$$) : "checked" === $key$$139$$ ? (this.$_setCheckedOnDom$($value$$252$$, this.$$buttons$), this.$$buttons$.each(function() {
        $$$$25$$(this).data("oj-ojButton").$_applyCheckedStateFromDom$(!1);
      })) : "focusManagement" === $key$$139$$ ? this.$_setRole$($value$$252$$) : "chroming" === $key$$139$$ && ($_setChromingClass$$(this.element, $value$$252$$), this.$$buttons$.ojButton("refresh"));
    }, refresh:function() {
      this._super();
      this.$_setup$(!1);
      ...
      "oneTabstop" === this.options.focusManagement && (this.$$buttons$.unbind("keydown" + this.eventNamespace).bind("keydown" + this.eventNamespace, function($event$$376$$) {
        $self$$152$$.$_handleKeyDown$($event$$376$$, $$$$25$$(this));
      ...
      return $$button$$.map(function($index$$194$$, $elem$$65$$) {
        if ("radio" != $elem$$65$$.type || $elem$$65$$.checked || "" == $elem$$65$$.name) {
          return $elem$$65$$;
        }
        var $$checkedRadio$$ = $_radioGroup$$($elem$$65$$, $$enabledButtons$$).filter(":checked");
        return $$checkedRadio$$.length ? $$checkedRadio$$[0] : $elem$$65$$;
      });
    ...
    }, $_handleKeyDown$:function($event$$379$$, $$button$$2$$) {
      switch($event$$379$$.which) {
        ...
        case $$$$25$$.ui.keyCode.RIGHT:
          ...
          $$enabledButtons$$1$$.eq(($oldIndex$$1$$ + ($event$$379$$.which == $$$$25$$.ui.keyCode.RIGHT ^ this.$isRtl$ ? 1 : -1) + $length$$18$$) % $length$$18$$).focus();
          break;
        case $$$$25$$.ui.keyCode.UP:
        ;
        case $$$$25$$.ui.keyCode.DOWN:
          "radio" == $$button$$2$$.attr("type") && $event$$379$$.preventDefault();
      }
    }, _destroy:function() {
    ...
    $oj$$26$$.Components.$setDefaultOptions$({ojButton:{chroming:$oj$$26$$.Components.$createDynamicPropertyGetter$(function($context$$105$$) {
      return $_getChromingDefault$$("button", $context$$105$$.element, $context$$105$$.containers);
    })}, ojButtonset:{chroming:$oj$$26$$.Components.$createDynamicPropertyGetter$(function($context$$106$$) {
      return $_getChromingDefault$$("buttonset", $context$$106$$.element, $context$$106$$.containers);
    })}});
  })();
});
