...
define(["ojs/ojcore", "jquery", "promise"], function($oj$$1$$, $$$$1$$) {
  ...
  $oj$$1$$.$Collection$.prototype.$_addInternal$ = function $$oj$$1$$$$Collection$$$$_addInternal$$($m$$2$$, $options$$24$$, $fillIn$$, $deferred$$2$$) {
    function $mergeAttrs$$($collection$$9$$, $modelToTryAndMerge_sortOpt$$inline_350$$, $modelFoundInCollection$$1$$, $newModel$$3$$, $deferred$$4$$) {
      ...
      $needSort$$ && void 0 === $existingModel$$1$$ && !$sort$$ && void 0 === $at$$1$$ && 1 < $collection$$9$$.$_getLength$() && (-1 < $index$$56$$ && ($cid$$ = $collection$$9$$.$_getModel$($index$$56$$).cid), $modelToTryAndMerge_sortOpt$$inline_350$$ = {}, $oj$$1$$.$CollectionUtils$.$copyInto$($modelToTryAndMerge_sortOpt$$inline_350$$, $options$$24$$), $modelToTryAndMerge_sortOpt$$inline_350$$.add = !0, $collection$$9$$.sort($modelToTryAndMerge_sortOpt$$inline_350$$), -1 < $index$$56$$ && ($index$$56$$ = 
  ...
  $oj$$1$$.$Collection$.prototype.$_modelEvent$ = function $$oj$$1$$$$Collection$$$$_modelEvent$$($event$$13$$, $model$$18$$, $collection$$13$$, $options$$35$$) {
    $event$$13$$ === $oj$$1$$.$Events$.$EventType$.DESTROY && this.remove($model$$18$$);
    void 0 !== $collection$$13$$ && $collection$$13$$ instanceof $oj$$1$$.$Collection$ && $collection$$13$$ !== this || (Array.prototype.slice.call(arguments), this.$TriggerInternal$($options$$35$$ && $options$$35$$.silent, $event$$13$$, $model$$18$$, $collection$$13$$, $options$$35$$));
  };
    ...
    if (this.$IsVirtual$()) {
      ...
      return new Promise(function($resolve$$10$$, $reject$$10$$) {
        ...
        $opts$$2$$.success = function $$opts$$2$$$success$($collection$$16$$, $response$$2$$) {
          if (null != $response$$2$$) {
            var $index$$inline_353$$ = $self$$15$$.$_getOffset$(), $model$$inline_354$$ = $self$$15$$.$_getModel$($index$$inline_353$$);
            void 0 !== $model$$inline_354$$ && $model$$inline_354$$.$Match$($id$$6$$, $cid$$3$$) ? $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$($index$$inline_353$$, $model$$inline_354$$)) : $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          } else {
  ...
  $oj$$1$$.$Collection$.prototype.$_setRangeLocalFetch$ = function $$oj$$1$$$$Collection$$$$_setRangeLocalFetch$$($start$$19$$, $count$$15$$, $actual$$3_placement$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) {
    ...
    $newStart_opts$$3$$.success = function $$newStart_opts$$3$$$success$() {
      var $actual$$inline_356$$ = $self$$18$$.$_getLocalRange$($original$$2$$.start, $original$$2$$.count);
      if ($fill$$ && $self$$18$$.$_hasTotalResults$() && $actual$$inline_356$$.count < $original$$2$$.count) {
        var $newPlacement$$inline_357$$ = $actual$$inline_356$$.start + $actual$$inline_356$$.count, $newStart$$inline_358$$ = $start$$19$$ + $count$$15$$;
        $newStart$$inline_358$$ < $self$$18$$.totalResults ? $self$$18$$.$_setRangeLocalFetch$($newStart$$inline_358$$, $count$$15$$, $newPlacement$$inline_357$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) : $resolve$$14$$($actual$$inline_356$$);
      } else {
        $resolve$$14$$($actual$$inline_356$$);
      }
    };
    try {
  ...
  $oj$$1$$.$Model$.prototype.matches = function $$oj$$1$$$$Model$$$matches$($JSCompiler_inline_result$$4_attrs$$17$$) {
    a: {
      for (var $prop$$inline_369$$ in $JSCompiler_inline_result$$4_attrs$$17$$) {
        if (this.get($prop$$inline_369$$) !== $JSCompiler_inline_result$$4_attrs$$17$$[$prop$$inline_369$$]) {
