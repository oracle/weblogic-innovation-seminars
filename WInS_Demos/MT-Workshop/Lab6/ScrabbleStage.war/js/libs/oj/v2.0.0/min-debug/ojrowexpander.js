...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdatasource-common"], function($oj$$21$$, $$$$20$$) {
  ...
  $oj$$21$$.$FlattenedNodeSet$.prototype.$_getDataOrMetadata$ = function $$oj$$21$$$$FlattenedNodeSet$$$$_getDataOrMetadata$$($nodeSet$$6$$, $index$$153$$, $current$$17$$, $func$$9$$) {
    var $start$$42$$, $count$$38$$, $i$$291$$, $child$$6_currIndex_result$$51$$;
    $start$$42$$ = $nodeSet$$6$$.$getStart$();
    $count$$38$$ = $nodeSet$$6$$.$getCount$();
    for ($i$$291$$ = 0;$i$$291$$ < $count$$38$$;$i$$291$$++) {
      $child$$6_currIndex_result$$51$$ = $current$$17$$.index;
      if ($child$$6_currIndex_result$$51$$ === $index$$153$$) {
        return $func$$9$$.call(this, $nodeSet$$6$$, $i$$291$$ + $start$$42$$);
      }
      $current$$17$$.index = $child$$6_currIndex_result$$51$$ + 1;
      if ($nodeSet$$6$$.$getChildNodeSet$ && ($child$$6_currIndex_result$$51$$ = $nodeSet$$6$$.$getChildNodeSet$($i$$291$$ + $start$$42$$), null != $child$$6_currIndex_result$$51$$ && ($child$$6_currIndex_result$$51$$ = this.$_getDataOrMetadata$($child$$6_currIndex_result$$51$$, $index$$153$$, $current$$17$$, $func$$9$$), null != $child$$6_currIndex_result$$51$$))) {
        return $child$$6_currIndex_result$$51$$;
      }
    }
    return null;
  };
  ...
  $oj$$21$$.$MergedNodeSet$.prototype.$_findIndex$ = function $$oj$$21$$$$MergedNodeSet$$$$_findIndex$$($key$$120$$) {
    ...
    for ($end$$13$$ = $i$$292_start$$43$$ + this.$m_nodeSet1$.$getCount$();$i$$292_start$$43$$ < $end$$13$$;$i$$292_start$$43$$++) {
      if ($rowKey$$11$$ = this.$m_nodeSet1$.getMetadata($i$$292_start$$43$$).key, $key$$120$$ === $rowKey$$11$$) {
  ...
  $oj$$21$$.$MergedNodeSet$.prototype.getData = function $$oj$$21$$$$MergedNodeSet$$$getData$($index$$154_result$$52$$) {
    $index$$154_result$$52$$ = this.$_getRelativeIndex$($index$$154_result$$52$$);
    return $index$$154_result$$52$$.set.getData($index$$154_result$$52$$.index);
  };
  $oj$$21$$.$Object$.$exportPrototypeSymbol$("MergedNodeSet.prototype.getData", {getData:$oj$$21$$.$MergedNodeSet$.prototype.getData});
  $oj$$21$$.$MergedNodeSet$.prototype.getMetadata = function $$oj$$21$$$$MergedNodeSet$$$getMetadata$($index$$155_result$$53$$) {
    $index$$155_result$$53$$ = this.$_getRelativeIndex$($index$$155_result$$53$$);
    return $index$$155_result$$53$$.set.getMetadata($index$$155_result$$53$$.index);
  };
  ...
  $oj$$21$$.$NodeSetWrapper$.prototype.$getChildNodeSet$ = function $$oj$$21$$$$NodeSetWrapper$$$$getChildNodeSet$$($index$$159_result$$54$$) {
    return null != this.$m_collapsedKeys$ && -1 != this.$m_collapsedKeys$.indexOf(this.$m_nodeSet$.getMetadata($index$$159_result$$54$$).key) || !this.$m_nodeSet$.$getChildNodeSet$ || ($index$$159_result$$54$$ = this.$m_nodeSet$.$getChildNodeSet$($index$$159_result$$54$$), null == $index$$159_result$$54$$) ? null : new $oj$$21$$.$NodeSetWrapper$($index$$159_result$$54$$, this.$m_callback$, null, this.$m_collapsedKeys$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.handleEvent = function $$oj$$21$$$$FlattenedTreeDataSource$$$handleEvent$($eventType$$38$$, $event$$335$$) {
    return $oj$$21$$.$FlattenedTreeDataSource$.$superclass$.handleEvent.call(this, $eventType$$38$$, $event$$335$$);
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_fetchFromAncestors$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_fetchFromAncestors$$($parent$$23$$, $depth$$15$$, $callbacks$$13$$, $maxFetchSize$$1$$) {
    ...
    for ($i$$293$$ = this.$_getLastIndex$() - 1;0 <= $i$$293$$;$i$$293$$--) {
      if ($currEntry_index$$161$$ = this.$_getEntry$($i$$293$$), $currDepth$$ = $currEntry_index$$161$$.depth, $currDepth$$ < $depth$$15$$ && ($parent$$23$$ = $currEntry_index$$161$$.parent, $count$$43$$ = this.$m_wrapped$.$getChildCount$($parent$$23$$), $currEntry_index$$161$$ = $currEntry_index$$161$$.index, ($countUnknown$$ = -1 === $count$$43$$) || $currEntry_index$$161$$ < $count$$43$$ - 1)) {
        $range$$12$$ = {};
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processNodeSet$$($nodeSet$$14$$, $parent$$24$$, $depth$$16$$, $toExpand$$1$$) {
    var $nodeStart$$1$$, $nodeCount$$1$$, $i$$294$$, $key$$121_metadata$$7$$;
    $nodeStart$$1$$ = $nodeSet$$14$$.$getStart$();
    $nodeCount$$1$$ = $nodeSet$$14$$.$getCount$();
    for ($i$$294$$ = 0;$i$$294$$ < $nodeCount$$1$$;$i$$294$$++) {
      $key$$121_metadata$$7$$ = $nodeSet$$14$$.getMetadata($nodeStart$$1$$ + $i$$294$$), $key$$121_metadata$$7$$ = $key$$121_metadata$$7$$.key, this.$_addEntry$($key$$121_metadata$$7$$, $depth$$16$$, $nodeStart$$1$$ + $i$$294$$, $parent$$24$$), this.$_isExpanded$($key$$121_metadata$$7$$) && $toExpand$$1$$.push($key$$121_metadata$$7$$);
    }
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processDescendantsNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processDescendantsNodeSet$$($nodeSet$$17$$, $parent$$25$$, $depth$$17$$, $lastEntry$$2$$, $maxCount$$1$$, $options$$270$$) {
    var $nodeStart$$2$$, $nodeCount$$2$$, $i$$295$$, $childNodeSet_metadata$$9$$, $key$$123$$;
    ...
    for ($i$$295$$ = 0;$i$$295$$ < $nodeCount$$2$$ && $options$$270$$.count != $maxCount$$1$$;$i$$295$$++) {
      $childNodeSet_metadata$$9$$ = $nodeSet$$17$$.getMetadata($nodeStart$$2$$ + $i$$295$$);
      ...
      if (null == $lastEntry$$2$$ || $options$$270$$.found) {
        this.$_addEntry$($key$$123$$, $depth$$17$$, $nodeStart$$2$$ + $i$$295$$, $parent$$25$$), $options$$270$$.count += 1, $childNodeSet_metadata$$9$$.state = $childNodeSet_metadata$$9$$.leaf ? "leaf" : "expanded";
      }
      ...
      $nodeSet$$17$$.$getChildNodeSet$ && this.$_isExpanded$($key$$123$$) && ($childNodeSet_metadata$$9$$ = $nodeSet$$17$$.$getChildNodeSet$($i$$295$$), null != $childNodeSet_metadata$$9$$ && this.$_processDescendantsNodeSet$($childNodeSet_metadata$$9$$, $key$$123$$, $depth$$17$$ + 1, $lastEntry$$2$$, $maxCount$$1$$, $options$$270$$));
    }
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.collapse = function $$oj$$21$$$$FlattenedTreeDataSource$$$collapse$($rowKey$$15$$) {
    var $rowIndex$$5$$, $depth$$18_i$$296_parent$$26$$, $count$$46$$, $keys$$31_lastIndex$$, $j$$37$$;
    $rowIndex$$5$$ = this.$getIndex$($rowKey$$15$$) + 1;
    $depth$$18_i$$296_parent$$26$$ = this.$_getEntry$($rowIndex$$5$$ - 1);
    $count$$46$$ = 0;
    $depth$$18_i$$296_parent$$26$$ = $depth$$18_i$$296_parent$$26$$.depth;
    ...
    for ($j$$37$$ = $rowIndex$$5$$;$j$$37$$ < $keys$$31_lastIndex$$ + 1;$j$$37$$++) {
      ...
      if ($rowDepth$$ > $depth$$18_i$$296_parent$$26$$) {
        $count$$46$$ += 1;
      } else {
        if ($rowDepth$$ == $depth$$18_i$$296_parent$$26$$) {
          break;
    ...
    if (0 != $count$$46$$) {
      ...
      $keys$$31_lastIndex$$ = [];
      for ($depth$$18_i$$296_parent$$26$$ = 0;$depth$$18_i$$296_parent$$26$$ < $count$$46$$;$depth$$18_i$$296_parent$$26$$++) {
        $keys$$31_lastIndex$$.push({key:this.$_getEntry$($rowIndex$$5$$ + $depth$$18_i$$296_parent$$26$$).key, index:$rowIndex$$5$$ + $depth$$18_i$$296_parent$$26$$});
      }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$handleExpandSuccess$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$handleExpandSuccess$$($rowKey$$23$$, $maxCount$$3_nodeSet$$19$$, $childCount_j$$38$$, $callbacks$$16_options$$272$$) {
    var $refIndex$$1$$, $rangeStart$$, $metadata$$10_rowStart$$, $rowCount$$5$$, $parent$$27$$, $depth$$19$$, $key$$124$$, $toExpand$$2$$, $i$$298$$, $queue$$4$$, $prevNodeSetInfo$$2$$;
    ...
    $toExpand$$2$$ = [];
    for ($i$$298$$ = $metadata$$10_rowStart$$;$i$$298$$ < $rowCount$$5$$;$i$$298$$++) {
      $metadata$$10_rowStart$$ = $maxCount$$3_nodeSet$$19$$.getMetadata($i$$298$$), $key$$124$$ = $metadata$$10_rowStart$$.key, this.$_isExpanded$($key$$124$$) && $toExpand$$2$$.push($key$$124$$), this.$_insertRow$($refIndex$$1$$, $metadata$$10_rowStart$$, $parent$$27$$.key, $i$$298$$, $depth$$19$$), $refIndex$$1$$++;
    }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_handleModelEvent$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_handleModelEvent$$($event$$337$$) {
    var $operation$$3$$, $ancestors_parentKey$$2$$, $index$$167$$;
    $operation$$3$$ = $event$$337$$.operation;
    $ancestors_parentKey$$2$$ = $event$$337$$.parent;
    ...
    $index$$167$$ = $event$$337$$.index;
    "insert" === $operation$$3$$ ? this.$_handleInsertEvent$($ancestors_parentKey$$2$$, $index$$167$$, $event$$337$$.data) : "delete" === $operation$$3$$ ? this.$_handleDeleteEvent$($ancestors_parentKey$$2$$, $index$$167$$) : "refresh" === $operation$$3$$ && this.$_handleRefreshEvent$($ancestors_parentKey$$2$$);
  };
  ...
  depth0:"oj-rowexpander-depth-0", depth1:"oj-rowexpander-depth-1", depth2:"oj-rowexpander-depth-2", depth3:"oj-rowexpander-depth-3", depth4:"oj-rowexpander-depth-4", depth5:"oj-rowexpander-depth-5", depth6:"oj-rowexpander-depth-6", depth7:"oj-rowexpander-depth-7"}, $constants$:{$MAX_STYLE_DEPTH$:7, $NUM5_KEY$:53}, _ComponentCreate:function() {
    ...
    var $self$$138$$ = this, $context$$102$$;
    $context$$102$$ = this.options.context;
    this.$component$ = "function" === typeof $context$$102$$.component ? $context$$102$$.component("instance") : $context$$102$$.component;
    this.$datasource$ = $context$$102$$.datasource;
    this.depth = $context$$102$$.depth;
    this.$iconState$ = $context$$102$$.state;
    this.$rowKey$ = $context$$102$$.key;
    this.index = $context$$102$$.index;
    this.$parentKey$ = $context$$102$$.parentKey;
    this.$_addIndentation$();
    this.$_addIcon$();
    this.$_setIconStateClass$();
    "expanded" === this.$iconState$ || "collapsed" === this.$iconState$ ? ($$$$20$$(this.$toucharea$).on("touchend", function($event$$338$$) {
      $event$$338$$.preventDefault();
      $self$$138$$.$_fireExpandCollapse$();
    }), $$$$20$$(this.$toucharea$).on("click", function($event$$339$$) {
      $event$$339$$.preventDefault();
      $self$$138$$.$_fireExpandCollapse$();
    }), $$$$20$$(this.element).on("keypress", function($event$$340$$) {
      var $code$$7$$ = $event$$340$$.keyCode || $event$$340$$.which;
      if ($code$$7$$ === $$$$20$$.ui.keyCode.ENTER || $code$$7$$ === $$$$20$$.ui.keyCode.SPACE) {
        $self$$138$$.$_fireExpandCollapse$(), $event$$340$$.preventDefault(), $event$$340$$.target.focus();
      }
    ...
    this.element.empty();
  }, _setOption:function($key$$128$$, $value$$248$$, $flags$$32$$) {
    this._super($key$$128$$, $value$$248$$, $flags$$32$$);
  ...
  }, $_handleActiveKeyChangeEvent$:function($event$$341$$, $ui$$18$$) {
    var $context$$103_rowKey$$26$$, $previousRowKey_state$$9$$;
    null != $ui$$18$$.currentCell && ($context$$103_rowKey$$26$$ = "cell" == $ui$$18$$.currentCell.type ? $ui$$18$$.currentCell.keys.row : $ui$$18$$.currentCell.key, null != $ui$$18$$.previousValue && ($previousRowKey_state$$9$$ = "cell" == $ui$$18$$.previousCurrentCell.type ? $ui$$18$$.previousCurrentCell.keys.row : $ui$$18$$.previousCurrentCell.key), this.$rowKey$ === $context$$103_rowKey$$26$$ && $previousRowKey_state$$9$$ != $context$$103_rowKey$$26$$ && this.$component$.$_setAccessibleContext$ && 
    ($context$$103_rowKey$$26$$ = this.$getTranslatedString$("accessibleRowDescription", {level:this.depth, num:this.index + 1, total:this.$datasource$.getWrappedDataSource().$getChildCount$(this.$parentKey$)}), $previousRowKey_state$$9$$ = "collapsed" === this.$iconState$ ? this.$getTranslatedString$("accessibleStateCollapsed") : "expanded" === this.$iconState$ ? this.$getTranslatedString$("accessibleStateExpanded") : "", this.$component$.$_setAccessibleContext$({context:$context$$103_rowKey$$26$$, 
    state:$previousRowKey_state$$9$$})));
  }, $_handleKeyDownEvent$:function($event$$342$$, $ui$$19$$) {
    var $ancestors$$2_code$$8_context$$104$$, $ancestorInfo$$, $i$$303$$;
    if (this.$rowKey$ === $ui$$19$$.rowKey && ($event$$342$$ = $event$$342$$.originalEvent, $ancestors$$2_code$$8_context$$104$$ = $event$$342$$.keyCode || $event$$342$$.which, $oj$$21$$.$DomUtils$.$isMetaKeyPressed$($event$$342$$))) {
      if ($ancestors$$2_code$$8_context$$104$$ == $$$$20$$.ui.keyCode.RIGHT && "collapsed" === this.$iconState$) {
        this.$_loading$(), this.$datasource$.expand(this.$rowKey$), $event$$342$$.preventDefault();
      } else {
        if ($ancestors$$2_code$$8_context$$104$$ == $$$$20$$.ui.keyCode.LEFT && "expanded" === this.$iconState$) {
          this.$_loading$(), this.$datasource$.collapse(this.$rowKey$), $event$$342$$.preventDefault();
        } else {
          if ($event$$342$$.altKey && $ancestors$$2_code$$8_context$$104$$ == this.$constants$.$NUM5_KEY$ && this.$component$.$_setAccessibleContext$) {
            $ancestors$$2_code$$8_context$$104$$ = this.$datasource$.$getAncestors$(this.$rowKey$);
            if (null != $ancestors$$2_code$$8_context$$104$$ && 0 < $ancestors$$2_code$$8_context$$104$$.length) {
              for ($ancestorInfo$$ = [], $i$$303$$ = 0;$i$$303$$ < $ancestors$$2_code$$8_context$$104$$.length;$i$$303$$++) {
                $ancestorInfo$$.push({key:$ancestors$$2_code$$8_context$$104$$[$i$$303$$], label:this.$getTranslatedString$("accessibleLevelDescription", {level:$i$$303$$ + 1})});
              }
            }
            $ancestors$$2_code$$8_context$$104$$ = this.$getTranslatedString$("accessibleRowDescription", {level:this.depth, num:this.index + 1, total:this.$datasource$.getWrappedDataSource().$getChildCount$(this.$parentKey$)});
            this.$component$.$_setAccessibleContext$({context:$ancestors$$2_code$$8_context$$104$$, state:"", ancestors:$ancestorInfo$$});
            $event$$342$$.preventDefault();
          }
        }
      }
    }
    ...
    this.$_setIconStateClass$();
  }, $_handleExpandEvent$:function($event$$343_rowKey$$28$$) {
    $event$$343_rowKey$$28$$ = $event$$343_rowKey$$28$$.rowKey;
    $event$$343_rowKey$$28$$ === this.$rowKey$ && (this.$_removeIconStateClass$(), this.$iconState$ = "expanded", this.$_setIconStateClass$(), this.$_ariaExpanded$(!0), this._trigger("expand", null, {rowKey:$event$$343_rowKey$$28$$}));
  }, $_handleCollapseEvent$:function($event$$344_rowKey$$29$$) {
    $event$$344_rowKey$$29$$ = $event$$344_rowKey$$29$$.rowKey;
    $event$$344_rowKey$$29$$ === this.$rowKey$ && (this.$_removeIconStateClass$(), this.$iconState$ = "collapsed", this.$_setIconStateClass$(), this.$_ariaExpanded$(!1), this._trigger("collapse", null, {rowKey:$event$$344_rowKey$$29$$}));
    ...
    return $node$$78$$ === this.icon.get(0) ? {$subId$:"oj-rowexpander-disclosure"} : null;
