...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "hammerjs", "ojs/ojpagingtabledatasource", "ojs/ojinputtext", "ojs/ojjquery-hammer"], function($oj$$10$$, $$$$10$$, $compCore$$, $Hammer$$2$$) {
  (function() {
    ...
    $_DATA_ATTR_PAGE_NUM$:"data-oj-pagenum", $_OPTION_ENABLED$:"enabled", $_OPTION_DISABLED$:"disabled", $_TAB_INDEX$:"tabindex", $_MODE$:{$_LOAD_MORE$:"loadMore", $_PAGE$:"page"}, $_PAGE_OPTION_LAYOUT$:{$_AUTO$:"auto", $_ALL$:"all", $_INPUT$:"input", $_RANGE_TEXT$:"rangeText", $_PAGES$:"pages", $_NAV$:"nav"}, $_PAGE_OPTION_DEFAULT_MAX_PAGE_LINKS$:6, $_TYPE$:{$_NUMBERS$:"numbers", $_DOTS$:"dots"}, firstPage:function() {
    ...
    }, $_events$:{"mouseup .oj-pagingcontrol-loadmore-link":function($event$$70$$) {
      this.loadNext();
      $$$$10$$($event$$70$$.target).data("_mouseup", !0);
      $event$$70$$.preventDefault();
    }, "click .oj-pagingcontrol-loadmore-link":function($event$$71$$) {
      $$$$10$$($event$$71$$.target).data("_mouseup") ? $$$$10$$($event$$71$$.target).data("_mouseup", !1) : this.loadNext();
      $event$$71$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-dot":function($event$$72$$) {
      var $pageNum$$ = $$$$10$$($event$$72$$.currentTarget).attr("data-oj-pagenum"), $self$$53$$ = this;
    ...
    }, "click .oj-pagingcontrol-nav-page":function($event$$73$$) {
      var $pageNum$$1$$ = $$$$10$$($event$$73$$.currentTarget).attr("data-oj-pagenum"), $self$$54$$ = this;
    ...
    }, "click .oj-pagingcontrol-nav-first":function($event$$74$$) {
    ...
    }, "click .oj-pagingcontrol-nav-previous":function($event$$75$$) {
    ...
    }, "click .oj-pagingcontrol-nav-next":function($event$$76$$) {
    ...
    }, "click .oj-pagingcontrol-nav-last":function($event$$77$$) {
    ...
    }, "keypress .oj-pagingcontrol-nav-input":function($event$$78$$) {
      13 == $event$$78$$.which && $event$$78$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-first":function($event$$79$$) {
    ...
    }, "mousedown .oj-pagingcontrol-nav-previous":function($event$$80$$) {
    ...
    }, "mousedown .oj-pagingcontrol-nav-next":function($event$$81$$) {
    ...
    }, "mousedown .oj-pagingcontrol-nav-last":function($event$$82$$) {
      ...
      this.$_queueRefresh$();
    }, $_handleDataPage$:function($event$$92$$) {
      $event$$92$$.page != $event$$92$$.previousPage && this.$_queueRefresh$();
    }, $_handleDataReset$:function() {
      this.$_invokeDataPage$(0, !1);
    }, $_handleDataRefresh$:function() {
      this.$_queueRefresh$();
    }, $_handleDataSort$:function($event$$95$$) {
      this.options.mode == this.$_MODE$.$_LOAD_MORE$ && this.$_handleDataReset$($event$$95$$);
    }, $_handleDataRowAdd$:function($event$$96$$) {
      this.options.mode == this.$_MODE$.$_PAGE$ && this.$_isOperationOnCurrentPage$($event$$96$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handleDataRowRemove$:function($event$$97$$) {
      0 < this.$_getTotalPages$() && this.$_getCurrentPage$() > this.$_getTotalPages$() - 1 ? this.$_invokeDataPage$(this.$_getTotalPages$() - 1, !0) : this.$_isOperationOnCurrentPage$($event$$97$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handlePageChange$:function($event$$98$$, $data$$69$$) {
    ...
    }, $_isOperationOnCurrentPage$:function($event$$99$$) {
      var $data$$72$$ = this.$_getData$(), $pageSize$$1$$ = this.options.pageSize, $i$$134$$;
      for ($i$$134$$ = 0;$i$$134$$ < $event$$99$$.indexes.length;$i$$134$$++) {
        var $rowIdx$$ = $event$$99$$.indexes[$i$$134$$], $startIndex$$4$$ = $data$$72$$.getStartItemIndex(), $endIndex$$ = $startIndex$$4$$ + $pageSize$$1$$;
      ...
      if (null != $data$$75$$) {
        ...
        for ($i$$135$$ = 0;$i$$135$$ < this.$_dataSourceEventHandlers$.length;$i$$135$$++) {
          ($ev$$ = $data$$75$$.on(this.$_dataSourceEventHandlers$[$i$$135$$].eventType, this.$_dataSourceEventHandlers$[$i$$135$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$135$$].eventHandler = $ev$$);
        }
      }
      ...
      if ($oj$$10$$.$DomUtils$.$isTouchSupported$() && this.options.mode == this.$_MODE$.$_PAGE$) {
        ...
        if (null != $pagingControlNavArrowSection$$2$$) {
          ...
          if ("vertical" == this.options.pageOptions.orientation) {
            ...
            this.$_hammerSwipeUp$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipeup", function($event$$100$$) {
              $event$$100$$.preventDefault();
              $self$$66$$.nextPage();
            });
            this.$_hammerSwipeDown$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipedown", function($event$$101$$) {
              $event$$101$$.preventDefault();
              $self$$66$$.previousPage();
            });
          } else {
            $options$$218$$ = {recognizers:[[$Hammer$$2$$.Swipe, {direction:$Hammer$$2$$.DIRECTION_HORIZONTAL}]]}, this.$_hammerSwipeLeft$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipeleft", function($event$$102$$) {
              $event$$102$$.preventDefault();
              $self$$66$$.nextPage();
            }), this.$_hammerSwipeRight$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swiperight", function($event$$103$$) {
      ...
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$76$$) {
        ...
        for ($i$$136$$ = 0;$i$$136$$ < this.$_dataSourceEventHandlers$.length;$i$$136$$++) {
          $data$$76$$.off(this.$_dataSourceEventHandlers$[$i$$136$$].eventType, this.$_dataSourceEventHandlers$[$i$$136$$].eventHandler);
        }
      }
