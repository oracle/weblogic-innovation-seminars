...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$28$$, $$$$27$$) {
  (function() {
    $oj$$28$$.$__registerWidget$("oj.ojCheckboxset", $$$$27$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{disabled:!1, value:void 0}, refresh:function() {
      ...
      var $allcheckboxes_first$$6_name$$113$$ = this.element.find("input[type\x3dcheckbox]:first");
      0 === $allcheckboxes_first$$6_name$$113$$.length && $oj$$28$$.$Logger$.warn("Could not find any input type\x3dcheckbox within this element");
      $allcheckboxes_first$$6_name$$113$$ = $allcheckboxes_first$$6_name$$113$$.attr("name");
      return void 0 === $allcheckboxes_first$$6_name$$113$$ ? ($allcheckboxes_first$$6_name$$113$$ = this.element.find("input[type\x3dcheckbox]"), $allcheckboxes_first$$6_name$$113$$.not("[name]")) : this.element.find("input[type\x3dcheckbox][name\x3d" + $allcheckboxes_first$$6_name$$113$$ + "]");
    }, $_NotifyContextMenuGesture$:function($launcher$$8_menu$$14$$, $event$$381$$, $eventType$$43$$) {
      $launcher$$8_menu$$14$$ = this.element.find("input[type\x3dcheckbox]:tabbable").first();
      this.$_OpenContextMenu$($event$$381$$, $eventType$$43$$, {launcher:$launcher$$8_menu$$14$$});
    ...
    }, $_events$:{change:function($event$$382$$) {
      this.$_HandleChangeEvent$($event$$382$$);
    }}, $_HandleChangeEvent$:function($event$$383$$) {
      var $submittedValue$$4$$ = this.$_GetDisplayValue$();
      this.$_SetValue$($submittedValue$$4$$, $event$$383$$, $_sValueChangeCheckFalse$$);
    ...
    }, _setOption:function($key$$140$$, $value$$255$$, $flags$$36$$) {
      this._super($key$$140$$, $value$$255$$, $flags$$36$$);
      "disabled" === $key$$140$$ && this.$_propagateDisabled$($value$$255$$);
    }, getNodeBySubId:function($locator$$34_subId$$39$$) {
      var $node$$82$$ = this._super($locator$$34_subId$$39$$);
      return $node$$82$$ || ($locator$$34_subId$$39$$ = $locator$$34_subId$$39$$.subId, "oj-checkboxset-inputs" !== $locator$$34_subId$$39$$) ? $node$$82$$ || null : this.$$checkboxes$.get();
    }, _destroy:function() {
      var $ret$$41$$ = this._super(), $wrapperDom$$ = this.element[0].firstChild;
