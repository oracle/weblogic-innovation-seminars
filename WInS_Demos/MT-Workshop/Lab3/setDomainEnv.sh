...
WL_HOME="/u01/wins/wls1221/wlserver"
export WL_HOME
...
SUN_JAVA_HOME="/u01/java/jdk1.8.0_40"
export SUN_JAVA_HOME

DEFAULT_SUN_JAVA_HOME="/u01/java/jdk1.8.0_40"
...
if [ "${VM_TYPE}" = "JRockit" ] ; then
	...
	if [ "${JAVA_VENDOR}" = "Sun" ] ; then
		...
		JAVA_VENDOR="Oracle"
		export JAVA_VENDOR
		JAVA_HOME="/u01/java/jdk1.8.0_40"
		export JAVA_HOME
		VM_TYPE="HotSpot"
		export VM_TYPE
	fi
...
DOMAIN_HOME="/u01/wins/wls1221/user_projects/domains/base_domain"
export DOMAIN_HOME

LONG_DOMAIN_HOME="/u01/wins/wls1221/user_projects/domains/base_domain"
