...
cmo.setUrl('jdbc:oracle:thin:@//localhost:1521/pdb3')
...
startEdit()
deploy(appName='web', partition='dp3', resourceGroup='app3RG', path='/u01/content/weblogic-innovation-seminars/WInS_Demos/MT-Workshop/Lab1/web-3.0.0.war')
activate()
