...
startEdit()
deploy(appName='medrec', partition='dp2', resourceGroup='app2RG', path='//u01/content/weblogic-innovation-seminars/WInS_Demos/MT-Workshop/Lab1/medrec.ear')
deploy(appName='physician', partition='dp2', resourceGroup='app2RG', path='/u01/content/weblogic-innovation-seminars/WInS_Demos/MT-Workshop/Lab1/physician.ear')
deploy(appName='chat', partition='dp2', resourceGroup='app2RG', path='/u01/content/weblogic-innovation-seminars/WInS_Demos/MT-Workshop/Lab1/chat.war')
activate()
