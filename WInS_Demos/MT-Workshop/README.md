...
14. Go to Admin Console of JCS instance [ Admin Console ](http://localhost:7001/console) and enter **weblogic/welcome1** as **Username/Password** and then click on **Login**.
