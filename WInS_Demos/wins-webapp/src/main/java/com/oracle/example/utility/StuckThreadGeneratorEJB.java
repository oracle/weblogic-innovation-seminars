 ...
 */
@Stateless(name = "StuckThreadGenerator", mappedName = "ejb/StuckThreadGenerator")
@LocalBean
public class StuckThreadGeneratorEJB  implements Serializable
{
  ...
  public void doIt()
  {
    logger.info("Generating Stuck Threads!!!!");
    int BATCH_SIZE = 50;
