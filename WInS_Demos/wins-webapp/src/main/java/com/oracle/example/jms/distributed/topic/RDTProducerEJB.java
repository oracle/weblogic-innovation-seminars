 ...
 */
@Stateless(name = "RDTProducerEJB", mappedName = "ejb/RDTProducer")
@LocalBean
public class RDTProducerEJB implements Serializable
{
  public static final String JMS_CF_JNDI = "com/oracle/example/jms/base/cf";
  public static final String JMS_QUEUE_JNDI = "com/oracle/example/jms/base/replicated-topic";

  private static final Logger logger = Logger.getLogger(RDTProducerEJB.class.getName());
  ...
  public void doIt()
  {
    ...
    try
    {
      ...
      {
        queueProducer.send(session.createTextMessage("Batch=[" + batchName + "] Replicated Distributed Topic!! [ " + x + " / " + BATCH_SIZE + " ]"));
