 ...
 * ExampleGAR.gar  the Grid Archive (GAR) which contains POJOs, cache and POF configuration, as well as other classes required by the Coherence applications and cache servers. 
