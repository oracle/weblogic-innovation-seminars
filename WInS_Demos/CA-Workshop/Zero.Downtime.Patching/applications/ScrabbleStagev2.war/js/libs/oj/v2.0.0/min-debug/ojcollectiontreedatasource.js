...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$33$$) {
  ...
  $oj$$33$$.$CollectionNodeSet$.prototype.$FetchChildNodeSet$ = function $$oj$$33$$$$CollectionNodeSet$$$$FetchChildNodeSet$$($index$$202$$, $callbacks$$36$$) {
    var $model$$71_parentKey$$7$$ = this.$collection$.at($index$$202$$);
    if (this.$treeDataSource$.$parseMetadata$($model$$71_parentKey$$7$$).leaf) {
      this.$childNodeSet$[$index$$202$$] = null, $callbacks$$36$$.success(null);
    } else {
      var $collection$$38$$ = this.$treeDataSource$.$GetChildCollection$($model$$71_parentKey$$7$$), $model$$71_parentKey$$7$$ = this.$treeDataSource$.$parseMetadata$($model$$71_parentKey$$7$$).key, $self$$166$$ = this;
  ...
  $oj$$33$$.$CollectionNodeSet$.prototype.getMetadata = function $$oj$$33$$$$CollectionNodeSet$$$getMetadata$($index$$205_model$$72_parse$$6$$) {
    this.$_checkRange$($index$$205_model$$72_parse$$6$$);
    var $metadata$$13$$ = {};
    $index$$205_model$$72_parse$$6$$ = this.$collection$.at($index$$205_model$$72_parse$$6$$);
    $index$$205_model$$72_parse$$6$$ = this.$treeDataSource$.$parseMetadata$($index$$205_model$$72_parse$$6$$);
    $metadata$$13$$.key = $index$$205_model$$72_parse$$6$$.key;
    $metadata$$13$$.leaf = $index$$205_model$$72_parse$$6$$.leaf;
    $metadata$$13$$.depth = $index$$205_model$$72_parse$$6$$.depth;
    return $metadata$$13$$;
  };
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$parseMetadata$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$parseMetadata$$($model$$73$$) {
    return{key:$model$$73$$.idAttribute + "\x3d" + $model$$73$$.id};
  };
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$ModelAdded$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$ModelAdded$$($event$$408_model$$74$$, $collection$$40_parents$$4$$, $options$$314$$) {
    var $index$$207$$ = 0;
    $options$$314$$ && $options$$314$$.at && ($index$$207$$ = $options$$314$$.at);
    $collection$$40_parents$$4$$ = this.$_getParentChain$($collection$$40_parents$$4$$);
    $event$$408_model$$74$$ = this.$_createEvent$(this, "insert", $index$$207$$, $collection$$40_parents$$4$$, this.$_putModelInNodeSet$(null != $collection$$40_parents$$4$$ && 0 < $collection$$40_parents$$4$$.length ? $collection$$40_parents$$4$$[$collection$$40_parents$$4$$.length - 1] : null, $event$$408_model$$74$$));
    this.handleEvent("change", $event$$408_model$$74$$);
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$ModelRemoved$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$ModelRemoved$$($event$$409_model$$75$$, $collection$$41$$, $options$$315$$) {
    var $index$$208$$ = 0;
    $options$$315$$ && $options$$315$$.index && ($index$$208$$ = $options$$315$$.index);
    this.$_removeCollectionFromCache$($event$$409_model$$75$$);
    $event$$409_model$$75$$ = this.$_createEvent$(this, "delete", $index$$208$$, this.$_getParentChain$($collection$$41$$), null);
    this.handleEvent("change", $event$$409_model$$75$$);
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$ModelUpdated$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$ModelUpdated$$($event$$410_model$$76$$) {
    var $collectionForModel$$ = this.$_getCollectionForModel$($event$$410_model$$76$$), $index$$209$$ = null, $parents$$5$$ = null;
    $collectionForModel$$ && ($index$$209$$ = $collectionForModel$$.index, $parents$$5$$ = this.$_getParentChain$($collectionForModel$$.$collection$));
    $event$$410_model$$76$$ = this.$_createEvent$(this, "update", $index$$209$$, $parents$$5$$, this.$_putModelInNodeSet$(null != $parents$$5$$ && 0 < $parents$$5$$.length ? $parents$$5$$[$parents$$5$$.length - 1] : null, $event$$410_model$$76$$));
    this.handleEvent("change", $event$$410_model$$76$$);
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$CollectionRefreshed$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$CollectionRefreshed$$($collection$$42_event$$411$$) {
    $collection$$42_event$$411$$ = this.$_createEvent$(this, "refresh", null, this.$_getParentChain$($collection$$42_event$$411$$), null);
    this.handleEvent("refresh", $collection$$42_event$$411$$);
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_putModelInNodeSet$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_putModelInNodeSet$$($parent$$36$$, $model$$77$$) {
    var $collection$$43$$ = new $oj$$33$$.$Collection$;
    $collection$$43$$.add($model$$77$$);
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_getCacheKey$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_getCacheKey$$($model$$78$$) {
    var $key$$147$$ = $model$$78$$ instanceof $oj$$33$$.$Model$ ? this.$parseMetadata$($model$$78$$).key : $model$$78$$;
    return $model$$78$$ ? $key$$147$$ : $oj$$33$$.$CollectionTreeDataSource$.$ROOT_CACHE_KEY$;
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$__getParentsChildCollectionFromCache$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$__getParentsChildCollectionFromCache$$($model$$79$$) {
    return this.$cache$[this.$_getCacheKey$($model$$79$$)];
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_setCollectionInCache$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_setCollectionInCache$$($model$$80$$, $collection$$45$$) {
    ...
    this.$cache$[this.$_getCacheKey$($model$$80$$)] = $collection$$45$$;
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_removeCollectionFromCache$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_removeCollectionFromCache$$($key$$148_model$$81$$) {
    $key$$148_model$$81$$ = this.$_getCacheKey$($key$$148_model$$81$$);
    for (var $prop$$66$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$66$$) && $prop$$66$$ === $key$$148_model$$81$$) {
        this.$cache$[$key$$148_model$$81$$].off(null, null, this);
        delete this.$cache$[$key$$148_model$$81$$];
        break;
      }
    }
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_keyInCollection$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_keyInCollection$$($key$$149$$, $collection$$46$$) {
    for (var $count$$56$$ = $collection$$46$$.length, $i$$333$$ = 0;$i$$333$$ < $count$$56$$;$i$$333$$++) {
      var $currKey$$ = this.$_getCacheKey$($collection$$46$$.at($i$$333$$));
      if ($key$$149$$ === $currKey$$) {
        return!0;
      }
    }
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_getCollectionForModel$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_getCollectionForModel$$($model$$82$$) {
    for (var $prop$$67$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$67$$)) {
        for (var $collection$$47$$ = this.$cache$[$prop$$67$$], $i$$334$$ = 0;$i$$334$$ < $collection$$47$$.length;$i$$334$$++) {
          if ($collection$$47$$.at($i$$334$$) === $model$$82$$) {
            return{index:$i$$334$$, $collection$:$collection$$47$$};
          }
        }
      }
    }
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_scanForKey$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_scanForKey$$($collection$$53$$, $key$$151$$) {
    ...
    return new Promise(function($resolve$$47$$) {
      function $checkNext$$($index$$211$$, $collection$$54$$, $key$$152$$) {
        $index$$211$$ < $collection$$54$$.length ? $collection$$54$$.at($index$$211$$, {deferred:!0}).then(function($model$$83$$) {
          if ($model$$83$$) {
            var $parse$$7$$ = $self$$169$$.$parseMetadata$($model$$83$$);
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_getModelForId$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_getModelForId$$($collection$$55$$, $key$$153$$, $depth$$25$$) {
    ...
    return new Promise(function($resolve$$48$$) {
      $self$$170$$.$_scanForKey$($collection$$55$$, $key$$153$$).then(function($model$$84$$) {
          ...
          if ($index$$212$$ < $max$$7$$) {
            ...
            $childColl$$1$$.$collection$ ? $tds$$.$_fetch$($childColl$$1$$, function($fetchColl$$) {
              $tds$$.$_getModelForId$($fetchColl$$, $key$$153$$, $depth$$25$$ + 1).then(function($childModel$$) {
                $childModel$$ ? $resolve$$48$$($childModel$$) : ($index$$212$$++, $getNextCollection$$($index$$212$$, $tds$$));
              });
        ...
        if ($model$$84$$) {
          $resolve$$48$$({$model$:$model$$84$$, depth:$depth$$25$$});
        } else {
