...
*/
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojconveyorbelt", "ojs/ojmenu", "jqueryui-amd/sortable", "ojs/ojtouchproxy"], function($oj$$71$$, $$$$65$$) {
  (function() {
    ...
    $oj$$71$$.$__registerWidget$("oj.ojTabs", $$$$65$$.oj.baseComponent, {widgetEventPrefix:"oj", delay:300, options:{selected:0, disabledTabs:null, truncation:"auto", selectOn:"click", orientation:"horizontal", edge:"top", removable:!1, reorderable:!1, beforeSelect:null, select:null, beforeDeselect:null, deselect:null, beforeRemove:null, remove:null, beforeReorder:null, reorder:null, optionChange:null}, _ComponentCreate:function() {
    ...
    }, $_isTabDisabled$:function($index$$273$$) {
      return 0 <= $index$$273$$ && $index$$273$$ < this.$tabs$.length ? $$$$65$$(this.$tabs$[$index$$273$$]).hasClass("oj-disabled") : !1;
    }, $_focusNextTab$:function($index$$274$$, $goingForward$$) {
      var $enabledTabs$$1_selTab$$1$$ = this.$_getEnabledTabs$(), $currentIndex$$4$$ = $enabledTabs$$1_selTab$$1$$.index(this.$tabs$[$index$$274$$]), $length$$20$$ = $enabledTabs$$1_selTab$$1$$.length, $enabledTabs$$1_selTab$$1$$ = $$$$65$$($enabledTabs$$1_selTab$$1$$[$goingForward$$ ? ($currentIndex$$4$$ + 1) % $length$$20$$ : ((0 == $currentIndex$$4$$ ? $length$$20$$ : $currentIndex$$4$$) - 1) % $length$$20$$]);
      $enabledTabs$$1_selTab$$1$$.focus();
      return $enabledTabs$$1_selTab$$1$$;
    }, $_getNextEnabledTab$:function($index$$275$$) {
      for (var $next$$10$$ = $index$$275$$ + 1, $lastTabIndex$$ = this.$tabs$.length - 1;$next$$10$$ <= $lastTabIndex$$;) {
        if (!this.$_isTabDisabled$($next$$10$$)) {
          return $next$$10$$;
        }
        $next$$10$$++;
      }
      for ($next$$10$$ = $index$$275$$ - 1;0 <= $next$$10$$;) {
        if (!this.$_isTabDisabled$($next$$10$$)) {
          return $next$$10$$;
        }
        $next$$10$$--;
    ...
    }, _setOption:function($edge$$13_key$$180_selectedIndex$$4$$, $value$$298$$, $flags$$49$$) {
      "selected" === $edge$$13_key$$180_selectedIndex$$4$$ ? ($value$$298$$ = this.$_getTab$($value$$298$$), void 0 !== $value$$298$$ && this.$_activate$($value$$298$$)) : "disabledTabs" === $edge$$13_key$$180_selectedIndex$$4$$ ? Array.isArray($value$$298$$) && (this.$_setOjDisabledOnTab$($value$$298$$), $edge$$13_key$$180_selectedIndex$$4$$ = this.$_getSelectedIndex$(), this.$_isTabDisabled$($edge$$13_key$$180_selectedIndex$$4$$) && this.$_fireSelectEvents$($edge$$13_key$$180_selectedIndex$$4$$), 
      this.refresh()) : "removable" === $edge$$13_key$$180_selectedIndex$$4$$ || "truncation" === $edge$$13_key$$180_selectedIndex$$4$$ ? $value$$298$$ != this.options[$edge$$13_key$$180_selectedIndex$$4$$] && (this._super($edge$$13_key$$180_selectedIndex$$4$$, $value$$298$$, $flags$$49$$), this.refresh()) : "reorderable" === $edge$$13_key$$180_selectedIndex$$4$$ ? $value$$298$$ !== this.options.reorderable && (this._super($edge$$13_key$$180_selectedIndex$$4$$, $value$$298$$, $flags$$49$$), this.refresh()) : 
      "orientation" === $edge$$13_key$$180_selectedIndex$$4$$ ? this.$_edgeSpecified$ || ($edge$$13_key$$180_selectedIndex$$4$$ = this.$_orientationToEdge$($value$$298$$)) && this.$_setupEdge$($edge$$13_key$$180_selectedIndex$$4$$) && this.refresh() : "edge" === $edge$$13_key$$180_selectedIndex$$4$$ ? this.$_setupEdge$($value$$298$$) && (this.$_edgeSpecified$ = !0, this._super($edge$$13_key$$180_selectedIndex$$4$$, $value$$298$$, $flags$$49$$), this.refresh()) : "selectOn" === $edge$$13_key$$180_selectedIndex$$4$$ ? 
      (this.$_tearDownEvents$(!0), this._super($edge$$13_key$$180_selectedIndex$$4$$, $value$$298$$, $flags$$49$$), this.$_setupEvents$()) : ("contextMenu" === $edge$$13_key$$180_selectedIndex$$4$$ && (this.$_clearMenu$(), $value$$298$$ && this.$_initMenu$($value$$298$$)), this._super($edge$$13_key$$180_selectedIndex$$4$$, $value$$298$$, $flags$$49$$), "translations" === $edge$$13_key$$180_selectedIndex$$4$$ && $flags$$49$$ && "removeCueText" === $flags$$49$$.subkey && this.$tablist$ && this.$_getCloseIcons$(this.$tablist$).attr("aria-label", 
      $value$$298$$ ? $value$$298$$.removeCueText : ""));
    }, refresh:function() {
      this._super();
      this.$_processTabs$();
      this.$_refresh$();
      ...
      if ($enabledTabs$$2_event$$638$$) {
        var $self$$217$$ = this;
        $$$$65$$.each($enabledTabs$$2_event$$638$$.split(" "), function($index$$277$$, $eventName$$2$$) {
          "click" == $eventName$$2$$ && ($selectOnClick$$ = !0);
          $oj$$71$$.$DomUtils$.$isValidIdentifier$($eventName$$2$$) && ($events$$17$$[$eventName$$2$$] = $self$$217$$.$_eventHandler$);
        });
      }
      $enabledTabs$$2_event$$638$$ = this.$_getEnabledTabs$();
      this._on($enabledTabs$$2_event$$638$$, $events$$17$$);
      $selectOnClick$$ || this._on($enabledTabs$$2_event$$638$$, {click:function($e$$114$$) {
      ...
      $toHide$$.hide();
      0 < $toHide$$.length && $oj$$71$$.Components.$subtreeHidden$($toHide$$[0]);
      ...
      $toShow$$.show();
      0 < $toShow$$.length && $oj$$71$$.Components.$subtreeShown$($toShow$$[0]);
      this.$running$ = !1;
      ...
      if (this.options.removable && this.$_isHorizontal$()) {
        ...
        this.$_getEnabledTabs$().each(function($index$$278_rmId$$) {
          var $div$$7$$ = $$$$65$$(this).find("\x3e :first-child");
          $div$$7$$.addClass("oj-removable");
          $index$$278_rmId$$ = "ojtabs-id_rm_" + $index$$278_rmId$$;
          $$$$65$$(this).attr("aria-describedby", $index$$278_rmId$$);
          $$$$65$$("\x3ca href\x3d'#'\x3e").addClass("oj-tabs-icon oj-component-icon oj-clickable-icon-nocontext oj-tabs-close-icon").attr({id:$index$$278_rmId$$, tabIndex:"-1", "aria-label":$removeCueText$$, role:"presentation"}).appendTo($div$$7$$);
        });
      }
    }, $_getEnabledTabs$:function() {
      return $$$$65$$(this.$tabs$.not(".oj-disabled"));
    }, $_getCloseIcons$:function($elem$$160$$) {
      return $elem$$160$$.find(".oj-tabs-close-icon");
    }, $_destroyTabBar$:function() {
      this.$tabs$ && this.$_tearDownEvents$();
      this.$_hasResizeListener$ && ($oj$$71$$.$DomUtils$.$removeResizeListener$(this.element[0], this.$_resizeHandler$), this.$_hasResizeListener$ = !1, this.$_originalWidth$ = void 0);
      this.$_sortable$ && ($oj$$71$$.$DomUtils$.$isTouchSupported$() && this.$_tearDownTouchReorder$(), this.$tablist$.sortable("destroy"), this.$_sortable$ = void 0);
      ...
      if (this.$tabs$ && (this.$_getCloseIcons$(this.$tabs$).remove(), $navRoot$$.length)) {
        ...
        $navRoot$$.children().each(function() {
          var $child$$25$$ = $$$$65$$(this);
          if ($child$$25$$.hasClass("oj-tabs-conveyorbelt-wrapper")) {
            $child$$25$$ = $tabbar$$;
          } else {
            if (!$child$$25$$.hasClass("oj-tabs-facet")) {
              return;
            }
          }
          $noFacet$$ = !1;
          $afterMe$$.after($child$$25$$);
          $afterMe$$ = $child$$25$$;
        });
      ...
      this.$tabs$.each(function($index$$279$$) {
        $tab$$3$$ = $$$$65$$(this);
        ...
        $self$$219$$.$_isOldMarkup$ ? $header$$13$$.prependTo($self$$219$$.$panels$.get($index$$279$$)) : $div$$8$$.hasClass("oj-tabs-gen-div") && $anchor$$6$$.hasClass("oj-tabs-gen-a") ? ($header$$13$$.prependTo($tab$$3$$), $div$$8$$.remove()) : $anchor$$6$$.hasClass("oj-tabs-gen-a") ? ($header$$13$$.prependTo($div$$8$$), $anchor$$6$$.remove()) : $div$$8$$.hasClass("oj-tabs-gen-div") && ($anchor$$6$$.prependTo($tab$$3$$), $div$$8$$.remove());
      });
      ...
      var $tab$$6$$, $content$$37$$, $index$$281_tabAfter$$ = -1;
      $contentAfter_navRoot$$1_newTab_tabbar$$2$$.tab && $contentAfter_navRoot$$1_newTab_tabbar$$2$$.content ? ($content$$37$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$.content, $tab$$6$$ = this.$_wrapLi$($contentAfter_navRoot$$1_newTab_tabbar$$2$$.tab, this.$_getUniqueId$($content$$37$$)), void 0 !== $contentAfter_navRoot$$1_newTab_tabbar$$2$$.index && ($index$$281_tabAfter$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$.index)) : ($content$$37$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$, 
      $tab$$6$$ = this.$_wrapLi$($$$$65$$($contentAfter_navRoot$$1_newTab_tabbar$$2$$).find("\x3e :first-child"), this.$_getUniqueId$($content$$37$$)));
      ...
      0 <= $index$$281_tabAfter$$ && $index$$281_tabAfter$$ < $contentAfter_navRoot$$1_newTab_tabbar$$2$$.children().length ? ($index$$281_tabAfter$$ = $contentAfter_navRoot$$1_newTab_tabbar$$2$$.children(":eq(" + $index$$281_tabAfter$$ + ")"), $contentAfter_navRoot$$1_newTab_tabbar$$2$$ = this.element.children("#" + $index$$281_tabAfter$$.attr("aria-controls")), $index$$281_tabAfter$$.before($tab$$6$$), $contentAfter_navRoot$$1_newTab_tabbar$$2$$.before($content$$37$$)) : ($tab$$6$$.appendTo($contentAfter_navRoot$$1_newTab_tabbar$$2$$), 
      $content$$37$$.appendTo(this.element));
      this.refresh();
      ...
      this.$_touchProxy$ = $oj$$71$$.$_TouchProxy$.$addTouchListeners$(this.$tablist$);
    }, $_tearDownTouchReorder$:function() {
      $oj$$71$$.$_TouchProxy$.$removeTouchListeners$(this.$tablist$);
    }, $_setupReorder$:function() {
      if (this.options.reorderable) {
        var $self$$221$$ = this;
        $oj$$71$$.$DomUtils$.$isTouchSupported$() && this.$_setupTouchReorder$();
    ...
    }, $_orientationToEdge$:function($value$$299$$) {
      return "horizontal" == $value$$299$$ ? "top" : "vertical" == $value$$299$$ ? "start" : null;
      ...
      return $ulParent$$;
    }, $_addPrefixId$:function($elem$$161$$) {
      0 > $elem$$161$$.id.indexOf("ojtabs-id_") && $$$$65$$($elem$$161$$).attr("id", "ojtabs-id_" + $elem$$161$$.id);
    }, getNodeBySubId:function($index$$282_locator$$57$$) {
      if (null == $index$$282_locator$$57$$) {
        return this.element ? this.element[0] : null;
      }
      var $subId$$61$$ = $index$$282_locator$$57$$.subId;
      $index$$282_locator$$57$$ = $index$$282_locator$$57$$.index;
      if ("oj-conveyorbelt" != $subId$$61$$ && ("number" !== typeof $index$$282_locator$$57$$ || 0 > $index$$282_locator$$57$$ || $index$$282_locator$$57$$ >= this.$panels$.length)) {
        return null;
      }
      switch($subId$$61$$) {
        ...
        case "oj-tabs-panel":
          return this.$_getPanelForTab$(this.$tabs$[$index$$282_locator$$57$$])[0];
        case "oj-tabs-tab":
          return this.$tabs$[$index$$282_locator$$57$$];
        case "oj-tabs-title":
          return $$$$65$$(this.$tabs$[$index$$282_locator$$57$$]).find(".oj-tabs-title")[0];
        case "oj-tabs-close-icon":
        ;
        case "oj-tabs-close":
          return $$$$65$$(this.$tabs$[$index$$282_locator$$57$$]).find(".oj-tabs-close-icon")[0];
      }
      return null;
    }, getSubIdByNode:function($node$$118$$) {
      for (var $panels_title$$11$$ = [], $i$$442_tabIndex$$5$$ = 0;$i$$442_tabIndex$$5$$ < this.$tabs$.length;$i$$442_tabIndex$$5$$++) {
        $panels_title$$11$$.push(this.$_getPanelForTab$(this.$tabs$[$i$$442_tabIndex$$5$$])[0]);
      }
      for (var $closeIcon_panelIndex$$ = $i$$442_tabIndex$$5$$ = -1, $currentNode$$4$$ = $node$$118$$;$currentNode$$4$$;) {
        if (this.$conveyor$ && $currentNode$$4$$ === this.$conveyor$[0]) {
          return{subId:"oj-conveyorbelt"};
        }
        $i$$442_tabIndex$$5$$ = Array.prototype.indexOf.call(this.$tabs$, $currentNode$$4$$);
        if (-1 != $i$$442_tabIndex$$5$$) {
          break;
        }
      ...
      if (-1 != $i$$442_tabIndex$$5$$) {
        for ($panels_title$$11$$ = this.getNodeBySubId({subId:"oj-tabs-title", index:$i$$442_tabIndex$$5$$}), $closeIcon_panelIndex$$ = this.getNodeBySubId({subId:"oj-tabs-close", index:$i$$442_tabIndex$$5$$}), $currentNode$$4$$ = $node$$118$$;$currentNode$$4$$;) {
          if ($currentNode$$4$$ === $panels_title$$11$$) {
            return{subId:"oj-tabs-title", index:$i$$442_tabIndex$$5$$};
          }
          if ($currentNode$$4$$ === $closeIcon_panelIndex$$) {
            return{subId:"oj-tabs-close", index:$i$$442_tabIndex$$5$$};
          }
          if ($currentNode$$4$$ === this.$tabs$[$i$$442_tabIndex$$5$$]) {
            return{subId:"oj-tabs-tab", index:$i$$442_tabIndex$$5$$};
          }
          $currentNode$$4$$ = $currentNode$$4$$.parentElement;
        }
      }
      ...
      this.$_isHorizontal$() && 0 < this.$tabs$.length && (null == this.$_resizeHandler$ && (this.$_resizeHandler$ = this.$_handleResize$.bind(this)), $oj$$71$$.$DomUtils$.$addResizeListener$(this.element[0], this.$_resizeHandler$), this.$_hasResizeListener$ = !0, this.$_originalWidth$ = this.$_getTabbarWrapper$()[0].scrollWidth, this.$_isProgressive$() && this.$_isOverflow$() && this.$_applyTabMaxWidth$());
    ...
    }, $_menu_paste$:function($event$$643$$, $obj$$58$$, $pasteBefore$$2$$) {
      if (!$obj$$58$$ || !$obj$$58$$.length || !this.$_menu$.$cutTab$) {
        return!1;
      }
      var $mvTab$$1$$ = this.$_menu$.$cutTab$;
      this.$_menu$.$cutTab$ = !1;
      this.$_doReorder$($event$$643$$, $mvTab$$1$$, $obj$$58$$, $pasteBefore$$2$$);
    }, $_menu_remove$:function($event$$644$$, $obj$$59$$) {
      if (!$obj$$59$$ || !$obj$$59$$.length) {
        return!1;
      }
      var $anchor$$8$$ = this.$_getCloseIcons$($obj$$59$$);
      ...
      var $id$$54$$ = $ui$$41$$ ? $ui$$41$$.item.attr("id") : void 0;
      "ojtabscut" === $id$$54$$ ? this.$_menu_cut$(this.$_menu$.tab) : "ojtabspastebefore" === $id$$54$$ ? this.$_menu_paste$($ev$$5$$, this.$_menu$.tab, !0) : "ojtabspasteafter" === $id$$54$$ ? this.$_menu_paste$($ev$$5$$, this.$_menu$.tab, !1) : "ojtabsremove" === $id$$54$$ && this.$_menu_remove$($ev$$5$$, this.$_menu$.tab);
    }, $_initMenu$:function($menu$$26_newVal$$4$$) {
      if ($menu$$26_newVal$$4$$ = $menu$$26_newVal$$4$$ || this.options.contextMenu) {
        var $t$$2$$ = $$$$65$$.type($menu$$26_newVal$$4$$);
        if ("function" == $t$$2$$) {
          try {
            $menu$$26_newVal$$4$$ = $menu$$26_newVal$$4$$();
          } catch ($e$$115$$) {
            $menu$$26_newVal$$4$$ = null;
          }
          $t$$2$$ = $$$$65$$.type($menu$$26_newVal$$4$$);
        }
        "string" == $t$$2$$ && $menu$$26_newVal$$4$$ && $$$$65$$($menu$$26_newVal$$4$$).length && (this.options.contextMenu = $menu$$26_newVal$$4$$);
      }
      ...
      if ($$menuContainer$$1$$ || this.options.reorderable || this.options.removable) {
        ...
        if (0 == $$menuContainer$$1$$.length) {
          var $key$$181$$ = this.options.reorderable ? "labelReorder" : $_arMenuKeyMap$$.remove, $menuId$$ = this.element.uniqueId().attr("id") + "contextmenu", $$menuContainer$$1$$ = $$$$65$$("\x3cul\x3e");
          $$menuContainer$$1$$.css("display", "none").attr("id", $menuId$$).attr("aria-label", this.$getTranslatedString$($key$$181$$));
      ...
      var $id$$55$$ = $panel$$5$$.attr("id");
      $id$$55$$ || ($id$$55$$ = $panel$$5$$.uniqueId().attr("id"), $panel$$5$$.addClass("oj-tabs-gen-id"));
      return $id$$55$$;
    }, $_getTab$:function($idOrIndex$$1_index$$285$$) {
      $idOrIndex$$1_index$$285$$ = this.$_getIndexByTabOrContentId$($idOrIndex$$1_index$$285$$);
      if (-1 !== $idOrIndex$$1_index$$285$$) {
        return $$$$65$$(this.$tabs$[$idOrIndex$$1_index$$285$$]);
      }
    }, $_getIndexByTabOrContentId$:function($idOrIndex$$2_selector$$45_tabOrContent$$) {
      var $index$$286$$ = -1;
      "number" === typeof $idOrIndex$$2_selector$$45_tabOrContent$$ ? 0 <= $idOrIndex$$2_selector$$45_tabOrContent$$ && $idOrIndex$$2_selector$$45_tabOrContent$$ < this.$tabs$.length && ($index$$286$$ = $idOrIndex$$2_selector$$45_tabOrContent$$) : "string" === typeof $idOrIndex$$2_selector$$45_tabOrContent$$ && ($idOrIndex$$2_selector$$45_tabOrContent$$ = this.$_sanitizeSelector$($idOrIndex$$2_selector$$45_tabOrContent$$), $oj$$71$$.$DomUtils$.$isValidIdentifier$($idOrIndex$$2_selector$$45_tabOrContent$$) && 
      ($idOrIndex$$2_selector$$45_tabOrContent$$ = this.element.find("#" + $idOrIndex$$2_selector$$45_tabOrContent$$), $idOrIndex$$2_selector$$45_tabOrContent$$.length && ($index$$286$$ = this.$tabs$.index($idOrIndex$$2_selector$$45_tabOrContent$$), -1 == $index$$286$$ && ($index$$286$$ = this.$panels$.index($idOrIndex$$2_selector$$45_tabOrContent$$)))));
      return $index$$286$$;
      ...
      if ($tab$$8$$) {
        var $id$$56$$ = $tab$$8$$.attr("id");
        return $id$$56$$ ? $id$$56$$ : this.$tabs$.index($tab$$8$$);
      }
      ...
      if ($disTabs$$ && 0 < $disTabs$$.length) {
        for (var $id$$57$$, $tab$$9$$, $i$$443$$ = 0;$i$$443$$ < $disTabs$$.length;$i$$443$$++) {
          if ($tab$$9$$ = this.$_getTab$($disTabs$$[$i$$443$$])) {
            $tab$$9$$.addClass("oj-disabled"), $tab$$9$$.attr("aria-disabled", "true"), $tab$$9$$.find(".oj-tabs-anchor").removeAttr("href"), $id$$57$$ = $tab$$9$$.attr("id"), $arr$$23$$.push($id$$57$$ ? $id$$57$$ : $children$$32$$.index($tab$$9$$));
          }
        }
      }
      ...
      $oj$$71$$.$Object$.$_compareSet$(this.options.disabledTabs, $arr$$24$$) || (this.$_initialRender$ ? this.options.disabledTabs = $arr$$24$$ : this.option({disabledTabs:$arr$$24$$}, {_context:{$internalSet$:!0, $writeback$:!0}, changed:!0}));
    }, $_isInATab$:function($element$$146$$) {
      var $found$$8$$ = !1;
      this.$tabs$.each(function() {
        if (this === $element$$146$$ || $$$$65$$.contains(this, $element$$146$$)) {
          return $found$$8$$ = !0, !1;
        }
      });
      return $found$$8$$;
      ...
      0 < $tabbar$$5$$.length && $tabbar$$5$$.children("li").each(function($index$$288$$) {
        $self$$224$$.$_wrapLi$($$$$65$$(this), $contentIds$$[$index$$288$$]);
      });
      ...
      if (0 == $tabbar$$6$$.length) {
        ...
        this.element.children().each(function($index$$289$$) {
          $self$$225$$.$_wrapLi$($$$$65$$(this).find("\x3e :first-child"), $contentIds$$1$$[$index$$289$$]).appendTo($tabbar$$6$$);
        });
