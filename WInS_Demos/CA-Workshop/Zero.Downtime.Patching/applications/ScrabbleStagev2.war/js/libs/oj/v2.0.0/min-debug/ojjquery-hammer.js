 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "hammerjs"], function($oj$$46$$, $$$$44$$, $Hammer$$4$$) {
  $Hammer$$4$$ ? ($$$$44$$.fn.$ojHammer$ = function $$$$$44$$$fn$$ojHammer$$($options$$351$$) {
    ...
    return function($type$$91$$, $data$$162$$) {
      $originalEmit$$.call(this, $type$$91$$, $data$$162$$);
      $$$$44$$(this.element).trigger({type:$type$$91$$, gesture:$data$$162$$});
    };
  }($Hammer$$4$$.Manager.prototype.emit)) : $oj$$46$$.$Logger$.warn("Hammer jQuery extension loaded without Hammer.");
});
