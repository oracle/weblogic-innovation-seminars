 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTimeline"], function($oj$$74$$, $$$$68$$, $comp$$18$$, $base$$14$$, $dvt$$11$$) {
  $oj$$74$$.$__registerWidget$("oj.ojTimeline", $$$$68$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{viewportChange:null}, $_CreateDvtComponent$:function($context$$167$$, $callback$$128$$, $callbackObj$$14$$) {
    return $dvt$$11$$.DvtTimeline.newInstance($context$$167$$, $callback$$128$$, $callbackObj$$14$$);
    ...
    if (!this.options.styleDefaults.series.colors) {
      var $handler$$52$$ = new $oj$$74$$.$ColorAttributeGroupHandler$;
      this.options.styleDefaults.series.colors = $handler$$52$$.$getValueRamp$();
    }
    ...
    var $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$ = this.options.translations, $ret$$63$$ = this._super();
    $ret$$63$$["DvtUtilBundle.TIMELINE"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$.componentName;
    $ret$$63$$["DvtUtilBundle.TIMELINE_SERIES"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$.labelSeries;
    $ret$$63$$["DvtUtilBundle.ZOOM_IN"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$.tooltipZoomIn;
    $ret$$63$$["DvtUtilBundle.ZOOM_OUT"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$.tooltipZoomOut;
    $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$ = $oj$$74$$.$LocaleData$.$getMonthNames$("wide");
    $ret$$63$$["DvtUtilBundle.MONTH_JANUARY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[0];
    $ret$$63$$["DvtUtilBundle.MONTH_FEBRUARY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[1];
    $ret$$63$$["DvtUtilBundle.MONTH_MARCH"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[2];
    $ret$$63$$["DvtUtilBundle.MONTH_APRIL"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[3];
    $ret$$63$$["DvtUtilBundle.MONTH_MAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[4];
    $ret$$63$$["DvtUtilBundle.MONTH_JUNE"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[5];
    $ret$$63$$["DvtUtilBundle.MONTH_JULY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[6];
    $ret$$63$$["DvtUtilBundle.MONTH_AUGUST"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[7];
    $ret$$63$$["DvtUtilBundle.MONTH_SEPTEMBER"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[8];
    $ret$$63$$["DvtUtilBundle.MONTH_OCTOBER"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[9];
    $ret$$63$$["DvtUtilBundle.MONTH_NOVEMBER"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[10];
    $ret$$63$$["DvtUtilBundle.MONTH_DECEMBER"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[11];
    $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$ = $oj$$74$$.$LocaleData$.$getDayNames$("wide");
    $ret$$63$$["DvtUtilBundle.DAY_SUNDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[0];
    $ret$$63$$["DvtUtilBundle.DAY_MONDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[1];
    $ret$$63$$["DvtUtilBundle.DAY_TUESDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[2];
    $ret$$63$$["DvtUtilBundle.DAY_WEDNESDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[3];
    $ret$$63$$["DvtUtilBundle.DAY_THURSDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[4];
    $ret$$63$$["DvtUtilBundle.DAY_FRIDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[5];
    $ret$$63$$["DvtUtilBundle.DAY_SATURDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[6];
    $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$ = $oj$$74$$.$LocaleData$.$getDayNames$("abbreviated");
    $ret$$63$$["DvtUtilBundle.DAY_SHORT_SUNDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[0];
    $ret$$63$$["DvtUtilBundle.DAY_SHORT_MONDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[1];
    $ret$$63$$["DvtUtilBundle.DAY_SHORT_TUESDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[2];
    $ret$$63$$["DvtUtilBundle.DAY_SHORT_WEDNESDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[3];
    $ret$$63$$["DvtUtilBundle.DAY_SHORT_THURSDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[4];
    $ret$$63$$["DvtUtilBundle.DAY_SHORT_FRIDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[5];
    $ret$$63$$["DvtUtilBundle.DAY_SHORT_SATURDAY"] = $dayNames$$1_dayShortNames_monthNames$$3_translations$$21$$[6];
    return $ret$$63$$;
  }, $_HandleEvent$:function($event$$648_minorAxisScale$$) {
    var $type$$105_viewportStart$$ = $event$$648_minorAxisScale$$ && $event$$648_minorAxisScale$$.getType ? $event$$648_minorAxisScale$$.getType() : null;
    if ($type$$105_viewportStart$$ === $dvt$$11$$.DvtSelectionEvent.TYPE) {
      this.$_UserOptionChange$("selection", $event$$648_minorAxisScale$$.getSelection());
    } else {
      if ($type$$105_viewportStart$$ === $dvt$$11$$.DvtTimelineViewportChangeEvent.TYPE) {
        var $type$$105_viewportStart$$ = (new Date($event$$648_minorAxisScale$$.getViewportStart())).toISOString(), $viewportEnd$$ = (new Date($event$$648_minorAxisScale$$.getViewportEnd())).toISOString();
        $event$$648_minorAxisScale$$ = $event$$648_minorAxisScale$$.getMinorAxisScale();
        var $viewportChangePayload$$1$$ = {viewportStart:$type$$105_viewportStart$$, viewportEnd:$viewportEnd$$, minorAxisScale:$event$$648_minorAxisScale$$};
        this.$_UserOptionChange$("viewportStart", $type$$105_viewportStart$$);
        this.$_UserOptionChange$("viewportEnd", $viewportEnd$$);
        this.$_UserOptionChange$("minorAxis.scale", $event$$648_minorAxisScale$$);
        this._trigger("viewportChange", null, $viewportChangePayload$$1$$);
      } else {
        this._super($event$$648_minorAxisScale$$);
      }
    }
  }, $_LoadResources$:function() {
    null == this.options._resources && (this.options._resources = {});
    var $resources$$4$$ = this.options._resources, $converterFactory_yearsConverterVert$$ = $oj$$74$$.$Validation$.$converterFactory$("datetime"), $secondsConverter$$ = $converterFactory_yearsConverterVert$$.createConverter({hour:"numeric", minute:"2-digit", second:"2-digit"}), $minutesConverter$$ = $converterFactory_yearsConverterVert$$.createConverter({hour:"numeric", minute:"2-digit"}), $hoursConverter$$ = $converterFactory_yearsConverterVert$$.createConverter({hour:"numeric"}), $daysConverter$$ = 
  ...
  }, getContextByNode:function($node$$121$$) {
    return this.getSubIdByNode($node$$121$$);
