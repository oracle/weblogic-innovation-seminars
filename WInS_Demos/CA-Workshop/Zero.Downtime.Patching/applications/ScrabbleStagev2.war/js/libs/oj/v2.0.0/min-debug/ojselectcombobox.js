...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$12$$, $$$$12$$) {
  var $_ComboUtils$$ = {$GENERATED_OPTIONS_SELECTOR$:"oj-select-options-generated", $KEY$:{TAB:9, ENTER:13, $ESC$:27, SPACE:32, LEFT:37, UP:38, RIGHT:39, DOWN:40, $SHIFT$:16, $CTRL$:17, $ALT$:18, PAGE_UP:33, PAGE_DOWN:34, HOME:36, END:35, $BACKSPACE$:8, $DELETE$:46, $isControl$:function($e$$51$$) {
  ...
  }, $killEvent$:function($event$$108$$) {
    $event$$108$$.preventDefault();
    $event$$108$$.stopPropagation();
  }, $killEventImmediately$:function($event$$109$$) {
    $event$$109$$.preventDefault();
    $event$$109$$.stopImmediatePropagation();
    ...
    return function($query$$6$$) {
      ...
      "" !== $query$$6$$.$term$ || $optKeys$$ ? ($data$$77$$() && $_ComboUtils$$.$each2$($$$$12$$($data$$77$$().$results$), function($i$$142$$, $datum$$) {
    ...
    var $node$$33$$ = $$$$12$$("\x3coption\x3e");
    $node$$33$$.addClass("oj-listbox-result oj-listbox-result-selectable oj-listbox-results-depth-" + $depth$$4$$);
    $node$$33$$.attr("role", "option");
    $node$$33$$.attr("id", "oj-listbox-result-label-" + $_ComboUtils$$.$nextUid$());
    $node$$33$$.text($formatFunc$$($label$$4$$));
    $node$$33$$.attr("value", $value$$181$$);
    return $node$$33$$;
  }, $createOptgroupTag$:function($container$$2$$, $label$$5$$, $formatFunc$$1$$) {
    var $node$$34$$ = $$$$12$$("\x3coptgroup\x3e");
    $node$$34$$.addClass("oj-listbox-results-sub");
    $node$$34$$.attr("label", $formatFunc$$1$$($label$$5$$));
    ...
    function $populate$$($container$$4$$, $list$$3$$, $depth$$5$$) {
      ...
      $list$$3$$.each(function() {
        ...
        }).text(), $node$$35$$ = $_ComboUtils$$.$createOptgroupTag$($container$$4$$, $label$$6$$, $formatFunc$$2$$), $ul$$ = $li$$.children("ul"), $populate$$($node$$35$$, $ul$$.children(), $depth$$5$$ + 1)) : $node$$35$$ = $_ComboUtils$$.$createOptionTag$($depth$$5$$, $li$$.attr("oj-data-value"), $li$$.text(), $formatFunc$$2$$), $node$$35$$.appendTo($container$$4$$));
      });
    }
    ...
    function $populate$$1$$($container$$6$$, $arrlist$$1$$, $depth$$6$$, $optionsKeys$$2$$) {
      for (var $item$$8$$, $label$$7_node$$36$$, $children$$1_value$$182$$, $i$$143$$ = 0, $l$$5$$ = $arrlist$$1$$.length;$i$$143$$ < $l$$5$$;$i$$143$$++) {
        $item$$8$$ = $arrlist$$1$$[$i$$143$$], $children$$1_value$$182$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "children"), $label$$7_node$$36$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "label"), $children$$1_value$$182$$ && 0 < $children$$1_value$$182$$.length ? ($label$$7_node$$36$$ = $_ComboUtils$$.$createOptgroupTag$($container$$6$$, $label$$7_node$$36$$, $formatFunc$$3$$), $populate$$1$$($label$$7_node$$36$$, $children$$1_value$$182$$, $depth$$6$$ + 
        1, $optionsKeys$$2$$.childKeys || {})) : ($children$$1_value$$182$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "value"), $label$$7_node$$36$$ = $_ComboUtils$$.$createOptionTag$($depth$$6$$, $children$$1_value$$182$$, $label$$7_node$$36$$, $formatFunc$$3$$)), $label$$7_node$$36$$.appendTo($container$$6$$);
      }
    }
    ...
    return function($query$$7$$) {
      var $context$$53$$ = {component:this.$ojContext$};
      $query$$7$$.value ? $context$$53$$.value = $query$$7$$.value : $context$$53$$.term = $query$$7$$.$term$ || "";
      $options$$224$$($context$$53$$).then(function($data$$78$$) {
        var $filtered$$1$$ = {$results$:[]};
        $data$$78$$ && $_ComboUtils$$.$each2$($$$$12$$($data$$78$$), function($i$$144$$, $datum$$1$$) {
  ...
  }, $LAST_QUERY_RESULT$:"last-query-result", $getLastQueryResult$:function($context$$54$$) {
    return $$$$12$$.data($context$$54$$.$container$, $context$$54$$.$_classNm$ + "-" + $_ComboUtils$$.$LAST_QUERY_RESULT$);
  }, $saveLastQueryResult$:function($context$$55$$, $queryResult$$2$$) {
    $$$$12$$.data($context$$55$$.$container$, $context$$55$$.$_classNm$ + "-" + $_ComboUtils$$.$LAST_QUERY_RESULT$, $queryResult$$2$$);
  ...
  }, $_clickAwayHandler$:function($event$$110$$) {
    var $dropdown_self$$74$$ = this.$dropdown$;
    !$$$$12$$($event$$110$$.target).closest($dropdown_self$$74$$).length && !$$$$12$$($event$$110$$.target).closest("#" + $dropdown_self$$74$$.attr("data-oj-containerid")).length && 0 < $dropdown_self$$74$$.length && ($dropdown_self$$74$$ = $dropdown_self$$74$$.data("ojlistbox"), $dropdown_self$$74$$.close($event$$110$$));
    ...
    var $element$$73$$, $datalist$$, $self$$75$$ = this;
    ...
    $opts$$12$$ = $$$$12$$.extend({}, {$populateResults$:function($container$$8$$, $results$$1$$, $query$$9$$, $showPlaceholder$$) {
      ...
      $populate$$2$$ = function $$populate$$2$$$($resultsParent$$, $results$$2$$, $container$$9$$, $depth$$7$$, $l$$6_showPlaceholder$$1$$) {
        function $createLabelContent$$($labelNode$$, $result$$32$$) {
          if ($optionRenderer$$1$$) {
            var $content$$15_context$$56_highlighterSection$$1$$ = {index:$i$$147$$, depth:$depth$$7$$, leaf:!$result$$32$$.children, parent:$resultsParent$$, data:$result$$32$$, component:$opts$$12$$.$ojContext$, parentElement:$labelNode$$.get(0)}, $content$$15_context$$56_highlighterSection$$1$$ = $optionRenderer$$1$$.call($opts$$12$$.$ojContext$, $content$$15_context$$56_highlighterSection$$1$$);
            null !== $content$$15_context$$56_highlighterSection$$1$$ && (null === $content$$15_context$$56_highlighterSection$$1$$.parentNode || $content$$15_context$$56_highlighterSection$$1$$.parentNode instanceof DocumentFragment) && $labelNode$$.appendChild($content$$15_context$$56_highlighterSection$$1$$);
          } else {
            $formatted$$ = $opts$$12$$.$formatResult$($result$$32$$), void 0 !== $formatted$$ && $labelNode$$.text($formatted$$);
          }
          !0 !== $query$$9$$.$initial$ && ($content$$15_context$$56_highlighterSection$$1$$ = $labelNode$$.find(".oj-listbox-highlighter-section"), $content$$15_context$$56_highlighterSection$$1$$.length || ($content$$15_context$$56_highlighterSection$$1$$ = $labelNode$$), $termHighlight$$($content$$15_context$$56_highlighterSection$$1$$, $query$$9$$.$term$));
        }
        function $termHighlight$$($highlighterSection$$, $pattern$$13$$) {
          function $innerHighlight$$($node$$39$$, $pat$$1$$) {
            var $skip$$1_spannode$$ = 0;
            if (3 === $node$$39$$.nodeType) {
              var $i$$148_middlebit_pos$$6$$ = $node$$39$$.data.toUpperCase().indexOf($pat$$1$$);
              if (0 <= $i$$148_middlebit_pos$$6$$) {
                $skip$$1_spannode$$ = document.createElement("span");
                $skip$$1_spannode$$.className = "oj-listbox-highlighter";
                $i$$148_middlebit_pos$$6$$ = $node$$39$$.splitText($i$$148_middlebit_pos$$6$$);
              ...
              if (1 === $node$$39$$.nodeType && $node$$39$$.childNodes && !/(script|style)/i.test($node$$39$$.tagName)) {
                for ($i$$148_middlebit_pos$$6$$ = 0;$i$$148_middlebit_pos$$6$$ < $node$$39$$.childNodes.length;++$i$$148_middlebit_pos$$6$$) {
                  $i$$148_middlebit_pos$$6$$ += $innerHighlight$$($node$$39$$.childNodes[$i$$148_middlebit_pos$$6$$], $pat$$1$$);
                }
              }
            }
        ...
        function $processChildren$$($node$$38$$, $result$$31$$) {
          if ($result$$31$$.children && 0 < $result$$31$$.children.length) {
            ...
            $nestedList$$ || $node$$38$$.append($innerContainer$$1$$);
          }
        }
        var $i$$147$$, $placeholder_result$$30$$, $label$$8_selectable$$, $disabled$$3$$, $node$$37$$, $formatted$$;
        $placeholder_result$$30$$ = $self$$75$$.$_getPlaceholder$();
        $l$$6_showPlaceholder$$1$$ && null !== $placeholder_result$$30$$ && !$query$$9$$.$term$ && 0 >= $container$$9$$.find(".oj-listbox-placeholder").length && ($placeholder_result$$30$$ = {value:"", label:$placeholder_result$$30$$}, $node$$37$$ = $$$$12$$("\x3cli\x3e\x3c/li\x3e"), $node$$37$$.addClass("oj-listbox-placeholder oj-listbox-results-depth-0 oj-listbox-result oj-listbox-result-selectable"), $node$$37$$.attr("role", "presentation"), $label$$8_selectable$$ = $$$$12$$(document.createElement("div")), 
        $label$$8_selectable$$.addClass("oj-listbox-result-label"), $label$$8_selectable$$.attr("id", "oj-listbox-result-label-" + $_ComboUtils$$.$nextUid$()), $label$$8_selectable$$.attr("role", "option"), $formatted$$ = $opts$$12$$.$formatResult$($placeholder_result$$30$$), void 0 !== $formatted$$ && $label$$8_selectable$$.text($formatted$$), $node$$37$$.append($label$$8_selectable$$), $node$$37$$.data($self$$75$$.$_elemNm$, $placeholder_result$$30$$), $container$$9$$.prepend($node$$37$$));
        $i$$147$$ = 0;
        for ($l$$6_showPlaceholder$$1$$ = $results$$2$$.length;$i$$147$$ < $l$$6_showPlaceholder$$1$$;$i$$147$$ += 1) {
          ...
          $node$$37$$ = $isList$$ ? $$$$12$$($placeholder_result$$30$$.element[0]) : $$$$12$$("\x3cli\x3e\x3c/li\x3e");
          $node$$37$$.hasClass("oj-listbox-result") ? ($placeholder_result$$30$$.children && 0 < $placeholder_result$$30$$.children.length && $processChildren$$($node$$37$$, $placeholder_result$$30$$), $$$$12$$($placeholder_result$$30$$.element[0]).css("display", "")) : ($node$$37$$.addClass("oj-listbox-results-depth-" + $depth$$7$$), $node$$37$$.addClass("oj-listbox-result"), $node$$37$$.addClass($label$$8_selectable$$ ? "oj-listbox-result-selectable" : "oj-listbox-result-unselectable"), $disabled$$3$$ && 
          $node$$37$$.addClass("oj-disabled"), $placeholder_result$$30$$.children && $node$$37$$.addClass("oj-listbox-result-with-children"), $node$$37$$.attr("role", "presentation"), $label$$8_selectable$$ = $$$$12$$(document.createElement("div")), $label$$8_selectable$$.addClass("oj-listbox-result-label"), $label$$8_selectable$$.attr("id", "oj-listbox-result-label-" + $_ComboUtils$$.$nextUid$()), $label$$8_selectable$$.attr("role", "option"), $disabled$$3$$ && $label$$8_selectable$$.attr("aria-disabled", 
          "true"), $isList$$ || ($createLabelContent$$($label$$8_selectable$$, $placeholder_result$$30$$), $node$$37$$.append($label$$8_selectable$$)), $placeholder_result$$30$$.children && 0 < $placeholder_result$$30$$.children.length && $processChildren$$($node$$37$$, $placeholder_result$$30$$), $node$$37$$.data($self$$75$$.$_elemNm$, $placeholder_result$$30$$), $isList$$ ? ($$$$12$$($placeholder_result$$30$$.element[0]).contents().filter(function() {
            return "UL" !== this.tagName;
          }).wrapAll($label$$8_selectable$$), $$$$12$$($placeholder_result$$30$$.element[0]).css("display", "")) : $container$$9$$.append($node$$37$$));
        }
      };
    ...
    $datalist$$ ? $opts$$12$$.$query$ = this.$_bind$(function($query$$10$$) {
      ...
      $process$$ = function $$process$$$($element$$74$$, $collection$$30$$) {
        ...
        if ($element$$74$$.is("option") || $element$$74$$.is("li") && !$nestedLi$$) {
          $query$$10$$.$matcher$($term$$1$$, $element$$74$$.text(), $element$$74$$) && $collection$$30$$.push($self$$75$$.$_optionToData$($element$$74$$));
        } else {
          if ($element$$74$$.is("optgroup") || $element$$74$$.is("li") && $nestedLi$$) {
            $group$$1$$ = $self$$75$$.$_optionToData$($element$$74$$), $_ComboUtils$$.$each2$($element$$74$$.is("optgroup") ? $element$$74$$.children() : $element$$74$$.children("ul").children(), function($i$$149$$, $elm$$1$$) {
  ...
  }, $_triggerSelect$:function($data$$81_evt$$20$$) {
    $data$$81_evt$$20$$ = $$$$12$$.Event(this.$_elemNm$ + "-selecting", {val:this.id($data$$81_evt$$20$$), object:$data$$81_evt$$20$$});
    this.$opts$.element.trigger($data$$81_evt$$20$$);
    return!$data$$81_evt$$20$$.isDefaultPrevented();
  ...
  }, $_highlightUnderEvent$:function($el$$5_event$$112$$) {
    $el$$5_event$$112$$ = $$$$12$$($el$$5_event$$112$$.target).closest(".oj-listbox-result-selectable");
    if (0 < $el$$5_event$$112$$.length && !$el$$5_event$$112$$.is(".oj-hover")) {
      var $choices$$2$$ = this.$_findHighlightableChoices$();
      this.$_highlight$($choices$$2$$.index($el$$5_event$$112$$));
    } else {
      0 == $el$$5_event$$112$$.length && this.$_removeHighlight$();
    }
  ...
  }, $_cancel$:function($event$$113$$) {
    this.close($event$$113$$);
  }, $_focusSearch$:function() {
    $_ComboUtils$$.$_focus$(this.search);
  }, $_selectHighlighted$:function($options$$225$$, $event$$114$$) {
    if (this.header) {
  ...
  }, $setVal$:function($val$$29$$, $event$$115$$, $context$$57$$) {
    var $options$$226$$ = {$doValueChangeCheck$:!1};
    $context$$57$$ && ($options$$226$$._context = $context$$57$$);
    "string" === typeof $val$$29$$ ? this.$ojContext$.$_SetValue$([$val$$29$$], $event$$115$$, $options$$226$$) : this.$ojContext$.$_SetValue$($val$$29$$, $event$$115$$, $options$$226$$);
  ...
  }, $_clear$:function($event$$116$$) {
    this.selection.data(this.$_elemNm$) && ($event$$116$$ || $oj$$12$$.$Logger$.warn("Event should not be null when user modified the value in UI"), "oj-select" === this.$_classNm$ && this.$ojContext$.$_IsRequired$() || this.$setVal$([], $event$$116$$), this.search.val(""), this.selection.removeData(this.$_elemNm$));
        ...
        if (void 0 !== this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          if (this.$opts$.manageNewEntry) {
            ...
            if (!$data$$86_selectionData$$ && "" !== this.search.val() || $data$$86_selectionData$$ && ($data$$86_selectionData$$.label !== this.search.val() || !this.$ojContext$.isValid())) {
              $data$$86_selectionData$$ = this.$opts$.manageNewEntry(this.search.val()), this.$_onSelect$($data$$86_selectionData$$, {trigger:"blur" === $e$$68_formatted$$1$$.type ? $_ComboUtils$$.$ValueChangeTriggerTypes$.$BLUR$ : $_ComboUtils$$.$ValueChangeTriggerTypes$.$ENTER_PRESSED$}, $e$$68_formatted$$1$$);
            }
          } else {
            null == this.$opts$.manageNewEntry && (($data$$86_selectionData$$ = this.selection.data(this.$_elemNm$), "" == this.search.val()) ? this.$_clear$($e$$68_formatted$$1$$) : $data$$86_selectionData$$ || "" === this.search.val() ? "oj-select" !== this.$_classNm$ && ($e$$68_formatted$$1$$ = this.$opts$.$formatSelection$($data$$86_selectionData$$), void 0 !== $e$$68_formatted$$1$$ && this.search.val($e$$68_formatted$$1$$)) : this.$_clearSearch$());
          }
        }
    ...
    if ("input" === $tagName$$3$$ && $opts$$14$$.element.attr("list") || "select" === $tagName$$3$$ && 0 < $opts$$14$$.element.children().length || $opts$$14$$.list) {
      ...
      $opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$76$$, $callback$$85$$) {
        var $selected$$1$$, $value$$184$$ = $self$$79$$.$getVal$();
        Array.isArray($value$$184$$) && ($value$$184$$ = $value$$184$$[0]);
        $selected$$1$$ = void 0 !== $value$$184$$ && null !== $value$$184$$ ? $self$$79$$.$_optionToData$($element$$76$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
        ...
        })) : $self$$79$$.$_optionToData$($element$$76$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
      ...
      $opts$$14$$.validate = function $$opts$$14$$$validate$($element$$77$$, $value$$185$$) {
        var $selected$$2$$;
        void 0 !== $value$$185$$ && null !== $value$$185$$ && ($selected$$2$$ = $self$$79$$.$_optionToData$($element$$77$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
    ...
    $_ComboUtils$$.$each2$($data$$87_highlightableChoices$$1$$, function($i$$155$$, $elm$$3$$) {
  ...
  }, $_onSelect$:function($data$$88$$, $options$$228$$, $event$$117$$) {
    if (this.$_triggerSelect$($data$$88$$)) {
      var $context$$58$$;
      $options$$228$$ && $options$$228$$.trigger && ($context$$58$$ = {$optionMetadata$:{trigger:$options$$228$$.trigger}});
      this.close($event$$117$$);
      this.$setVal$(0 === this.id($data$$88$$).length ? [] : this.id($data$$88$$), $event$$117$$, $context$$58$$);
      this.$_focusSearch$();
    }
  }, $_clearSearch$:function() {
    this.search.val("");
  ...
  }, close:function($event$$118$$) {
    this.$_opened$() && $_OjSingleCombobox$$.$superclass$.close.apply(this, arguments);
  }, $_opening$:function($event$$119$$, $dontUpdateResults$$1$$) {
  ...
  }, $_updateSelectedOption$:function($data$$90_selected$$4_value$$187$$) {
    if (void 0 === $data$$90_selected$$4_value$$187$$ || null === $data$$90_selected$$4_value$$187$$) {
      $data$$90_selected$$4_value$$187$$ = ($data$$90_selected$$4_value$$187$$ = this.$getVal$()) ? Array.isArray($data$$90_selected$$4_value$$187$$) ? Array.isArray($data$$90_selected$$4_value$$187$$) && $data$$90_selected$$4_value$$187$$.length ? {label:$data$$90_selected$$4_value$$187$$[0]} : null : {label:$data$$90_selected$$4_value$$187$$} : null;
    }
    this.$_updateSelection$($data$$90_selected$$4_value$$187$$);
  ...
  }, close:function($event$$120$$) {
    this.$_opened$() && ($_OjSingleSelect$$.$superclass$.close.apply(this, arguments), this.$container$.find(".oj-select-choice").attr("aria-expanded", !1), this.$_testClear$($event$$120$$) || this.$_clearSearch$(), $event$$120$$ instanceof MouseEvent && $event$$120$$.target != this.selection && $event$$120$$.target != this.search || $_ComboUtils$$.$_focus$(this.selection), this.$container$.find(".oj-listbox-spyglass-box").off("mouseup click"));
  }, $_opening$:function($event$$121$$, $dontUpdateResults$$2$$) {
    $_OjSingleSelect$$.$superclass$.$_opening$.apply(this, arguments);
    var $searchText$$;
    $event$$121$$ && "keydown" == $event$$121$$.type && $event$$121$$.which != $_ComboUtils$$.$KEY$.UP && $event$$121$$.which != $_ComboUtils$$.$KEY$.DOWN && $event$$121$$.which != $_ComboUtils$$.$KEY$.LEFT && $event$$121$$.which != $_ComboUtils$$.$KEY$.RIGHT && ($searchText$$ = String.fromCharCode($event$$121$$.which), $_ComboUtils$$.$killEvent$($event$$121$$));
  ...
  }, $setVal$:function($val$$31$$, $event$$122$$, $context$$59$$) {
    $_OjSingleSelect$$.$superclass$.$setVal$.call(this, $val$$31$$, $event$$122$$, $context$$59$$);
  ...
  }, $_testClear$:function($event$$123$$) {
    return "" == this.text.text() ? (this.$_clear$($event$$123$$), !0) : !1;
    ...
    if ("input" === $tagName$$4$$ && $opts$$15$$.element.attr("list") || "select" === $tagName$$4$$ && 0 < $opts$$15$$.element.children().length || $opts$$15$$.list) {
      ...
      $opts$$15$$.$initSelection$ = function $$opts$$15$$$$initSelection$$($element$$81$$, $callback$$88$$) {
        var $data$$92$$ = [];
        if ($self$$83$$.$getVal$()) {
          for (var $selected$$6$$, $ids$$ = $self$$83$$.$getVal$(), $i$$156$$ = 0;$i$$156$$ < $ids$$.length;$i$$156$$++) {
            var $id$$20$$ = $ids$$[$i$$156$$];
    ...
    this.search.on("blur keyup", this.$_bind$(function($e$$76$$) {
      if ("keyup" !== $e$$76$$.type || 10 === $e$$76$$.keyCode || 13 === $e$$76$$.keyCode) {
        if (this.$opts$.manageNewEntry && this.search.val() && 0 >= this.$results$.find(".oj-hover").length) {
          ...
          this.$_onSelect$($data$$93$$, {trigger:"blur" === $e$$76$$.type ? $_ComboUtils$$.$ValueChangeTriggerTypes$.$BLUR$ : $_ComboUtils$$.$ValueChangeTriggerTypes$.$ENTER_PRESSED$}, $e$$76$$);
        }
        this.search.removeClass(this.$_classNm$ + "-focused");
        this.$container$.removeClass("oj-focus");
        this.$_selectChoice$(null);
  ...
  }, $_onSelect$:function($data$$97$$, $options$$230$$, $event$$126$$) {
    if (this.$_triggerSelect$($data$$97$$)) {
      var $context$$60$$;
      $options$$230$$ && $options$$230$$.trigger && ($context$$60$$ = {$optionMetadata$:{trigger:$options$$230$$.trigger}});
      ...
      this.$setVal$($val$$32$$, $event$$126$$, $context$$60$$);
      !this.select && this.$opts$.$closeOnSelect$ || this.$_postprocessResults$($data$$97$$, !1, !0 === this.$opts$.$closeOnSelect$);
      this.$opts$.$closeOnSelect$ && (this.close($event$$126$$), this.search.width(10));
      $options$$230$$ && $options$$230$$.$noFocus$ || this.$_focusSearch$();
    }
  }, $_cancel$:function($event$$127$$) {
    this.close($event$$127$$);
    this.$_focusSearch$();
  ...
  }, $_unselect$:function($selected$$9$$, $event$$128$$) {
    ...
    if ($data$$99$$ = $selected$$9$$.data(this.$_elemNm$)) {
      for (this.$ojContext$.isValid() || ($val$$33$$ = $_ComboUtils$$.$splitVal$(this.$opts$.element.val(), this.$opts$.separator));0 <= ($index$$108$$ = $val$$33$$.indexOf(this.id($data$$99$$)));) {
        $val$$33$$.splice($index$$108$$, 1), this.$setVal$($val$$33$$, $event$$128$$), this.select && this.$_postprocessResults$();
      }
      $selected$$9$$.remove();
    }
  ...
  }, $setVal$:function($options$$231_val$$35$$, $event$$129$$, $context$$61$$) {
    var $unique$$;
    $unique$$ = [];
    ...
    $context$$61$$ && ($options$$231_val$$35$$._context = $context$$61$$);
    this.$ojContext$.$_SetValue$($unique$$, $event$$129$$, $options$$231_val$$35$$);
  ...
  $oj$$12$$.$__registerWidget$("oj.ojCombobox", $$$$12$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:void 0, placeholder:"", list:void 0, multiple:!1, options:null, optionsKeys:null, optionRenderer:null, minLength:0, beforeExpand:null}, widget:function() {
    ...
    var $list$$7_node$$40_selectedItems$$ = null, $subId$$8$$;
    if (null == $item$$12_locator$$12$$) {
      return this.$combobox$.$container$ ? this.$combobox$.$container$[0] : null;
    }
    $list$$7_node$$40_selectedItems$$ = this._super($item$$12_locator$$12$$);
    if (!$list$$7_node$$40_selectedItems$$) {
      ...
      switch($subId$$8$$) {
        ...
        case "oj-combobox-arrow":
          $list$$7_node$$40_selectedItems$$ = this.widget().find("." + $subId$$8$$)[0];
          break;
        case "oj-listitem":
          $dropdown$$5$$ && ($list$$7_node$$40_selectedItems$$ = $dropdown$$5$$.find(".oj-listbox-result"), $list$$7_node$$40_selectedItems$$ = this.$_findItem$($list$$7_node$$40_selectedItems$$, $item$$12_locator$$12$$.value));
          break;
        case "oj-combobox-remove":
          $list$$7_node$$40_selectedItems$$ = this.widget().find(".oj-combobox-selected-choice");
          $list$$7_node$$40_selectedItems$$ = ($item$$12_locator$$12$$ = this.$_findItem$($list$$7_node$$40_selectedItems$$, $item$$12_locator$$12$$.value)) ? $$$$12$$($item$$12_locator$$12$$).find(".oj-combobox-clear-entry-icon")[0] : null;
          break;
        case "oj-listbox-drop":
          $dropdown$$5$$ && ($list$$7_node$$40_selectedItems$$ = $dropdown$$5$$[0]);
          break;
        case "oj-listbox-results":
          $dropdown$$5$$ && ($list$$7_node$$40_selectedItems$$ = $dropdown$$5$$.find("." + $subId$$8$$)[0]);
          break;
        case "oj-combobox-selected-choice":
          $list$$7_node$$40_selectedItems$$ = this.widget().find("." + $subId$$8$$).toArray();
      }
    }
    return $list$$7_node$$40_selectedItems$$ || null;
  }, getSubIdByNode:function($node$$41_nodeCached$$) {
    var $subId$$9$$ = null;
    null != $node$$41_nodeCached$$ && ($node$$41_nodeCached$$ = $$$$12$$($node$$41_nodeCached$$), $node$$41_nodeCached$$.hasClass("oj-combobox-input") ? $subId$$9$$ = {subId:"oj-combobox-input"} : $node$$41_nodeCached$$.hasClass("oj-combobox-arrow") ? $subId$$9$$ = {subId:"oj-combobox-arrow"} : $node$$41_nodeCached$$.hasClass("oj-listbox-result") ? $subId$$9$$ = {subId:"oj-listitem", value:$node$$41_nodeCached$$.data("ojcombobox").value} : $node$$41_nodeCached$$.hasClass("oj-combobox-clear-entry-icon") && 
    ($subId$$9$$ = {subId:"oj-combobox-remove", value:$node$$41_nodeCached$$.closest(".oj-combobox-selected-choice").data("ojcombobox").value}));
    return $subId$$9$$;
  }});
    ...
    $trigger$$3$$.on("click", function($event$$130$$) {
      if ($self$$87$$.$_isInterfaceEnabled$()) {
        if ($self$$87$$.$opts$.manageNewEntry) {
          ...
          $self$$87$$.$_onSelect$($data$$101$$, {trigger:$_ComboUtils$$.$ValueChangeTriggerTypes$.$SEARCH_ICON_CLICKED$}, $event$$130$$);
        }
        return!1;
      }
  ...
  $oj$$12$$.$__registerWidget$("oj.ojInputSearch", $$$$12$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{placeholder:void 0, options:null, optionsKeys:null, optionRenderer:null, minLength:0, beforeExpand:null, optionChange:null}, widget:function() {
    ...
    $oj$$12$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $defaultOptionValue$:null, $validateOption$:!0}, {$attribute$:"placeholder", $defaultOptionValue$:""}, {$attribute$:"required", $defaultOptionValue$:!1, $coerceDomValue$:!0, $validateOption$:!0}, {$attribute$:"title", $defaultOptionValue$:""}], $constructorOptions$$9$$, this);
    if (void 0 === this.options.value) {
      this.options.value = void 0 !== this.element.attr("value") ? $_ComboUtils$$.$splitVal$(this.element.val(), ",") : null;
    } else {
      var $value$$193$$ = this.options.value;
      Array.isArray($value$$193$$) ? $value$$193$$ = $value$$193$$.slice(0) : "string" === typeof $value$$193$$ && ($value$$193$$ = [$value$$193$$]);
      this.options.value = $value$$193$$;
    }
  }, $_setup$:function() {
    var $opts$$17$$ = {};
    $opts$$17$$.element = this.element;
    $opts$$17$$.$ojContext$ = this;
    $opts$$17$$.$inputSearch$ = !0;
    $opts$$17$$ = $$$$12$$.extend(this.options, $opts$$17$$);
    this.$inputSearch$ = new $_OjInputSeachContainer$$;
    this.$inputSearch$._init($opts$$17$$);
  }, _destroy:function() {
    ...
    this.$_SetRootAttributes$();
    this.$_Refresh$("required", this.options.required);
  }, _setOption:function($key$$61$$, $value$$194$$, $flags$$18$$) {
    "value" === $key$$61$$ && (Array.isArray($value$$194$$) ? $value$$194$$ = $value$$194$$.slice(0) : "string" === typeof $value$$194$$ && ($value$$194$$ = [$value$$194$$]), this.$inputSearch$.$valueChangeTrigger$ = $flags$$18$$ && $flags$$18$$._context && $flags$$18$$._context.$optionMetadata$ ? $flags$$18$$._context.$optionMetadata$.trigger : null);
    this._super($key$$61$$, $value$$194$$, $flags$$18$$);
    "options" === $key$$61$$ && (this.$inputSearch$.$opts$.options = $value$$194$$, this.$inputSearch$.$opts$ = this.$inputSearch$.$_prepareOpts$(this.$inputSearch$.$opts$));
    "disabled" === $key$$61$$ && ($value$$194$$ ? this.$inputSearch$.$_disable$() : this.$inputSearch$.$_enable$());
  }, $_NotifyDetached$:function() {
  ...
  }, $_SetPlaceholder$:function($value$$195$$) {
    this.$inputSearch$ && (this.$inputSearch$.$opts$.placeholder = $value$$195$$, this.$inputSearch$.$_setPlaceholder$ && this.$inputSearch$.$_setPlaceholder$());
  }, validate:function() {
    var $displayValue$$6$$ = this.$inputSearch$.search.val(), $existingValue$$1_newValue$$7$$ = null, $existingValue$$1_newValue$$7$$ = this.$inputSearch$.$getVal$(), $existingValue$$1_newValue$$7$$ = void 0 === $displayValue$$6$$ || null === $displayValue$$6$$ || "" === $displayValue$$6$$ ? $existingValue$$1_newValue$$7$$ : $existingValue$$1_newValue$$7$$.push($displayValue$$6$$);
    ...
    if (Array.isArray($submittedValue$$3$$)) {
      for (var $i$$167$$ = 0;$i$$167$$ < $submittedValue$$3$$.length;$i$$167$$++) {
        var $parsed$$3$$ = this._super($submittedValue$$3$$[$i$$167$$]);
    ...
    if (this.$inputSearch$ && this.$inputSearch$.$_opened$()) {
      for (var $dropdown$$6$$ = $$$$12$$(".oj-listbox-drop"), $i$$168$$ = 0;$i$$168$$ < $dropdown$$6$$.length;$i$$168$$++) {
        if ("oj-listbox-drop" == $$$$12$$($dropdown$$6$$[$i$$168$$]).attr("id") && $$$$12$$($dropdown$$6$$[$i$$168$$]).attr("data-oj-containerid") == this.$inputSearch$.$containerId$) {
          return $$$$12$$($dropdown$$6$$[$i$$168$$]);
        }
      }
    }
    return null;
    ...
    var $list$$8_node$$42$$ = null, $dropdown$$7_subId$$10$$;
    if (null === $locator$$13$$) {
      return this.$inputSearch$.$container$ ? this.$inputSearch$.$container$[0] : null;
    }
    $list$$8_node$$42$$ = this._super($locator$$13$$);
    if (!$list$$8_node$$42$$) {
      switch($dropdown$$7_subId$$10$$ = $locator$$13$$.subId, "oj-inputsearch-search" === $dropdown$$7_subId$$10$$ && ($dropdown$$7_subId$$10$$ = "oj-inputsearch-search-button"), $dropdown$$7_subId$$10$$) {
        case "oj-inputsearch-input":
        ;
        case "oj-inputsearch-search-button":
          $list$$8_node$$42$$ = this.widget().find("." + $dropdown$$7_subId$$10$$)[0];
          break;
        case "oj-listitem":
          if ($dropdown$$7_subId$$10$$ = this.$_getDropdown$()) {
            $list$$8_node$$42$$ = $dropdown$$7_subId$$10$$.find(".oj-listbox-result"), $list$$8_node$$42$$ = this.$inputSearch$.$_findItem$($list$$8_node$$42$$, $locator$$13$$.value);
          }
        ;
      }
    }
    return $list$$8_node$$42$$ || null;
  }, getSubIdByNode:function($node$$43_nodeCached$$1$$) {
    var $subId$$11$$ = null;
    null != $node$$43_nodeCached$$1$$ && ($node$$43_nodeCached$$1$$ = $$$$12$$($node$$43_nodeCached$$1$$), $node$$43_nodeCached$$1$$.hasClass("oj-inputsearch-input") ? $subId$$11$$ = {subId:"oj-inputsearch-input"} : $node$$43_nodeCached$$1$$.hasClass("oj-inputsearch-search-button") ? $subId$$11$$ = {subId:"oj-inputsearch-search"} : $node$$43_nodeCached$$1$$.hasClass("oj-listbox-result") && ($subId$$11$$ = {subId:"oj-listitem", value:$node$$43_nodeCached$$1$$.data("ojinputsearch").value}));
    return $subId$$11$$;
  }});
  $oj$$12$$.$__registerWidget$("oj.ojSelect", $$$$12$$.oj.editableValue, {defaultElement:"\x3cselect\x3e", widgetEventPrefix:"oj", options:{minimumResultsForSearch:10, placeholder:null, list:void 0, multiple:!1, options:null, optionsKeys:null, beforeExpand:null, renderMode:"jet"}, widget:function() {
    ...
    var $opts$$18$$ = {}, $multiple$$1$$ = this.options.multiple;
    ...
    this.select && this.select.close();
  }, $_SetPlaceholder$:function($value$$196$$) {
    if (this.$_isNative$() && null != $value$$196$$) {
      var $placeholder$$4$$ = $$$$12$$(this.element.children("option:first-child"));
      $placeholder$$4$$ && "" === $placeholder$$4$$.attr("value") ? ($placeholder$$4$$.text(this.options.placeholder), $placeholder$$4$$.attr("value", "")) : ($placeholder$$4$$ = $_ComboUtils$$.$createOptionTag$(0, "", $value$$196$$, this.$_formatValue$.bind(this)), $placeholder$$4$$.addClass("oj-listbox-placeholder"), $placeholder$$4$$.prependTo(this.element));
    }
    ...
    if (void 0 === this.options.value) {
      ...
      Array.isArray($value$$197$$) && ($value$$197$$ = $value$$197$$.slice(0));
      this.options.value = $value$$197$$;
    }
  }, validate:function() {
    return this.select ? this.$_SetValue$(this.select.$getVal$(), null, this.$_VALIDATE_METHOD_OPTIONS$) : !0;
  }, $_SetDisplayValue$:function($children$$4_displayValue$$7$$) {
    this.select ? this.select.$_initSelection$() : null == $children$$4_displayValue$$7$$ ? this.$_HasPlaceholderSet$() ? (this.element[0].selectedIndex = 0, this.element.addClass("oj-select-default")) : ($children$$4_displayValue$$7$$ = this.element.children(), 0 < $children$$4_displayValue$$7$$.length && (this.options.value = [$children$$4_displayValue$$7$$.first().attr("value")])) : this.element.val($children$$4_displayValue$$7$$);
  ...
  }, $_nativeSetOptions$:function($defVal_value$$198$$) {
    ...
    $_ComboUtils$$.$arrayPopulateResults$($element$$86$$, $defVal_value$$198$$, this.$_formatValue$.bind(this), this.options.optionsKeys);
    $element$$86$$.addClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$);
    $defVal_value$$198$$ = null;
    this.$_HasPlaceholderSet$() && (this.options.required && ($defVal_value$$198$$ = this.$_nativeFindFirstEnabledOptionValue$()), this.$_SetPlaceholder$());
    null === $defVal_value$$198$$ && ($defVal_value$$198$$ = this.$_nativeFindFirstEnabledOptionValue$());
    this.options.value = $defVal_value$$198$$;
    this._setOption("value", $oSelected$$);
  }, $_removePlaceholderInMultiValues$:function($valArr$$) {
    for (var $val$$36$$, $narr$$ = [], $i$$169$$ = 0;$i$$169$$ < $valArr$$.length;$i$$169$$++) {
      $val$$36$$ = $valArr$$[$i$$169$$], null != $val$$36$$ && (0 < $val$$36$$.length ? (1 == $narr$$.length && "" === $narr$$[0] && $narr$$.pop(), $narr$$.push($val$$36$$)) : 0 == $narr$$.length && $narr$$.push($val$$36$$));
    }
    return $narr$$;
  }, _setOption:function($key$$62$$, $value$$199$$, $flags$$19$$) {
    if ("value" === $key$$62$$) {
      if (this.$_HasPlaceholderSet$() && $value$$199$$ && 0 == $value$$199$$.length) {
        this._super($key$$62$$, $value$$199$$, $flags$$19$$);
      } else {
        ...
        Array.isArray($value$$199$$) || ($value$$199$$ = [$value$$199$$]);
        this.$_isNative$() && ($value$$199$$ = this.$_removePlaceholderInMultiValues$($value$$199$$), 1 == $value$$199$$.length && "" == $value$$199$$[0] ? this.element.addClass("oj-select-default") : this.element.removeClass("oj-select-default"));
        for (var $newArr$$ = [], $i$$170$$ = 0;$i$$170$$ < $value$$199$$.length;$i$$170$$++) {
          this.select ? (this.options.multiple || this.select.$opts$.validate($element$$87_selected$$10$$, $value$$199$$[$i$$170$$])) && $newArr$$.push($value$$199$$[$i$$170$$]) : 0 < this.element.find("option[value\x3d'" + $value$$199$$[$i$$170$$] + "']").length && $newArr$$.push($value$$199$$[$i$$170$$]);
        }
        (0 < $newArr$$.length || this.options.multiple) && this._super($key$$62$$, $newArr$$, $flags$$19$$);
      }
    } else {
      "placeholder" === $key$$62$$ ? this.select ? (this.select.$opts$.placeholder = $value$$199$$, this.select.$_setPlaceholder$()) : ($element$$87_selected$$10$$ = this.options.value, $element$$87_selected$$10$$ && 0 !== $element$$87_selected$$10$$.length && $element$$87_selected$$10$$[0] || (this.element[0].selectedIndex = 0)) : "minimumResultsForSearch" === $key$$62$$ ? this.select && (this.select.$opts$.minimumResultsForSearch = $value$$199$$) : "renderMode" === $key$$62$$ && (this.$_cleanup$(), 
      this.options.renderMode = $value$$199$$, this.refresh()), this._super($key$$62$$, $value$$199$$, $flags$$19$$), "disabled" === $key$$62$$ ? this.select ? $value$$199$$ ? this.select.$_disable$() : this.select.$_enable$() : this.$_nativeSetDisabled$($value$$199$$) : "options" === $key$$62$$ && (this.select ? (this.select.$opts$.options = $value$$199$$, this.select.$opts$ = this.select.$_prepareOpts$(this.select.$opts$), this._super("value", this.select.$getVal$())) : this.$_nativeSetOptions$($value$$199$$))
      ;
    }
  }, $_getDropdown$:function() {
    if (this.select && this.select.$_opened$()) {
      var $dropdown$$8$$ = this.select.$dropdown$;
      if ($dropdown$$8$$ && $dropdown$$8$$.attr("data-oj-containerid") === this.select.$containerId$) {
        return $dropdown$$8$$;
      }
    }
    return null;
  ...
  }, getNodeBySubId:function($container$$18_index$$109_item$$13_locator$$14$$) {
    var $list$$9_node$$44_selectedItems$$1$$ = null, $subId$$12$$;
    if (null == $container$$18_index$$109_item$$13_locator$$14$$) {
      return($container$$18_index$$109_item$$13_locator$$14$$ = this.widget()) ? $container$$18_index$$109_item$$13_locator$$14$$[0] : null;
    }
    if (this.$_isNative$()) {
      return null;
    }
    $list$$9_node$$44_selectedItems$$1$$ = this._super($container$$18_index$$109_item$$13_locator$$14$$);
    if (!$list$$9_node$$44_selectedItems$$1$$) {
      var $ddlist_dropdown$$9$$ = this.$_getDropdown$();
      $subId$$12$$ = $container$$18_index$$109_item$$13_locator$$14$$.subId;
      switch($subId$$12$$) {
        case "oj-select-drop":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$44_selectedItems$$1$$ = $ddlist_dropdown$$9$$[0]);
          break;
        case "oj-select-results":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$44_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-results")[0]);
          break;
        case "oj-select-search":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$44_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-search")[0]);
          break;
        case "oj-select-input":
        ;
        case "oj-listbox-input":
          !0 === this.options.multiple ? $list$$9_node$$44_selectedItems$$1$$ = this.widget().find(".oj-listbox-input")[0] : $ddlist_dropdown$$9$$ && ($list$$9_node$$44_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-input")[0]);
          break;
        ...
        case "oj-select-arrow":
          $list$$9_node$$44_selectedItems$$1$$ = this.widget().find("." + $subId$$12$$)[0];
          break;
        case "oj-listitem":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$44_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-result"), $list$$9_node$$44_selectedItems$$1$$ = this.select.$_findItem$($list$$9_node$$44_selectedItems$$1$$, $container$$18_index$$109_item$$13_locator$$14$$.value));
          break;
        case "oj-select-remove":
          $list$$9_node$$44_selectedItems$$1$$ = this.widget().find(".oj-select-selected-choice");
          $list$$9_node$$44_selectedItems$$1$$ = ($container$$18_index$$109_item$$13_locator$$14$$ = this.select.$_findItem$($list$$9_node$$44_selectedItems$$1$$, $container$$18_index$$109_item$$13_locator$$14$$.value)) ? $$$$12$$($container$$18_index$$109_item$$13_locator$$14$$).find(".oj-select-clear-entry-icon")[0] : null;
          break;
        case "oj-listbox-result-label":
          $ddlist_dropdown$$9$$ && ($ddlist_dropdown$$9$$ = $$$$12$$("#" + this.select.$results$.attr("id")).children(), $container$$18_index$$109_item$$13_locator$$14$$ = $container$$18_index$$109_item$$13_locator$$14$$.index, $ddlist_dropdown$$9$$.length && $container$$18_index$$109_item$$13_locator$$14$$ < $ddlist_dropdown$$9$$.length && ($list$$9_node$$44_selectedItems$$1$$ = $ddlist_dropdown$$9$$.eq($container$$18_index$$109_item$$13_locator$$14$$).find("." + $subId$$12$$)[0]));
      }
    }
    return $list$$9_node$$44_selectedItems$$1$$ || null;
  }, getSubIdByNode:function($node$$45_nodeCached$$2$$) {
    if (this.$_isNative$()) {
      return this._super($node$$45_nodeCached$$2$$);
    }
    var $subId$$13$$ = null;
    null != $node$$45_nodeCached$$2$$ && ($node$$45_nodeCached$$2$$ = $$$$12$$($node$$45_nodeCached$$2$$), $node$$45_nodeCached$$2$$.hasClass("oj-listbox-input") ? $subId$$13$$ = {subId:"oj-select-input"} : $node$$45_nodeCached$$2$$.hasClass("oj-select-arrow") ? $subId$$13$$ = {subId:"oj-select-arrow"} : $node$$45_nodeCached$$2$$.hasClass("oj-listbox-result") ? $subId$$13$$ = {subId:"oj-listitem", value:$node$$45_nodeCached$$2$$.data("ojselect").value} : $node$$45_nodeCached$$2$$.hasClass("oj-select-clear-entry-icon") && 
    ($subId$$13$$ = {subId:"oj-select-remove", value:$node$$45_nodeCached$$2$$.closest(".oj-select-selected-choice").data("ojselect").value}));
    return $subId$$13$$;
  }, _GetDefaultStyleClass:function() {
    return "oj-select";
  }, _GetMessagingLauncherElement:function() {
