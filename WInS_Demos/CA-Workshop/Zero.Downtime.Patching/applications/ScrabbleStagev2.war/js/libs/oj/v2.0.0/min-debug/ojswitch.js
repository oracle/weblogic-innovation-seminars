...
*/
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$69$$) {
  (function() {
    $oj$$69$$.$__registerWidget$("oj.ojSwitch", $.oj.editableValue, {version:"1.1.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:!1, readOnly:!1, required:!1, title:"", value:!1}, refresh:function() {
      this._super();
      this.$_setup$();
    }, widget:function() {
      return this.$_element2$;
    }, getNodeBySubId:function($locator$$56_subId$$60$$) {
      var $node$$116$$, $rootElement$$19$$ = this.widget();
      $node$$116$$ = null == $locator$$56_subId$$60$$ || null == $locator$$56_subId$$60$$.subId ? $rootElement$$19$$ : null;
      return $node$$116$$ || ($locator$$56_subId$$60$$ = $locator$$56_subId$$60$$.subId, "oj-switch-thumb" !== $locator$$56_subId$$60$$ && "oj-switch-track" !== $locator$$56_subId$$60$$) ? $node$$116$$ || null : $rootElement$$19$$.find("." + $locator$$56_subId$$60$$)[0];
    }, getSubIdByNode:function($node$$117$$) {
      var $originalId$$ = $(this.element).attr("id"), $nodeId$$1$$, $result$$80$$ = null;
      null != $node$$117$$ && ($($node$$117$$).hasClass("oj-switch-track") || $($node$$117$$).hasClass("oj-switch-thumb")) && ($nodeId$$1$$ = $($node$$117$$).parents("div.oj-switch").find("input.oj-component-initnode").attr("id"), $originalId$$ === $nodeId$$1$$ && $($node$$117$$).hasClass("oj-switch-track") ? $result$$80$$ = {subId:"oj-switch-track"} : $originalId$$ === $nodeId$$1$$ && $($node$$117$$).hasClass("oj-switch-thumb") && ($result$$80$$ = {subId:"oj-switch-thumb"}));
      return $result$$80$$;
      ...
      $oj$$69$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"readonly", option:"readOnly", $validateOption$:!0}, {$attribute$:"required", $validateOption$:!1, $coerceDomValue$:function() {
        return!1;
      ...
      $val$$65$$ = this.option("value");
      this.option({required:!1, value:!!$val$$65$$}, {_context:{$writeback$:!0, $internalSet$:!0}});
      ...
      this.$_setup$();
    }, $_setAriaLabel$:function($elem$$159$$, $target$$103$$) {
      var $id$$53_switchLabel$$ = $elem$$159$$.prop("id"), $ariaLabelledBy$$ = $elem$$159$$.attr("aria-labelledby"), $ariaLabel$$ = $elem$$159$$.attr("aria-label");
      $ariaLabel$$ ? $target$$103$$.attr("aria-label", $ariaLabel$$) : $ariaLabelledBy$$ ? $target$$103$$.attr("aria-labelledby", $ariaLabelledBy$$) : $id$$53_switchLabel$$ && ($id$$53_switchLabel$$ = $("label[for\x3d'" + $id$$53_switchLabel$$ + "']")) && ($id$$53_switchLabel$$.attr("id") ? $target$$103$$.attr("aria-labelledby", $id$$53_switchLabel$$.attr("id")) : $target$$103$$.attr("aria-label", $($id$$53_switchLabel$$).text()));
    }, $_setup$:function() {
      ...
      $oj$$69$$.$DomUtils$.unwrap(this.element);
      this.$_RestoreAttributes$(this.element);
      return this._super();
    }, $_GetContentElement$:function() {
      return this.$_element2$;
    }, _setOption:function($key$$179$$, $coercedValue$$2_value$$297$$, $flags$$47$$) {
      switch($key$$179$$) {
        case "disabled":
        ;
        case "readOnly":
        ;
        case "value":
          $coercedValue$$2_value$$297$$ = !!$coercedValue$$2_value$$297$$;
          break;
        case "required":
          $coercedValue$$2_value$$297$$ = !1;
          break;
      }
      this._super($key$$179$$, $coercedValue$$2_value$$297$$, $flags$$47$$);
      this.$_setup$();
    }});
  })();
});
