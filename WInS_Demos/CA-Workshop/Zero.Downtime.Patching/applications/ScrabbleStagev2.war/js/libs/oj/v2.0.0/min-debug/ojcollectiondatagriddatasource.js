...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$30$$) {
  ...
  $oj$$30$$.$CollectionCellSet$.prototype.getData = function $$oj$$30$$$$CollectionCellSet$$$getData$($indexes$$12$$) {
    var $model$$58$$;
    $model$$58$$ = this.$_getModel$($indexes$$12$$);
    return null == $model$$58$$ ? null : $model$$58$$.get(this.$m_columns$[$indexes$$12$$.column]);
  };
  ...
  $oj$$30$$.$CollectionCellSet$.prototype.getMetadata = function $$oj$$30$$$$CollectionCellSet$$$getMetadata$($indexes$$13$$) {
    var $model$$59$$;
    $model$$59$$ = this.$_getModel$($indexes$$13$$);
    return null == $model$$59$$ ? null : {keys:{row:$oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$59$$), column:this.$m_columns$[$indexes$$13$$.column]}};
  };
  ...
  $oj$$30$$.$CollectionCellSet$.prototype.$_getModel$ = function $$oj$$30$$$$CollectionCellSet$$$$_getModel$$($column$$25_indexes$$14$$) {
    ...
    $row$$41$$ = $column$$25_indexes$$14$$.row;
    $column$$25_indexes$$14$$ = $column$$25_indexes$$14$$.column;
    $oj$$30$$.$Assert$.assert($row$$41$$ >= this.$m_startRow$ && $row$$41$$ <= this.$m_endRow$ && $column$$25_indexes$$14$$ >= this.$m_startColumn$ && $column$$25_indexes$$14$$ <= this.$m_endColumn$);
    return this.$m_models$[$row$$41$$ - this.$m_startRow$];
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$fetchHeaders$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$fetchHeaders$$($headerRange$$2$$, $callbacks$$23$$, $callbackObjects$$9$$) {
    var $axis$$39$$, $callback$$105$$;
    null != $callbacks$$23$$ && ($axis$$39$$ = $headerRange$$2$$.axis, $callback$$105$$ = {}, $callback$$105$$.$headerRange$ = $headerRange$$2$$, $callback$$105$$.callbacks = $callbacks$$23$$, $callback$$105$$.$callbackObjects$ = $callbackObjects$$9$$, this.$pendingHeaderCallback$[$axis$$39$$] = $callback$$105$$);
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_getRanges$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_getRanges$$($cellRanges$$1$$) {
    var $i$$324$$, $cellRange$$3$$, $rowStart$$2$$, $rowCount$$6$$, $colStart$$1$$, $colCount$$1$$;
    for ($i$$324$$ = 0;$i$$324$$ < $cellRanges$$1$$.length;$i$$324$$ += 1) {
      $cellRange$$3$$ = $cellRanges$$1$$[$i$$324$$], "row" === $cellRange$$3$$.axis ? ($rowStart$$2$$ = $cellRange$$3$$.start, $rowCount$$6$$ = $cellRange$$3$$.count) : "column" === $cellRange$$3$$.axis && ($colStart$$1$$ = $cellRange$$3$$.start, $colCount$$1$$ = $cellRange$$3$$.count);
    }
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_resolveModels$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_resolveModels$$($i$$325_rowStart$$4$$, $rowEnd$$2$$, $set$$4$$, $ranges$$1$$, $callbacks$$26$$, $callbackObjects$$12$$) {
    var $promises$$;
    for ($promises$$ = [];$i$$325_rowStart$$4$$ < $rowEnd$$2$$;$i$$325_rowStart$$4$$++) {
      $promises$$.push(this.$collection$.at($i$$325_rowStart$$4$$, {deferred:!0}));
    }
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_fetchCells$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_fetchCells$$($cellRanges$$5_ranges$$2$$) {
    ...
    this.$collection$.$setRangeLocal$($rowStart$$5$$, $cellRanges$$5_ranges$$2$$.rowCount).then(function($actual$$5$$) {
      ...
      void 0 === this.columns ? this.$collection$.at($rowStart$$5$$, {deferred:!0}).then(function($model$$60$$) {
        null != $model$$60$$ && this.$_setupColumns$($model$$60$$);
        this.$_fetchCellsComplete$();
      }.bind(this)) : this.$_fetchCellsComplete$();
    }.bind(this), function($e$$92$$) {
      this.$_fetchCellsError$($e$$92$$);
    }.bind(this));
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_setupColumns$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_setupColumns$$($model$$61$$) {
    this.columns = $model$$61$$.keys();
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.keys = function $$oj$$30$$$$CollectionDataGridDataSource$$$keys$($indexes$$15$$) {
    ...
    return new Promise(function($resolve$$38$$) {
      $self$$154$$.$collection$.at($rowIndex$$9$$, {deferred:!0}).then(function($rowModel$$) {
        null == $rowModel$$ ? $resolve$$38$$({row:null, column:null}) : ($rowKey$$33$$ = $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($rowModel$$), null == $self$$154$$.columns && $self$$154$$.$_setupColumns$($rowModel$$), $columnKey$$3$$ = $self$$154$$.columns[$columnIndex$$4$$], $resolve$$38$$({row:$rowKey$$33$$, column:$columnKey$$3$$}));
      }.bind($self$$154$$));
    });
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$indexes$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$indexes$$($keys$$38$$) {
    var $rowKey$$34$$, $columnKey$$4$$, $columnIndex$$5$$, $self$$155$$;
    $rowKey$$34$$ = $keys$$38$$.row;
    $columnKey$$4$$ = $keys$$38$$.column;
    $self$$155$$ = this;
    return new Promise(function($resolve$$39$$) {
      $self$$155$$.$collection$.indexOf($rowKey$$34$$, {deferred:!0}).then(function($rowIndex$$10$$) {
        -1 === $rowIndex$$10$$ ? $resolve$$39$$({row:-1, column:-1}) : null == $self$$155$$.columns ? $self$$155$$.$collection$.at($rowIndex$$10$$, {deferred:!0}).then(function($model$$62$$) {
          $self$$155$$.$_setupColumns$($model$$62$$);
          $columnIndex$$5$$ = $self$$155$$.columns.indexOf($columnKey$$4$$);
          -1 === $columnIndex$$5$$ && ($rowIndex$$10$$ = -1);
          $resolve$$39$$({row:$rowIndex$$10$$, column:$columnIndex$$5$$});
        }.bind($self$$155$$)) : ($columnIndex$$5$$ = $self$$155$$.columns.indexOf($columnKey$$4$$), -1 === $columnIndex$$5$$ && ($rowIndex$$10$$ = -1), $resolve$$39$$({row:$rowIndex$$10$$, column:$columnIndex$$5$$}));
      }.bind($self$$155$$));
    });
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_getModelEvent$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_getModelEvent$$($operation$$5$$, $rowKey$$35$$, $columnKey$$5$$, $rowIndex$$11$$, $columnIndex$$6$$) {
    var $event$$393$$ = {source:this};
    $event$$393$$.operation = $operation$$5$$;
    $event$$393$$.keys = {row:$rowKey$$35$$, column:$columnKey$$5$$};
    $event$$393$$.indexes = {row:$rowIndex$$11$$, column:$columnIndex$$6$$};
    return $event$$393$$;
  };
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_handleModelAdded$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_handleModelAdded$$($model$$63$$) {
    this.handleEvent("change", this.$_getModelEvent$("insert", $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$63$$), null, $model$$63$$.index, -1));
  };
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_handleModelDeleted$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_handleModelDeleted$$($model$$64$$, $collection$$33$$, $args$$20$$) {
    this.handleEvent("change", this.$_getModelEvent$("delete", $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$64$$), null, $args$$20$$.index, -1));
  };
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_handleModelChanged$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_handleModelChanged$$($model$$65$$) {
    this.handleEvent("change", this.$_getModelEvent$("update", $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$65$$), null, $model$$65$$.index, -1));
  };
  ...
  $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$ = function $$oj$$30$$$$CollectionDataGridUtils$$$_getModelKey$$($model$$66$$) {
    var $key$$144$$;
    $key$$144$$ = $model$$66$$.$GetId$();
    null == $key$$144$$ && ($key$$144$$ = $model$$66$$.$GetCid$());
    return $key$$144$$;
  };
  ...
  $oj$$30$$.$CollectionHeaderSet$.prototype.getData = function $$oj$$30$$$$CollectionHeaderSet$$$getData$($index$$196$$, $level$$30$$) {
    ...
    if (null != this.$m_rowHeader$) {
      ...
      $model$$67$$ = this.$m_models$[$index$$196$$ - this.$m_start$];
  ...
  $oj$$30$$.$CollectionHeaderSet$.prototype.getMetadata = function $$oj$$30$$$$CollectionHeaderSet$$$getMetadata$($index$$197$$, $level$$31$$) {
    ...
    if (null != this.$m_rowHeader$) {
      ...
      $data$$150_model$$68$$ = this.$m_models$[$index$$197$$ - this.$m_start$];
      return{key:$oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($data$$150_model$$68$$)};
    }
    $data$$150_model$$68$$ = this.getData($index$$197$$, $level$$31$$);
    return this.$m_sortInfo$.key === $data$$150_model$$68$$ ? {key:$data$$150_model$$68$$, sortDirection:this.$m_sortInfo$.direction} : {key:$data$$150_model$$68$$};
  };
