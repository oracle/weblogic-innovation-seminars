...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise", "ojdnd", "ojs/ojdomscroller", "ojs/ojeditablevalue", "ojs/ojmenu", "ojs/ojdatasource-common", "ojs/ojpagingtabledatasource", "ojs/ojflattenedtreetabledatasource"], function($oj$$14$$, $$$$14$$) {
  (function() {
    ...
    $_KEYBOARD_CODE_ENTER$:13, $_KEYBOARD_CODE_UP$:38, $_KEYBOARD_CODE_DOWN$:40, $_KEYBOARD_CODE_LEFT$:37, $_KEYBOARD_CODE_RIGHT$:39, $_KEYBOARD_CODE_HOME$:36, $_KEYBOARD_CODE_END$:35, $_KEYBOARD_CODE_TAB$:9, $_KEYBOARD_CODE_ESC$:27, $_KEYBOARD_MODIFIER_SHIFT$:"shiftKey"}, getContextByNode:function($node$$55$$) {
      return this.getSubIdByNode($node$$55$$, !0);
      ...
      return null;
    }, getSubIdByNode:function($node$$56$$, $ignoreSortIcons$$) {
      var $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$56$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_CLASS$);
      ...
      $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$56$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ASC_LINK_CLASS$);
      if (0 < $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$.length) {
      ...
      $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$56$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DSC_LINK_CLASS$);
      if (0 < $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$.length) {
      ...
      $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$56$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CELL_CLASS$);
      if (0 < $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$.length) {
      ...
      $cell$$2_footer_header$$9_headerSortAsc_headerSortDsc$$ = $$$$14$$($node$$56$$).closest("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$);
      ...
      var $errDetail$$2_rowKey_tableBodyRows$$ = this.$_getRowKeyForRowIdx$($rowIdx$$2$$), $row$$4$$ = $data$$104_errSummary$$9$$.get($errDetail$$2_rowKey_tableBodyRows$$);
      if (null == $row$$4$$) {
        return!1;
      }
      var $self$$94$$ = this;
      return this.$_queueTask$(function() {
        return $row$$4$$.then(function($row$$5$$) {
          $self$$94$$.$_refreshTableBodyRow$($rowIdx$$2$$, $row$$5$$);
        }).then(function() {
          return!0;
        });
      });
      ...
      this.$_initFetch$();
    }, $_NotifyContextMenuGesture$:function($contextMenu$$2$$, $event$$148$$, $eventType$$33$$) {
      var $openOptions$$3$$ = {};
      this.$_contextMenuEvent$ = $event$$148$$.originalEvent;
      if (!(this.$_isNodeEditable$($$$$14$$(this.$_contextMenuEvent$.target)) || this.$_isNodeClickable$($$$$14$$(this.$_contextMenuEvent$.target)) || "touch" == $eventType$$33$$ && this.$_isNodeDraggable$($$$$14$$(this.$_contextMenuEvent$.target)))) {
        ...
        this.$_OpenContextMenu$($event$$148$$, $eventType$$33$$, $openOptions$$3$$);
      }
    }, _destroy:function() {
      this.$_getData$();
    ...
    }, $_events$:{blur:function($event$$149$$) {
      var $table$$1$$ = this.$_getTableDomUtils$().$getTable$();
      0 < $table$$1$$.has($event$$149$$.relatedTarget).length || null != $event$$149$$.originalEvent && $event$$149$$.originalEvent.explicitOriginalTarget == $table$$1$$[0] || (this.$_clearKeyboardKeys$(), this.$_clearFocusedHeaderColumn$(), this.$_clearFocusedRow$(!1), this.$_setTableNavigationMode$(!1));
    }, focus:function($event$$150$$) {
      this.$_checkRowOrHeaderColumnFocus$($event$$150$$);
    }, "focus .oj-table-column-header-acc-asc-link":function($event$$151$$) {
      var $self$$95$$ = this;
      setTimeout(function() {
        $self$$95$$.$_checkRowOrHeaderColumnFocus$($event$$151$$);
      }, 0);
    }, "click .oj-table-checkbox-acc-select-column":function($event$$152$$) {
      var $columnIdx$$2$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$152$$.currentTarget)), $selected$$15$$ = $$$$14$$($event$$152$$.currentTarget).is(":checked");
      $selected$$15$$ && this.$_setHeaderColumnFocus$($columnIdx$$2$$, !0, !0, null);
      this.$_setHeaderColumnSelection$($columnIdx$$2$$, $selected$$15$$, $event$$152$$.currentTarget, $event$$152$$, !0);
      $event$$152$$.stopPropagation();
    }, "click .oj-table-checkbox-acc-select-row":function($event$$153$$) {
      var $rowIdx$$3$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$153$$.currentTarget)), $selected$$16$$ = $$$$14$$($event$$153$$.currentTarget).is(":checked"), $focused$$ = !1;
      $selected$$16$$ && ($focused$$ = this.$_setRowFocus$($rowIdx$$3$$, !0, !0, null, $event$$153$$, !0));
      $focused$$ && this.$_setRowSelection$($rowIdx$$3$$, $selected$$16$$, $event$$153$$.currentTarget, $event$$153$$, !0);
      $event$$153$$.stopPropagation();
    }, keydown:function($event$$154$$) {
      if (!(this.$_isNodeEditable$($$$$14$$($event$$154$$.target)) || null != this.$_getTableDomUtils$().$getTableFooter$() && 0 < this.$_getTableDomUtils$().$getTableFooter$().has($event$$154$$.target).length) && (this.$_addKeyboardKey$($event$$154$$.keyCode), 1 == this.$_getKeyboardKeys$().length || 2 == this.$_getKeyboardKeys$().length && $event$$154$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$])) {
        if (this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_UP$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_DOWN$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_SPACEBAR$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_HOME$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_END$)) {
          $event$$154$$.preventDefault(), $event$$154$$.stopPropagation();
        }
        this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_UP$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_DOWN$) ? this.$_handleKeydownUpDown$($event$$154$$) : this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_LEFT$) || this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_RIGHT$) ? this.$_handleKeydownLeftRight$($event$$154$$) : this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_TAB$) && this.$_handleKeydownTab$($event$$154$$);
      }
    }, keyup:function($event$$155$$) {
      if (!(this.$_isNodeEditable$($$$$14$$($event$$155$$.target)) || null != this.$_getTableDomUtils$().$getTableFooter$() && 0 < this.$_getTableDomUtils$().$getTableFooter$().has($event$$155$$.target).length)) {
        if (1 == this.$_getKeyboardKeys$().length) {
          var $keyboardCode1$$ = this.$_getKeyboardKeys$()[0];
          $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_SPACEBAR$ ? this.$_handleKeyupSpacebar$($event$$155$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_ENTER$ ? this.$_handleKeyupEnter$($event$$155$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_HOME$ ? this.$_handleKeyupHome$($event$$155$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_END$ ? this.$_handleKeyupEnd$($event$$155$$) : $keyboardCode1$$ == this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_ESC$ && 
          this.$_handleKeyupEsc$($event$$155$$);
          this.$_removeKeyboardKey$($keyboardCode1$$);
        }
        this.$_removeKeyboardKey$($event$$155$$.keyCode);
      }
    }, "mousedown .oj-table-body":function($event$$156$$) {
      this.$_mouseDownRowIdx$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$156$$.target));
      if (null != this.$_mouseDownRowIdx$) {
        var $tableBodyRow$$2$$ = this.$_getTableDomUtils$().$getTableBodyRow$(this.$_mouseDownRowIdx$);
        null != $tableBodyRow$$2$$ && $tableBodyRow$$2$$.prop("draggable") ? this.$_mouseDownRowIdx$ = null : null == this.$_mouseDownRowIdx$ || $event$$156$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$] || $oj$$14$$.$DomUtils$.$isMetaKeyPressed$($event$$156$$) || this.$_getRowSelection$(this.$_mouseDownRowIdx$) && 1 == this.$_getSelectedRowIdxs$().length || this.$_nonContiguousSelection$ || this.$_clearSelectedRows$();
      }
    }, "mouseup .oj-table-body":function() {
      this.$_mouseDownRowIdx$ = null;
    }, "mouseenter .oj-table-body-row":function($event$$158$$) {
      $$$$14$$($event$$158$$.currentTarget).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
      this.$_handleMouseEnterSelection$($event$$158$$.target);
    }, "mouseleave .oj-table-body-row":function($event$$159$$) {
      $$$$14$$($event$$159$$.currentTarget).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
    }, "mousedown .oj-table-column-header-cell":function($event$$160$$) {
      var $columnIdx$$3$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$160$$.currentTarget));
      this.$_setHeaderColumnFocus$($columnIdx$$3$$, !0, !0, $event$$160$$);
      $$$$14$$($event$$160$$.target).data(this.$_FOCUS_CALLED$, !0);
    }, "mouseenter .oj-table-column-header-cell":function($columnIdx$$4_event$$161$$) {
      $$$$14$$($columnIdx$$4_event$$161$$.currentTarget).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
      $columnIdx$$4_event$$161$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($columnIdx$$4_event$$161$$.currentTarget));
      this.$_showTableHeaderColumnSortLink$($columnIdx$$4_event$$161$$);
    }, "mouseleave .oj-table-column-header-cell":function($columnIdx$$5_event$$162$$) {
      $$$$14$$($columnIdx$$5_event$$162$$.currentTarget).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
      $columnIdx$$5_event$$162$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($columnIdx$$5_event$$162$$.currentTarget));
      this.$_hideTableHeaderColumnSortLink$($columnIdx$$5_event$$162$$, !0);
      this.$_hideTableHeaderColumnSortLink$($columnIdx$$5_event$$162$$, !1);
    }, "mousedown .oj-table-data-cell":function($event$$163$$) {
      var $rowIdx$$4$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$163$$.currentTarget));
      this.$_setRowFocus$($rowIdx$$4$$, !0, !0, $event$$163$$.currentTarget, $event$$163$$);
      $$$$14$$($event$$163$$.target).data(this.$_FOCUS_CALLED$, !0);
    }, "mouseenter .oj-table-data-cell":function($event$$164$$) {
      $$$$14$$($event$$164$$.currentTarget).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
    }, "mouseleave .oj-table-data-cell":function($event$$165$$) {
      $$$$14$$($event$$165$$.currentTarget).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
    }, "click .oj-table-column-header-asc-link":function($event$$166$$) {
      var $columnIdx$$6$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$166$$.target)), $tableHeaderColumn$$1$$ = this.$_getTableDomUtils$().$getTableHeaderColumn$($columnIdx$$6$$);
      $tableHeaderColumn$$1$$ && ($tableHeaderColumn$$1$$.data("sorted") == this.$_COLUMN_SORT_ORDER$.$_ASCENDING$ ? this.$_handleSortTableHeaderColumn$($columnIdx$$6$$, !1, $event$$166$$) : this.$_handleSortTableHeaderColumn$($columnIdx$$6$$, !0, $event$$166$$), $event$$166$$.preventDefault(), $event$$166$$.stopPropagation());
    }, "click .oj-table-column-header-acc-asc-link":function($event$$167$$) {
      var $columnIdx$$7$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$167$$.target));
      this.$_handleSortTableHeaderColumn$($columnIdx$$7$$, !0, $event$$167$$);
      $event$$167$$.preventDefault();
      $event$$167$$.stopPropagation();
    }, "click .oj-table-column-header-dsc-link":function($event$$168$$) {
      var $columnIdx$$8$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$168$$.target)), $tableHeaderColumn$$2$$ = this.$_getTableDomUtils$().$getTableHeaderColumn$($columnIdx$$8$$);
      $tableHeaderColumn$$2$$ && ($tableHeaderColumn$$2$$.data("sorted") == this.$_COLUMN_SORT_ORDER$.$_DESCENDING$ ? this.$_handleSortTableHeaderColumn$($columnIdx$$8$$, !0, $event$$168$$) : this.$_handleSortTableHeaderColumn$($columnIdx$$8$$, !1, $event$$168$$), $event$$168$$.preventDefault(), $event$$168$$.stopPropagation());
    }, "click .oj-table-column-header-acc-dsc-link":function($event$$169$$) {
      var $columnIdx$$9$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$169$$.target));
      this.$_handleSortTableHeaderColumn$($columnIdx$$9$$, !1, $event$$169$$);
      $event$$169$$.preventDefault();
      $event$$169$$.stopPropagation();
    }, "click .oj-table-data-cell":function($event$$170$$) {
      var $rowIdx$$5$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$170$$.currentTarget));
      if (!$$$$14$$($event$$170$$.target).data(this.$_FOCUS_CALLED$)) {
        var $focused$$2_lastSelectedRowIdx_rowSelected$$1$$ = this.$_setRowFocus$($rowIdx$$5$$, !0, !0, $event$$170$$.currentTarget, $event$$170$$);
        $$$$14$$($event$$170$$.target).data(this.$_FOCUS_CALLED$, !1);
        if (!$focused$$2_lastSelectedRowIdx_rowSelected$$1$$) {
          return;
        }
      }
      if ($event$$170$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$]) {
        if ($focused$$2_lastSelectedRowIdx_rowSelected$$1$$ = this.$_getLastRowSelection$(), null != $focused$$2_lastSelectedRowIdx_rowSelected$$1$$) {
          if (window.getSelection().removeAllRanges(), $rowIdx$$5$$ < $focused$$2_lastSelectedRowIdx_rowSelected$$1$$) {
            var $i$$176$$;
            for ($i$$176$$ = $rowIdx$$5$$;$i$$176$$ <= $focused$$2_lastSelectedRowIdx_rowSelected$$1$$;$i$$176$$++) {
              this.$_setRowSelection$($i$$176$$, !0, $event$$170$$.currentTarget, $event$$170$$, !0);
            }
          } else {
            for ($i$$176$$ = $focused$$2_lastSelectedRowIdx_rowSelected$$1$$;$i$$176$$ <= $rowIdx$$5$$;$i$$176$$++) {
              this.$_setRowSelection$($i$$176$$, !0, $event$$170$$.currentTarget, $event$$170$$, !0);
            }
          }
        }
      } else {
        $oj$$14$$.$DomUtils$.$isMetaKeyPressed$($event$$170$$) ? this.$_setRowSelection$($rowIdx$$5$$, !this.$_getRowSelection$($rowIdx$$5$$), $event$$170$$.currentTarget, $event$$170$$, !0) : 0 == this.$_getKeyboardKeys$().length && ($focused$$2_lastSelectedRowIdx_rowSelected$$1$$ = this.$_getRowSelection$($rowIdx$$5$$), this.$_setRowSelection$($rowIdx$$5$$, !$focused$$2_lastSelectedRowIdx_rowSelected$$1$$, $event$$170$$.currentTarget, $event$$170$$, !0), this.$_isTouchDevice$() && this.$_getRowSelectionMode$() == 
    ...
    }, "contextmenu .oj-table-data-cell":function($event$$171$$) {
      var $rowIdx$$6_rowKey$$1$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($event$$171$$.currentTarget)), $rowIdx$$6_rowKey$$1$$ = this.$_getRowKeyForRowIdx$($rowIdx$$6_rowKey$$1$$);
      this.$_setCurrentRow$({rowKey:$rowIdx$$6_rowKey$$1$$}, $event$$171$$);
    }, "click .oj-table-column-header-cell":function($event$$172$$) {
      var $columnIdx$$10$$ = this.$_getTableDomUtils$().$getElementColumnIdx$($$$$14$$($event$$172$$.currentTarget));
      $$$$14$$($event$$172$$.target).data(this.$_FOCUS_CALLED$) || (this.$_setHeaderColumnFocus$($columnIdx$$10$$, !0, !0, $event$$172$$), $$$$14$$($event$$172$$.target).data(this.$_FOCUS_CALLED$, !1));
      if ($event$$172$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$]) {
        ...
        if (null != $lastSelectedColumnIdx$$) {
          if ($columnIdx$$10$$ < $lastSelectedColumnIdx$$) {
            ...
            for ($i$$177$$ = $columnIdx$$10$$;$i$$177$$ <= $lastSelectedColumnIdx$$;$i$$177$$++) {
              this.$_setHeaderColumnSelection$($i$$177$$, !0, $event$$172$$.currentTarget, $event$$172$$, !0);
            }
          } else {
        ...
        $oj$$14$$.$DomUtils$.$isMetaKeyPressed$($event$$172$$) ? this.$_setHeaderColumnSelection$($columnIdx$$10$$, !this.$_getHeaderColumnSelection$($columnIdx$$10$$), $event$$172$$.currentTarget, $event$$172$$, !0) : 0 == this.$_getKeyboardKeys$().length && (this.$_clearSelectedHeaderColumns$(), this.$_setHeaderColumnSelection$($columnIdx$$10$$, !this.$_getHeaderColumnSelection$($columnIdx$$10$$), $event$$172$$.currentTarget, $event$$172$$, !0), this.$_getTableDndContext$().$setTableHeaderColumnDraggable$($columnIdx$$10$$, 
        !0));
      }
    }, "dragstart .oj-table-column-header-cell":function($event$$173$$) {
      return this.$_getTableDndContext$().$handleColumnDragStart$($event$$173$$);
    }, "dragenter .oj-table-column-header-cell":function($event$$174$$) {
      return this.$_getTableDndContext$().$handleColumnDragEnter$($event$$174$$);
    }, "dragover .oj-table-column-header-cell":function($event$$175$$) {
      return this.$_getTableDndContext$().$handleColumnDragOver$($event$$175$$);
    }, "dragleave .oj-table-column-header-cell":function($event$$176$$) {
      return this.$_getTableDndContext$().$handleColumnDragLeave$($event$$176$$);
    }, "drop .oj-table-column-header-cell":function($event$$177$$) {
      return this.$_getTableDndContext$().$handleColumnDrop$($event$$177$$);
    }, "dragend .oj-table-column-header-cell":function() {
      return this.$_getTableDndContext$().$handleColumnDragEnd$();
    }, "dragstart .oj-table-body-row":function($event$$179$$) {
      return this.$_getTableDndContext$().$handleRowDragStart$($event$$179$$);
    }, "drag .oj-table-body-row":function($event$$180$$) {
      return this.$_getTableDndContext$().$handleRowDrag$($event$$180$$);
    }, "dragend .oj-table-body-row":function($event$$181$$) {
      return this.$_getTableDndContext$().$handleRowDragEnd$($event$$181$$);
    }, "dragenter .oj-table-body":function($event$$182$$) {
      return this.$_getTableDndContext$().$handleRowDragEnter$($event$$182$$);
    }, "dragover .oj-table-body":function($event$$183$$) {
      return this.$_getTableDndContext$().$handleRowDragOver$($event$$183$$);
    }, "dragleave .oj-table-body":function($event$$184$$) {
      return this.$_getTableDndContext$().$handleRowDragLeave$($event$$184$$);
    }, "drop .oj-table-body":function($event$$185$$) {
      return this.$_getTableDndContext$().$handleRowDrop$($event$$185$$);
    }}, $_eventsContainer$:{touchstart:function($event$$186$$) {
      if (1 == $event$$186$$.originalEvent.touches.length && this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_MULTIPLE$) {
        if ($$$$14$$($event$$186$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_TOP_CLASS$) || $$$$14$$($event$$186$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_TOP_ICON_CLASS$)) {
          $event$$186$$.preventDefault(), this.$_mouseDownRowIdx$ = this.$_getTableDomUtils$().$getTableBodyRowTouchSelectionAffordanceBottom$().data("rowIdx");
        } else {
          if ($$$$14$$($event$$186$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_BOTTOM_CLASS$) || $$$$14$$($event$$186$$.target).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_TOUCH_SELECTIOM_AFFORDANCE_BOTTOM_ICON_CLASS$)) {
            $event$$186$$.preventDefault(), this.$_mouseDownRowIdx$ = this.$_getTableDomUtils$().$getTableBodyRowTouchSelectionAffordanceTop$().data("rowIdx");
          }
        }
      }
    }, touchmove:function($event$$187_eventTarget$$) {
      null != this.$_mouseDownRowIdx$ && ($event$$187_eventTarget$$.preventDefault(), $event$$187_eventTarget$$ = this.$_getTouchEventTargetElement$($event$$187_eventTarget$$), this.$_handleMouseEnterSelection$($event$$187_eventTarget$$));
    }, touchend:function($event$$188_eventTarget$$1$$) {
      null != this.$_mouseDownRowIdx$ && ($event$$188_eventTarget$$1$$ = this.$_getTouchEventTargetElement$($event$$188_eventTarget$$1$$), this.$_handleMouseEnterSelection$($event$$188_eventTarget$$1$$));
      this.$_mouseDownRowIdx$ = null;
    ...
    }, $_checkRowOrHeaderColumnFocus$:function($event$$190$$) {
      var $focusedRowIdx$$1$$ = this.$_getFocusedRowIdx$(), $focusedHeaderColumnIdx$$ = this.$_getFocusedHeaderColumnIdx$();
      null == $focusedRowIdx$$1$$ && null == $focusedHeaderColumnIdx$$ && (this.$_isTableHeaderless$() ? this.$_setRowFocus$(0, !0, !0, null, $event$$190$$) : this.$_setHeaderColumnFocus$(0, !0, !1, $event$$190$$));
      ...
      this.$_queueTask$(function() {
        ...
        if (1 < $rows$$.length) {
          ...
          if ($isContiguous_tableBodyDocFrag$$) {
            ...
            for ($i$$181_tableBodyRowBefore$$ = 0;$i$$181_tableBodyRowBefore$$ < $rowsCount$$;$i$$181_tableBodyRowBefore$$++) {
              $self$$97$$.$_addSingleTableBodyRow$($rows$$[$i$$181_tableBodyRowBefore$$].$rowIdx$, $rows$$[$i$$181_tableBodyRowBefore$$].row, $isContiguous_tableBodyDocFrag$$, $rows$$[0].$rowIdx$);
            }
            0 == $rows$$[0].$rowIdx$ ? $batchAdd_tableBody$$.prepend($isContiguous_tableBodyDocFrag$$) : ($i$$181_tableBodyRowBefore$$ = $self$$97$$.$_getTableDomUtils$().$getTableBodyRow$($rows$$[0].$rowIdx$), null != $i$$181_tableBodyRowBefore$$ ? $batchAdd_tableBody$$[0].insertBefore($isContiguous_tableBodyDocFrag$$[0], $i$$181_tableBodyRowBefore$$[0]) : $batchAdd_tableBody$$[0].insertBefore($isContiguous_tableBodyDocFrag$$[0], null));
        ...
        if (!$batchAdd_tableBody$$) {
          for ($rowsCount$$ = $rows$$.length, $i$$181_tableBodyRowBefore$$ = 0;$i$$181_tableBodyRowBefore$$ < $rowsCount$$;$i$$181_tableBodyRowBefore$$++) {
            $self$$97$$.$_addSingleTableBodyRow$($rows$$[$i$$181_tableBodyRowBefore$$].$rowIdx$, $rows$$[$i$$181_tableBodyRowBefore$$].row);
          }
        }
        $self$$97$$.$_getTableDomUtils$().$clearCachedDomRowData$();
      ...
      this.$_queueTask$(function() {
        ...
        for ($i$$182$$ = 0;$i$$182$$ < $rowsCount$$1$$;$i$$182$$++) {
          $self$$98$$.$_refreshTableBodyRow$($rows$$1$$[$i$$182$$].$rowIdx$, $rows$$1$$[$i$$182$$].row);
        }
      ...
      this.$_queueTask$(function() {
        ...
        for ($i$$183_tableBodyRows$$1$$ = 0;$i$$183_tableBodyRows$$1$$ < $rowsCount$$2$$;$i$$183_tableBodyRows$$1$$++) {
          $self$$99$$.$_getTableDomUtils$().$removeTableBodyRow$($rows$$2$$[$i$$183_tableBodyRows$$1$$].$rowIdx$), null != $currentRowKey$$ && ($rowKey$$2$$ = $rows$$2$$[$i$$183_tableBodyRows$$1$$].row[$self$$99$$.$_FIELD_ID$], $oj$$14$$.$Object$.$compareValues$($rowKey$$2$$, $currentRowKey$$) && ($self$$99$$.$_setCurrentRow$(null, null), $currentRowKey$$ = null));
        }
        $self$$99$$.$_refreshTableFooter$();
        $i$$183_tableBodyRows$$1$$ = $self$$99$$.$_getTableDomUtils$().$getTableBodyRows$();
      ...
      var $defaultedColumns_sortSupportedData$$ = [], $data$$106_i$$184$$, $columnsCount$$ = $columns_columnsSortedArray$$.length;
      for ($data$$106_i$$184$$ = 0;$data$$106_i$$184$$ < $columnsCount$$;$data$$106_i$$184$$++) {
        $defaultedColumns_sortSupportedData$$[$data$$106_i$$184$$] = $$$$14$$.extend({}, $columnsDefault_defaultedColumnsCount$$, $columns_columnsSortedArray$$[$data$$106_i$$184$$]);
      }
      $columns_columnsSortedArray$$ = [];
      $columnsDefault_defaultedColumnsCount$$ = $defaultedColumns_sortSupportedData$$.length;
      for ($data$$106_i$$184$$ = 0;$data$$106_i$$184$$ < $columnsDefault_defaultedColumnsCount$$;$data$$106_i$$184$$++) {
        $columns_columnsSortedArray$$.push($defaultedColumns_sortSupportedData$$[$data$$106_i$$184$$]);
      }
      $data$$106_i$$184$$ = this.$_getData$();
      $defaultedColumns_sortSupportedData$$ = !1;
      null != $data$$106_i$$184$$ && "full" == $data$$106_i$$184$$.getCapability("sort") && ($defaultedColumns_sortSupportedData$$ = !0);
      for ($data$$106_i$$184$$ = 0;$data$$106_i$$184$$ < $columnsDefault_defaultedColumnsCount$$;$data$$106_i$$184$$++) {
        null == $columns_columnsSortedArray$$[$data$$106_i$$184$$][this.$_FIELD_ID$] && ($columns_columnsSortedArray$$[$data$$106_i$$184$$][this.$_FIELD_ID$] = this.$_COLUMN_HEADER_ID_PREFIX$ + $data$$106_i$$184$$), null != $columns_columnsSortedArray$$[$data$$106_i$$184$$].sortable && $columns_columnsSortedArray$$[$data$$106_i$$184$$].sortable != this.$_OPTION_AUTO$ || !$defaultedColumns_sortSupportedData$$ || ($columns_columnsSortedArray$$[$data$$106_i$$184$$].sortable = this.$_OPTION_ENABLED$)
        ;
      }
      ...
      if (null != $startIndex$$17_tableBodyRows$$3$$ && 0 < $startIndex$$17_tableBodyRows$$3$$.length) {
        ...
        for ($i$$189$$ = 0;$i$$189$$ < $tableBodyRowsCount$$1$$;$i$$189$$++) {
          if ($oj$$14$$.$Object$.$compareValues$($$$$14$$($startIndex$$17_tableBodyRows$$3$$[$i$$189$$]).data("rowKey"), $data$$109_rowKey$$4$$)) {
            return $data$$109_rowKey$$4$$ = this.$_getData$(), $startIndex$$17_tableBodyRows$$3$$ = 0, $data$$109_rowKey$$4$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($startIndex$$17_tableBodyRows$$3$$ = $data$$109_rowKey$$4$$.getStartItemIndex()), $i$$189$$ + $startIndex$$17_tableBodyRows$$3$$;
          }
        }
      }
      return null;
      ...
      if (null != $tableBodyRows$$4$$ && 0 < $tableBodyRows$$4$$.length) {
        var $data$$110_i$$191$$ = this.$_getData$(), $startIndex$$18$$ = 0;
        $data$$110_i$$191$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($startIndex$$18$$ = $data$$110_i$$191$$.getStartItemIndex());
        for (var $tableBodyRowsCount$$2$$ = $tableBodyRows$$4$$.length, $data$$110_i$$191$$ = 0;$data$$110_i$$191$$ < $tableBodyRowsCount$$2$$;$data$$110_i$$191$$++) {
          if ($startIndex$$18$$ + $data$$110_i$$191$$ == $rowIndex$$3$$) {
            return $$$$14$$($tableBodyRows$$4$$[$data$$110_i$$191$$]).data("rowKey");
          }
        }
      }
      return null;
    ...
    }, $_getTouchEventTargetElement$:function($event$$191_eventLocation$$) {
      $event$$191_eventLocation$$ = $event$$191_eventLocation$$.originalEvent.changedTouches[0];
      return $$$$14$$(document.elementFromPoint($event$$191_eventLocation$$.clientX, $event$$191_eventLocation$$.clientY));
    }, $_handleContextMenuSelect$:function($event$$192$$, $ui$$5$$) {
    ...
    }, $_handleDataFetchEnd$:function($event$$194$$) {
      try {
        var $self$$100$$ = this;
        this.$_queueTask$(function() {
          ...
          var $data$$111_indexArray$$ = [], $i$$194$$, $eventDataCount$$ = $event$$194$$[$self$$100$$.$_CONST_DATA$].length;
          for ($i$$194$$ = 0;$i$$194$$ < $eventDataCount$$;$i$$194$$++) {
            $data$$111_indexArray$$[$i$$194$$] = $i$$194$$ + $offset$$22$$ + $event$$194$$[$self$$100$$.$_CONST_STARTINDEX$];
          }
          $self$$100$$.$_refreshAll$({data:$event$$194$$[$self$$100$$.$_CONST_DATA$], keys:$event$$194$$[$self$$100$$.$_CONST_KEYS$], indexes:$data$$111_indexArray$$}, $event$$194$$[$self$$100$$.$_CONST_STARTINDEX$]);
        });
      } catch ($e$$81$$) {
    ...
    }, $_handleDataRowAdd$:function($event$$197_startIndex$$19$$) {
      try {
        var $data$$112_rowArray$$ = this.$_getData$(), $eventData$$5$$ = $event$$197_startIndex$$19$$[this.$_CONST_DATA$], $eventIndexes$$ = $event$$197_startIndex$$19$$[this.$_CONST_INDEXES$], $eventKeys$$ = $event$$197_startIndex$$19$$[this.$_CONST_KEYS$];
        $eventData$$5$$ instanceof Array || ($eventData$$5$$ = [$eventData$$5$$]);
        $event$$197_startIndex$$19$$ = 0;
        $data$$112_rowArray$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$197_startIndex$$19$$ = $data$$112_rowArray$$.getStartItemIndex());
        var $data$$112_rowArray$$ = [], $i$$195$$, $eventDataCount$$1$$ = $eventData$$5$$.length;
        for ($i$$195$$ = 0;$i$$195$$ < $eventDataCount$$1$$;$i$$195$$++) {
          var $rowIdx$$11$$ = $eventIndexes$$[$i$$195$$] - $event$$197_startIndex$$19$$;
          void 0 !== $rowIdx$$11$$ && $data$$112_rowArray$$.push({row:{data:$eventData$$5$$[$i$$195$$], key:$eventKeys$$[$i$$195$$], index:$eventIndexes$$[$i$$195$$]}, $rowIdx$:$rowIdx$$11$$});
        }
    ...
    }, $_handleDataRowChange$:function($event$$198_startIndex$$20$$) {
      try {
        var $data$$113_rowArray$$1$$ = this.$_getData$(), $eventData$$6$$ = $event$$198_startIndex$$20$$[this.$_CONST_DATA$], $eventIndexes$$1$$ = $event$$198_startIndex$$20$$[this.$_CONST_INDEXES$], $eventKeys$$1$$ = $event$$198_startIndex$$20$$[this.$_CONST_KEYS$];
        $eventData$$6$$ instanceof Array || ($eventData$$6$$ = [$eventData$$6$$]);
        $event$$198_startIndex$$20$$ = 0;
        $data$$113_rowArray$$1$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$198_startIndex$$20$$ = $data$$113_rowArray$$1$$.getStartItemIndex());
        var $data$$113_rowArray$$1$$ = [], $i$$196$$, $eventDataCount$$2$$ = $eventData$$6$$.length;
        for ($i$$196$$ = 0;$i$$196$$ < $eventDataCount$$2$$;$i$$196$$++) {
          var $rowIdx$$12$$ = $eventIndexes$$1$$[$i$$196$$] - $event$$198_startIndex$$20$$;
          void 0 !== $rowIdx$$12$$ && $data$$113_rowArray$$1$$.push({row:{data:$eventData$$6$$[$i$$196$$], key:$eventKeys$$1$$[$i$$196$$], index:$eventIndexes$$1$$[$i$$196$$]}, $rowIdx$:$rowIdx$$12$$});
        }
    ...
    }, $_handleDataRowRemove$:function($event$$199_startIndex$$21$$) {
      try {
        var $data$$114_rowArray$$2$$ = this.$_getData$(), $eventData$$7$$ = $event$$199_startIndex$$21$$[this.$_CONST_DATA$], $eventIndexes$$2$$ = $event$$199_startIndex$$21$$[this.$_CONST_INDEXES$], $eventKeys$$2$$ = $event$$199_startIndex$$21$$[this.$_CONST_KEYS$];
        $eventData$$7$$ instanceof Array || ($eventData$$7$$ = [$eventData$$7$$]);
        $event$$199_startIndex$$21$$ = 0;
        $data$$114_rowArray$$2$$ instanceof $oj$$14$$.$PagingTableDataSource$ && ($event$$199_startIndex$$21$$ = $data$$114_rowArray$$2$$.getStartItemIndex());
        var $data$$114_rowArray$$2$$ = [], $i$$197$$;
        for ($i$$197$$ = $eventData$$7$$.length - 1;0 <= $i$$197$$;$i$$197$$--) {
          var $rowIdx$$13$$ = $eventIndexes$$2$$[$i$$197$$] - $event$$199_startIndex$$21$$;
          void 0 !== $rowIdx$$13$$ && $data$$114_rowArray$$2$$.push({row:{data:$eventData$$7$$[$i$$197$$], key:$eventKeys$$2$$[$i$$197$$], index:$eventIndexes$$2$$[$i$$197$$]}, $rowIdx$:$rowIdx$$13$$});
        }
    ...
    }, $_handleDataSort$:function($clearSelection_event$$200$$) {
      try {
        var $columnIdx$$19$$;
        if (null != $clearSelection_event$$200$$) {
          ...
          for ($i$$198$$ = 0;$i$$198$$ < $columnsCount$$2$$;$i$$198$$++) {
            if ($column$$6$$ = $columns$$4$$[$i$$198$$], $sortField$$ = null == $column$$6$$.sortProperty ? $column$$6$$.field : $column$$6$$.sortProperty, $clearSelection_event$$200$$.header == $sortField$$) {
              $columnIdx$$19$$ = $i$$198$$;
              break;
            }
          }
          null != $columnIdx$$19$$ && this.$_refreshSortTableHeaderColumn$($columnIdx$$19$$, $clearSelection_event$$200$$.direction == this.$_COLUMN_SORT_ORDER$.$_ASCENDING$);
        }
        var $existingSelection$$ = this.options.selection;
        if (null != $existingSelection$$) {
          $clearSelection_event$$200$$ = !1;
          if (1 < $existingSelection$$.length) {
            $clearSelection_event$$200$$ = !0;
          } else {
            if (null != $existingSelection$$[0]) {
              var $endIndex$$1$$ = $existingSelection$$[0][this.$_CONST_ENDINDEX$];
              $oj$$14$$.$Object$.$compareValues$($existingSelection$$[0][this.$_CONST_STARTINDEX$], $endIndex$$1$$) || null == $endIndex$$1$$ || ($clearSelection_event$$200$$ = !0);
            }
          }
          $clearSelection_event$$200$$ && (this.$_setSelection$(null), this.option("selection", null, {_context:{$writeback$:!0, $internalSet$:!0}}));
        }
    ...
    }, $_handleKeydownLeftRight$:function($event$$201$$) {
      ...
      if (null != $focusedHeaderColumnIdx$$2$$) {
        ...
        $newFocusedHeaderColumnIdx$$ != $focusedHeaderColumnIdx$$2$$ && (this.$_setHeaderColumnFocus$($newFocusedHeaderColumnIdx$$, !0, !1, null), $event$$201$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$] && ($columns$$5_newFocusedHeaderColumnSelection$$ = this.$_getHeaderColumnSelection$($newFocusedHeaderColumnIdx$$), this.$_setHeaderColumnSelection$($newFocusedHeaderColumnIdx$$, !$columns$$5_newFocusedHeaderColumnSelection$$, null, $event$$201$$, !0), $columns$$5_newFocusedHeaderColumnSelection$$ && 
        this.$_getHeaderColumnSelection$($focusedHeaderColumnIdx$$2$$) && this.$_setHeaderColumnSelection$($focusedHeaderColumnIdx$$2$$, !1, null, $event$$201$$, !0)));
      }
    }, $_handleKeydownTab$:function($event$$202$$) {
      ...
      if (!$tabHandled_tabbableElementsInDocument$$) {
        ...
        if ($event$$202$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$]) {
        ...
        $event$$202$$.preventDefault();
        $event$$202$$.stopPropagation();
      }
      this.$_removeKeyboardKey$($event$$202$$.keyCode);
    }, $_handleKeydownUpDown$:function($event$$203$$) {
      ...
      if (null != $focusedRowIdx$$4$$) {
        ...
        $focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$ != $focusedRowIdx$$4$$ ? this.$_setRowFocus$($focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$, !0, !0, null, $event$$203$$) && $event$$203$$[this.$_KEYBOARD_CODES$.$_KEYBOARD_MODIFIER_SHIFT$] && ($newFocusedRowSelection_rowCount$$2$$ = this.$_getRowSelection$($focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$), this.$_setRowSelection$($focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$, !$newFocusedRowSelection_rowCount$$2$$, 
        null, $event$$203$$, !0), $newFocusedRowSelection_rowCount$$2$$ && this.$_getRowSelection$($focusedRowIdx$$4$$) && this.$_setRowSelection$($focusedRowIdx$$4$$, !1, null, $event$$203$$, !0)) : $focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$ == $focusedRowIdx$$4$$ && 0 == $focusedRowIdx$$4$$ && this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_UP$) && this.$_setHeaderColumnFocus$(0, !0, !1, null);
      } else {
        null != $focusedHeaderColumnIdx$$3_newFocusedRowIdx_tableBodyRows$$5$$ && this.$_isKeyboardKeyPressed$(this.$_KEYBOARD_CODES$.$_KEYBOARD_CODE_DOWN$) && this.$_setRowFocus$(0, !0, !0, null, $event$$203$$);
      }
    }, $_handleKeyupEnd$:function($event$$204$$) {
      ...
      if (null != $focusedColumnIdx_focusedRowIdx$$5$$ && $focusedColumnIdx_focusedRowIdx$$5$$ != this.$_getColumnDefs$().length - 1) {
        ...
        null != $focusedColumnIdx_focusedRowIdx$$5$$ && $focusedColumnIdx_focusedRowIdx$$5$$ != $rowCount$$3_tableBodyRows$$6$$ - 1 && 0 < $rowCount$$3_tableBodyRows$$6$$ && this.$_setRowFocus$($rowCount$$3_tableBodyRows$$6$$ - 1, !0, !0, null, $event$$204$$);
      }
    }, $_handleKeyupEnter$:function($event$$205$$) {
      ...
      if (null != $focusedColumnIdx$$1$$ && this.$_getColumnDefs$()[$focusedColumnIdx$$1$$].sortable == this.$_OPTION_ENABLED$) {
        ...
        null == $sorted$$4$$ || $sorted$$4$$ == this.$_COLUMN_SORT_ORDER$.$_DESCENDING$ ? this.$_handleSortTableHeaderColumn$($focusedColumnIdx$$1$$, !0, $event$$205$$) : this.$_handleSortTableHeaderColumn$($focusedColumnIdx$$1$$, !1, $event$$205$$);
      }
    }, $_handleKeyupEsc$:function($event$$206$$) {
      $event$$206$$.preventDefault();
      $event$$206$$.stopPropagation();
      this.$_getTableDomUtils$().$getTable$().focus();
      this.$_setTableNavigationMode$(!1);
    }, $_handleKeyupHome$:function($event$$207$$) {
      var $focusedColumnIdx$$2_focusedRowIdx$$6$$ = this.$_getFocusedHeaderColumnIdx$();
      null != $focusedColumnIdx$$2_focusedRowIdx$$6$$ && 0 != $focusedColumnIdx$$2_focusedRowIdx$$6$$ ? this.$_setHeaderColumnFocus$(0, !0, !1, null) : ($focusedColumnIdx$$2_focusedRowIdx$$6$$ = this.$_getFocusedRowIdx$(), null != $focusedColumnIdx$$2_focusedRowIdx$$6$$ && 0 != $focusedColumnIdx$$2_focusedRowIdx$$6$$ && this.$_setRowFocus$(0, !0, !0, null, $event$$207$$));
    }, $_handleKeyupSpacebar$:function($event$$208$$) {
      var $focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ = this.$_getFocusedRowIdx$();
      null != $focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ ? this.$_setRowSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$, !this.$_getRowSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$), null, $event$$208$$, !0) : ($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ = this.$_getFocusedHeaderColumnIdx$(), null != $focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$ && (this.$_clearSelectedRows$(), this.$_setHeaderColumnSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$, !this.$_getHeaderColumnSelection$($focusedHeaderColumnIdx$$4_focusedRowIdx$$7$$), 
      null, $event$$208$$, !0)));
    ...
    }, $_handleSortTableHeaderColumn$:function($columnIdx$$20$$, $ascending$$, $event$$209$$) {
      this.$_clearSortedHeaderColumn$($columnIdx$$20$$);
      var $column$$7$$ = this.$_getColumnDefs$()[$columnIdx$$20$$];
      this.$_invokeDataSort$(null == $column$$7$$.sortProperty ? $column$$7$$.field : $column$$7$$.sortProperty, $ascending$$, $event$$209$$);
      ...
      return new Promise(function($resolve$$27$$, $reject$$27$$) {
        null != $data$$116$$ ? ($self$$105$$.$_setDataWaitingState$(), $data$$116$$.fetch($options$$238$$).then(function($result$$36$$) {
          if (null != $result$$36$$ && null != $result$$36$$[$self$$105$$.$_CONST_DATA$]) {
            ...
            var $indexArray$$1$$ = [], $i$$201$$, $resultDataCount$$ = $result$$36$$[$self$$105$$.$_CONST_DATA$].length;
            for ($i$$201$$ = 0;$i$$201$$ < $resultDataCount$$;$i$$201$$++) {
              $indexArray$$1$$[$i$$201$$] = $i$$201$$ + $offset$$23$$ + $result$$36$$[$self$$105$$.$_CONST_STARTINDEX$];
            }
    ...
    }, $_invokeDataSort$:function($sortField$$2$$, $ascending$$2$$, $event$$210$$) {
      ...
      this._trigger("sort", $event$$210$$, {header:$sortCriteria$$[this.$_CONST_KEY$], direction:$sortCriteria$$.direction});
    ...
    }, $_isNodeEditable$:function($node$$57$$) {
      return this.$_isNodeType$($node$$57$$, /^INPUT|TEXTAREA/);
    }, $_isNodeClickable$:function($node$$58$$) {
      return this.$_isNodeType$($node$$58$$, /SELECT|OPTION|BUTTON|^A\b/);
    }, $_isNodeDraggable$:function($node$$59$$) {
      return 0 < $node$$59$$.closest("[draggable\x3d'true']").length;
    }, $_isNodeType$:function($node$$60$$, $type$$80$$) {
      for (var $nodeName$$3$$, $table$$3$$ = this.$_getTableDomUtils$().$getTable$();null != $node$$60$$ && $node$$60$$[0] != $table$$3$$[0] && "TD" != ($nodeName$$3$$ = $node$$60$$.prop("nodeName")) && "TH" != $nodeName$$3$$;) {
        if (3 == $node$$60$$[0].nodeType) {
          $node$$60$$ = $node$$60$$[0].parentNode;
        } else {
          var $tabIndex$$ = $node$$60$$.attr("tabIndex");
          if ($nodeName$$3$$.match($type$$80$$) && -1 != $tabIndex$$) {
            return!0;
          }
          $node$$60$$ = $node$$60$$.parentNode;
        }
      }
      return!1;
    ...
    }, $_refreshTableBodyRow$:function($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$, $tableBodyRow$$7$$, $docFrag$$1_i$$209$$, $docFragStartIdx$$1_tableBodyCells$$, $context$$62_isNew$$) {
      ...
      if (null == $tableBodyRow$$7$$) {
        if ($tableBodyRow$$7$$ = this.$_getTableDomUtils$().$getTableBodyRow$($moveTableBodyCell_rowIdx$$16$$)) {
          $tableBodyRow$$7$$.empty(), $context$$62_isNew$$ = !0, this.$_getTableDomUtils$().$createTableBodyCellAccSelect$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$[this.$_CONST_KEY$], $rowHashCode$$, $tableBodyRow$$7$$, $context$$62_isNew$$);
        } else {
          return;
        }
      }
      ...
      $context$$62_isNew$$ = {rowContext:$oj$$14$$.$TableRendererUtils$.$getRendererContextObject$(this, $row$$11_swapTableBodyCell$$, $tableBodyRow$$7$$[0]), row:$$$$14$$.extend({}, $row$$11_swapTableBodyCell$$[this.$_CONST_DATA$])};
      if ($rowContent_rowRenderer$$1_tableBodyCell$$2$$) {
        $rowContent_rowRenderer$$1_tableBodyCell$$2$$ = $rowContent_rowRenderer$$1_tableBodyCell$$2$$($context$$62_isNew$$);
        ...
        $oj$$14$$.$TableRendererUtils$.$tableBodyRowDefaultRenderer$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$, $context$$62_isNew$$);
      }
      ...
      if ($columns$$13$$ && 0 < $columns$$13$$.length) {
        ...
        for (var $column$$10_headerColumnContent$$, $headerRenderer$$, $headerColumn$$3$$, $context$$63_headerContext$$, $columnsCount$$9$$ = $columns$$13$$.length, $i$$211_tableHeaderAccSelectRowColumn$$ = 0;$i$$211_tableHeaderAccSelectRowColumn$$ < $columnsCount$$9$$;$i$$211_tableHeaderAccSelectRowColumn$$++) {
          $column$$10_headerColumnContent$$ = $columns$$13$$[$i$$211_tableHeaderAccSelectRowColumn$$], $headerRenderer$$ = this.$_getColumnRenderer$($i$$211_tableHeaderAccSelectRowColumn$$, "header"), $headerColumn$$3$$ = this.$_getTableDomUtils$().$createTableHeaderColumn$($i$$211_tableHeaderAccSelectRowColumn$$), $headerRenderer$$ && ($context$$63_headerContext$$ = $oj$$14$$.$TableRendererUtils$.$getRendererContextObject$(this, null, $headerColumn$$3$$[0]), $context$$63_headerContext$$ = {headerContext:$context$$63_headerContext$$, 
          columnIndex:$i$$211_tableHeaderAccSelectRowColumn$$, data:$column$$10_headerColumnContent$$.headerText}, $column$$10_headerColumnContent$$.sortable == $oj$$14$$.$TableDomUtils$.$_OPTION_ENABLED$ ? $context$$63_headerContext$$.columnHeaderSortableIconRenderer = function $$context$$63_headerContext$$$columnHeaderSortableIconRenderer$($options$$240$$, $delegateRenderer$$) {
            $oj$$14$$.$TableRendererUtils$.$columnHeaderSortableIconRenderer$(this, $delegateRenderer$$);
          } : $context$$63_headerContext$$.columnHeaderDefaultRenderer = function $$context$$63_headerContext$$$columnHeaderDefaultRenderer$($options$$241$$, $delegateRenderer$$1$$) {
            $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultRenderer$(this, $delegateRenderer$$1$$);
          }, $column$$10_headerColumnContent$$ = $headerRenderer$$($context$$63_headerContext$$), null != $column$$10_headerColumnContent$$ ? ($headerColumn$$3$$.empty(), $headerColumn$$3$$.append($column$$10_headerColumnContent$$)) : ($headerColumn$$3$$ = $$$$14$$($tableHeader$$1_tableHeaderRow$$1$$.children(":not(." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ACC_SELECT_ROW_CLASS$ + ")")[$i$$211_tableHeaderAccSelectRowColumn$$]), this.$_getTableDomUtils$().$setTableHeaderColumnAttributes$($i$$211_tableHeaderAccSelectRowColumn$$, 
      ...
      $jqEventSpecial$$.ojtablebeforecurrentrow = {handle:function $$jqEventSpecial$$$ojtablebeforecurrentrow$handle$($event$$211$$, $JSCompiler_OptimizeArgumentsArray_p1$$) {
        return $event$$211$$.handleObj.handler.apply(this, [$event$$211$$, $JSCompiler_OptimizeArgumentsArray_p1$$]);
      }};
      $jqEventSpecial$$.ojtablesort = {handle:function $$jqEventSpecial$$$ojtablesort$handle$($event$$212$$, $JSCompiler_OptimizeArgumentsArray_p2$$) {
        return $event$$212$$.handleObj.handler.apply(this, [$event$$212$$, $JSCompiler_OptimizeArgumentsArray_p2$$]);
      }};
      ...
      if (null != $data$$118$$) {
        ...
        for ($i$$212$$ = 0;$i$$212$$ < $dataSourceEventHandlersCount$$;$i$$212$$++) {
          ($ev$$1$$ = $data$$118$$.on(this.$_dataSourceEventHandlers$[$i$$212$$].eventType, this.$_dataSourceEventHandlers$[$i$$212$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$212$$].eventHandler = $ev$$1$$);
        }
      }
    }, $_registerDomEventListeners$:function() {
      null != this.$_getTableDomUtils$().$getScroller$() && this.$_getTableDomUtils$().$getScroller$().scroll(function($event$$213$$) {
        this.$_handleScrollerScrollLeft$(this.$_getTableDomUtils$().$getScrollLeft$($event$$213$$.target));
      }.bind(this));
    ...
    }, $_setCurrentRow$:function($currentRow$$1_errSummary$$13$$, $event$$214$$, $currentFocusedRowIdx_optionChange$$) {
      ...
      if (null == $currentRow$$1_errSummary$$13$$) {
        if (null != $existingCurrentRow_existingCurrentRowIdx_existingCurrentRowIndex_existingCurrentRowKey$$) {
          try {
            $tableBodyRow$$9_updateCurrentRow$$1$$ = this._trigger("beforecurrentrow", $event$$214$$, {currentRow:null, previousCurrentRow:this.$_currentRow$});
          } catch ($err$$15$$) {
          ...
          this.option("currentRow", null, {_context:{$writeback$:!0, originalEvent:$event$$214$$, $internalSet$:!0}});
          null == $event$$214$$ && this.$_setRowFocus$(-1, !0, !1, null, $event$$214$$);
      ...
      if ($currentRowChanged_data$$119$$ = !$oj$$14$$.$Object$.$compareValues$(this.$_currentRow$, $currentRow$$1_errSummary$$13$$)) {
        try {
          $tableBodyRow$$9_updateCurrentRow$$1$$ = this._trigger("beforecurrentrow", $event$$214$$, {currentRow:{rowIndex:$rowIndex$$4$$, rowKey:$rowKey$$5$$}, previousCurrentRow:this.$_currentRow$});
        } catch ($err$$16$$) {
        ...
        this.option("currentRow", this.$_currentRow$, {_context:{$writeback$:!0, originalEvent:$event$$214$$, $internalSet$:!0}});
      ...
      ($currentRowChanged_data$$119$$ || $currentFocusedRowIdx_optionChange$$ != $currentRow$$1_errSummary$$13$$.rowIndex) && null == $event$$214$$ && this.$_setRowFocus$($errDetail$$6_rowIdx$$18$$, !0, !1, null, $event$$214$$);
      return!0;
    }, $_setDataWaitingState$:function() {
      this.$_showStatusMessage$();
      this.$_hideNoDataMessage$();
      this.$_dataFetching$ = !0;
    }, $_setHeaderColumnFocus$:function($columnIdx$$25$$, $focused$$4$$, $clearSelectedRows$$, $event$$215$$) {
      var $element$$91$$ = null;
      null != $event$$215$$ && ($element$$91$$ = $event$$215$$.currentTarget);
      if ($focused$$4$$) {
        var $focusedHeaderColumnIdx$$5$$ = this.$_getFocusedHeaderColumnIdx$();
        null != $focusedHeaderColumnIdx$$5$$ && $focusedHeaderColumnIdx$$5$$ != $columnIdx$$25$$ && this.$_setHeaderColumnFocus$($focusedHeaderColumnIdx$$5$$, !1, !1, $event$$215$$);
    ...
    }, $_setHeaderColumnSelection$:function($accSelectionColumn_columnIdx$$26$$, $selected$$17_selection$$3$$, $element$$92$$, $event$$216$$, $updateSelection$$) {
    ...
    }, $_setRowFocus$:function($rowIdx$$20$$, $focused$$6$$, $rowKey$$6_updateCurrentRow$$2$$, $element$$94$$, $event$$218_updateRowFocus$$) {
      if (-1 == $rowIdx$$20$$) {
        ...
        return $rowKey$$6_updateCurrentRow$$2$$ && ($event$$218_updateRowFocus$$ = this.$_setCurrentRow$(null, $event$$218_updateRowFocus$$), !$event$$218_updateRowFocus$$) ? !1 : !0;
      }
      ...
      if ($focused$$6$$) {
        ...
        if ($rowKey$$6_updateCurrentRow$$2$$ && ($rowKey$$6_updateCurrentRow$$2$$ = this.$_getRowKeyForRowIdx$($rowIdx$$20$$), $event$$218_updateRowFocus$$ = this.$_setCurrentRow$({rowKey:$rowKey$$6_updateCurrentRow$$2$$}, $event$$218_updateRowFocus$$), !$event$$218_updateRowFocus$$)) {
          return!1;
        }
      ...
      return!0;
    }, $_setRowSelection$:function($accSelectionCell_rowIdx$$21$$, $selected$$21_selection$$4$$, $element$$95_tableBodyRow$$11$$, $event$$219_selectionChanged$$, $updateSelection$$1$$) {
      if (this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_SINGLE$ || this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_MULTIPLE$) {
        if ((isNaN($accSelectionCell_rowIdx$$21$$) || 0 > $accSelectionCell_rowIdx$$21$$) && $oj$$14$$.$Logger$.error("Error: Invalid row selection value: " + $accSelectionCell_rowIdx$$21$$), this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_SINGLE$ && $selected$$21_selection$$4$$ && this.$_clearSelectedRows$(), $element$$95_tableBodyRow$$11$$ = this.$_getTableDomUtils$().$getTableBodyRow$($accSelectionCell_rowIdx$$21$$), null != $element$$95_tableBodyRow$$11$$) {
          ...
          $event$$219_selectionChanged$$ && ($selected$$21_selection$$4$$ ? this.$_updateRowStateCellsClass$($accSelectionCell_rowIdx$$21$$, {hover:!1, $focused$:!1, selected:!0}) : this.$_updateRowStateCellsClass$($accSelectionCell_rowIdx$$21$$, {selected:!1}));
      ...
      if (null != this.$_dataSourceEventHandlers$ && null != $data$$120$$) {
        ...
        for ($i$$217$$ = 0;$i$$217$$ < $dataSourceEventHandlersCount$$1$$;$i$$217$$++) {
          $data$$120$$.off(this.$_dataSourceEventHandlers$[$i$$217$$].eventType, this.$_dataSourceEventHandlers$[$i$$217$$].eventHandler);
        }
      }
      ...
      if (null != $i$$218_tableBodyRows$$8$$ && 0 < $i$$218_tableBodyRows$$8$$.length) {
        for (var $j$$32$$, $tableBodyCell$$3$$, $rowSelected$$3$$, $selectedRowIdxsCount$$1$$, $tableBodyRowsCount$$4$$ = $i$$218_tableBodyRows$$8$$.length, $i$$218_tableBodyRows$$8$$ = 0;$i$$218_tableBodyRows$$8$$ < $tableBodyRowsCount$$4$$;$i$$218_tableBodyRows$$8$$++) {
  ...
  $oj$$14$$.$TableDndContext$ = function $$oj$$14$$$$TableDndContext$$($component$$16$$) {
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_addDragMarkerClass$ = function $$oj$$14$$$$TableDndContext$$$$_addDragMarkerClass$$($columnIdx$$31$$) {
    this.$_getTableDomUtils$().$getTableHeaderColumn$($columnIdx$$31$$).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAG$);
    this.$_getTableDomUtils$().$setTableColumnCellsClass$($columnIdx$$31$$, !0, $oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAG$);
  };
  $oj$$14$$.$TableDndContext$.prototype.$_removeDragMarkerClass$ = function $$oj$$14$$$$TableDndContext$$$$_removeDragMarkerClass$$() {
    ...
    if (null != $dragColumns$$ && 0 < $dragColumns$$.length) {
      var $i$$220$$, $dragColumnsCount$$ = $dragColumns$$.length;
      for ($i$$220$$ = 0;$i$$220$$ < $dragColumnsCount$$;$i$$220$$++) {
        $$$$14$$($dragColumns$$[$i$$220$$]).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAG$);
      }
    }
    this.$_getTableDomUtils$().$setTableColumnCellsClass$(null, !1, $oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAG$);
  };
  $oj$$14$$.$TableDndContext$.prototype.$_cloneTableBody$ = function $$oj$$14$$$$TableDndContext$$$$_cloneTableBody$$($tableBody$$5$$) {
    var $bodyClone$$;
    $tableBody$$5$$[0].getBoundingClientRect();
    var $scrollLeft$$1$$ = $tableBody$$5$$.scrollLeft(), $scrollTop$$ = $tableBody$$5$$.scrollTop();
    $bodyClone$$ = $tableBody$$5$$.clone();
    $bodyClone$$.css({overflow:"hidden", "overflow-x":"hidden", "overflow-y":"hidden", "background-color":"transparent", width:$tableBody$$5$$.css("width"), height:$tableBody$$5$$.css("height"), position:"fixed", top:1E4});
    $$$$14$$("body").append($bodyClone$$);
    $bodyClone$$.scrollLeft(1 * $scrollLeft$$1$$);
    $bodyClone$$.scrollTop(1 * $scrollTop$$);
    return $bodyClone$$;
  };
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_getOverRowIndex$ = function $$oj$$14$$$$TableDndContext$$$$_getOverRowIndex$$($context$$64_event$$221$$) {
    var $newRowIndex_overRow_tableBodyRows$$9$$;
    $newRowIndex_overRow_tableBodyRows$$9$$ = $$$$14$$($context$$64_event$$221$$.target).closest("tr");
    $newRowIndex_overRow_tableBodyRows$$9$$ = ($context$$64_event$$221$$ = this.$component$.getContextByNode($context$$64_event$$221$$.target)) && "oj-table-cell" == $context$$64_event$$221$$.subId ? $context$$64_event$$221$$.rowIndex : $newRowIndex_overRow_tableBodyRows$$9$$ && $newRowIndex_overRow_tableBodyRows$$9$$.hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_DRAG_INDICATOR_BEFORE_CLASS$) ? this.$_dropRowIndex$ : ($newRowIndex_overRow_tableBodyRows$$9$$ = this.$_getTableDomUtils$().$getTableBodyRows$()) ? 
    $newRowIndex_overRow_tableBodyRows$$9$$.length : 0;
    return $newRowIndex_overRow_tableBodyRows$$9$$;
  };
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragStart$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragStart$$($event$$222$$) {
    if (this.$_isColumnReorderEnabled$()) {
      var $columnIdx$$32$$ = this.$_getEventColumnIndex$($event$$222$$);
      this.$_dragStartColumnIdx$ = $columnIdx$$32$$;
      this.$_setReorderColumnsDataTransfer$($event$$222$$, $columnIdx$$32$$);
      this.$component$.$_setSelection$(null);
      this.$component$.option("selection", null, {_context:{$writeback$:!0, $internalSet$:!0}});
      setTimeout(function() {
        window.getSelection().removeAllRanges();
      }, 0);
      this.$_addDragMarkerClass$($columnIdx$$32$$);
      return!0;
    }
  };
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragEnter$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragEnter$$($event$$224$$) {
    if (!this.$_isColumnReordering$()) {
      var $columnIdx$$33$$ = this.$_getEventColumnIndex$($event$$224$$);
      return this.$_invokeDropCallback$("columns", "dragEnter", $event$$224$$, {columnIndex:$columnIdx$$33$$});
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnReorderDragOver$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnReorderDragOver$$($event$$225$$) {
    var $columnIdx$$34$$ = this.$_getEventColumnIndex$($event$$225$$), $dragStartColumnIdx$$ = this.$_dragStartColumnIdx$;
    null != $dragStartColumnIdx$$ && $dragStartColumnIdx$$ != $columnIdx$$34$$ && ((this.$_currentDropColumnBefore$ = this.$_isDragOverBeforeColumn$($event$$225$$)) && $dragStartColumnIdx$$ == $columnIdx$$34$$ - 1 || !this.$_currentDropColumnBefore$ && $dragStartColumnIdx$$ == $columnIdx$$34$$ + 1 || this.$_getTableDomUtils$().$displayDragOverIndicatorColumn$($columnIdx$$34$$, this.$_currentDropColumnBefore$), $event$$225$$.preventDefault());
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragOver$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragOver$$($event$$226$$) {
    ...
    var $columnIdx$$35$$ = this.$_getEventColumnIndex$($event$$226$$);
    this.$_currentDropColumnBefore$ = this.$_isDragOverBeforeColumn$($event$$226$$);
    var $returnValue$$1$$ = this.$_invokeDropCallback$("columns", "dragOver", $event$$226$$, {columnIndex:$columnIdx$$35$$});
    (!1 === $returnValue$$1$$ || $event$$226$$.isDefaultPrevented()) && this.$_getTableDomUtils$().$displayDragOverIndicatorColumn$($columnIdx$$35$$, this.$_isDragOverBeforeColumn$($event$$226$$));
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragLeave$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragLeave$$($event$$227$$) {
    if (!this.$_isColumnReordering$()) {
      ...
      var $columnIdx$$36$$ = this.$_getEventColumnIndex$($event$$227$$);
      return this.$_invokeDndCallback$("drop", "columns", "dragLeave", $event$$227$$, {columnIndex:$columnIdx$$36$$});
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnReorderDrop$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnReorderDrop$$($event$$228$$) {
    var $columnIdx$$37$$ = this.$_getEventColumnIndex$($event$$228$$);
    this.$_currentDropColumnBefore$ || $columnIdx$$37$$++;
    this.$component$.$_columnsDestMap$ = this.$_getTableDomUtils$().$moveTableHeaderColumn$(this.$_dragStartColumnIdx$, $columnIdx$$37$$, $event$$228$$);
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDrop$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDrop$$($event$$229$$) {
    ...
    this.$_getTableDomUtils$().$removeDragOverIndicatorColumn$();
    var $columnIdx$$38$$ = this.$_getEventColumnIndex$($event$$229$$);
    this.$_currentDropColumnBefore$ || $columnIdx$$38$$++;
    return this.$_invokeDropCallback$("columns", "drop", $event$$229$$, {columnIndex:$columnIdx$$38$$});
  };
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_hideUnselectedRows$ = function $$oj$$14$$$$TableDndContext$$$$_hideUnselectedRows$$($bodyClone$$1$$, $selArray$$) {
    ...
    for (var $i$$221$$ = 0;$i$$221$$ < $bodyRows$$.length;$i$$221$$++) {
      -1 == $selArray$$.indexOf($i$$221$$) && $$$$14$$($bodyRows$$[$i$$221$$]).css("visibility", "hidden");
    }
  };
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_isDndEventInElement$ = function $$oj$$14$$$$TableDndContext$$$$_isDndEventInElement$$($event$$239$$, $element$$97$$) {
    var $rect$$1$$ = $element$$97$$.getBoundingClientRect(), $domEvent$$ = $event$$239$$.originalEvent;
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_setHeaderColumnDraggable$ = function $$oj$$14$$$$TableDndContext$$$$_setHeaderColumnDraggable$$($headerColumn$$5$$, $draggable$$) {
    if ($headerColumn$$5$$.draggable = $draggable$$) {
      $$$$14$$($headerColumn$$5$$).css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_CURSOR$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_MOVE$), $$$$14$$($headerColumn$$5$$).addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAGGABLE$);
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$_clearHeaderColumnDraggable$ = function $$oj$$14$$$$TableDndContext$$$$_clearHeaderColumnDraggable$$($headerColumn$$6$$) {
    $headerColumn$$6$$.draggable = "";
    $$$$14$$($headerColumn$$6$$).css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_CURSOR$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_AUTO$);
    $$$$14$$($headerColumn$$6$$).removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAGGABLE$);
  };
  $oj$$14$$.$TableDndContext$.prototype.$_setDragRowsData$ = function $$oj$$14$$$$TableDndContext$$$$_setDragRowsData$$($dataTransfer_nativeEvent$$, $dataTypes$$2$$, $jsonStr$$1_rowDataArray$$) {
    ...
    if ("string" == typeof $dataTypes$$2$$) {
      ...
      if ($dataTypes$$2$$) {
        for (var $i$$223$$ = 0;$i$$223$$ < $dataTypes$$2$$.length;$i$$223$$++) {
          $dataTransfer_nativeEvent$$.setData($dataTypes$$2$$[$i$$223$$], $jsonStr$$1_rowDataArray$$);
        }
      }
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$_setDragRowsDataTransfer$ = function $$oj$$14$$$$TableDndContext$$$$_setDragRowsDataTransfer$$($event$$242$$, $dataTypes$$3$$, $selArray$$1$$) {
    for (var $rowDataArray$$1$$ = [], $i$$224$$ = 0;$i$$224$$ < $selArray$$1$$.length;$i$$224$$++) {
      var $row$$12$$ = this.$component$.getDataForVisibleRow($selArray$$1$$[$i$$224$$]);
      $row$$12$$ && $rowDataArray$$1$$.push($row$$12$$);
    }
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_setDragRowsImage$ = function $$oj$$14$$$$TableDndContext$$$$_setDragRowsImage$$($nativeEvent$$1$$, $scrollTop$$1_tableBody$$6$$, $rect$$2_selArray$$2$$) {
    var $bodyClone$$2$$ = this.$_cloneTableBody$($scrollTop$$1_tableBody$$6$$);
    this.$_hideUnselectedRows$($bodyClone$$2$$, $rect$$2_selArray$$2$$);
    $rect$$2_selArray$$2$$ = $scrollTop$$1_tableBody$$6$$[0].getBoundingClientRect();
    var $scrollLeft$$2$$ = $scrollTop$$1_tableBody$$6$$.scrollLeft();
    $scrollTop$$1_tableBody$$6$$ = $scrollTop$$1_tableBody$$6$$.scrollTop();
    $nativeEvent$$1$$.dataTransfer.setDragImage($bodyClone$$2$$[0], $nativeEvent$$1$$.clientX - $rect$$2_selArray$$2$$.left + $scrollLeft$$2$$, $nativeEvent$$1$$.clientY - $rect$$2_selArray$$2$$.top + $scrollTop$$1_tableBody$$6$$);
    return $bodyClone$$2$$;
  };
  $oj$$14$$.$TableDndContext$.prototype.$_setReorderColumnsDataTransfer$ = function $$oj$$14$$$$TableDndContext$$$$_setReorderColumnsDataTransfer$$($event$$243$$, $columnIdx$$39$$) {
    ...
    $dataTransfer$$1$$.setData("Text", this.$component$.$_DND_REORDER_TABLE_ID_DATA_KEY$ + ":" + $dragImage_tableIdHashCode$$ + ":" + $columnIdx$$39$$);
    $dragImage_tableIdHashCode$$ = this.$_getTableDomUtils$().$createTableHeaderColumnDragImage$($columnIdx$$39$$);
    try {
      $dataTransfer$$1$$.setDragImage($dragImage_tableIdHashCode$$[0], 0, 0);
    } catch ($e$$91$$) {
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$setTableHeaderColumnDraggable$ = function $$oj$$14$$$$TableDndContext$$$$setTableHeaderColumnDraggable$$($columnIdx$$40$$, $draggable$$1$$) {
    if (this.$_isColumnReorderEnabled$()) {
      var $headerColumns$$ = this.$_getTableDomUtils$().$getTableHeaderColumns$();
      if (null != $headerColumns$$ && 0 < $headerColumns$$.length) {
        var $i$$225$$;
        for ($i$$225$$ = 0;$i$$225$$ < $headerColumns$$.length;$i$$225$$++) {
          var $headerColumn$$7$$ = $headerColumns$$[$i$$225$$];
          null != $columnIdx$$40$$ && $i$$225$$ == $columnIdx$$40$$ ? this.$_setHeaderColumnDraggable$($headerColumn$$7$$, $draggable$$1$$) : this.$_clearHeaderColumnDraggable$($headerColumn$$7$$);
        }
      }
    }
  };
  ...
  $oj$$14$$.$TableDomUtils$ = function $$oj$$14$$$$TableDomUtils$$($component$$17$$) {
    this.$component$ = $component$$17$$;
    this.options = $component$$17$$.options;
    this.element = $component$$17$$.element;
    this.Init();
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$createTableBody$ = function $$oj$$14$$$$TableDomUtils$$$$createTableBody$$() {
    var $table$$5$$ = this.$getTable$(), $tableBody$$7$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TBODY$));
    $table$$5$$.append($tableBody$$7$$);
    this.$_cachedDomTableBody$ = $tableBody$$7$$;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$createTableFooter$ = function $$oj$$14$$$$TableDomUtils$$$$createTableFooter$$() {
    var $table$$6$$ = this.$getTable$(), $tableFooter$$2$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TFOOT$)), $tableBody$$8_tableFooterRow$$2_tableHeader$$2$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TR$));
    this.$createTableFooterAccSelect$($tableBody$$8_tableFooterRow$$2_tableHeader$$2$$);
    $tableFooter$$2$$.append($tableBody$$8_tableFooterRow$$2_tableHeader$$2$$);
    $tableBody$$8_tableFooterRow$$2_tableHeader$$2$$ = this.$getTableHeader$();
    null != $tableBody$$8_tableFooterRow$$2_tableHeader$$2$$ ? $tableBody$$8_tableFooterRow$$2_tableHeader$$2$$.after($tableFooter$$2$$) : ($tableBody$$8_tableFooterRow$$2_tableHeader$$2$$ = this.$getTableBody$(), null != $tableBody$$8_tableFooterRow$$2_tableHeader$$2$$ ? $tableBody$$8_tableFooterRow$$2_tableHeader$$2$$.before($tableFooter$$2$$) : $table$$6$$.append($tableFooter$$2$$));
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$createTableHeader$ = function $$oj$$14$$$$TableDomUtils$$$$createTableHeader$$() {
    var $table$$7$$ = this.$getTable$(), $tableHeader$$3$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_THEAD$)), $tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TR$));
    this.$_cachedDomTableHeaderRow$ = $tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$;
    $tableHeader$$3$$.append($tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$);
    $tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$ = this.$getTableFooter$();
    null != $tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$ ? $tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$.before($tableHeader$$3$$) : ($tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$ = this.$getTableBody$(), null != $tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$ ? $tableBody$$9_tableFooter$$3_tableHeaderRow$$2$$.before($tableHeader$$3$$) : $table$$7$$.append($tableHeader$$3$$));
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$createTableHeaderAccSelectRowColumn$ = function $$oj$$14$$$$TableDomUtils$$$$createTableHeaderAccSelectRowColumn$$() {
    var $headerColumn$$8$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TH$));
    $headerColumn$$8$$.addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ACC_SELECT_ROW_CLASS$);
    $headerColumn$$8$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$, this.$getTableId$() + ":" + $oj$$14$$.$TableDomUtils$.$_COLUMN_HEADER_ROW_SELECT_ID$);
    var $selectRowTitle$$1$$ = this.$component$.$getTranslatedString$(this.$component$.$_BUNDLE_KEY$.$_LABEL_SELECT_ROW$);
    $headerColumn$$8$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_TITLE$, $selectRowTitle$$1$$);
    $headerColumn$$8$$.css("padding", "0");
    $headerColumn$$8$$.css("border", "0");
    ...
    $headerColumn$$8$$.append($headerColumnText$$);
    return $headerColumn$$8$$;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$createTableHeaderColumn$ = function $$oj$$14$$$$TableDomUtils$$$$createTableHeaderColumn$$($columnIdx$$43_headerContext$$1$$) {
    var $column$$12$$ = this.$component$.$_getColumnDefs$()[$columnIdx$$43_headerContext$$1$$], $headerColumnCell$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TH$));
    this.$styleTableHeaderColumn$($columnIdx$$43_headerContext$$1$$, $headerColumnCell$$, !0);
    $headerColumnCell$$.attr("abbr", $column$$12$$.headerText);
    $headerColumnCell$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_TITLE$, $column$$12$$.headerText);
    this.$insertTableHeaderColumn$($columnIdx$$43_headerContext$$1$$, $headerColumnCell$$);
    $columnIdx$$43_headerContext$$1$$ = {columnIndex:$columnIdx$$43_headerContext$$1$$, headerContext:{component:this.$component$, parentElement:$headerColumnCell$$}};
    $column$$12$$.sortable == $oj$$14$$.$TableDomUtils$.$_OPTION_ENABLED$ ? ($headerColumnCell$$.attr("data-oj-sortable", $oj$$14$$.$TableDomUtils$.$_OPTION_ENABLED$), $oj$$14$$.$TableRendererUtils$.$columnHeaderSortableIconRenderer$($columnIdx$$43_headerContext$$1$$, null)) : $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultRenderer$($columnIdx$$43_headerContext$$1$$, null);
    return $headerColumnCell$$;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$createTableHeaderColumnDragImage$ = function $$oj$$14$$$$TableDomUtils$$$$createTableHeaderColumnDragImage$$($columnIdx$$44_headerColumnDragImage$$) {
    $columnIdx$$44_headerColumnDragImage$$ = this.$getTableHeaderColumn$($columnIdx$$44_headerColumnDragImage$$).clone();
    $columnIdx$$44_headerColumnDragImage$$.removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_DRAG$);
    $columnIdx$$44_headerColumnDragImage$$.removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_FOCUS$);
    $columnIdx$$44_headerColumnDragImage$$.removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_HOVER$);
    $columnIdx$$44_headerColumnDragImage$$.addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_IMAGE$);
    $columnIdx$$44_headerColumnDragImage$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_POSITION$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_ABSOLUTE$);
    $columnIdx$$44_headerColumnDragImage$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_TOP$, "0");
    $columnIdx$$44_headerColumnDragImage$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_LEFT$, "0");
    $columnIdx$$44_headerColumnDragImage$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_ZINDEX$, "-999");
    this.$getTableContainer$().append($columnIdx$$44_headerColumnDragImage$$);
    return $columnIdx$$44_headerColumnDragImage$$;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$createTableHeaderColumnAccSelect$ = function $$oj$$14$$$$TableDomUtils$$$$createTableHeaderColumnAccSelect$$($columnIdx$$45$$, $columnSelectionMode$$2$$) {
    if ($columnSelectionMode$$2$$ == $oj$$14$$.$TableDomUtils$.$_OPTION_SELECTION_MODES$.$_SINGLE$ || $columnSelectionMode$$2$$ == $oj$$14$$.$TableDomUtils$.$_OPTION_SELECTION_MODES$.$_MULTIPLE$) {
      var $headerColumn$$10$$ = this.$getTableHeaderColumn$($columnIdx$$45$$), $accSelectionHeaderColumn$$ = this.$getTableHeaderColumnAccSelect$($columnIdx$$45$$);
      if (null == $accSelectionHeaderColumn$$) {
        ...
        $accSelectCheckbox$$3$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$, this.$getTableId$() + ":acc_sel_col" + $columnIdx$$45$$);
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$createTableNoDataRow$ = function $$oj$$14$$$$TableDomUtils$$$$createTableNoDataRow$$($columnCount$$) {
    var $tableBody$$10$$ = this.$getTableBody$(), $tableNoDataRow$$ = $$$$14$$(document.createElement($oj$$14$$.$TableDomUtils$.$DOM_ELEMENT$.$_TR$));
    ...
    $tableBody$$10$$.append($tableNoDataRow$$);
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$displayDragOverIndicatorColumn$ = function $$oj$$14$$$$TableDomUtils$$$$displayDragOverIndicatorColumn$$($columnIdx$$46$$, $before$$1$$) {
    this.$removeDragOverIndicatorColumn$();
    var $tableHeaderRow$$3$$ = this.$getTableHeaderRow$(), $columns$$14_tableHeaderColumn$$8$$ = this.$getTableHeaderColumn$($columnIdx$$46$$);
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getElementColumnIdx$ = function $$oj$$14$$$$TableDomUtils$$$$getElementColumnIdx$$($element$$98_tableFooterCell$$2$$) {
    var $tableBodyCell$$5_tableHeaderColumn$$9$$ = this.$getFirstAncestor$($element$$98_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_CLASS$);
    ...
    $tableBodyCell$$5_tableHeaderColumn$$9$$ = this.$getFirstAncestor$($element$$98_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CELL_CLASS$);
    if (null != $tableBodyCell$$5_tableHeaderColumn$$9$$) {
    ...
    $element$$98_tableFooterCell$$2$$ = this.$getFirstAncestor$($element$$98_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$);
    return null != $element$$98_tableFooterCell$$2$$ ? $element$$98_tableFooterCell$$2$$.parent().children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$).index($element$$98_tableFooterCell$$2$$) : null;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getElementRowIdx$ = function $$oj$$14$$$$TableDomUtils$$$$getElementRowIdx$$($element$$99_tableBodyRow$$15$$) {
    $element$$99_tableBodyRow$$15$$ = this.$getFirstAncestor$($element$$99_tableBodyRow$$15$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_CLASS$);
    return null != $element$$99_tableBodyRow$$15$$ ? $element$$99_tableBodyRow$$15$$.index() : null;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getFirstAncestor$ = function $$oj$$14$$$$TableDomUtils$$$$getFirstAncestor$$($element$$100$$, $className$$8$$) {
    var $parents$$1$$;
    if (null == $element$$100$$) {
      return null;
    }
    $element$$100$$ = $$$$14$$($element$$100$$);
    if ($element$$100$$.hasClass($className$$8$$)) {
      return $element$$100$$;
    }
    $parents$$1$$ = $element$$100$$.parents("." + $className$$8$$);
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getScrollLeft$ = function $$oj$$14$$$$TableDomUtils$$$$getScrollLeft$$($element$$101$$) {
    $element$$101$$ = $$$$14$$($element$$101$$);
    var $scrollLeft$$3$$ = $element$$101$$[0].scrollLeft;
    "rtl" === this.$component$.$_GetReadingDirection$() && ($scrollLeft$$3$$ = Math.abs($scrollLeft$$3$$), this.$_isWebkit$() && ($scrollLeft$$3$$ = $element$$101$$[0].scrollWidth - $element$$101$$[0].clientWidth - $scrollLeft$$3$$));
    return $scrollLeft$$3$$;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getTableBody$ = function $$oj$$14$$$$TableDomUtils$$$$getTableBody$$() {
    if (!this.$_cachedDomTableBody$) {
      var $table$$9$$ = this.$getTable$(), $tableBody$$11$$ = null;
      $table$$9$$ && ($tableBody$$11$$ = $table$$9$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_BODY_CLASS$)) && 0 < $tableBody$$11$$.length && (this.$_cachedDomTableBody$ = $$$$14$$($tableBody$$11$$.get(0)));
    }
    return this.$_cachedDomTableBody$;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getTableBodyCell$ = function $$oj$$14$$$$TableDomUtils$$$$getTableBodyCell$$($rowIdx$$28_tableBodyCells$$2$$, $columnIdx$$47$$, $tableBodyRow$$16$$) {
    return($rowIdx$$28_tableBodyCells$$2$$ = this.$getTableBodyCells$($rowIdx$$28_tableBodyCells$$2$$, $tableBodyRow$$16$$)) ? $rowIdx$$28_tableBodyCells$$2$$.length > $columnIdx$$47$$ ? $$$$14$$($rowIdx$$28_tableBodyCells$$2$$[$columnIdx$$47$$]) : null : null;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getTableBodyRow$ = function $$oj$$14$$$$TableDomUtils$$$$getTableBodyRow$$($rowIdx$$31$$) {
    var $tableBodyRows$$10$$ = this.$getTableBodyRows$();
    return $tableBodyRows$$10$$ && null != $rowIdx$$31$$ ? $tableBodyRows$$10$$.length > $rowIdx$$31$$ ? $$$$14$$($tableBodyRows$$10$$[$rowIdx$$31$$]) : null : null;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getTableFooterCell$ = function $$oj$$14$$$$TableDomUtils$$$$getTableFooterCell$$($columnIdx$$48$$) {
    var $tableFooterCells$$ = this.$getTableFooterCells$();
    return null != $tableFooterCells$$ && $tableFooterCells$$.length > $columnIdx$$48$$ ? $$$$14$$($tableFooterCells$$[$columnIdx$$48$$]) : null;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getTableHeaderColumn$ = function $$oj$$14$$$$TableDomUtils$$$$getTableHeaderColumn$$($columnIdx$$49$$) {
    var $headerColumns$$1$$ = this.$getTableHeaderColumns$();
    return $headerColumns$$1$$ ? $headerColumns$$1$$.length > $columnIdx$$49$$ ? $$$$14$$($headerColumns$$1$$[$columnIdx$$49$$]) : null : null;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getTableHeaderColumnAccSelect$ = function $$oj$$14$$$$TableDomUtils$$$$getTableHeaderColumnAccSelect$$($accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$) {
    $accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$ = this.$getTableHeaderColumn$($accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$);
    return null != $accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$ && ($accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$ = $accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ACC_SELECT_COLUMN_CLASS$), null != $accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$ && 0 < $accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$.length) ? $$$$14$$($accSelectionCell$$3_columnIdx$$50_headerColumn$$11$$[0]) : null;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getTableNoDataRow$ = function $$oj$$14$$$$TableDomUtils$$$$getTableNoDataRow$$() {
    var $noDataRow$$2_tableBody$$13$$ = this.$getTableBody$();
    return $noDataRow$$2_tableBody$$13$$ && ($noDataRow$$2_tableBody$$13$$ = $noDataRow$$2_tableBody$$13$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_NO_DATA_ROW_CLASS$)) && 0 < $noDataRow$$2_tableBody$$13$$.length ? $$$$14$$($noDataRow$$2_tableBody$$13$$.get(0)) : null;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$hashCode$ = function $$oj$$14$$$$TableDomUtils$$$$hashCode$$($str$$18$$) {
    ...
    var $charVal$$, $i$$226$$, $strCount$$ = $str$$18$$.length;
    for ($i$$226$$ = 0;$i$$226$$ < $strCount$$;$i$$226$$++) {
      $charVal$$ = $str$$18$$.charCodeAt($i$$226$$), $hash$$1$$ = ($hash$$1$$ << 5) - $hash$$1$$ + $charVal$$, $hash$$1$$ &= $hash$$1$$;
    }
    return $hash$$1$$;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$insertTableBodyCell$ = function $$oj$$14$$$$TableDomUtils$$$$insertTableBodyCell$$($rowIdx$$32$$, $rowKey$$9$$, $rowHashCode$$2$$, $columnIdx$$51$$, $tableBodyCell$$6$$, $tableBodyRow$$20$$) {
    this.$setTableBodyCellAttributes$($rowIdx$$32$$, $rowKey$$9$$, $rowHashCode$$2$$, $columnIdx$$51$$, $tableBodyCell$$6$$);
    $$$$14$$($tableBodyRow$$20$$).append($tableBodyCell$$6$$);
  };
  $oj$$14$$.$TableDomUtils$.prototype.$insertTableBodyRow$ = function $$oj$$14$$$$TableDomUtils$$$$insertTableBodyRow$$($rowIdx$$33$$, $tableBodyRow$$21$$, $row$$13_tableBody$$14$$, $docFrag$$2_tableBodyRows$$11$$) {
    this.$setTableBodyRowAttributes$($row$$13_tableBody$$14$$, $tableBodyRow$$21$$);
    null == $docFrag$$2_tableBodyRows$$11$$ ? ($row$$13_tableBody$$14$$ = this.$getTableBody$(), $docFrag$$2_tableBodyRows$$11$$ = $row$$13_tableBody$$14$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_CLASS$), 0 == $rowIdx$$33$$ ? $row$$13_tableBody$$14$$.prepend($tableBodyRow$$21$$) : $docFrag$$2_tableBodyRows$$11$$.length >= $rowIdx$$33$$ ? $$$$14$$($docFrag$$2_tableBodyRows$$11$$.get($rowIdx$$33$$ - 1)).after($tableBodyRow$$21$$) : $row$$13_tableBody$$14$$.append($tableBodyRow$$21$$)) : 
    $docFrag$$2_tableBodyRows$$11$$.append($tableBodyRow$$21$$);
    this.$clearCachedDomRowData$();
  };
  $oj$$14$$.$TableDomUtils$.prototype.$insertTableFooterCell$ = function $$oj$$14$$$$TableDomUtils$$$$insertTableFooterCell$$($columnIdx$$52$$, $tableFooterCell$$3$$) {
    ...
    0 == $columnIdx$$52$$ ? ($accFooterCell$$1_tableFooterCells$$3$$ = $tableFooterRow$$5$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_HIDDEN_CONTENT_ACC_CLASS$), null != $accFooterCell$$1_tableFooterCells$$3$$ && 0 < $accFooterCell$$1_tableFooterCells$$3$$.length ? $$$$14$$($accFooterCell$$1_tableFooterCells$$3$$[0]).after($tableFooterCell$$3$$) : $tableFooterRow$$5$$.prepend($tableFooterCell$$3$$)) : $tableFooterRow$$5$$.length >= $columnIdx$$52$$ ? $$$$14$$($accFooterCell$$1_tableFooterCells$$3$$.get($columnIdx$$52$$ - 
    1)).after($tableFooterCell$$3$$) : $tableFooterRow$$5$$.append($tableFooterCell$$3$$);
  };
  $oj$$14$$.$TableDomUtils$.prototype.$insertTableHeaderColumn$ = function $$oj$$14$$$$TableDomUtils$$$$insertTableHeaderColumn$$($columnIdx$$53$$, $tableHeaderColumn$$10$$) {
    var $tableHeaderRow$$5$$ = this.$getTableHeaderRow$(), $accSelectionColumn$$1_tableHeaderColumns$$2$$ = this.$getTableHeaderColumns$();
    this.$setTableHeaderColumnAttributes$($columnIdx$$53$$, $tableHeaderColumn$$10$$);
    var $oldTableHeaderColumn$$ = this.$getTableHeaderColumn$($columnIdx$$53$$);
    $oldTableHeaderColumn$$ ? $oldTableHeaderColumn$$.replaceWith($tableHeaderColumn$$10$$) : 0 == $columnIdx$$53$$ ? ($accSelectionColumn$$1_tableHeaderColumns$$2$$ = $tableHeaderRow$$5$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ACC_SELECT_ROW_CLASS$), null != $accSelectionColumn$$1_tableHeaderColumns$$2$$ && 0 < $accSelectionColumn$$1_tableHeaderColumns$$2$$.length ? $$$$14$$($accSelectionColumn$$1_tableHeaderColumns$$2$$[0]).after($tableHeaderColumn$$10$$) : $tableHeaderRow$$5$$.prepend($tableHeaderColumn$$10$$)) : 
    $accSelectionColumn$$1_tableHeaderColumns$$2$$.length >= $columnIdx$$53$$ ? $$$$14$$($accSelectionColumn$$1_tableHeaderColumns$$2$$.get($columnIdx$$53$$ - 1)).after($tableHeaderColumn$$10$$) : $tableHeaderRow$$5$$.append($tableHeaderColumn$$10$$);
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$moveTableBodyRowTouchSelectionAffordanceTop$ = function $$oj$$14$$$$TableDomUtils$$$$moveTableBodyRowTouchSelectionAffordanceTop$$($rowIdx$$34_tableBodyRowRect$$) {
    ...
    if (null != $topAffordance$$2$$) {
      ...
      $topAffordance$$2$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_LEFT$, $tableBody$$15$$.width() / 2 + "px");
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$moveTableBodyRowTouchSelectionAffordanceBottom$ = function $$oj$$14$$$$TableDomUtils$$$$moveTableBodyRowTouchSelectionAffordanceBottom$$($rowIdx$$35_tableBodyRowRect$$1$$) {
    ...
    if (null != $bottomAffordance$$2$$) {
      ...
      var $tableBody$$16$$ = this.$getTableBody$();
      ...
      $bottomAffordance$$2$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_LEFT$, $tableBody$$16$$.width() / 2 + "px");
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$moveTableHeaderColumn$ = function $$oj$$14$$$$TableDomUtils$$$$moveTableHeaderColumn$$($columnIdx$$54_columnsDestMapItem$$, $destColIdx_destIdx$$, $columnDef_event$$245$$) {
    var $columns$$16_i$$227$$ = this.$component$.$_getColumnDefs$(), $tableBodyRows$$12_tableHeaderColumn$$11$$ = this.$getTableHeaderColumn$($columnIdx$$54_columnsDestMapItem$$), $tableFooterCell$$4$$ = this.$getTableFooterCell$($columnIdx$$54_columnsDestMapItem$$), $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = null, $destTableBodyCell$$ = $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = null, $colSpan_columnsOption$$ = 
    null, $afterColumn_columnOption$$ = !1;
    $destColIdx_destIdx$$ == $columns$$16_i$$227$$.length && ($destColIdx_destIdx$$ -= 1, $afterColumn_columnOption$$ = !0);
    null != $tableBodyRows$$12_tableHeaderColumn$$11$$ && ($colSpan_columnsOption$$ = $tableBodyRows$$12_tableHeaderColumn$$11$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_COLSPAN$), $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = this.$getTableHeaderColumn$($destColIdx_destIdx$$), null == $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ || null != $colSpan_columnsOption$$ && 1 != $colSpan_columnsOption$$ || ($afterColumn_columnOption$$ ? $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$.after($tableBodyRows$$12_tableHeaderColumn$$11$$) : 
    $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$.before($tableBodyRows$$12_tableHeaderColumn$$11$$)));
    ...
    $tableBodyRows$$12_tableHeaderColumn$$11$$ = this.$getTableBodyRows$();
    if (null != $tableBodyRows$$12_tableHeaderColumn$$11$$) {
      for ($columns$$16_i$$227$$ = 0;$columns$$16_i$$227$$ < $tableBodyRows$$12_tableHeaderColumn$$11$$.length;$columns$$16_i$$227$$++) {
        $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ = this.$getTableBodyCell$($columns$$16_i$$227$$, $columnIdx$$54_columnsDestMapItem$$, null), null != $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$ && ($destTableBodyCell$$ = this.$getTableBodyCell$($columns$$16_i$$227$$, $destColIdx_destIdx$$, null), $colSpan_columnsOption$$ = $destTableFooterCell_destTableHeaderColumn_tableBodyCell$$7$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_COLSPAN$), null == $destTableBodyCell$$ || 
    ...
    $destColIdx_destIdx$$ = $columnIdx$$54_columnsDestMapItem$$ < $destColIdx_destIdx$$ && !$afterColumn_columnOption$$ ? $destColIdx_destIdx$$ - 1 : $destColIdx_destIdx$$;
    $afterColumn_columnOption$$ = $colSpan_columnsOption$$.splice($columnIdx$$54_columnsDestMapItem$$, 1);
    ...
    this.$component$.option("columns", $colSpan_columnsOption$$, {_context:{$writeback$:!0, originalEvent:$columnDef_event$$245$$, $internalSet$:!0}});
    $columnDef_event$$245$$ = this.$component$.$_columnDefArray$.splice($columnIdx$$54_columnsDestMapItem$$, 1);
    this.$component$.$_columnDefArray$.splice($destColIdx_destIdx$$, 0, $columnDef_event$$245$$[0]);
    if (!this.$_columnsDestMap$) {
      for (this.$_columnsDestMap$ = [], $columns$$16_i$$227$$ = 0;$columns$$16_i$$227$$ < $colSpan_columnsOption$$.length;$columns$$16_i$$227$$++) {
        this.$_columnsDestMap$[$columns$$16_i$$227$$] = $columns$$16_i$$227$$;
      }
    }
    $columnIdx$$54_columnsDestMapItem$$ = this.$_columnsDestMap$.splice($columnIdx$$54_columnsDestMapItem$$, 1);
    this.$_columnsDestMap$.splice($destColIdx_destIdx$$, 0, $columnIdx$$54_columnsDestMapItem$$[0]);
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$removeDragOverIndicatorColumn$ = function $$oj$$14$$$$TableDomUtils$$$$removeDragOverIndicatorColumn$$() {
    var $indicatorElements$$ = this.$getTable$().find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_BEFORE_CLASS$ + ",." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_AFTER_CLASS$), $i$$228$$ = 0;
    if ($indicatorElements$$ && 0 < $indicatorElements$$.length) {
      for (var $indicatorElementsCount$$ = $indicatorElements$$.length, $i$$228$$ = 0;$i$$228$$ < $indicatorElementsCount$$;$i$$228$$++) {
        $$$$14$$($indicatorElements$$[$i$$228$$]).removeClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_BEFORE_CLASS$), $$$$14$$($indicatorElements$$[$i$$228$$]).removeClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_DRAG_INDICATOR_AFTER_CLASS$);
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$removeDragOverIndicatorRow$ = function $$oj$$14$$$$TableDomUtils$$$$removeDragOverIndicatorRow$$() {
    var $indicatorRowAfterElements_tableBody$$17$$ = this.$getTableBody$(), $indicatorRowAfterElementsCount_indicatorRowBeforeElements$$ = $indicatorRowAfterElements_tableBody$$17$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_DRAG_INDICATOR_BEFORE_CLASS$), $indicatorRowAfterElements_tableBody$$17$$ = $indicatorRowAfterElements_tableBody$$17$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_DRAG_INDICATOR_AFTER_CLASS$), $i$$229$$ = 0;
    if ($indicatorRowAfterElementsCount_indicatorRowBeforeElements$$ && 0 < $indicatorRowAfterElementsCount_indicatorRowBeforeElements$$.length) {
      for (var $indicatorRowBeforeElementsCount$$ = $indicatorRowAfterElementsCount_indicatorRowBeforeElements$$.length, $i$$229$$ = 0;$i$$229$$ < $indicatorRowBeforeElementsCount$$;$i$$229$$++) {
        $$$$14$$($indicatorRowAfterElementsCount_indicatorRowBeforeElements$$[$i$$229$$]).remove();
      }
    }
    if ($indicatorRowAfterElements_tableBody$$17$$ && 0 < $indicatorRowAfterElements_tableBody$$17$$.length) {
      for ($indicatorRowAfterElementsCount_indicatorRowBeforeElements$$ = $indicatorRowAfterElements_tableBody$$17$$.length, $i$$229$$ = 0;$i$$229$$ < $indicatorRowAfterElementsCount_indicatorRowBeforeElements$$;$i$$229$$++) {
        $$$$14$$($indicatorRowAfterElements_tableBody$$17$$[$i$$229$$]).remove();
      }
    }
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$removeTableBodyRowTouchSelectionAffordance$ = function $$oj$$14$$$$TableDomUtils$$$$removeTableBodyRowTouchSelectionAffordance$$() {
    ...
    if (null != $touchAffordance$$ && 0 < $touchAffordance$$.length) {
      var $i$$230$$;
      for ($i$$230$$ = 0;$i$$230$$ < $touchAffordance$$.length;$i$$230$$++) {
        $touchAffordance$$[$i$$230$$].remove();
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$removeTableHeaderColumnDragImage$ = function $$oj$$14$$$$TableDomUtils$$$$removeTableHeaderColumnDragImage$$() {
    ...
    if ($headerDragImage$$ && 0 < $headerDragImage$$.length) {
      var $i$$231$$, $headerDragImageCount$$ = $headerDragImage$$.length;
      for ($i$$231$$ = 0;$i$$231$$ < $headerDragImageCount$$;$i$$231$$++) {
        $$$$14$$($headerDragImage$$[$i$$231$$]).remove();
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$setScrollLeft$ = function $$oj$$14$$$$TableDomUtils$$$$setScrollLeft$$($element$$102$$, $scrollLeft$$4$$) {
    $element$$102$$ = $$$$14$$($element$$102$$);
    "rtl" === this.$component$.$_GetReadingDirection$() && ($scrollLeft$$4$$ = Math.abs($scrollLeft$$4$$), this.$_isWebkit$() ? $scrollLeft$$4$$ = $element$$102$$[0].scrollWidth - $element$$102$$[0].clientWidth - $scrollLeft$$4$$ : this.$_isFF$() && ($scrollLeft$$4$$ *= -1));
    $element$$102$$[0].scrollLeft != $scrollLeft$$4$$ && ($element$$102$$[0].scrollLeft = $scrollLeft$$4$$);
  };
  $oj$$14$$.$TableDomUtils$.prototype.$setTableBodyCellAttributes$ = function $$oj$$14$$$$TableDomUtils$$$$setTableBodyCellAttributes$$($headers$$3_rowIdx$$37_rowKeyStr$$1$$, $rowKey$$10$$, $cellRowHeaderId_rowHashCode$$3_rowKeyStrHashCode$$1$$, $column$$13_columnIdx$$55$$, $tableBodyCell$$8$$) {
    var $accessibility$$ = this.options.accessibility;
    $column$$13_columnIdx$$55$$ = this.$component$.$_getColumnDefs$()[$column$$13_columnIdx$$55$$];
    ...
    $headers$$3_rowIdx$$37_rowKeyStr$$1$$ = this.$getTableId$() + ":" + $column$$13_columnIdx$$55$$.id;
    $rowHeaderColumnId$$ == $column$$13_columnIdx$$55$$.id ? ($tableBodyCell$$8$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$, $cellRowHeaderId_rowHashCode$$3_rowKeyStrHashCode$$1$$), $isTableHeaderless$$2$$ && ($headers$$3_rowIdx$$37_rowKeyStr$$1$$ = "")) : $headers$$3_rowIdx$$37_rowKeyStr$$1$$ = $isTableHeaderless$$2$$ ? $cellRowHeaderId_rowHashCode$$3_rowKeyStrHashCode$$1$$ : $headers$$3_rowIdx$$37_rowKeyStr$$1$$ + " " + $cellRowHeaderId_rowHashCode$$3_rowKeyStrHashCode$$1$$;
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$setTableHeaderColumnAttributes$ = function $$oj$$14$$$$TableDomUtils$$$$setTableHeaderColumnAttributes$$($columnIdx$$56$$, $tableHeaderColumn$$12$$) {
    var $column$$14$$ = this.$component$.$_getColumnDefs$()[$columnIdx$$56$$];
    $tableHeaderColumn$$12$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$) || $tableHeaderColumn$$12$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_ID$, this.$getTableId$() + ":" + $column$$14$$.id);
  };
  $oj$$14$$.$TableDomUtils$.prototype.$setTableColumnCellsClass$ = function $$oj$$14$$$$TableDomUtils$$$$setTableColumnCellsClass$$($columnIdx$$57_tableBodyCells$$5$$, $add$$7$$, $styleClass$$2$$) {
    var $i$$232_tableBodyRows$$13$$ = this.$getTableBodyRows$();
    if (null != $i$$232_tableBodyRows$$13$$ && 0 < $i$$232_tableBodyRows$$13$$.length) {
      if (null === $columnIdx$$57_tableBodyCells$$5$$) {
        if ($columnIdx$$57_tableBodyCells$$5$$ = null, $columnIdx$$57_tableBodyCells$$5$$ = $add$$7$$ ? this.$getTableBody$().find("[td]") : this.$getTableBody$().find("." + $styleClass$$2$$), null != $columnIdx$$57_tableBodyCells$$5$$ && 0 < $columnIdx$$57_tableBodyCells$$5$$.length) {
          for (var $tableBodyCell$$9_tableBodyCellsCount$$2$$ = $columnIdx$$57_tableBodyCells$$5$$.length, $i$$232_tableBodyRows$$13$$ = 0;$i$$232_tableBodyRows$$13$$ < $tableBodyCell$$9_tableBodyCellsCount$$2$$;$i$$232_tableBodyRows$$13$$++) {
            $add$$7$$ ? $$$$14$$($columnIdx$$57_tableBodyCells$$5$$[$i$$232_tableBodyRows$$13$$]).addClass($styleClass$$2$$) : $$$$14$$($columnIdx$$57_tableBodyCells$$5$$[$i$$232_tableBodyRows$$13$$]).removeClass($styleClass$$2$$);
          }
        }
      } else {
        for (var $tableBodyRowsCount$$5$$ = $i$$232_tableBodyRows$$13$$.length, $i$$232_tableBodyRows$$13$$ = 0;$i$$232_tableBodyRows$$13$$ < $tableBodyRowsCount$$5$$;$i$$232_tableBodyRows$$13$$++) {
          $tableBodyCell$$9_tableBodyCellsCount$$2$$ = this.$getTableBodyCell$($i$$232_tableBodyRows$$13$$, $columnIdx$$57_tableBodyCells$$5$$, null), $add$$7$$ ? $$$$14$$($tableBodyCell$$9_tableBodyCellsCount$$2$$).addClass($styleClass$$2$$) : $$$$14$$($tableBodyCell$$9_tableBodyCellsCount$$2$$).removeClass($styleClass$$2$$);
        }
      }
    }
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$styleInitialTable$ = function $$oj$$14$$$$TableDomUtils$$$$styleInitialTable$$() {
    ...
    this.$styleTableBody$($tableBody$$18$$);
  };
  $oj$$14$$.$TableDomUtils$.prototype.$styleTableBody$ = function $$oj$$14$$$$TableDomUtils$$$$styleTableBody$$($tableBody$$19$$) {
    $tableBody$$19$$.addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_BODY_CLASS$);
    $tableBody$$19$$.attr($oj$$14$$.Components.$_OJ_CONTAINER_ATTR$, this.$component$.widgetName);
  };
  $oj$$14$$.$TableDomUtils$.prototype.$styleTableBodyCell$ = function $$oj$$14$$$$TableDomUtils$$$$styleTableBodyCell$$($column$$15_columnIdx$$58$$, $tableBodyCell$$10$$, $isNew$$3$$) {
    $column$$15_columnIdx$$58$$ = this.$component$.$_getColumnDefs$()[$column$$15_columnIdx$$58$$];
    if ($isNew$$3$$ || !$tableBodyCell$$10$$.hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_CLASS$)) {
      $tableBodyCell$$10$$.addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_CLASS$), null == $column$$15_columnIdx$$58$$.style || !$isNew$$3$$ && $tableBodyCell$$10$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$) == $column$$15_columnIdx$$58$$.style || $tableBodyCell$$10$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, $column$$15_columnIdx$$58$$.style), null == $column$$15_columnIdx$$58$$.className || !$isNew$$3$$ && $tableBodyCell$$10$$.hasClass($column$$15_columnIdx$$58$$.className) || 
      $tableBodyCell$$10$$.addClass($column$$15_columnIdx$$58$$.className);
    }
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$styleTableFooterCell$ = function $$oj$$14$$$$TableDomUtils$$$$styleTableFooterCell$$($columnIdx$$59$$, $tableFooterCell$$5$$) {
    this.$component$.$_getColumnDefs$();
    var $column$$16$$ = this.$component$.$_getColumnDefs$()[$columnIdx$$59$$];
    $tableFooterCell$$5$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, $column$$16$$.footerStyle);
    ...
    $column$$16$$.footerClassName && $tableFooterCell$$5$$.addClass($column$$16$$.footerClassName);
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$styleTableHeaderColumn$ = function $$oj$$14$$$$TableDomUtils$$$$styleTableHeaderColumn$$($column$$17_columnIdx$$60$$, $tableHeaderColumn$$13$$, $isNew$$5$$) {
    $column$$17_columnIdx$$60$$ = this.$component$.$_getColumnDefs$()[$column$$17_columnIdx$$60$$];
    if ($isNew$$5$$ || !$tableHeaderColumn$$13$$.hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CELL_CLASS$)) {
      $tableHeaderColumn$$13$$.addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CELL_CLASS$), this.$_isVerticalGridEnabled$() && (!$isNew$$5$$ && $tableHeaderColumn$$13$$.hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_VGRID_LINES_CLASS$) || $tableHeaderColumn$$13$$.addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_VGRID_LINES_CLASS$)), null == $column$$17_columnIdx$$60$$.headerStyle || !$isNew$$5$$ && $tableHeaderColumn$$13$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$) == 
      $column$$17_columnIdx$$60$$.headerStyle || $tableHeaderColumn$$13$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, $column$$17_columnIdx$$60$$.headerStyle), null == $column$$17_columnIdx$$60$$.headerClassName || !$isNew$$5$$ && $tableHeaderColumn$$13$$.hasClass($column$$17_columnIdx$$60$$.headerClassName) || $tableHeaderColumn$$13$$.addClass($column$$17_columnIdx$$60$$.headerClassName);
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$_getColspanLogicalElements$ = function $$oj$$14$$$$TableDomUtils$$$$_getColspanLogicalElements$$($elementArray$$) {
    var $i$$233$$, $j$$33$$, $indexedElementArrayNum$$ = 0, $indexedElementArray$$ = [], $elementArrayCount$$ = $elementArray$$.length;
    for ($i$$233$$ = 0;$i$$233$$ < $elementArrayCount$$;$i$$233$$++) {
      var $colSpan$$1$$ = $$$$14$$($elementArray$$[$i$$233$$]).attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_COLSPAN$);
      if (null != $colSpan$$1$$) {
        $colSpan$$1$$ = parseInt($colSpan$$1$$, 10);
        for ($j$$33$$ = 0;$j$$33$$ < $colSpan$$1$$;$j$$33$$++) {
          $indexedElementArray$$[$indexedElementArrayNum$$ + $j$$33$$] = $elementArray$$[$i$$233$$];
        }
        $indexedElementArrayNum$$ += $colSpan$$1$$;
      } else {
        $indexedElementArray$$[$indexedElementArrayNum$$++] = $elementArray$$[$i$$233$$];
      }
    }
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_refreshTableDimensions$ = function $$oj$$14$$$$TableDomUtils$$$$_refreshTableDimensions$$($scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$, $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$, $resetScrollTop$$3$$, $resetScrollLeft$$3$$) {
    var $caption_table$$15_tableHeaderHeight$$ = this.$getTable$(), $tableDivScroller$$2_tableHeader$$8$$ = this.$getTableHeader$(), $tableFooter$$8$$ = this.$getTableFooter$(), $tableBodyHeight_tableFooterRow$$7$$ = this.$getTableFooterRow$(), $tableFooterHeight_tableHeaderRow$$7$$ = this.$getTableHeaderRow$(), $tableContainer$$22$$ = this.$getTableContainer$(), $tableBody$$20$$ = this.$getTableBody$(), $scrollTop$$2$$ = null, $scrollLeft$$5$$ = null;
    if (null != this.$getScroller$()) {
      ...
      0 < $maxScrollTop_tableContainerScrollableState$$ && ($scrollTop$$2$$ = this.$getScroller$()[0].scrollTop);
      0 < $captionHeight_maxScrollLeft$$2$$ && ($scrollLeft$$5$$ = this.$getScrollLeft$(this.$getScroller$()[0]));
    }
    ...
    if (null != $tableBody$$20$$) {
      if (this.$_tableHeightConstrained$ || this.$_tableWidthConstrained$) {
        this.$_tableDimensions$ || (this.$_tableDimensions$ = {}), 0 < $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$ || 0 < $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ ? (0 < $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$ && this.$_tableWidthConstrained$ && (this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$] = $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$), 0 < $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ && 
        this.$_tableHeightConstrained$ && (this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_HEIGHT$] = $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$)) : (this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_HEIGHT$] = this.$_tableHeightConstrained$ ? $tableContainer$$22$$[0].offsetHeight : 0, this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$] = this.$_tableWidthConstrained$ ? $tableContainer$$22$$[0].offsetWidth : 0), this.$_tableBorderWidth$ || 
        ...
        $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $maxScrollTop_tableContainerScrollableState$$ = this.$isTableContainerScrollable$(), 1 === $maxScrollTop_tableContainerScrollableState$$[1] && $caption_table$$15_tableHeaderHeight$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, $tableContainer$$22$$.get(0).clientWidth + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$)), $tableContainer$$22$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW$, "")), $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ = 
        ...
        $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_BLOCK$), $tableBodyHeight_tableFooterRow$$7$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_DISPLAY$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_BLOCK$), $tableBodyHeight_tableFooterRow$$7$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_POSITION$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_RELATIVE$)), $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_DISPLAY$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_BLOCK$), $tableBodyHeight_tableFooterRow$$7$$ = 0, this.$isDivScroller$() || 
        ($tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_Y$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_AUTO$), $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_POSITION$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_RELATIVE$), this.$_tableWidthConstrained$ ? $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$] - this.$_tableBorderWidth$) : 0 < $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$ && 
        $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ - this.$_tableBorderWidth$ + $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$), $tableBody$$20$$.width(), null != $tableFooter$$8$$ && ($tableFooterHeight_tableHeaderRow$$7$$ = $tableFooter$$8$$.outerHeight(), $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_TOP$, -1 * $tableFooterHeight_tableHeaderRow$$7$$ + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$)), 
        this.$_tableHeightConstrained$ ? ($tableBodyHeight_tableFooterRow$$7$$ = this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_HEIGHT$] - $caption_table$$15_tableHeaderHeight$$ - $tableFooterHeight_tableHeaderRow$$7$$ - $captionHeight_maxScrollLeft$$2$$ - this.$_tableBorderHeight$, 0 < $tableBodyHeight_tableFooterRow$$7$$ && ($tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_HEIGHT$, $tableBodyHeight_tableFooterRow$$7$$ + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_HEIGHT$, 
        $tableBodyHeight_tableFooterRow$$7$$ + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$))) : $tableBodyHeight_tableFooterRow$$7$$ = $tableBody$$20$$.outerHeight(), $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$ = this.$getScrollbarWidth$(), this.$_tableWidthConstrained$ ? ($height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ = this.$getTableBodyRows$(), null != $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ && 0 < $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$.length ? 
        ($tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_X$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_AUTO$), $tableContainer$$22$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_X$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_HIDDEN$), $tableContainer$$22$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_Y$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_HIDDEN$), null != $tableDivScroller$$2_tableHeader$$8$$ && ($height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ = this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$] - 
        this.$_tableBorderWidth$, 0 < $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ && (0 < $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$ ? $tableDivScroller$$2_tableHeader$$8$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ - $scrollbarWidth$$2_tableContainerScrollbarWidth_width$$20$$ + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$) : $tableDivScroller$$2_tableHeader$$8$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, 
        $height$$16_tableBodyRows$$14_tableHeaderWidth_tableWidth$$ + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$)))) : ($tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_X$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_HIDDEN$), $tableContainer$$22$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_X$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_AUTO$), $tableContainer$$22$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_Y$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_HIDDEN$))) : $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW_X$, 
        ...
        $tableDivScroller$$2_tableHeader$$8$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_HEIGHT$, this.$_tableDimensions$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_HEIGHT$] - $caption_table$$15_tableHeaderHeight$$ - $tableFooterHeight_tableHeaderRow$$7$$), $tableBody$$20$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_FLOAT$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_LEFT$), $tableContainer$$22$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_OVERFLOW$, $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_HIDDEN$)), null != 
      ...
      null == $scrollTop$$2$$ || $resetScrollTop$$3$$ ? $resetScrollTop$$3$$ && (this.$getScroller$()[0].scrollTop = 0, this.$getScroller$().scroll()) : ($maxScrollTop_tableContainerScrollableState$$ = this.$getScroller$()[0].scrollHeight - this.$getScroller$()[0].clientHeight, $scrollTop$$2$$ = $scrollTop$$2$$ > $maxScrollTop_tableContainerScrollableState$$ ? $maxScrollTop_tableContainerScrollableState$$ : $scrollTop$$2$$, this.$component$.$_isLoadMoreOnScroll$() && $maxScrollTop_tableContainerScrollableState$$ == 
      $scrollTop$$2$$ && $scrollTop$$2$$--, this.$getScroller$()[0].scrollTop = $scrollTop$$2$$, this.$getScroller$().scroll());
      null == $scrollLeft$$5$$ || $resetScrollLeft$$3$$ ? $resetScrollLeft$$3$$ && (this.$setScrollLeft$(this.$getScroller$()[0], 0), this.$getScroller$().scroll()) : (this.$setScrollLeft$(this.$getScroller$()[0], $scrollLeft$$5$$), this.$getScroller$().scroll());
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$refreshTableStatusPosition$ = function $$oj$$14$$$$TableDomUtils$$$$refreshTableStatusPosition$$() {
    var $isRTL$$4_tableContainer$$23$$ = this.$getTableContainer$(), $tableBody$$21_tableStatusMessageText$$ = this.$getTableBody$(), $msgTextOptions_tableStatusMessage$$2$$ = this.$getTableStatusMessage$(), $options$$246_overTableElement$$ = $isRTL$$4_tableContainer$$23$$;
    0 < $tableBody$$21_tableStatusMessageText$$.height() && ($options$$246_overTableElement$$ = $tableBody$$21_tableStatusMessageText$$);
    $msgTextOptions_tableStatusMessage$$2$$ && $msgTextOptions_tableStatusMessage$$2$$[0].offsetParent && ($msgTextOptions_tableStatusMessage$$2$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_HEIGHT$, $tableBody$$21_tableStatusMessageText$$.height() + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $msgTextOptions_tableStatusMessage$$2$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, $tableBody$$21_tableStatusMessageText$$.width() + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $tableBody$$21_tableStatusMessageText$$ = 
    ...
    $msgTextOptions_tableStatusMessage$$2$$ = {my:"center", at:"center", collision:"none", of:$msgTextOptions_tableStatusMessage$$2$$}, $msgTextOptions_tableStatusMessage$$2$$ = $oj$$14$$.$PositionUtils$.$normalizeHorizontalAlignment$($msgTextOptions_tableStatusMessage$$2$$, $isRTL$$4_tableContainer$$23$$), $tableBody$$21_tableStatusMessageText$$.position($msgTextOptions_tableStatusMessage$$2$$));
  };
  $oj$$14$$.$TableDomUtils$.prototype.$_removeHeaderColumnAndCellColumnWidths$ = function $$oj$$14$$$$TableDomUtils$$$$_removeHeaderColumnAndCellColumnWidths$$() {
    var $i$$234_tableBodyRows$$15$$, $headerColumn$$12_tableBodyCell$$11$$, $columnCount$$2$$ = this.$component$.$_getColumnDefs$().length;
    for ($i$$234_tableBodyRows$$15$$ = 0;$i$$234_tableBodyRows$$15$$ < $columnCount$$2$$;$i$$234_tableBodyRows$$15$$++) {
      $headerColumn$$12_tableBodyCell$$11$$ = this.$getTableHeaderColumn$($i$$234_tableBodyRows$$15$$), null != $headerColumn$$12_tableBodyCell$$11$$ && $headerColumn$$12_tableBodyCell$$11$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, "");
    }
    $i$$234_tableBodyRows$$15$$ = this.$getTableBodyRows$();
    if (null != $i$$234_tableBodyRows$$15$$ && 0 < $i$$234_tableBodyRows$$15$$.length) {
      for ($i$$234_tableBodyRows$$15$$ = 0;$i$$234_tableBodyRows$$15$$ < $columnCount$$2$$;$i$$234_tableBodyRows$$15$$++) {
        $headerColumn$$12_tableBodyCell$$11$$ = this.$getTableBodyCell$(0, $i$$234_tableBodyRows$$15$$, null), null != $headerColumn$$12_tableBodyCell$$11$$ && $headerColumn$$12_tableBodyCell$$11$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, "");
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$_removeTableBodyRowBottomBorder$ = function $$oj$$14$$$$TableDomUtils$$$$_removeTableBodyRowBottomBorder$$($underflow$$) {
    if (this.$_isHorizontalGridEnabled$()) {
      var $lastTableBodyRow_tableBodyRows$$16$$ = this.$getTableBodyRows$();
      if (null != $lastTableBodyRow_tableBodyRows$$16$$ && 0 < $lastTableBodyRow_tableBodyRows$$16$$.length) {
        var $i$$235$$, $tableBodyRowsCount$$6$$ = $lastTableBodyRow_tableBodyRows$$16$$.length;
        for ($i$$235$$ = 0;$i$$235$$ < $tableBodyRowsCount$$6$$;$i$$235$$++) {
          $$$$14$$($lastTableBodyRow_tableBodyRows$$16$$[$i$$235$$]).hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_HGRID_LINES_CLASS$) || $$$$14$$($lastTableBodyRow_tableBodyRows$$16$$[$i$$235$$]).addClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_HGRID_LINES_CLASS$);
        }
        $lastTableBodyRow_tableBodyRows$$16$$ = $$$$14$$($lastTableBodyRow_tableBodyRows$$16$$[$lastTableBodyRow_tableBodyRows$$16$$.length - 1]);
        $underflow$$ || $lastTableBodyRow_tableBodyRows$$16$$.removeClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_HGRID_LINES_CLASS$);
      }
    }
  };
  $oj$$14$$.$TableDomUtils$.prototype.$_removeTableDimensionsStyling$ = function $$oj$$14$$$$TableDomUtils$$$$_removeTableDimensionsStyling$$() {
    var $table$$16$$ = this.$getTable$(), $headerColumnTextDivs_tableHeader$$9$$ = this.$getTableHeader$(), $i$$236_tableHeaderRow$$8$$ = this.$getTableHeaderRow$(), $tableFooter$$9$$ = this.$getTableFooter$(), $tableFooterRow$$8$$ = this.$getTableFooterRow$(), $tableBody$$22$$ = this.$getTableBody$();
    if (null != $headerColumnTextDivs_tableHeader$$9$$ && ($headerColumnTextDivs_tableHeader$$9$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, ""), $i$$236_tableHeaderRow$$8$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, ""), ($headerColumnTextDivs_tableHeader$$9$$ = $i$$236_tableHeaderRow$$8$$.find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_TEXT_CLASS$)) && 0 < $headerColumnTextDivs_tableHeader$$9$$.length)) {
      for (var $headerColumnTextDivsCount$$ = $headerColumnTextDivs_tableHeader$$9$$.length, $i$$236_tableHeaderRow$$8$$ = 0;$i$$236_tableHeaderRow$$8$$ < $headerColumnTextDivsCount$$;$i$$236_tableHeaderRow$$8$$++) {
        $$$$14$$($headerColumnTextDivs_tableHeader$$9$$[$i$$236_tableHeaderRow$$8$$]).css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, "");
      }
    }
    ...
    null != $tableBody$$22$$ && $tableBody$$22$$.attr($oj$$14$$.$TableDomUtils$.$DOM_ATTR$.$_STYLE$, "");
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_setColumnWidths$ = function $$oj$$14$$$$TableDomUtils$$$$_setColumnWidths$$() {
    var $columnWidths$$ = [], $columnPaddingWidths$$ = [], $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = null, $adjustedColumnWidths_defaultColumnPaddingWidth$$, $defaultTableBodyCellPaddingWidth_footerCell$$1$$, $headerColumnTextDivHeight_headerRenderer$$1$$, $i$$237_tableBodyRows$$17$$, $headerColumnCellStyle_headerColumnTextDiv$$, $columnsCount$$10$$ = this.$component$.$_getColumnDefs$().length;
    for ($i$$237_tableBodyRows$$17$$ = 0;$i$$237_tableBodyRows$$17$$ < $columnsCount$$10$$;$i$$237_tableBodyRows$$17$$++) {
      $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = this.$getTableHeaderColumn$($i$$237_tableBodyRows$$17$$), null != $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ && ($headerColumnCellStyle_headerColumnTextDiv$$ = window.getComputedStyle($adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$[0]), 
      $columnWidths$$[$i$$237_tableBodyRows$$17$$] = parseInt($headerColumnCellStyle_headerColumnTextDiv$$[$oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$], 10), $headerColumnTextDivHeight_headerRenderer$$1$$ = this.$component$.$_getColumnRenderer$($i$$237_tableBodyRows$$17$$, "header"), $adjustedColumnWidths_defaultColumnPaddingWidth$$ || null != $headerColumnTextDivHeight_headerRenderer$$1$$ ? $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] = null != $headerColumnTextDivHeight_headerRenderer$$1$$ ? 
      ...
      10), $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] = $adjustedColumnWidths_defaultColumnPaddingWidth$$), $headerColumnTextDivHeight_headerRenderer$$1$$ = null, ($headerColumnCellStyle_headerColumnTextDiv$$ = $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$.find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_TEXT_CLASS$)) && 0 < $headerColumnCellStyle_headerColumnTextDiv$$.length && 
    ...
    $i$$237_tableBodyRows$$17$$ = this.$getTableBodyRows$();
    if (null != $i$$237_tableBodyRows$$17$$ && 0 < $i$$237_tableBodyRows$$17$$.length) {
      for ($i$$237_tableBodyRows$$17$$ = 0;$i$$237_tableBodyRows$$17$$ < $columnsCount$$10$$;$i$$237_tableBodyRows$$17$$++) {
        $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = this.$getTableBodyCell$(0, $i$$237_tableBodyRows$$17$$, null), null != $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ && (this.$component$.$_getColumnRenderer$($i$$237_tableBodyRows$$17$$, "cell"), this.$component$.$_hasRowOrCellRenderer$($i$$237_tableBodyRows$$17$$) ? 
        ...
        $defaultTableBodyCellPaddingWidth_footerCell$$1$$), $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ > $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] ? $columnWidths$$[$i$$237_tableBodyRows$$17$$] - $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ + 
        $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] : $columnWidths$$[$i$$237_tableBodyRows$$17$$] + $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] - $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$, $adjustedColumnWidths_defaultColumnPaddingWidth$$[$i$$237_tableBodyRows$$17$$] = $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$)
        ;
      }
    }
    for ($i$$237_tableBodyRows$$17$$ = 0;$i$$237_tableBodyRows$$17$$ < $columnsCount$$10$$;$i$$237_tableBodyRows$$17$$++) {
      ...
      $columnWidths$$[$i$$237_tableBodyRows$$17$$] + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = this.$getTableBodyCell$(0, $i$$237_tableBodyRows$$17$$, null), null != $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ && $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, 
      $adjustedColumnWidths_defaultColumnPaddingWidth$$[$i$$237_tableBodyRows$$17$$] + $oj$$14$$.$TableDomUtils$.$CSS_VAL$.$_PX$), $defaultTableBodyCellPaddingWidth_footerCell$$1$$ = this.$getTableFooterCell$($i$$237_tableBodyRows$$17$$), null != $defaultTableBodyCellPaddingWidth_footerCell$$1$$ && ($adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = parseInt($defaultTableBodyCellPaddingWidth_footerCell$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_RIGHT$), 
      10) + parseInt($defaultTableBodyCellPaddingWidth_footerCell$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_PADDING_LEFT$), 10), $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ = $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ > $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] ? $columnWidths$$[$i$$237_tableBodyRows$$17$$] - 
      $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$ + $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] : $columnWidths$$[$i$$237_tableBodyRows$$17$$] + $columnPaddingWidths$$[$i$$237_tableBodyRows$$17$$] - $adjustedColumnWidth_footerPaddingWidth_headerColumnCell$$1_headerColumnDiv_tableBodyCell$$12_tableBodyCellPaddingWidth_tableBodyCellStyle$$, $defaultTableBodyCellPaddingWidth_footerCell$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_MIN_WIDTH$, 
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$_setHeaderColumnOverflowWidths$ = function $$oj$$14$$$$TableDomUtils$$$$_setHeaderColumnOverflowWidths$$() {
    var $columns$$19$$ = this.$component$.$_getColumnDefs$(), $i$$238$$, $column$$18_headerColumnTextDivWidth$$, $headerColumnCell$$2_newHeaderColumnTextDivWidth$$, $headerColumnDiv$$1$$, $headerColumnTextDiv$$1$$, $sortPlaceHolderDivWidth$$, $columnsCount$$11$$ = $columns$$19$$.length;
    for ($i$$238$$ = 0;$i$$238$$ < $columnsCount$$11$$;$i$$238$$++) {
      $column$$18_headerColumnTextDivWidth$$ = $columns$$19$$[$i$$238$$], $headerColumnCell$$2_newHeaderColumnTextDivWidth$$ = this.$getTableHeaderColumn$($i$$238$$), null != $headerColumnCell$$2_newHeaderColumnTextDivWidth$$ && ($headerColumnDiv$$1$$ = $headerColumnCell$$2_newHeaderColumnTextDivWidth$$.children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CLASS$), 0 < $headerColumnDiv$$1$$.length && ($headerColumnDiv$$1$$ = $$$$14$$($headerColumnDiv$$1$$[0]), ($headerColumnTextDiv$$1$$ = 
      $headerColumnCell$$2_newHeaderColumnTextDivWidth$$.find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_TEXT_CLASS$)) && 0 < $headerColumnTextDiv$$1$$.length && ($sortPlaceHolderDivWidth$$ = 0, $column$$18_headerColumnTextDivWidth$$.sortable == $oj$$14$$.$TableDomUtils$.$_OPTION_ENABLED$ && ($sortPlaceHolderDivWidth$$ = $$$$14$$($headerColumnCell$$2_newHeaderColumnTextDivWidth$$.find("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_SORT_PACEHOLDER_CLASS$).get(0)).width()), 
      0 < $headerColumnDiv$$1$$[0].clientWidth && $headerColumnTextDiv$$1$$.width() + $sortPlaceHolderDivWidth$$ > $headerColumnDiv$$1$$[0].clientWidth && ($headerColumnTextDiv$$1$$.css($oj$$14$$.$TableDomUtils$.$CSS_PROP$.$_WIDTH$, ""), $column$$18_headerColumnTextDivWidth$$ = $headerColumnTextDiv$$1$$.width(), $headerColumnCell$$2_newHeaderColumnTextDivWidth$$ = $headerColumnCell$$2_newHeaderColumnTextDivWidth$$.width() - $sortPlaceHolderDivWidth$$, $column$$18_headerColumnTextDivWidth$$ > $headerColumnCell$$2_newHeaderColumnTextDivWidth$$ + 
  ...
  $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderDefaultRenderer$$($context$$65$$, $delegateRenderer$$2$$) {
    var $headerContentDiv_parentElement$$1$$ = $$$$14$$($context$$65$$.headerContext.parentElement), $headerColumnDiv$$2$$ = $$$$14$$(document.createElement("div"));
    ...
    null != $delegateRenderer$$2$$ ? $delegateRenderer$$2$$($headerContentDiv_parentElement$$1$$) : this.$columnHeaderDefaultTextRenderer$($headerContentDiv_parentElement$$1$$, $context$$65$$);
  };
  $oj$$14$$.$TableRendererUtils$.$columnHeaderSortableIconRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderSortableIconRenderer$$($context$$66$$, $delegateRenderer$$3$$) {
    var $component$$18_headerContentDiv$$1$$ = $context$$66$$.headerContext.component, $headerColumnAscDiv_headerColumnDscDiv_headerColumnSortPlaceholderDiv_parentElement$$2$$ = $$$$14$$($context$$66$$.headerContext.parentElement), $headerColumnDiv$$3$$ = $$$$14$$(document.createElement("div"));
    ...
    null != $delegateRenderer$$3$$ ? $delegateRenderer$$3$$($component$$18_headerContentDiv$$1$$) : this.$columnHeaderDefaultTextRenderer$($component$$18_headerContentDiv$$1$$, $context$$66$$);
  };
  $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultTextRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderDefaultTextRenderer$$($headerContentDiv$$2$$, $context$$67$$) {
    var $column$$19_columnIdx$$61$$ = $context$$67$$.columnIndex, $column$$19_columnIdx$$61$$ = $context$$67$$.headerContext.component.$_getColumnDefs$()[$column$$19_columnIdx$$61$$];
    $headerContentDiv$$2$$.text($column$$19_columnIdx$$61$$.headerText);
  };
  $oj$$14$$.$TableRendererUtils$.$tableBodyRowDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$tableBodyRowDefaultRenderer$$($rowIdx$$38$$, $row$$15$$, $context$$68$$) {
    var $component$$20_j$$34$$ = $context$$68$$.rowContext.component, $columnsCount$$12_tableBodyRow$$27$$ = $$$$14$$($context$$68$$.rowContext.parentElement), $rowHashCode$$4$$ = $component$$20_j$$34$$.$_getTableDomUtils$().$hashCode$($row$$15$$.key), $columns$$20$$ = $component$$20_j$$34$$.$_getColumnDefs$();
    ...
    for ($component$$20_j$$34$$ = 0;$component$$20_j$$34$$ < $columnsCount$$12_tableBodyRow$$27$$;$component$$20_j$$34$$++) {
      this.$tableBodyCellDefaultRenderer$($rowIdx$$38$$, $component$$20_j$$34$$, $row$$15$$, $rowHashCode$$4$$, $context$$68$$);
    }
  };
  $oj$$14$$.$TableRendererUtils$.$tableBodyCellDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$tableBodyCellDefaultRenderer$$($rowIdx$$39$$, $columnIdx$$62$$, $row$$16$$, $rowHashCode$$5$$, $context$$69_tableBodyRow$$28$$) {
    var $component$$21$$ = $context$$69_tableBodyRow$$28$$.rowContext.component;
    $context$$69_tableBodyRow$$28$$ = $$$$14$$($context$$69_tableBodyRow$$28$$.rowContext.parentElement);
    ...
    $component$$21$$.$_getTableDomUtils$().$insertTableBodyCell$($rowIdx$$39$$, $row$$16$$.key, $rowHashCode$$5$$, $columnIdx$$62$$, $tableBodyCell$$13$$, $context$$69_tableBodyRow$$28$$);
    var $cellColumnContent_data$$121$$ = null;
    null != $cellRenderer$$2_column$$20$$.field && ($cellColumnContent_data$$121$$ = $row$$16$$.data[$cellRenderer$$2_column$$20$$.field]);
    if ($cellRenderer$$2_column$$20$$ = $component$$21$$.$_getColumnRenderer$($columnIdx$$62$$, "cell")) {
      var $cellContext$$ = this.$getRendererContextObject$($component$$21$$, $row$$16$$, $tableBodyCell$$13$$[0]), $cellColumnContent_data$$121$$ = $cellRenderer$$2_column$$20$$({cellContext:$cellContext$$, columnIndex:$columnIdx$$62$$, data:$cellColumnContent_data$$121$$, row:$$$$14$$.extend({}, $row$$16$$.data)});
      null != $cellColumnContent_data$$121$$ ? $tableBodyCell$$13$$.append($cellColumnContent_data$$121$$) : ($tableBodyCell$$13$$ = $$$$14$$($context$$69_tableBodyRow$$28$$.children(":not(." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_ACC_SELECT_CLASS$ + ")")[$columnIdx$$62$$]), $component$$21$$.$_getTableDomUtils$().$setTableBodyCellAttributes$($rowIdx$$39$$, $row$$16$$.key, $rowHashCode$$5$$, $columnIdx$$62$$, $tableBodyCell$$13$$), $component$$21$$.$_getTableDomUtils$().$styleTableBodyCell$($columnIdx$$62$$, 
      $tableBodyCell$$13$$, !1));
    } else {
  ...
  $oj$$14$$.$TableRendererUtils$.$getRendererContextObject$ = function $$oj$$14$$$$TableRendererUtils$$$getRendererContextObject$$($component$$22_rowContext$$1$$, $row$$17$$, $parentElement$$3$$) {
    var $context$$70$$ = {};
    $context$$70$$.component = $component$$22_rowContext$$1$$;
    ...
    $context$$70$$.datasource = $dataSource$$;
    $context$$70$$.parentElement = $parentElement$$3$$;
    if (null != $row$$17$$ && ($context$$70$$.status = this.$getRendererStatusObject$($component$$22_rowContext$$1$$, $row$$17$$), $dataSource$$ instanceof $oj$$14$$.$FlattenedTreeTableDataSource$)) {
      $component$$22_rowContext$$1$$ = $dataSource$$.$_getMetadata$($row$$17$$.index);
      for (var $i$$239$$ in $component$$22_rowContext$$1$$) {
        $component$$22_rowContext$$1$$.hasOwnProperty($i$$239$$) && ($context$$70$$[$i$$239$$] = $component$$22_rowContext$$1$$[$i$$239$$]);
      }
    }
    return $context$$70$$;
  };
