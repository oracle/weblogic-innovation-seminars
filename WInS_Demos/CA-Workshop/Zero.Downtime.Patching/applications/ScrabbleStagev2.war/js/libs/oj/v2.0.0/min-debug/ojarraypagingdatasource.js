...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojdatasource-common"], function($oj$$24$$, $$$$23$$, $ko$$4$$) {
  ...
  $oj$$24$$.$ArrayPagingDataSource$.prototype.$_refreshDataWindow$ = function $$oj$$24$$$$ArrayPagingDataSource$$$$_refreshDataWindow$$($options$$277$$) {
    ...
    for (var $i$$308$$ = 0;$i$$308$$ < this.$dataWindow$.length;$i$$308$$++) {
      this.$dataWindow$[$i$$308$$] = this.data[this.current + $i$$308$$];
    }
  ...
  $oj$$24$$.$ArrayPagingDataSource$.prototype.$_refreshObservableDataWindow$ = function $$oj$$24$$$$ArrayPagingDataSource$$$$_refreshObservableDataWindow$$() {
    if (void 0 !== this.$observableDataWindow$) {
      ...
      for (var $i$$309$$ = 0;$i$$309$$ < this.$dataWindow$.length;$i$$309$$++) {
        this.$observableDataWindow$.push(this.$dataWindow$[$i$$309$$]);
      }
    }
  };
  $oj$$24$$.$ArrayPagingDataSource$.prototype.handleEvent = function $$oj$$24$$$$ArrayPagingDataSource$$$handleEvent$($eventType$$40$$, $event$$357$$) {
    return $oj$$24$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call(this, $eventType$$40$$, $event$$357$$);
  };
  ...
  $oj$$24$$.$ArrayPagingDataSource$.prototype.setPage = function $$oj$$24$$$$ArrayPagingDataSource$$$setPage$($value$$250$$, $options$$278$$) {
    $options$$278$$ = $options$$278$$ || {};
    $value$$250$$ = parseInt($value$$250$$, 10);
    try {
      $oj$$24$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call(this, $oj$$24$$.$PagingModel$.$EventType$.BEFOREPAGE, {page:$value$$250$$, previousPage:this.$_page$});
    } catch ($err$$22$$) {
      return Promise.reject(null);
    }
    this.pageSize = null != $options$$278$$.pageSize ? $options$$278$$.pageSize : this.pageSize;
    $options$$278$$.startIndex = $value$$250$$ * this.pageSize;
    var $previousPage$$1$$ = this.$_page$;
    this.$_page$ = $value$$250$$;
    this.$_startIndex$ = $options$$278$$.startIndex;
    var $self$$143$$ = this;
    return new Promise(function($resolve$$35$$, $reject$$32$$) {
