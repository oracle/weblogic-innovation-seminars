...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore"], function($oj$$51$$, $$$$48$$) {
  (function() {
    $oj$$51$$.$__registerWidget$("oj.ojMenu", $$$$48$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", delay:300, role:"menu", widgetEventPrefix:"oj", options:{menuSelector:"ul", openOptions:{initialFocus:"menu", launcher:null, position:{my:"start top", at:"start bottom", collision:"flipfit"}}, submenuOpenOptions:{position:{my:"start top", at:"end top", collision:"flipfit"}}, beforeOpen:null, close:null, open:null, select:null}, _ComponentCreate:function() {
      ...
      var $handleMouseEnterMenuItem$$ = function($event$$538$$) {
        if (!this.$focusHandled$) {
          this.$focusHandled$ = !0;
          var $target$$94$$ = $$$$48$$($event$$538$$.currentTarget);
          $target$$94$$.siblings().removeClass("oj-focus-ancestor");
          this.$_focus$($event$$538$$, $target$$94$$);
        }
      }.bind(this);
      this._on({"mousedown .oj-menu-item \x3e a":function($event$$539$$) {
        ...
        var $target$$95$$ = $$$$48$$($event$$544$$.target).closest(".oj-menu-item");
        !this.$mouseHandled$ && $target$$95$$.not(".oj-disabled").length && (this.$mouseHandled$ = !0, $event$$544$$.preventDefault(), this.$active$ && this.$active$.closest($target$$95$$).length && this.$active$.get(0) != $target$$95$$.get(0) || ($target$$95$$.has(".oj-menu").length ? this.$_expand$($event$$544$$) : (this.$_select$($event$$544$$), this.element.is(":focus") || (this.element.trigger("focus", [!0]), this.$active$ && 1 === this.$active$.parents(".oj-menu").length && clearTimeout(this.$timer$)))));
      ...
      this.$_setup$();
    }, $__contextMenuPressHoldJustEnded$:function($val$$56$$) {
      if (arguments.length) {
        $_contextMenuPressHoldJustEnded$$ = $val$$56$$;
      } else {
      ...
      if (("focus" === $event$$549$$.type || "mousedown" === $event$$549$$.type || "touchstart" === $event$$549$$.type || 93 == $event$$549$$.which || 121 == $event$$549$$.which && $event$$549$$.shiftKey || 93 == $event$$549$$.keyCode) && ("mousedown" !== $event$$549$$.type || !$_contextMenuPressHoldJustEnded$$)) {
        ...
        $$$$48$$.each($openPopupMenus$$, function($index$$244$$, $menu$$19$$) {
    ...
    }, _setOption:function($key$$168$$, $value$$279$$) {
      this._superApply(arguments);
      this.$_launcher$ || ("submenuOpenOptions" === $key$$168$$ ? this.$_submenuPosition$ = $oj$$51$$.$PositionUtils$.$normalizeHorizontalAlignment$($value$$279$$.position, this.$isRtl$) : "submenuOpenOptions.position" === $key$$168$$ && (this.$_submenuPosition$ = $oj$$51$$.$PositionUtils$.$normalizeHorizontalAlignment$($value$$279$$, this.$isRtl$)));
    }, _destroy:function() {
      ...
      this.element.find(".oj-menu-item").removeClass("oj-menu-item").removeAttr("role").children("a").removeAttr("aria-disabled").removeUniqueId().removeClass("oj-hover").removeAttr("tabIndex").removeAttr("role").removeAttr("aria-haspopup").children().each(function() {
        var $elem$$156$$ = $$$$48$$(this);
        $elem$$156$$.data("oj-ojMenu-submenu-icon") && $elem$$156$$.remove();
      });
      ...
      function $escape$$1$$($value$$280$$) {
        return $value$$280$$.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, "\\$\x26");
      }
      var $match$$25_prev$$2$$, $activeItemId_character$$1$$, $skip$$3_topLevelAnchorSelector$$, $regex$$1$$, $preventDefault$$ = !0;
      switch($event$$550$$.keyCode) {
        ...
        case $$$$48$$.ui.keyCode.ESCAPE:
          ...
          break;
        default:
          $preventDefault$$ = !1, $match$$25_prev$$2$$ = this.$previousFilter$ || "", $activeItemId_character$$1$$ = String.fromCharCode($event$$550$$.keyCode), $skip$$3_topLevelAnchorSelector$$ = !1, clearTimeout(this.$filterTimer$), $activeItemId_character$$1$$ === $match$$25_prev$$2$$ ? $skip$$3_topLevelAnchorSelector$$ = !0 : $activeItemId_character$$1$$ = $match$$25_prev$$2$$ + $activeItemId_character$$1$$, $regex$$1$$ = new RegExp("^" + $escape$$1$$($activeItemId_character$$1$$), "i"), $match$$25_prev$$2$$ = 
          this.$activeMenu$.children(".oj-menu-item").filter(function() {
            return $regex$$1$$.test($$$$48$$(this).children("a").text());
          }), $match$$25_prev$$2$$ = $skip$$3_topLevelAnchorSelector$$ && -1 !== $match$$25_prev$$2$$.index(this.$active$.next()) ? this.$active$.nextAll(".oj-menu-item") : $match$$25_prev$$2$$, $match$$25_prev$$2$$.length || ($activeItemId_character$$1$$ = String.fromCharCode($event$$550$$.keyCode), $regex$$1$$ = new RegExp("^" + $escape$$1$$($activeItemId_character$$1$$), "i"), $match$$25_prev$$2$$ = this.$activeMenu$.children(".oj-menu-item").filter(function() {
            return $regex$$1$$.test($$$$48$$(this).children("a").text());
          })), $match$$25_prev$$2$$.length ? (this.$_focus$($event$$550$$, $match$$25_prev$$2$$), 1 < $match$$25_prev$$2$$.length ? (this.$previousFilter$ = $activeItemId_character$$1$$, this.$filterTimer$ = this._delay(function() {
      ...
      this._super();
      this.$_setup$();
      var $element$$130$$ = this.element;
      if ($element$$130$$.is(":visible")) {
        var $position$$27$$ = $element$$130$$.data("oj-menu-position");
        $position$$27$$ && $element$$130$$.position($position$$27$$);
        $element$$130$$.find(".oj-menu").each(function() {
          var $menu$$20$$ = $$$$48$$(this);
      ...
      this.$_submenuPosition$ = $oj$$51$$.$PositionUtils$.$normalizeHorizontalAlignment$(this.options.submenuOpenOptions.position, this.$isRtl$);
      ...
      $psOptions$$5$$[$oj$$51$$.$PopupService$.$OPTION$.$POPUP$] = this.element;
      $oj$$51$$.$PopupService$.$getInstance$().close($psOptions$$5$$);
      ...
      $oj$$51$$.$PositionUtils$.$_normalizeEventForPosition$($event$$558$$);
      ...
      if ($beforeOpenResults_position$$28$$.proceed) {
        ...
        if (this.element.is(":visible") && (this.$_currentOpenOptions$ = $launcher$$9_oldOpenOptions$$, this.$__dismiss$($beforeOpenResults_position$$28$$.event), this.$_currentOpenOptions$ = $initialFocus_openOptions$$5$$), $launcher$$9_oldOpenOptions$$ = $initialFocus_openOptions$$5$$.launcher, ($launcher$$9_oldOpenOptions$$ = "string" === $$$$48$$.type($launcher$$9_oldOpenOptions$$) ? $$$$48$$($launcher$$9_oldOpenOptions$$) : $launcher$$9_oldOpenOptions$$) && $launcher$$9_oldOpenOptions$$.length) {
          if ($beforeOpenResults_position$$28$$ = $oj$$51$$.$PositionUtils$.$normalizeHorizontalAlignment$($initialFocus_openOptions$$5$$.position, this.$isRtl$), $beforeOpenResults_position$$28$$.of = $oj$$51$$.$PositionUtils$.$normalizePositionOf$($beforeOpenResults_position$$28$$.of, $launcher$$9_oldOpenOptions$$, $event$$558$$), null == $beforeOpenResults_position$$28$$.of) {
            $oj$$51$$.$Logger$.warn("position.of passed to Menu.open() is 'event', but the event is null.  Ignoring the call."), this.$_currentOpenOptions$ = null;
          } else {
            var $currentMenu$$ = this.element[0], $openPopupMenus$$1$$ = $_openPopupMenus$$.slice(0, $_openPopupMenus$$.length);
            $$$$48$$.each($openPopupMenus$$1$$, function($index$$245$$, $menu$$23$$) {
              $menu$$23$$.element[0] !== $currentMenu$$ && ($menu$$23$$.$_collapse$($event$$558$$, "eventSubtree"), $menu$$23$$.$_launcher$ && $menu$$23$$.$__dismiss$($event$$558$$));
            });
            this.$_submenuPosition$ = $oj$$51$$.$PositionUtils$.$normalizeHorizontalAlignment$($focusFirstItem_psOptions$$6_submenuOpenOptions$$1_usingCallback$$.position, this.$isRtl$);
            ...
            $focusFirstItem_psOptions$$6_submenuOpenOptions$$1_usingCallback$$[$oj$$51$$.$PopupService$.$OPTION$.$POPUP$] = this.element;
            $focusFirstItem_psOptions$$6_submenuOpenOptions$$1_usingCallback$$[$oj$$51$$.$PopupService$.$OPTION$.$LAUNCHER$] = $launcher$$9_oldOpenOptions$$;
            $focusFirstItem_psOptions$$6_submenuOpenOptions$$1_usingCallback$$[$oj$$51$$.$PopupService$.$OPTION$.$POSITION$] = $beforeOpenResults_position$$28$$;
            $focusFirstItem_psOptions$$6_submenuOpenOptions$$1_usingCallback$$[$oj$$51$$.$PopupService$.$OPTION$.$EVENTS$] = this.$_getPopupServiceEvents$();
            $focusFirstItem_psOptions$$6_submenuOpenOptions$$1_usingCallback$$[$oj$$51$$.$PopupService$.$OPTION$.$LAYER_SELECTORS$] = "oj-menu-layer";
            $oj$$51$$.$PopupService$.$getInstance$().open($focusFirstItem_psOptions$$6_submenuOpenOptions$$1_usingCallback$$);
          ...
          $oj$$51$$.$Logger$.warn("When calling Menu.open(), must specify openOptions.launcher via the component option, method param, or beforeOpen listener.  Ignoring the call."), this.$_currentOpenOptions$ = null;
        }
      }
      ...
      if (null == $which$$ || "active" === $which$$) {
        ...
        "all" === $which$$ || "eventSubtree" === $which$$ ? this.$__collapseAll$($event$$560$$, "all" === $which$$, this.delay) : $oj$$51$$.$Logger$.warn("Invalid param " + $which$$ + " passed to Menu._collapse().  Ignoring the call.");
      }
      ...
      this.$active$ ? this.$active$.has(".oj-menu").length || this.$active$.is(".oj-disabled") ? $oj$$51$$.$Logger$.warn("Selecting a disabled menu item or parent menu item is not allowed.") : ($menuItem$$2_ui$$32$$ = {item:this.$active$}, this.$__collapseAll$($event$$565$$, !0), this.$_launcher$ && this.$_focusLauncherAndDismiss$($event$$565$$, $menuItem$$2_ui$$32$$)) : $oj$$51$$.$Logger$.warn("Menu._select() called when no menu item is focused and no menu item can be inferred from event param.");
      ...
      if (!this.$_popupServiceEvents$) {
        ...
        $events$$5$$[$oj$$51$$.$PopupService$.$EVENT$.$POPUP_CLOSE$] = $$$$48$$.proxy(this.$_closeAll$, this);
        $events$$5$$[$oj$$51$$.$PopupService$.$EVENT$.$POPUP_REMOVE$] = $$$$48$$.proxy(this.$_surrogateRemoveHandler$, this);
        $events$$5$$[$oj$$51$$.$PopupService$.$EVENT$.$POPUP_REFRESH$] = $$$$48$$.proxy(this.refresh, this);
        $events$$5$$[$oj$$51$$.$PopupService$.$EVENT$.$POPUP_AUTODISMISS$] = $$$$48$$.proxy(this.$_clickAwayHandler$, this);
      }
      ...
      var $origUsing_position$$30_rootMenu$$ = $props$$20$$.element.element;
      $origUsing_position$$30_rootMenu$$.css($pos$$12$$);
      ($origUsing_position$$30_rootMenu$$ = $origUsing_position$$30_rootMenu$$.data("oj-menu-position")) && ($origUsing_position$$30_rootMenu$$ = $origUsing_position$$30_rootMenu$$.origUsing) && $origUsing_position$$30_rootMenu$$($pos$$12$$, $props$$20$$);
      $oj$$51$$.$PositionUtils$.$isAligningPositionClipped$($props$$20$$) && (this.$_closeDelayTimer$ = this._delay($$$$48$$.proxy(this.$_closeAll$, this), 1));
    }});
