...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojdatasource-common", "ojs/ojmodel", "ojs/ojknockout-model"], function($oj$$31$$, $$$$30$$, $ko$$5$$) {
  ...
  $oj$$31$$.$CollectionPagingDataSource$.prototype.$_refreshDataWindow$ = function $$oj$$31$$$$CollectionPagingDataSource$$$$_refreshDataWindow$$() {
    ...
    return this.$collection$.$IterativeAt$(this.current, this.current + this.$dataWindow$.length).then(function($array$$16$$) {
      for (var $i$$326$$ = 0;$i$$326$$ < $array$$16$$.length;$i$$326$$++) {
        $self$$157$$.$dataWindow$[$i$$326$$] = $array$$16$$[$i$$326$$];
      }
  ...
  $oj$$31$$.$CollectionPagingDataSource$.prototype.$_refreshObservableDataWindow$ = function $$oj$$31$$$$CollectionPagingDataSource$$$$_refreshObservableDataWindow$$() {
    if (void 0 !== this.$observableDataWindow$) {
      ...
      for (var $i$$327$$ = 0;$i$$327$$ < this.$dataWindow$.length;$i$$327$$++) {
        this.$observableDataWindow$.push($oj$$31$$.$KnockoutUtils$.map(this.$dataWindow$[$i$$327$$]));
      }
    }
  };
  ...
  $oj$$31$$.$CollectionPagingDataSource$.prototype.setPage = function $$oj$$31$$$$CollectionPagingDataSource$$$setPage$($value$$258$$, $options$$300$$) {
    $options$$300$$ = $options$$300$$ || {};
    $value$$258$$ = parseInt($value$$258$$, 10);
    try {
      $oj$$31$$.$CollectionPagingDataSource$.$superclass$.handleEvent.call(this, $oj$$31$$.$PagingModel$.$EventType$.BEFOREPAGE, {page:$value$$258$$, previousPage:this.$_page$});
    } catch ($err$$24$$) {
      return Promise.reject(null);
    }
    this.pageSize = null != $options$$300$$.pageSize ? $options$$300$$.pageSize : this.pageSize;
    $options$$300$$.startIndex = $value$$258$$ * this.pageSize;
    var $previousPage$$2$$ = this.$_page$;
    this.$_page$ = $value$$258$$;
    this.$_startIndex$ = $options$$300$$.startIndex;
    var $self$$158$$ = this;
    return new Promise(function($resolve$$40$$, $reject$$37$$) {
      ...
      try {
        $self$$160$$.$collection$.fetch({success:function() {
          $self$$160$$.$_refreshDataWindow$().then(function() {
            ...
            $resolve$$41$$({data:$self$$160$$.$getWindow$(), startIndex:$self$$160$$.current});
          });
        }});
      } catch ($e$$93$$) {
        $self$$160$$.$_refreshDataWindow$().then(function() {
  ...
  $oj$$31$$.$CollectionPagingDataSource$.prototype.handleEvent = function $$oj$$31$$$$CollectionPagingDataSource$$$handleEvent$($eventType$$45$$, $event$$399$$) {
    return $oj$$31$$.$CollectionPagingDataSource$.$superclass$.handleEvent.call(this, $eventType$$45$$, $event$$399$$);
  };
