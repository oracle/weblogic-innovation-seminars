...
define(["ojs/ojcore", "jquery", "jqueryui-amd/core", "jqueryui-amd/widget", "ojs/ojmessaging"], function($oj$$3$$, $$$$3$$) {
  ...
  $$$$3$$.widget("oj.baseComponent", {options:{contextMenu:null, rootAttributes:null, optionChange:void 0, destroy:void 0}, refresh:function() {
    ...
    return this.$_trigger2$($type$$63$$, $event$$15$$, $data$$49$$).proceed;
  }, $_trigger2$:function($type$$64$$, $event$$16$$, $data$$50$$) {
    var $callback$$79$$ = this.options[$type$$64$$];
    $data$$50$$ = $data$$50$$ || {};
    $event$$16$$ = $$$$3$$.Event($event$$16$$, $_OJ_COMPONENT_EVENT_OVERRIDES$$);
    $event$$16$$.type = (this.widgetEventPrefix + $type$$64$$).toLowerCase();
    $event$$16$$.target = this.element[0];
    this.element.trigger($event$$16$$, $data$$50$$);
    return{proceed:!($$$$3$$.isFunction($callback$$79$$) && !1 === $callback$$79$$.apply(this.element[0], [$event$$16$$].concat($data$$50$$)) || $event$$16$$.isDefaultPrevented()), event:$event$$16$$};
    ...
    if (this.options.contextMenu) {
      ...
      var $self$$41$$ = this;
      this.$_preventKeyUpEventIfMenuOpen$ = function $this$$_preventKeyUpEventIfMenuOpen$$($event$$17$$) {
        121 == $event$$17$$.which && $event$$17$$.shiftKey && $self$$41$$.$_getContextMenuNode$().is(":visible") && $event$$17$$.preventDefault();
      };
      var $isPressHold$$ = !1, $touchInProgress$$ = !1, $touchPageX$$, $touchPageY$$, $doubleOpenTimer$$, $doubleOpenType$$ = null, $launch$$ = function $$launch$$$($event$$18$$, $eventType$$25$$, $pressHold$$) {
        ...
        "touchstart" === $doubleOpenType$$ && "contextmenu" === $event$$18$$.type || "contextmenu" === $doubleOpenType$$ && "touchstart" === $event$$18$$.type ? ($doubleOpenType$$ = null, clearTimeout($doubleOpenTimer$$)) : $event$$18$$.isDefaultPrevented() || $event$$18$$.originalEvent && $event$$18$$.originalEvent.defaultPrevented || $self$$41$$.$_IsEffectivelyDisabled$() || ($self$$41$$.$_NotifyContextMenuGesture$($menu$$, $event$$18$$, $eventType$$25$$), !$self$$41$$.$_getContextMenuNode$().is(":visible") || 
        ($event$$18$$.preventDefault(), document.addEventListener("keyup", $self$$41$$.$_preventKeyUpEventIfMenuOpen$), "touchstart" !== $event$$18$$.type && "contextmenu" !== $event$$18$$.type)) || ($doubleOpenType$$ = $event$$18$$.type, $doubleOpenTimer$$ = setTimeout(function() {
          $doubleOpenType$$ = null;
        }, 300));
      };
      this.$_clickListener$ = function $this$$_clickListener$$($event$$20$$) {
        $isPressHold$$ && ($event$$20$$.preventDefault(), $event$$20$$.stopPropagation(), $isPressHold$$ = !1);
      };
      $rootNode$$[0].addEventListener("click", this.$_clickListener$, !0);
      $rootNode$$.on("touchstart" + this.$contextMenuEventNamespace$ + " mousedown" + this.$contextMenuEventNamespace$ + " keydown" + this.$contextMenuEventNamespace$ + " ", function($event$$21$$) {
        if ("mousedown" !== $event$$21$$.type || !$self$$41$$.$_getContextMenu$().$__contextMenuPressHoldJustEnded$()) {
          $isPressHold$$ = !1;
          if ("touchstart" === $event$$21$$.type && 1 === $event$$21$$.originalEvent.touches.length) {
            var $firstTouch$$ = $event$$21$$.originalEvent.touches[0];
            $touchPageX$$ = $firstTouch$$.pageX;
            $touchPageY$$ = $firstTouch$$.pageY;
            $touchInProgress$$ = !0;
            this.$_contextMenuPressHoldTimer$ = setTimeout($launch$$.bind(void 0, $event$$21$$, "touch", !0), 750);
          }
          return!0;
        }
      }).on("touchmove" + this.$contextMenuEventNamespace$, function($event$$22_firstTouch$$1$$) {
        $event$$22_firstTouch$$1$$ = $event$$22_firstTouch$$1$$.originalEvent.touches[0];
        if (5 < Math.abs($touchPageX$$ - $event$$22_firstTouch$$1$$.pageX) || 5 < Math.abs($touchPageY$$ - $event$$22_firstTouch$$1$$.pageY)) {
        ...
        return!0;
      }).on("keydown" + this.$contextMenuEventNamespace$ + " contextmenu" + this.$contextMenuEventNamespace$, function($event$$24$$) {
        ("contextmenu" === $event$$24$$.type || 121 == $event$$24$$.which && $event$$24$$.shiftKey) && $launch$$($event$$24$$, $touchInProgress$$ ? "touch" : "keydown" === $event$$24$$.type ? "keyboard" : "mouse", !1);
        return!0;
  ...
  }, $_NotifyContextMenuGesture$:function($menu$$1$$, $event$$26$$, $eventType$$27$$) {
    this.$_OpenContextMenu$($event$$26$$, $eventType$$27$$);
  }, $_OpenContextMenu$:function($event$$27$$, $defaults_eventType$$28$$, $openOptions$$, $submenuOpenOptions$$, $menu$$2_shallow$$) {
    $defaults_eventType$$28$$ = {launcher:this.element, position:{mouse:{my:"start top", at:"start bottom", of:$event$$27$$, collision:"flipfit"}, touch:{my:"start\x3e40 center", at:"start bottom", of:$event$$27$$, collision:"flipfit"}, keyboard:{my:"start top", at:"start bottom", of:"launcher", collision:"flipfit"}}[$defaults_eventType$$28$$]};
    ...
    $menu$$2_shallow$$.open($event$$27$$, $openOptions$$, $submenuOpenOptions$$);
    ...
    this._on($element$$19$$, {mouseenter:function($event$$28$$) {
      $$$$3$$($event$$28$$.currentTarget).hasClass("oj-disabled") || $$$$3$$($event$$28$$.currentTarget).addClass("oj-hover");
    }, mouseleave:function($event$$29$$) {
      $$$$3$$($event$$29$$.currentTarget).removeClass("oj-hover");
    }});
  }, _focusable:function($element$$20$$) {
    this._on($element$$20$$, {focusin:function($event$$30$$) {
      $$$$3$$($event$$30$$.currentTarget).addClass("oj-focus");
    }, focusout:function($event$$31$$) {
      $$$$3$$($event$$31$$.currentTarget).removeClass("oj-focus");
    }});
  }, $_activeable$:function($element$$21$$) {
    this._on($element$$21$$, {mousedown:function($event$$32$$) {
      $$$$3$$($event$$32$$.currentTarget).addClass("oj-active");
    }, mouseup:function($event$$33$$) {
      $$$$3$$($event$$33$$.currentTarget).removeClass("oj-active");
    }});
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$activate$ = function $$oj$$3$$$$ComponentMessaging$$$$activate$$($launcher$$, $content$$4$$) {
    ...
    this.$_activated$ ? this.$_reactivate$() : ($$$$3$$.each(this.$_strategies$, function($i$$86$$, $strategy$$) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.update = function $$oj$$3$$$$ComponentMessaging$$$update$($content$$5$$) {
    ...
    this.$_activated$ && $$$$3$$.each(this.$_strategies$, function($i$$87$$, $strategy$$1$$) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$deactivate$ = function $$oj$$3$$$$ComponentMessaging$$$$deactivate$$() {
    $$$$3$$.each(this.$_strategies$, function($i$$88$$, $strategy$$2$$) {
  ...
  $oj$$3$$.$ComponentMessaging$.prototype.$_getResolvedMessagingDisplayOptions$ = function $$oj$$3$$$$ComponentMessaging$$$$_getResolvedMessagingDisplayOptions$$() {
    var $artifactsByDisplayType$$ = {}, $artifactDisplayTypeResolved$$ = !1, $displayTypes$$, $displayType_key$$34$$, $compPH$$ = this.$_component$.options.placeholder, $artifact$$, $keys$$5$$, $i$$89$$, $j$$7$$, $messagingPreferences$$ = this.$_component$.options.displayOptions || {}, $$messagingPreferences$$ = {};
    $keys$$5$$ = Object.keys($messagingPreferences$$);
    for ($i$$89$$ = 0;$i$$89$$ < $keys$$5$$.length;$i$$89$$++) {
      $displayType_key$$34$$ = $keys$$5$$[$i$$89$$];
    ...
    $$$$3$$.each($oj$$3$$.$ComponentMessaging$.$_DISPLAY_TYPE$, function($type$$67$$, $name$$69$$) {
  ...
  $oj$$3$$.$DomUtils$.$_cleanElementHtml$ = function $$oj$$3$$$$DomUtils$$$_cleanElementHtml$$($node$$11$$) {
    for (var $children$$ = $node$$11$$.childNodes, $child$$1$$, $attrs$$19$$, $attr$$11$$, $childHasAttr$$, $i$$90$$, $count$$22$$ = $children$$.length - 1;0 <= $count$$22$$;) {
      if (($child$$1$$ = $children$$.item($count$$22$$)) && 1 === $child$$1$$.nodeType) {
        if ($oj$$3$$.$DomUtils$.$_LEGAL_ELEMENTS$[$child$$1$$.nodeName]) {
          ...
          for ($i$$90$$ = $attrs$$19$$.length - 1;0 <= $i$$90$$;$i$$90$$--) {
            $attr$$11$$ = $attrs$$19$$[$i$$90$$], ($childHasAttr$$ = void 0 !== $$$$3$$($child$$1$$).attr($attr$$11$$.name)) && ($oj$$3$$.$DomUtils$.$_LEGAL_ATTRIBUTES$[$attr$$11$$.name] || $child$$1$$.removeAttribute($attr$$11$$.nodeName));
          }
  ...
  $oj$$3$$.$DomUtils$.$_ResizeTracker$ = function $$oj$$3$$$$DomUtils$$$_ResizeTracker$$($div$$2$$) {
    ...
    function $_notifyListeners$$($i$$91_useAfterPaint$$) {
      var $newWidth$$1$$ = $div$$2$$.offsetWidth, $newHeight$$1$$ = $div$$2$$.offsetHeight;
      $_listeners$$.has() && ($i$$91_useAfterPaint$$ ? (null !== $_invokeId$$ && $oj$$3$$.$DomUtils$.$_cancelInvokeAfterPaint$($_invokeId$$), $_invokeId$$ = $oj$$3$$.$DomUtils$.$_invokeAfterPaint$(function() {
        $_invokeId$$ = null;
        $_listeners$$.fire($newWidth$$1$$, $newHeight$$1$$);
      })) : $_listeners$$.fire($newWidth$$1$$, $newHeight$$1$$));
      for ($i$$91_useAfterPaint$$ = 0;$i$$91_useAfterPaint$$ < $_collapsingManagers$$.length;$i$$91_useAfterPaint$$++) {
        $_collapsingManagers$$[$i$$91_useAfterPaint$$].$getCallback$()($newWidth$$1$$, $newHeight$$1$$);
      }
    }
  ...
  $oj$$3$$.$DomUtils$.$isChromeEvent$ = function $$oj$$3$$$$DomUtils$$$isChromeEvent$$($JSCompiler_temp$$12_event$$34$$) {
    function $_isChromeEventWebkit$$($event$$37$$) {
      var $domTarget$$ = $event$$37$$.target, $target$$73$$ = $$$$3$$($domTarget$$), $pos$$ = $domTarget$$.getBoundingClientRect(), $sbw$$ = $oj$$3$$.$DomUtils$.$getScrollBarWidth$(), $isLTR$$ = "ltr" === $oj$$3$$.$DomUtils$.$getReadingDirection$();
      return $isLTR$$ && ("HTML" === $domTarget$$.nodeName || "visible" !== $target$$73$$.css("overflow-x")) && $event$$37$$.clientX > $pos$$.right - $sbw$$ ? !0 : !$isLTR$$ && "HTML" === $domTarget$$.nodeName && $event$$37$$.clientX > $pos$$.left - $sbw$$ ? !0 : !$isLTR$$ && "visible" !== $target$$73$$.css("overflow-x") && $event$$37$$.clientX < $pos$$.left + $sbw$$ ? !0 : ("HTML" === $domTarget$$.nodeName || "visible" !== $target$$73$$.css("overflow-y")) && $event$$37$$.clientY > $pos$$.bottom - 
      $sbw$$ ? !0 : !1;
    }
    if (!("clientX" in $JSCompiler_temp$$12_event$$34$$ && "clientY" in $JSCompiler_temp$$12_event$$34$$)) {
      return!1;
    }
    ...
    if ($oj$$3$$.$AgentUtils$.$OS$.$ANDROID$ === $agentInfo$$1$$.os || $oj$$3$$.$AgentUtils$.$OS$.$IOS$ === $agentInfo$$1$$.os) {
      $JSCompiler_temp$$12_event$$34$$ = !1;
    } else {
      var $JSCompiler_temp$$13$$;
      if ($oj$$3$$.$AgentUtils$.$ENGINE$.$GECKO$ === $agentInfo$$1$$.engine) {
        try {
          $JSCompiler_temp$$13$$ = $JSCompiler_temp$$12_event$$34$$.originalTarget.localName ? !1 : !0;
        } catch ($e$$inline_466$$) {
          $JSCompiler_temp$$13$$ = !0;
        }
      } else {
        $JSCompiler_temp$$13$$ = $oj$$3$$.$AgentUtils$.$ENGINE$.$WEBKIT$ === $agentInfo$$1$$.engine ? $_isChromeEventWebkit$$($JSCompiler_temp$$12_event$$34$$) : $oj$$3$$.$AgentUtils$.$BROWSER$.$IE$ === $agentInfo$$1$$.browser ? $_isChromeEventWebkit$$($JSCompiler_temp$$12_event$$34$$) : !1;
      }
      $JSCompiler_temp$$12_event$$34$$ = $JSCompiler_temp$$13$$;
    }
    return $JSCompiler_temp$$12_event$$34$$;
  };
  ...
  $oj$$3$$.$DomUtils$.$_supressNativeContextMenu$ = function $$oj$$3$$$$DomUtils$$$_supressNativeContextMenu$$() {
    $$$$3$$(document.body).hasClass("oj-hybrid") && document.body.addEventListener("contextmenu", function($event$$38$$) {
      $event$$38$$.preventDefault();
    }, !0);
  };
  ...
  $$$$3$$(document).ready(function() {
    var $div$$inline_468$$ = $$$$3$$("\x3cdiv style\x3d'border: 1px solid;border-color:red green;position: absolute;top: -999px;background-image: url(data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACwAAAAAAQABAAACAkQBADs\x3d);'\x3e\x3c/div\x3e"), $bki$$inline_469$$;
    $div$$inline_468$$.appendTo("body");
    $bki$$inline_469$$ = $div$$inline_468$$.css("backgroundImage");
    $div$$inline_468$$.css("borderTopColor") != $div$$inline_468$$.css("borderRightColor") && (null == $bki$$inline_469$$ || "none" != $bki$$inline_469$$ && "url (invalid-url:)" != $bki$$inline_469$$) || $$$$3$$("body").addClass("oj-hicontrast");
    $div$$inline_468$$.remove();
  });
  $$$$3$$(document).ready(function() {
