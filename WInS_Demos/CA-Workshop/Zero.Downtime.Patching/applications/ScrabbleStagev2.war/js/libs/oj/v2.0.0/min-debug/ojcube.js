...
define(["ojs/ojcore", "jquery", "promise", "ojs/ojdatasource-common"], function($oj$$18$$, $$$$17$$) {
  ...
  $oj$$18$$.$Cube$.prototype.$_findAxisInLayout$ = function $$oj$$18$$$$Cube$$$$_findAxisInLayout$$($axis$$3$$) {
    for (var $i$$261$$ = 0;$i$$261$$ < this.$_layout$.length;$i$$261$$++) {
      if (this.$_layout$[$i$$261$$].axis === $axis$$3$$) {
    ...
    if (null !== this.$_rows$) {
      for (var $row$$19$$ = 0;$row$$19$$ < this.$_rows$.length;$row$$19$$++) {
        for (var $pageHashObj_pageKey$$ = new $oj$$18$$.$CubeKeys$, $axis$$7_hash$$3_pageHash$$ = 2;$axis$$7_hash$$3_pageHash$$ < this.$_axes$.length;$axis$$7_hash$$3_pageHash$$++) {
          $pageHashObj_pageKey$$ = this.$_axes$[$axis$$7_hash$$3_pageHash$$].$ProcessRow$(this.$_rows$[$row$$19$$], $pageHashObj_pageKey$$);
        }
        for (var $pageHashObj_pageKey$$ = $pageHashObj_pageKey$$.$GetHashCodes$(), $ph$$ = 0;$ph$$ < $pageHashObj_pageKey$$.length;$ph$$++) {
          ...
          for (var $dataHash_keys$$11$$ = new $oj$$18$$.$CubeKeys$, $h$$5_maxAxes$$ = $cube$$2$$.$_axes$.length, $axis$$7_hash$$3_pageHash$$ = 0;$axis$$7_hash$$3_pageHash$$ < $h$$5_maxAxes$$;$axis$$7_hash$$3_pageHash$$++) {
            $dataHash_keys$$11$$ = $cube$$2$$.$_axes$[$axis$$7_hash$$3_pageHash$$].$ProcessRow$(this.$_rows$[$row$$19$$], $dataHash_keys$$11$$);
          }
          $dataHash_keys$$11$$ = $axis$$7_hash$$3_pageHash$$ = $dataHash_keys$$11$$.$GetHashCodes$();
          if (void 0 !== $pageHashObj_pageKey$$[$ph$$].$dataValue$) {
            for ($dataHash_keys$$11$$ = [], $h$$5_maxAxes$$ = 0;$h$$5_maxAxes$$ < $axis$$7_hash$$3_pageHash$$.length;$h$$5_maxAxes$$++) {
              $dataHash_keys$$11$$.push($pageHashObj_pageKey$$[$ph$$]);
            }
          }
          $cube$$2$$.$_storeData$($axis$$7_hash$$3_pageHash$$, $dataHash_keys$$11$$, this.$_rows$[$row$$19$$]);
        }
      }
    }
  };
  ...
  $oj$$18$$.$Cube$.prototype.$_createCubeKeys$ = function $$oj$$18$$$$Cube$$$$_createCubeKeys$$($indices$$5$$) {
    for (var $axes$$2$$ = this.$getAxes$(), $keys$$13$$ = new $oj$$18$$.$CubeKeys$, $a$$106$$ = 0;$a$$106$$ < $indices$$5$$.length;$a$$106$$++) {
      $keys$$13$$ = $axes$$2$$[$a$$106$$].$GetCubeKeys$($indices$$5$$[$a$$106$$], $keys$$13$$);
    }
    return $keys$$13$$;
  };
  ...
  $oj$$18$$.$CubeAxisValue$ = function $$oj$$18$$$$CubeAxisValue$$($value$$231$$, $label$$10$$, $level$$14$$, $parent$$12$$) {
    this.Init();
    this.$_children$ = [];
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$AddNode$ = function $$oj$$18$$$$CubeAxisValue$$$$AddNode$$($newValue$$19_value$$233$$, $label$$11$$, $level$$15$$) {
    ...
    $newValue$$19_value$$233$$ = new $oj$$18$$.$CubeAxisValue$($newValue$$19_value$$233$$, $label$$11$$, $level$$15$$, this);
  ...
  $oj$$18$$.$CubeAxis$ = function $$oj$$18$$$$CubeAxis$$($levels$$2$$, $axis$$10_i$$267$$, $cube$$3$$) {
    this.Init();
    this.axis = $axis$$10_i$$267$$;
    this.$_levels$ = [];
    for ($axis$$10_i$$267$$ = 0;$axis$$10_i$$267$$ < $levels$$2$$.length;$axis$$10_i$$267$$++) {
      this.$_levels$.push($cube$$3$$.$GenerateLevel$($levels$$2$$[$axis$$10_i$$267$$], this));
    }
    this.$_cube$ = $cube$$3$$;
  ...
  $oj$$18$$.$CubeAxis$.prototype.$getValues$ = function $$oj$$18$$$$CubeAxis$$$$getValues$$($index$$116$$) {
    for (var $values$$8$$ = [], $node$$62$$ = this.$_values$;$node$$62$$;) {
      ($node$$62$$ = $node$$62$$.$GetChildAt$($index$$116$$)) && $values$$8$$.push($node$$62$$);
    }
    return $values$$8$$;
  };
  ...
  $oj$$18$$.$CubeAxis$.prototype.$getIndex$ = function $$oj$$18$$$$CubeAxis$$$$getIndex$$($key$$82_keyVal$$) {
    ...
    for (var $node$$63$$ = this.$_values$, $lastNode$$ = null;$node$$63$$;) {
      $lastNode$$ = $node$$63$$, $node$$63$$ = $node$$63$$.$GetChild$($key$$82_keyVal$$);
    }
  ...
  $oj$$18$$.$CubeAxis$.prototype.$GetPartialCubeKeys$ = function $$oj$$18$$$$CubeAxis$$$$GetPartialCubeKeys$$($index$$118_values$$9$$, $level$$16_stopLevel$$, $keys$$16$$) {
  ...
  $oj$$18$$.$CubeCellSet$.prototype.$_getAxisMetadata$ = function $$oj$$18$$$$CubeCellSet$$$$_getAxisMetadata$$($indexes$$3$$, $axis$$11$$, $keys$$18_len$$18$$) {
    var $axes$$3$$ = this.$_cube$.$getAxes$();
    return void 0 !== $indexes$$3$$[$axis$$11$$] && $axes$$3$$.length >= $keys$$18_len$$18$$ ? ($keys$$18_len$$18$$ = new $oj$$18$$.$CubeKeys$, $keys$$18_len$$18$$ = $axes$$3$$[$oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$($axis$$11$$)].$GetCubeKeys$($indexes$$3$$[$axis$$11$$], $keys$$18_len$$18$$), $keys$$18_len$$18$$.$GetHashCodes$()[0].key) : null;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$getCount$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$getCount$$($axis$$14_axisObj$$) {
    return($axis$$14_axisObj$$ = this.$_getAxis$($axis$$14_axisObj$$)) ? $axis$$14_axisObj$$.$getExtent$() : 0;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$fetchCells$$($cellRange$$1$$, $callbacks$$5$$, $callbackObjects$$1$$) {
    for (var $cubecells_obj$$54$$ = {}, $i$$268$$ = 0;$i$$268$$ < $cellRange$$1$$.length;$i$$268$$++) {
      var $start$$34$$ = void 0 === $cellRange$$1$$[$i$$268$$].start ? 0 : $cellRange$$1$$[$i$$268$$].start;
      if ("row" === $cellRange$$1$$[$i$$268$$].axis) {
        var $count$$33$$ = void 0 === $cellRange$$1$$[$i$$268$$].count ? this.data.$getAxes$()[1].$getExtent$() : $cellRange$$1$$[$i$$268$$].count;
        $cubecells_obj$$54$$.row = {start:$start$$34$$, count:$count$$33$$};
      }
      "column" === $cellRange$$1$$[$i$$268$$].axis && ($count$$33$$ = void 0 === $cellRange$$1$$[$i$$268$$].count ? this.data.$getAxes$()[0].$getExtent$() : $cellRange$$1$$[$i$$268$$].count, $cubecells_obj$$54$$.column = {start:$start$$34$$, count:$count$$33$$});
    }
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getKey$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getKey$$($indexes$$5_item$$14$$, $axis$$16$$, $retObj$$14$$) {
    var $axisObj$$1$$ = this.$_getAxis$($axis$$16$$);
    $indexes$$5_item$$14$$ = $indexes$$5_item$$14$$[$axis$$16$$];
    var $keys$$19$$ = new $oj$$18$$.$CubeKeys$, $keys$$19$$ = $axisObj$$1$$ ? $axisObj$$1$$.$GetCubeKeys$($indexes$$5_item$$14$$, $keys$$19$$) : "";
    $retObj$$14$$[$axis$$16$$] = $keys$$19$$.$GetHashCodes$()[0].key;
    return $retObj$$14$$;
  };
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$indexes$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$indexes$$($keys$$20$$) {
    var $retObj$$15$$ = {}, $retObj$$15$$ = this.$_getIndex$($keys$$20$$, "row", $retObj$$15$$), $retObj$$15$$ = this.$_getIndex$($keys$$20$$, "column", $retObj$$15$$);
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getIndex$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getIndex$$($keys$$21$$, $axis$$17$$, $retObj$$16$$) {
    $retObj$$16$$[$axis$$17$$] = this.$_getAxis$($axis$$17$$).$getIndex$($keys$$21$$[$axis$$17$$]);
    return $retObj$$16$$;
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$ = function $$oj$$18$$$$CubeDataGridDataSource$$$_convertAxes$$($axis$$18$$) {
    return "row" === $axis$$18$$ ? 1 : 0;
  };
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getAxis$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getAxis$$($axis$$19_axisNum$$) {
    $axis$$19_axisNum$$ = $oj$$18$$.$CubeDataGridDataSource$.$_convertAxes$($axis$$19_axisNum$$);
    var $axes$$4$$ = this.data.$getAxes$();
    return $axes$$4$$.length > $axis$$19_axisNum$$ ? $axes$$4$$[$axis$$19_axisNum$$] : null;
  };
  $oj$$18$$.$CubeDataValue$ = function $$oj$$18$$$$CubeDataValue$$($value$$234$$, $indices$$7$$, $aggType$$2$$, $rows$$5$$, $square$$) {
    this.Init();
    this.$_data$ = {};
  ...
  $oj$$18$$.$CubeDataValue$.prototype.$_getVariance$ = function $$oj$$18$$$$CubeDataValue$$$$_getVariance$$() {
    ...
    var $count$$34$$ = this.$_data$.rows.length;
    return 1 < $count$$34$$ ? this.$_data$.$square$ / ($count$$34$$ - 1) : 0;
  };
  $oj$$18$$.$CubeHeaderSet$ = function $$oj$$18$$$$CubeHeaderSet$$($axis$$20$$, $cube$$7$$, $start$$35$$, $count$$35$$) {
    this.$_cube$ = $cube$$7$$;
    this.$_axis$ = $axis$$20$$;
    this.$_start$ = void 0 === $start$$35$$ ? 0 : $start$$35$$;
    this.$_count$ = void 0 === $count$$35$$ ? this.$_axis$.$getExtent$() : Math.min($count$$35$$, this.$_axis$.$getExtent$() - $start$$35$$);
    this.$_end$ = $start$$35$$ + $count$$35$$ - 1;
  };
  $goog$exportPath_$$("CubeHeaderSet", $oj$$18$$.$CubeHeaderSet$, $oj$$18$$);
  $oj$$18$$.$CubeHeaderSet$.prototype.getData = function $$oj$$18$$$$CubeHeaderSet$$$getData$($index$$119$$, $level$$17$$) {
    var $val$$45$$ = this.$_getValue$($index$$119$$, $level$$17$$);
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.getMetadata = function $$oj$$18$$$$CubeHeaderSet$$$getMetadata$($index$$120$$, $level$$18$$) {
    var $hash$$6_keys$$22$$ = new $oj$$18$$.$CubeKeys$, $hash$$6_keys$$22$$ = this.$_axis$.$GetPartialCubeKeys$($index$$120$$, $level$$18$$, $hash$$6_keys$$22$$);
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$getExtent$ = function $$oj$$18$$$$CubeHeaderSet$$$$getExtent$$($index$$121$$, $level$$19$$) {
    var $start$$36_val$$46$$ = this.$_getValue$($index$$121$$, $level$$19$$), $extent$$ = $start$$36_val$$46$$.$getExtent$(), $start$$36_val$$46$$ = $start$$36_val$$46$$.$getStart$(), $end$$11$$ = $start$$36_val$$46$$ + $extent$$ - 1, $after$$ = $index$$121$$ < $start$$36_val$$46$$ + $extent$$ - 1;
    $start$$36_val$$46$$ < this.$_start$ && ($extent$$ -= this.$_start$ - $start$$36_val$$46$$);
    $end$$11$$ > this.$_end$ && ($extent$$ -= $end$$11$$ - this.$_end$);
    return{extent:$extent$$, more:{before:$index$$121$$ > $start$$36_val$$46$$, after:$after$$}};
  };
  $oj$$18$$.$Object$.$exportPrototypeSymbol$("CubeHeaderSet.prototype.getExtent", {$getExtent$:$oj$$18$$.$CubeHeaderSet$.prototype.$getExtent$});
  $oj$$18$$.$CubeHeaderSet$.prototype.$getDepth$ = function $$oj$$18$$$$CubeHeaderSet$$$$getDepth$$($index$$122$$, $level$$20$$) {
    return this.$_getValue$($index$$122$$, $level$$20$$).$getDepth$();
  };
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$_getValue$ = function $$oj$$18$$$$CubeHeaderSet$$$$_getValue$$($index$$123$$, $level$$21$$) {
    void 0 === $level$$21$$ && ($level$$21$$ = 0);
    var $values$$10$$ = this.$_axis$.$getValues$($index$$123$$);
    return $values$$10$$ && $values$$10$$.length > $level$$21$$ ? $values$$10$$[$level$$21$$] : null;
  };
  $oj$$18$$.$CubeKeys$ = function $$oj$$18$$$$CubeKeys$$() {
    this.$_key$ = [];
    this.$_data$ = [];
  };
  $oj$$18$$.$CubeKeys$.prototype.$UpdateKeys$ = function $$oj$$18$$$$CubeKeys$$$$UpdateKeys$$($node$$64$$) {
    this.$_key$.push($node$$64$$);
  };
  $oj$$18$$.$CubeKeys$.prototype.$AddDataValue$ = function $$oj$$18$$$$CubeKeys$$$$AddDataValue$$($name$$108$$, $value$$235$$) {
    this.$_data$.push({name:$name$$108$$, value:$value$$235$$});
  };
  ...
  $oj$$18$$.$CubeLevel$ = function $$oj$$18$$$$CubeLevel$$($attribute$$4$$, $axis$$21$$, $dataValue$$1$$) {
    this.Init();
    this.attribute = $attribute$$4$$;
    this.$_axisObj$ = $axis$$21$$;
    this.axis = $axis$$21$$.axis;
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$GenerateLevel$ = function $$oj$$18$$$$DataColumnCube$$$$GenerateLevel$$($level$$22$$, $axis$$22$$) {
    return $level$$22$$.attribute === this.$_labelAttr$ ? new $oj$$18$$.$CubeLevel$($level$$22$$.attribute, $axis$$22$$, !0) : new $oj$$18$$.$CubeLevel$($level$$22$$.attribute, $axis$$22$$, !1);
  };
  $oj$$18$$.$DataColumnCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataColumnCube$$$$ProcessLevel$$($axis$$23$$, $levelNum$$1$$, $currNode$$1_node$$65$$, $row$$26$$, $keys$$23$$, $addKeys$$1$$) {
    if ($levelNum$$1$$ >= $axis$$23$$.$getLevels$().length) {
      return $keys$$23$$;
    }
    var $level$$23$$ = $axis$$23$$.$getLevels$()[$levelNum$$1$$], $value$$236$$ = $row$$26$$[$level$$23$$.attribute];
    $currNode$$1_node$$65$$ = $currNode$$1_node$$65$$.$AddNode$($value$$236$$, null, $level$$23$$);
    $level$$23$$.$isDataValue$() ? $keys$$23$$.$AddDataValue$($value$$236$$, $row$$26$$[this.$_valueAttr$]) : $keys$$23$$.$UpdateKeys$($currNode$$1_node$$65$$);
    return this.$ProcessLevel$($axis$$23$$, $levelNum$$1$$ + 1, $currNode$$1_node$$65$$, $row$$26$$, $keys$$23$$, $addKeys$$1$$);
  };
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataColumnCube$$$$_buildAggTypeLookup$$() {
    ...
    if (this.$_aggregation$) {
      for (var $i$$269$$ = 0;$i$$269$$ < this.$_aggregation$.length;$i$$269$$++) {
        var $dv$$ = this.$_aggregation$[$i$$269$$], $agg$$1$$ = $dv$$.aggregation;
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$GenerateLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$GenerateLevel$$($level$$24$$, $axis$$24$$) {
    return $level$$24$$.dataValue ? new $oj$$18$$.$CubeLevel$(null, $axis$$24$$, !0) : new $oj$$18$$.$CubeLevel$($level$$24$$.attribute, $axis$$24$$, !1);
  };
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$ProcessLevel$$($axis$$25$$, $levelNum$$2$$, $currNode$$2_node$$66$$, $row$$27$$, $keys$$24$$, $addKeys$$2$$) {
    if ($levelNum$$2$$ >= $axis$$25$$.$getLevels$().length) {
      return $keys$$24$$;
    }
    var $level$$25$$ = $axis$$25$$.$getLevels$()[$levelNum$$2$$];
    if ($level$$25$$.$isDataValue$()) {
      return this.$_processDataValue$($axis$$25$$, $currNode$$2_node$$66$$, $row$$27$$, $levelNum$$2$$, $keys$$24$$);
    }
    $currNode$$2_node$$66$$ = $currNode$$2_node$$66$$.$AddNode$($row$$27$$[$level$$25$$.attribute], null, $level$$25$$);
    $addKeys$$2$$ && $keys$$24$$.$UpdateKeys$($currNode$$2_node$$66$$);
    return this.$ProcessLevel$($axis$$25$$, $levelNum$$2$$ + 1, $currNode$$2_node$$66$$, $row$$27$$, $keys$$24$$, $addKeys$$2$$);
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_processDataValue$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_processDataValue$$($axis$$26$$, $node$$67$$, $row$$28$$, $levelNum$$3$$, $keys$$25$$) {
    for (var $dsKeysAdded$$ = !0, $d$$7$$ = 0;$d$$7$$ < this.$_dataValues$.length;$d$$7$$++) {
      var $dvAttr$$ = this.$_dataValues$[$d$$7$$].attribute, $currNode$$3_dvLabel$$ = this.$_dataValues$[$d$$7$$].label;
      $row$$28$$.hasOwnProperty($dvAttr$$) && ($currNode$$3_dvLabel$$ = $node$$67$$.$AddNode$($dvAttr$$, $currNode$$3_dvLabel$$, $axis$$26$$.$getLevels$()[$levelNum$$3$$]), $keys$$25$$.$AddDataValue$($dvAttr$$, $row$$28$$[$dvAttr$$]), this.$ProcessLevel$($axis$$26$$, $levelNum$$3$$ + 1, $currNode$$3_dvLabel$$, $row$$28$$, $keys$$25$$, $dsKeysAdded$$), $dsKeysAdded$$ = !1);
    }
    return $keys$$25$$;
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_buildAggTypeLookup$$() {
    this.$_dataValueAggType$ = [];
    for (var $i$$270$$ = 0;$i$$270$$ < this.$_dataValues$.length;$i$$270$$++) {
      var $dv$$1$$ = this.$_dataValues$[$i$$270$$];
