 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$65$$, $$$$60$$) {
  (function() {
    $oj$$65$$.$__registerWidget$("oj.ojRadioset", $$$$60$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{disabled:!1, value:void 0}, refresh:function() {
      this._super();
      this.$_setup$();
    }, widget:function() {
      ...
      $oj$$65$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"placeholder"}, {$attribute$:"required", $coerceDomValue$:!0, $validateOption$:!0}, {$attribute$:"title"}], $constructorOptions$$18$$, this);
      ...
      var $element$$144$$ = this.element;
      this._super();
      if ($element$$144$$.is("fieldset")) {
        throw Error("ojRadioset cannot be bound to a fieldset. Use a div instead.");
      }
      this.$$radios$._ojRadioCheckbox();
      this.$uiRadioset$ = $element$$144$$.addClass("oj-radioset oj-component").attr("role", "radiogroup").wrapInner("\x3cdiv class\x3d'oj-radioset-wrapper'\x3e\x3c/div\x3e");
      ...
      var $allradios_element$$145$$ = this.element, $first$$11_name$$118$$ = $allradios_element$$145$$.find("input[type\x3dradio]:first");
      0 === $first$$11_name$$118$$.length && $oj$$65$$.$Logger$.warn("Could not find any input type\x3dradio within this element");
      $first$$11_name$$118$$ = $first$$11_name$$118$$.attr("name");
      return void 0 === $first$$11_name$$118$$ ? ($allradios_element$$145$$ = $allradios_element$$145$$.find("input[type\x3dradio]"), $allradios_element$$145$$.not("[name]")) : $allradios_element$$145$$.find("input[type\x3dradio][name\x3d" + $first$$11_name$$118$$ + "]");
      ...
      var $inputElem$$1$$ = this.$_GetContentElement$(), $renderInputAs$$1$$ = $oj$$65$$.$ThemeUtils$.$getOptionDefaultMap$("radioset").renderInputAs;
    ...
    }, _setOption:function($key$$177$$, $value$$293$$) {
      this._superApply(arguments);
      "disabled" === $key$$177$$ && this.$_propagateDisabled$($value$$293$$);
    }, getNodeBySubId:function($locator$$52_subId$$56$$) {
      var $node$$112$$ = this._super($locator$$52_subId$$56$$);
      $node$$112$$ || ($locator$$52_subId$$56$$ = $locator$$52_subId$$56$$.subId, "oj-radioset-inputs" === $locator$$52_subId$$56$$ && ($node$$112$$ = this.$$radios$.get()));
      return $node$$112$$ || null;
    }, _destroy:function() {
      var $ret$$56$$ = this._super(), $wrapperDom$$1$$ = this.element[0].firstChild;
