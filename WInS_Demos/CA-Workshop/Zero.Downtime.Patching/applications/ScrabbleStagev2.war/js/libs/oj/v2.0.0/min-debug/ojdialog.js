...
/*
 ...
 http://jquery.org/license
*/
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore", "jqueryui-amd/draggable", "jqueryui-amd/mouse"], function($oj$$39$$, $$$$37$$) {
  (function() {
    $oj$$39$$.$__registerWidget$("oj.ojDialog", $$$$37$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancelBehavior:"icon", dragAffordance:"title-bar", initialVisibility:"hide", modality:"modal", position:{my:"center", at:"center", of:window, collision:"fit", $using$:function($pos$$9$$) {
      ...
      if (this.element.find(".oj-dialog").length) {
        var $that$$1$$ = this;
        this.element.find(".oj-dialog-header").each(function($index$$215$$, $li$$2$$) {
      ...
      if (this.isOpen() && (!1 !== this._trigger("beforeClose", $event$$430$$) || this.$_ignoreBeforeCloseResultant$)) {
        ...
        var $psOptions$$2$$ = {};
        $psOptions$$2$$[$oj$$39$$.$PopupService$.$OPTION$.$POPUP$] = this.$uiDialog$;
        $oj$$39$$.$PopupService$.$getInstance$().close($psOptions$$2$$);
      ...
      if (!1 !== this._trigger("beforeOpen", $event$$431_isRtl$$2_position$$21$$)) {
        if (!this.isOpen()) {
          ...
          $event$$431_isRtl$$2_position$$21$$ = $oj$$39$$.$PositionUtils$.$normalizeHorizontalAlignment$(this.options.position, $event$$431_isRtl$$2_position$$21$$);
          var $psOptions$$3$$ = {};
          $psOptions$$3$$[$oj$$39$$.$PopupService$.$OPTION$.$POPUP$] = this.$uiDialog$;
          $psOptions$$3$$[$oj$$39$$.$PopupService$.$OPTION$.$LAUNCHER$] = this.opener;
          $psOptions$$3$$[$oj$$39$$.$PopupService$.$OPTION$.$POSITION$] = $event$$431_isRtl$$2_position$$21$$;
          $psOptions$$3$$[$oj$$39$$.$PopupService$.$OPTION$.$MODALITY$] = this.options.modality;
          $psOptions$$3$$[$oj$$39$$.$PopupService$.$OPTION$.$EVENTS$] = this.$_getPopupServiceEvents$();
          $psOptions$$3$$[$oj$$39$$.$PopupService$.$OPTION$.$LAYER_SELECTORS$] = "oj-dialog-layer";
          $psOptions$$3$$[$oj$$39$$.$PopupService$.$OPTION$.$LAYER_LEVEL$] = $oj$$39$$.$PopupService$.$LAYER_LEVEL$.$TOP_LEVEL$;
          $oj$$39$$.$PopupService$.$getInstance$().open($psOptions$$3$$);
          this._trigger("open");
        }
        this.$_focusTabbable$();
      }
      ...
      $hasFocus$$ && 0 < $hasFocus$$.length && $oj$$39$$.$DomUtils$.$isAncestorOrSelf$(this.$uiDialog$[0], $hasFocus$$[0]) || ($hasFocus$$ || ($hasFocus$$ = this.element.find("[autofocus]")), $hasFocus$$.length || ($hasFocus$$ = this.element.find(":tabbable")), $hasFocus$$.length || this.$uiDialogFooter$.length && ($hasFocus$$ = this.$uiDialogFooter$.find(":tabbable")), $hasFocus$$.length || this.$uiDialogTitlebarClose$ && ($hasFocus$$ = this.$uiDialogTitlebarClose$.filter(":tabbable")), $hasFocus$$.length || 
      ($hasFocus$$ = this.$uiDialog$), $hasFocus$$.eq(0).focus(), this._trigger("focus"));
    }, _keepFocus:function($activeElement$$inline_869_event$$432$$) {
      $activeElement$$inline_869_event$$432$$.preventDefault();
      $activeElement$$inline_869_event$$432$$ = this.document[0].activeElement;
      this.$uiDialog$[0] === $activeElement$$inline_869_event$$432$$ || $$$$37$$.contains(this.$uiDialog$[0], $activeElement$$inline_869_event$$432$$) || this.$_focusTabbable$();
    }, $_isNumber$:function($value$$262$$) {
      return!isNaN(parseInt($value$$262$$, 10));
      ...
      this._on(this.$uiDialog$, {keyup:function() {
        ...
        if ("none" != this.options.cancelBehavior && !$event$$434$$.isDefaultPrevented() && $event$$434$$.keyCode && $event$$434$$.keyCode === $$$$37$$.ui.keyCode.ESCAPE) {
          ...
          if ($event$$434$$.keyCode === $$$$37$$.ui.keyCode.TAB && "modeless" !== this.options.modality) {
            var $tabbables$$ = this.$uiDialog$.find(":tabbable"), $first$$7_index$$216$$ = $tabbables$$.filter(":first"), $last$$4$$ = $tabbables$$.filter(":last");
            $event$$434$$.shiftKey ? $event$$434$$.shiftKey && ($event$$434$$.target === $first$$7_index$$216$$[0] || $event$$434$$.target === this.$uiDialog$[0] ? ($last$$4$$.focus(), $event$$434$$.preventDefault()) : ($first$$7_index$$216$$ = $tabbables$$.index(document.activeElement), 1 == $first$$7_index$$216$$ && $tabbables$$[0] && ($tabbables$$[0].focus(), $event$$434$$.preventDefault()))) : $event$$434$$.target === $last$$4$$[0] || $event$$434$$.target === this.$uiDialog$[0] ? ($first$$7_index$$216$$.focus(), 
            $event$$434$$.preventDefault()) : ($first$$7_index$$216$$ = $tabbables$$.index(document.activeElement), 0 == $first$$7_index$$216$$ && $tabbables$$[1] && ($tabbables$$[1].focus(), $event$$434$$.preventDefault()));
          }
        }
      }});
      ...
      var $isRtl$$3_position$$23$$ = "rtl" === this.$_GetReadingDirection$(), $isRtl$$3_position$$23$$ = $oj$$39$$.$PositionUtils$.$normalizeHorizontalAlignment$(this.options.position, $isRtl$$3_position$$23$$);
      this.$uiDialog$.position($isRtl$$3_position$$23$$);
      this.$_positionDescendents$();
    }, $_positionDescendents$:function() {
      $oj$$39$$.$PopupService$.$getInstance$().$triggerOnDescendents$(this.$uiDialog$, $oj$$39$$.$PopupService$.$EVENT$.$POPUP_REFRESH$);
    }, _setOption:function($isDraggable$$1_key$$156$$, $value$$263$$, $flags$$39$$) {
      var $isResizable_psOptions$$4_uiDialog$$;
      $isResizable_psOptions$$4_uiDialog$$ = this.$uiDialog$;
      if ("disabled" !== $isDraggable$$1_key$$156$$) {
        switch(this._super($isDraggable$$1_key$$156$$, $value$$263$$, $flags$$39$$), $isDraggable$$1_key$$156$$) {
          case "dragAffordance":
            ($isDraggable$$1_key$$156$$ = $isResizable_psOptions$$4_uiDialog$$.hasClass("oj-draggable")) && "none" === $value$$263$$ && ($isResizable_psOptions$$4_uiDialog$$.draggable("destroy"), this.$uiDialog$.removeClass("oj-draggable"));
            $isDraggable$$1_key$$156$$ || "title-bar" !== $value$$263$$ || this.$_makeDraggable$();
            break;
          case "position":
            this.$_position$();
            break;
          case "resizeBehavior":
            ...
            $isResizable_psOptions$$4_uiDialog$$ && "resizable" != $value$$263$$ && (this.$_resizableComponent$("instance") && this.$_resizableComponent$("destroy"), this.$_resizableComponent$ = null);
            $isResizable_psOptions$$4_uiDialog$$ || "resizable" !== $value$$263$$ || this.$_makeResizable$();
            break;
          case "title":
            this.$_title$(this.$uiDialogTitlebar$.find(".oj-dialog-title"));
            break;
          case "role":
            $isResizable_psOptions$$4_uiDialog$$.attr("role", $value$$263$$);
            break;
          case "modality":
            this.isOpen() && ($isResizable_psOptions$$4_uiDialog$$ = {}, $isResizable_psOptions$$4_uiDialog$$[$oj$$39$$.$PopupService$.$OPTION$.$POPUP$] = this.$uiDialog$, $isResizable_psOptions$$4_uiDialog$$[$oj$$39$$.$PopupService$.$OPTION$.$MODALITY$] = $value$$263$$, $oj$$39$$.$PopupService$.$getInstance$().$changeOptions$($isResizable_psOptions$$4_uiDialog$$));
            break;
          case "cancelBehavior":
            "none" === $value$$263$$ || "escape" === $value$$263$$ ? this.$_destroyCloseButton$() : "icon" === $value$$263$$ && (this.$userDefinedDialogHeader$ ? (this.$_destroyCloseButton$(), this.$_createCloseButton$(this.$_userDefinedHeader$), this.$_userDefinedTitle$ = this.$_userDefinedHeader$.find(".oj-dialog-title"), this.$_userDefinedTitle$.length && this.$_userDefinedTitle$.insertAfter(this.$uiDialogTitlebarCloseWrapper$)) : (this.$_destroyCloseButton$(), this.$_createCloseButton$(this.$uiDialogTitlebar$), 
      ...
      return null;
    }, getSubIdByNode:function($node$$88_nodeCached$$3$$) {
      if (null != $node$$88_nodeCached$$3$$) {
        $node$$88_nodeCached$$3$$ = $$$$37$$($node$$88_nodeCached$$3$$);
        if ($node$$88_nodeCached$$3$$.hasClass("oj-dialog-header")) {
          return{subId:"oj-dialog-header"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-dialog-footer")) {
          return{subId:"oj-dialog-footer"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-dialog-content")) {
          return{subId:"oj-dialog-content"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-dialog-header-close-wrapper")) {
          return{subId:"oj-dialog-header-close-wrapper"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-dialog-close-icon")) {
          return{subId:"oj-dialog-close"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-n")) {
          return{subId:"oj-resizable-n"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-e")) {
          return{subId:"oj-resizable-e"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-s")) {
          return{subId:"oj-resizable-s"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-w")) {
          return{subId:"oj-resizable-w"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-se")) {
          return{subId:"oj-resizable-se"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-sw")) {
          return{subId:"oj-resizable-sw"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-ne")) {
          return{subId:"oj-resizable-ne"};
        }
        if ($node$$88_nodeCached$$3$$.hasClass("oj-resizable-nw")) {
      ...
      if (!this.$_popupServiceEvents$) {
        ...
        $events$$4$$[$oj$$39$$.$PopupService$.$EVENT$.$POPUP_CLOSE$] = $$$$37$$.proxy(this.$_closeImplicitly$, this);
        $events$$4$$[$oj$$39$$.$PopupService$.$EVENT$.$POPUP_REMOVE$] = $$$$37$$.proxy(this.$_surrogateRemoveHandler$, this);
        $events$$4$$[$oj$$39$$.$PopupService$.$EVENT$.$POPUP_REFRESH$] = $$$$37$$.proxy(this.$_positionDescendents$, this);
      }
  ...
  (function() {
    $oj$$39$$.$__registerWidget$("oj.ojResizable", $$$$37$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancel:"input,textarea,button,select,option", distance:1, delay:0, maxHeight:null, maxWidth:null, minHeight:10, minWidth:10, alsoResize:!1, animate:!1, animateDuration:"slow", animateEasing:"swing", containment:!1, ghost:!1, grid:!1, handles:"e,s,se", helper:!1, resize:null, start:null, stop:null}, $_num$:function($value$$264$$) {
      return parseInt($value$$264$$, 10) || 0;
    }, $_isNumber$:function($value$$265$$) {
      return!isNaN(parseInt($value$$265$$, 10));
      ...
      this._super();
      var $n$$24_o$$, $i$$343_mouseConstructor$$, $handle$$19$$, $axis$$44$$, $hname$$, $that$$4$$ = this;
      $n$$24_o$$ = this.options;
      $i$$343_mouseConstructor$$ = this.element.mouse.bind(this.element);
      $i$$343_mouseConstructor$$();
      this.$mouse$ = $i$$343_mouseConstructor$$("instance");
      ...
      if (this.handles.constructor === String) {
        for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), $n$$24_o$$ = this.handles.split(","), this.handles = {}, $i$$343_mouseConstructor$$ = 0;$i$$343_mouseConstructor$$ < $n$$24_o$$.length;$i$$343_mouseConstructor$$++) {
          $handle$$19$$ = $$$$37$$.trim($n$$24_o$$[$i$$343_mouseConstructor$$]), $hname$$ = "oj-resizable-" + $handle$$19$$, $axis$$44$$ = $$$$37$$("\x3cdiv class\x3d'oj-resizable-handle " + $hname$$ + "'\x3e\x3c/div\x3e"), this.handles[$handle$$19$$] = ".oj-resizable-" + $handle$$19$$, this.element.append($axis$$44$$);
        }
      }
      this.$_renderAxis$ = function $this$$_renderAxis$$() {
        for (var $i$$344$$ in this.handles) {
          this.handles[$i$$344$$].constructor === String && (this.handles[$i$$344$$] = this.element.children(this.handles[$i$$344$$]).first().show());
        }
      };
      this.$_renderAxis$();
      ...
      var $i$$345$$, $handle$$20$$, $capture$$ = !1;
      for ($i$$345$$ in this.handles) {
        if ($handle$$20$$ = $$$$37$$(this.handles[$i$$345$$])[0], $handle$$20$$ === $event$$452$$.target || $$$$37$$.contains($handle$$20$$, $event$$452$$.target)) {
          $capture$$ = !0;
        }
      }
      ...
      var $data$$154_dx$$4$$, $el$$12$$ = this.helper, $props$$18$$ = {}, $dy$$4_smp$$ = this.$originalMousePosition$;
      ...
      $$$$37$$.isEmptyObject($props$$18$$) || this._trigger("resize", $event$$454$$, this.ui());
      return!1;
      ...
      if (this.$_proportionallyResizeElements$.length) {
        var $i$$346$$, $j$$43$$, $borders$$, $paddings$$, $prel$$, $element$$119$$ = this.helper || this.element;
        for ($i$$346$$ = 0;$i$$346$$ < this.$_proportionallyResizeElements$.length;$i$$346$$++) {
          $prel$$ = this.$_proportionallyResizeElements$[$i$$346$$];
          if (!this.$borderDif$) {
          ...
          $prel$$.css({height:$element$$119$$.height() - this.$borderDif$[0] - this.$borderDif$[2] || 0, width:$element$$119$$.width() - this.$borderDif$[1] - this.$borderDif$[3] || 0});
        }
      }
      ...
      "object" !== typeof $o$$6$$.alsoResize || $o$$6$$.alsoResize.parentNode ? $_store$$($o$$6$$.alsoResize) : $o$$6$$.alsoResize.length ? ($o$$6$$.alsoResize = $o$$6$$.alsoResize[0], $_store$$($o$$6$$.alsoResize)) : $$$$37$$.each($o$$6$$.alsoResize, function($exp$$3$$) {
        $_store$$($exp$$3$$);
      });
    }, $_alsoresize_resize$:function($event$$465$$, $ui$$29$$) {
      function $_alsoResize$$($exp$$4$$, $c$$45$$) {
        $$$$37$$($exp$$4$$).each(function() {
          var $el$$15$$ = $$$$37$$(this), $start$$55$$ = $$$$37$$(this).data("oj-resizable-alsoresize"), $style$$18$$ = {};
          $$$$37$$.each($c$$45$$ && $c$$45$$.length ? $c$$45$$ : $el$$15$$.parents($ui$$29$$.$originalElement$[0]).length ? ["width", "height"] : ["width", "height", "top", "left"], function($i$$347$$, $prop$$71$$) {
            var $sum$$ = ($start$$55$$[$prop$$71$$] || 0) + ($delta$$5$$[$prop$$71$$] || 0);
            $sum$$ && 0 <= $sum$$ && ($style$$18$$[$prop$$71$$] = $sum$$ || null);
          });
          $el$$15$$.css($style$$18$$);
        });
      }
      ...
      "object" !== typeof $o$$7$$.alsoResize || $o$$7$$.alsoResize.nodeType ? $_alsoResize$$($o$$7$$.alsoResize, null) : $$$$37$$.each($o$$7$$.alsoResize, function($exp$$5$$, $c$$46$$) {
        $_alsoResize$$($exp$$5$$, $c$$46$$);
      });
    }, $_alsoresize_stop$:function() {
      $$$$37$$(this).removeData("oj-resizable-alsoresize");
    }, $_containment_start$:function() {
      var $element$$120$$, $p$$6$$, $co_oc$$, $ch$$3_height$$26$$, $cw$$1_width$$28$$, $that$$8$$ = this, $ce_el$$16$$ = $that$$8$$.element;
      ...
      if ($ce_el$$16$$ = $co_oc$$ instanceof $$$$37$$ ? $co_oc$$.get(0) : /parent/.test($co_oc$$) ? $ce_el$$16$$.parent().get(0) : $co_oc$$) {
        $that$$8$$.$containerElement$ = $$$$37$$($ce_el$$16$$), /document/.test($co_oc$$) || $co_oc$$ === document ? ($that$$8$$.$containerOffset$ = {left:0, top:0}, $that$$8$$.$containerPosition$ = {left:0, top:0}, $that$$8$$.$parentData$ = {element:$$$$37$$(document), left:0, top:0, width:$$$$37$$(document).width(), height:$$$$37$$(document).height() || document.body.parentNode.scrollHeight}) : ($element$$120$$ = $$$$37$$($ce_el$$16$$), $p$$6$$ = [], $$$$37$$(["Top", "Right", "Left", "Bottom"]).each(function($i$$348$$, 
        $name$$114$$) {
          $p$$6$$[$i$$348$$] = $that$$8$$.$_num$($element$$120$$.css("padding" + $name$$114$$));
        }), $that$$8$$.$containerOffset$ = $element$$120$$.offset(), $that$$8$$.$containerPosition$ = $element$$120$$.position(), $that$$8$$.$containerSize$ = {height:$element$$120$$.innerHeight() - $p$$6$$[3], width:$element$$120$$.innerWidth() - $p$$6$$[1]}, $co_oc$$ = $that$$8$$.$containerOffset$, $ch$$3_height$$26$$ = $that$$8$$.$containerSize$.height, $cw$$1_width$$28$$ = $that$$8$$.$containerSize$.width, $cw$$1_width$$28$$ = $that$$8$$.$_hasScroll$($ce_el$$16$$, "left") ? $ce_el$$16$$.scrollWidth : 
