package com.oracle.example.jms.base.topic.rdt;
...
@MessageDriven(
    ...
    name = "RDTListenerBeanA",
    mappedName = "com/oracle/example/jms/base/replicated-topic",
    activationConfig = {
...
public class RDTListenerBeanA
    implements MessageListener
{
  public static final boolean DEBUG = false;

  public RDTListenerBeanA()
  {
  }
  ...
  public void onMessage(Message message)
  {
    ...
    if (message instanceof TextMessage)
    {
      ...
      try
      {
        System.out.println("A - RDTListenerBeanA Message:" + msg.getText());
      }
      catch (JMSException e)
      {
        e.printStackTrace();
