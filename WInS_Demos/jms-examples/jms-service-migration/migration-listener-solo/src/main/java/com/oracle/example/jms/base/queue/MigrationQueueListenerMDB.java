...
@MessageDriven(
    ...
    name = "MigrationQueueListenerMDB",
    mappedName = "com/oracle/example/jms/migration/queue",
    activationConfig = {
    ...
    implements MessageListener, Serializable
{
  ...
  public MigrationQueueListenerMDB()
  {
  }
  ...
  public void onMessage(Message message)
  {
    ...
    if (message instanceof TextMessage)
    {
      ...
      try
      {
        System.out.println("QueueListenerSOLOMDB - Queue Message:" + msg.getText());
      }
      catch (JMSException e)
      {
        e.printStackTrace();
